...
* resource/aws_quicksight_analysis: Covert `permissions` argument to set type, preventing persistent differences ([#33023](https://github.com/hashicorp/terraform-provider-aws/issues/33023))
...
* resource/aws_quicksight_dashboard: Covert `permissions` argument to set type, preventing persistent differences ([#33023](https://github.com/hashicorp/terraform-provider-aws/issues/33023))
...
* resource/aws_quicksight_template: Covert `permissions` argument to set type, preventing persistent differences ([#33023](https://github.com/hashicorp/terraform-provider-aws/issues/33023))
