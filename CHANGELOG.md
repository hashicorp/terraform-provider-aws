...
* resource/aws_cloudfront_response_headers_policy: Add `remove_headers_config` argument ([#28694](https://github.com/hashicorp/terraform-provider-aws/issues/28694))
