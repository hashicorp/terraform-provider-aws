...
* resource/aws_directory_service_directory Validate `size` argument [GH-3453]
...
* resource/aws_ecs_service: Fix reading `load_balancer` into state [GH-3502]
...
* resource/aws_cognito_user_pool_client: support `USER_PASSWORD_AUTH` for explicit_auth_flows [GH-3417]
