...
* resource/aws_appmesh_virtual_node: Add Support for multiple listeners ([#26380](https://github.com/hashicorp/terraform-provider-aws/issues/26380))
* resource/aws_appmesh_virtual_router: Add Support for multiple listeners ([#26380](https://github.com/hashicorp/terraform-provider-aws/issues/26380))
* resource/aws_appmesh_virtual_gateway: Add Support for multiple listeners ([#26380](https://github.com/hashicorp/terraform-provider-aws/issues/26380))
...
* resource/aws_db_instance: Ensure that `apply_immediately` default value is applied ([#28298](https://github.com/hashicorp/terraform-provider-aws/issues/28298))
