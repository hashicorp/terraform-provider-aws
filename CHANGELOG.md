...
* resource/aws_config_config_rule: Update validation regex on name to allow for 128 characters. ([#27798](https://github.com/hashicorp/terraform-provider-aws/issues/27798))
