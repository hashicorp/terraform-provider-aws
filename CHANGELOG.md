...
* resource/aws_batch_job_definition: Add `evaluate_on_exit` argument to `retry_strategy` configuration block ([#16940](https://github.com/hashicorp/terraform-provider-aws/issues/16940))
* resource/aws_batch_job_definition: Add `platform_capabilities` argument ([#16850](https://github.com/hashicorp/terraform-provider-aws/issues/16850))
...
* resource/aws_datasync_task: Add `log_level` argument ([#18932](https://github.com/hashicorp/terraform-provider-aws/issues/18932))
