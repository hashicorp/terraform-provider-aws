...
func TestAccAWSMqConfiguration_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			tfaws.HelperAccTestPreCheck(t)
			tfaws.HelperAccTestPartitionHasServicePreCheck(mq.EndpointsID, t)
			testAccPreCheckAWSMq(t)
		},
		ErrorCheck:   tfaws.HelperAccTestErrorCheck(t, mq.EndpointsID),
		Providers:    tfaws.HelperAccTestProviders,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					tfaws.HelperAccTestMatchResourceAttrRegionalARN(resourceName, "arn", "mq", regexp.MustCompile(`configuration:+.`)),
...
func testAccCheckAwsMqConfigurationDestroy(s *terraform.State) error {
	conn := tfaws.HelperAccTestProvider.Meta().(*tfaws.AWSClient).MQconn
