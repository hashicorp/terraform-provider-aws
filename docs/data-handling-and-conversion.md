...
- **Terraform Plugin Framework**: High-level library that converts Go code into Terraform Plugin Protocol compatible operations and data types. This library replaces Plugin SDK V2. See [Terraform Plugin Versions](terraform-plugin-versions.md) for more information. [Project](https://github.com/hashicorp/terraform-plugin-framework).
- **Terraform Plugin SDK V2**: High-level library that converts Go code into Terraform Plugin Protocol compatible operations and data types. This library is replaced by Plugin Framework. See [Terraform Plugin Versions](terraform-plugin-versions.md) for more information. [Project](https://github.com/hashicorp/terraform-plugin-sdk).
