...
func TestAccAwsVpcIpv4CidrBlockAssociation_basicIpam(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAwsVpcIpv4CidrBlockAssociationIpam(netmaskLength),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsVpcIpv4CidrBlockAssociationExists("aws_vpc_ipv4_cidr_block_association.secondary_cidr", &associationSecondary),
...
func TestAccAwsVpcIpv4CidrBlockAssociation_basicIpamExplicitCidr(t *testing.T) {
	var associationSecondary ec2.VpcCidrBlockAssociation
	cidr := "172.2.0.0/28"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAwsVpcIpv4CidrBlockAssociationIpamExplicitCidr(cidr),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsVpcIpv4CidrBlockAssociationExists("aws_vpc_ipv4_cidr_block_association.secondary_cidr", &associationSecondary),
					testAccCheckAdditionalAwsVpcIpv4CidrBlock(&associationSecondary, "172.2.0.0/28")),
			},
			{
				ResourceName:            "aws_vpc_ipv4_cidr_block_association.secondary_cidr",
				ImportState:             true,
...
func testAccAwsVpcIpv4CidrBlockAssociationIpam(netmaskLength string) string {
...
func testAccAwsVpcIpv4CidrBlockAssociationIpamExplicitCidr(cidr string) string {
	return testAccVpcIpamBase + fmt.Sprintf(`
resource "aws_vpc" "test" {
	cidr_block = "10.0.0.0/16"
