		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					atest.CheckAttrRfc3339(dataSourceName, "delegated_services.0.delegation_enabled_date"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					atest.CheckAttrRfc3339(dataSourceName, "delegated_services.0.delegation_enabled_date"),
					resource.TestCheckResourceAttr(dataSourceName, "delegated_services.0.service_principal", servicePrincipal),
					atest.CheckAttrRfc3339(dataSourceName, "delegated_services.1.delegation_enabled_date"),
...
func testAccDataSourceAwsOrganizationsDelegatedServicesEmptyConfig() string {
	return atest.ConfigProviderAlternateAccount() + `
