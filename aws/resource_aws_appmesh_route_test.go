		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.2995937615.invert", "false"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.2995937615.match.#", "0"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.2995937615.name", "X-Testing1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3692984846.invert", "true"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3692984846.match.#", "0"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3692984846.name", "X-Testing1"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.invert", "false"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.match.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.match.0.exact", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.match.0.prefix", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.match.0.range.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.match.0.range.0.end", "7"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.match.0.range.0.start", "2"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.match.0.regex", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.match.0.suffix", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.3002668394.name", "X-Testing2"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.2995937615.invert", "false"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.2995937615.match.#", "0"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.2995937615.name", "X-Testing1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3692984846.invert", "true"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3692984846.match.#", "0"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3692984846.name", "X-Testing1"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.invert", "false"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.match.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.match.0.exact", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.match.0.prefix", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.match.0.range.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.match.0.range.0.end", "7"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.match.0.range.0.start", "2"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.match.0.regex", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.match.0.suffix", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.3002668394.name", "X-Testing2"),
