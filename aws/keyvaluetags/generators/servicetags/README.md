...
```text
aws/keyvaluetags/service_tags_gen.go:397:43: undefined: appmesh.Tag
aws/keyvaluetags/service_tags_gen.go:398:20: undefined: appmesh.Tag
aws/keyvaluetags/service_tags_gen.go:401:11: undefined: appmesh.Tag
aws/keyvaluetags/service_tags_gen.go:413:34: undefined: appmesh.Tag
```
...
```text
aws/keyvaluetags/service_tags_gen.go:1563:4: unknown field 'Key' in struct literal of type kms.Tag
aws/keyvaluetags/service_tags_gen.go:1578:24: tag.Key undefined (type *kms.Tag has no field or method Key)
```
...
```text
aws/keyvaluetags/service_tags_gen.go:1564:4: unknown field 'Value' in struct literal of type kms.Tag
aws/keyvaluetags/service_tags_gen.go:1578:39: tag.Value undefined (type *kms.Tag has no field or method Value)
```
