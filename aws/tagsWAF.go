...
func setTagsWAF(conn *waf.WAF, d *schema.ResourceData) error {
	if d.HasChange("tags") {
		oraw, nraw := d.GetChange("tags")
		o := oraw.(map[string]interface{})
		n := nraw.(map[string]interface{})
		create, remove := diffTagsWAF(tagsFromMapWAF(o), tagsFromMapWAF(n))
...
// be destroyed.
func diffTagsWAF(oldTags, newTags []*waf.Tag) ([]*waf.Tag, []*waf.Tag) {
