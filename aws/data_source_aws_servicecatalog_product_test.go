		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "provisioning_artifacts.#", "1"),
					resource.TestCheckResourceAttrSet(dataSourceName, "provisioning_artifacts.0.id"),
					resource.TestCheckResourceAttrPair(resourceName, "provisioning_artifact_parameters.0.name", dataSourceName, "provisioning_artifacts.0.name"),
					resource.TestCheckResourceAttrPair(resourceName, "provisioning_artifact_parameters.0.description", dataSourceName, "provisioning_artifacts.0.description"),
				),
			},
		},
	})
