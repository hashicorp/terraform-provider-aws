		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "port_ranges.0.from_port", "80"),
					resource.TestCheckResourceAttr(resourceName, "port_ranges.0.to_port", "81"),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "port_ranges.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "port_ranges.0.from_port", "443"),
					resource.TestCheckResourceAttr(resourceName, "port_ranges.0.to_port", "444"),
				),
			},
			{
				ResourceName:      resourceName,
