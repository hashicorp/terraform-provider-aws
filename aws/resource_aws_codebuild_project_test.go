		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "source.2491592095.git_clone_depth", gitCloneDepth),
					resource.TestCheckResourceAttr(resourceName, "source.2491592095.insecure_ssl", insecureSsl),
					resource.TestCheckResourceAttr(resourceName, "source.2491592095.auth.2706882902.resource", authResource),
					resource.TestCheckResourceAttr(resourceName, "source.2491592095.auth.2706882902.type", authType),
				),
			},
		},
	})
