	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSCodeBuildProjectExists(resourceName, &project),
					resource.TestCheckResourceAttr(resourceName, "environment.1580725535.environment_variable.0.type", "PLAINTEXT"),
					resource.TestCheckResourceAttr(resourceName, "environment.1580725535.environment_variable.1.type", "SECRETS_MANAGER"),
				),
			},
		},
	})
