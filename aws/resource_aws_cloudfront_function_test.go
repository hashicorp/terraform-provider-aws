		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf),
					...
					testAccCheckAwsCloudfrontFunctionInvokeArn(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "reserved_concurrent_executions", "-1"),
					resource.TestCheckResourceAttr(resourceName, "version", CloudfrontFunctionVersionLatest),
					resource.TestCheckResourceAttr(resourceName, "package_type", lambda.PackageTypeZip),
					testAccCheckResourceAttrRegionalARN(resourceName, "qualified_arn", "lambda", fmt.Sprintf("function:%s:%s", funcName, CloudfrontFunctionVersionLatest)),
				),
			},
			{
...
func TestAccAWSCloudfrontFunction_UnpublishedCodeUpdate(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf1),
					resource.TestCheckResourceAttr(resourceName, "version", CloudfrontFunctionVersionLatest),
					testAccCheckResourceAttrRegionalARN(resourceName, "qualified_arn", "lambda", fmt.Sprintf("function:%s:%s", funcName, CloudfrontFunctionVersionLatest)),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf2),
					resource.TestCheckResourceAttr(resourceName, "version", CloudfrontFunctionVersionLatest),
					testAccCheckResourceAttrRegionalARN(resourceName, "qualified_arn", "lambda", fmt.Sprintf("function:%s:%s", funcName, CloudfrontFunctionVersionLatest)),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, rName, &function),
...
func TestAccAWSCloudfrontFunction_codeSigningConfig(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_concurrency(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_concurrencyCycle(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_expectFilenameAndS3Attributes(t *testing.T) {
	rString := acctest.RandString(8)
...
func TestAccAWSCloudfrontFunction_envVariables(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_Environment_Variables_NoValue(t *testing.T) {
	var conf lambda.GetFunctionOutput
	rName := acctest.RandomWithPrefix("tf-acc-test")
	resourceName := "aws_lambda_function.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, rName, &conf),
...
func TestAccAWSCloudfrontFunction_encryptedEnvVariables(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_versioned(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_versionedUpdate(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_enablePublish(t *testing.T) {
	...
	unpublishedVersion := CloudfrontFunctionVersionLatest
	publishedVersion := "1"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf1),
					testAccCheckAwsCloudfrontFunctionName(&conf1, funcName),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf2),
					testAccCheckAwsCloudfrontFunctionName(&conf2, funcName),
			...
			},
			{
				...
				Config: testAccAWSLambdaConfigPublishable(fileName, funcName, policyName, roleName, sgName, true),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf3),
					testAccCheckAwsCloudfrontFunctionName(&conf3, funcName),
					testAccCheckResourceAttrRegionalARN(resourceName, "arn", "lambda", fmt.Sprintf("function:%s", funcName)),
					resource.TestCheckResourceAttr(resourceName, "version", publishedVersion),
					testAccCheckResourceAttrRegionalARN(resourceName, "qualified_arn", "lambda", fmt.Sprintf("function:%s:%s", funcName, publishedVersion)),
				),
...
func TestAccAWSCloudfrontFunction_disablePublish(t *testing.T) {
	var conf1, conf2 lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_DeadLetterConfig(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_DeadLetterConfigUpdated(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_nilDeadLetterConfig(t *testing.T) {
	rString := acctest.RandString(8)
...
func TestAccAWSCloudfrontFunction_FileSystemConfig(t *testing.T) {
	var conf lambda.GetFunctionOutput
	resourceName := "aws_lambda_function.test"
...
func TestAccAWSCloudfrontFunction_imageConfig(t *testing.T) {
	var conf lambda.GetFunctionOutput
	resourceName := "aws_lambda_function.test"
...
func TestAccAWSCloudfrontFunction_tracingConfig(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_KmsKeyArn_NoEnvironmentVariables(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, rName, &function1),
					resource.TestCheckResourceAttr(resourceName, "kms_key_arn", ""),
				),
				ExpectNonEmptyPlan: true,
			},
...
func TestAccAWSCloudfrontFunction_Layers(t *testing.T) {
	var conf lambda.GetFunctionOutput
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckAwsCloudfrontFunctionName(&conf, funcName),
					testAccCheckResourceAttrRegionalARN(resourceName, "arn", "lambda", fmt.Sprintf("function:%s", funcName)),
					testAccCheckAWSCloudfrontFunctionVersion(&conf, CloudfrontFunctionVersionLatest),
...
func TestAccAWSCloudfrontFunction_LayersUpdate(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_VPC(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_VPCRemoval(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_VPCUpdate(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_VPC_withInvocation(t *testing.T) {
	var conf lambda.GetFunctionOutput
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf),
					testAccAwsInvokeCloudfrontFunction(&conf),
				),
			},
			{
				ResourceName:            resourceName,
...
func TestAccAWSCloudfrontFunction_VpcConfig_ProperIamDependencies(t *testing.T) {
	var function lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_EmptyVpcConfig(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_s3(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_localUpdate(t *testing.T) {
	var conf lambda.GetFunctionOutput
		...
		Steps: []resource.TestStep{
			{
				...
				Config: genAWSCloudfrontFunctionConfig_local(path, roleName, funcName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf),
					testAccCheckAwsCloudfrontFunctionName(&conf, funcName),
					testAccCheckResourceAttrRegionalARN(resourceName, "arn", "lambda", fmt.Sprintf("function:%s", funcName)),
...
func TestAccAWSCloudfrontFunction_localUpdate_nameOnly(t *testing.T) {
	var conf lambda.GetFunctionOutput
		...
		Steps: []resource.TestStep{
			{
				...
				Config: genAWSCloudfrontFunctionConfig_local_name_only(path, roleName, funcName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf),
					testAccCheckAwsCloudfrontFunctionName(&conf, funcName),
					testAccCheckResourceAttrRegionalARN(resourceName, "arn", "lambda", fmt.Sprintf("function:%s", funcName)),
			...
			},
			{
				...
				Config: genAWSCloudfrontFunctionConfig_local_name_only(updatedPath, roleName, funcName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf),
					testAccCheckAwsCloudfrontFunctionName(&conf, funcName),
					testAccCheckResourceAttrRegionalARN(resourceName, "arn", "lambda", fmt.Sprintf("function:%s", funcName)),
...
func TestAccAWSCloudfrontFunction_s3Update_basic(t *testing.T) {
	var conf lambda.GetFunctionOutput
		...
		Steps: []resource.TestStep{
			{
				...
				Config: genAWSCloudfrontFunctionConfig_s3(bucketName, key, path, roleName, funcName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf),
					testAccCheckAwsCloudfrontFunctionName(&conf, funcName),
					testAccCheckResourceAttrRegionalARN(resourceName, "arn", "lambda", fmt.Sprintf("function:%s", funcName)),
...
func TestAccAWSCloudfrontFunction_s3Update_unversioned(t *testing.T) {
	var conf lambda.GetFunctionOutput
		...
		Steps: []resource.TestStep{
			{
				...
				Config: testAccAWSCloudfrontFunctionConfig_s3_unversioned_tpl(bucketName, roleName, funcName, key, path),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf),
					testAccCheckAwsCloudfrontFunctionName(&conf, funcName),
					testAccCheckResourceAttrRegionalARN(resourceName, "arn", "lambda", fmt.Sprintf("function:%s", funcName)),
			...
			},
			{
				...
				Config: testAccAWSCloudfrontFunctionConfig_s3_unversioned_tpl(bucketName, roleName, funcName, key2, path),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudfrontFunctionExists(resourceName, funcName, &conf),
					testAccCheckAwsCloudfrontFunctionName(&conf, funcName),
					testAccCheckResourceAttrRegionalARN(resourceName, "arn", "lambda", fmt.Sprintf("function:%s", funcName)),
...
func TestAccAWSCloudfrontFunction_tags(t *testing.T) {
	var conf lambda.GetFunctionOutput
...
func TestAccAWSCloudfrontFunction_runtimes(t *testing.T) {
	...
	for _, runtime := range lambda.Runtime_Values() {
		...
		steps = append(steps, resource.TestStep{
			...
			Check: resource.ComposeTestCheckFunc(
				testAccCheckAwsCloudfrontFunctionExists(resourceName, rName, &v),
...
func testAccCheckAwsCloudfrontFunctionDisappears(function *lambda.GetFunctionOutput) resource.TestCheckFunc {
...
func testAccCheckAwsCloudfrontFunctionExists(res, funcName string, function *lambda.GetFunctionOutput) resource.TestCheckFunc {
	// Wait for IAM role
	return func(s *terraform.State) error {
...
func testAccCheckAwsCloudfrontFunctionInvokeArn(name string, function *lambda.GetFunctionOutput) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
func testAccAwsInvokeCloudfrontFunction(function *lambda.GetFunctionOutput) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
func testAccCheckAwsCloudfrontFunctionName(function *lambda.GetFunctionOutput, expectedName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
func testAccCheckAWSCloudfrontFunctionVersion(function *lambda.GetFunctionOutput, expectedVersion string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		c := function.Configuration
...
func genAWSCloudfrontFunctionConfig_local(filePath, roleName, funcName string) string {
	return fmt.Sprintf(`
resource "aws_iam_role" "iam_for_lambda" {
  name = "%s"
...
func genAWSCloudfrontFunctionConfig_local_name_only(filePath, roleName, funcName string) string {
	return testAccAWSCloudfrontFunctionConfig_local_name_only_tpl(filePath, roleName, funcName)
}

func testAccAWSCloudfrontFunctionConfig_local_name_only_tpl(filePath, roleName, funcName string) string {
	return fmt.Sprintf(`
resource "aws_iam_role" "iam_for_lambda" {
  name = "%s"
...
func genAWSCloudfrontFunctionConfig_s3(bucketName, key, path, roleName, funcName string) string {
	return fmt.Sprintf(`
...
func testAccAWSCloudfrontFunctionConfig_s3_unversioned_tpl(bucketName, roleName, funcName, key, path string) string {
	return fmt.Sprintf(`
resource "aws_s3_bucket" "artifacts" {
  bucket        = "%s"
  acl           = "private"
