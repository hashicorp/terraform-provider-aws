		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					atest.MatchAttrRegionalARN(resourceName, "arn", "macie2", regexp.MustCompile(`findings-filter/.+`)),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					atest.CheckAttrRfc3339(resourceName, "finding_criteria.0.criterion.2.gte"),
					atest.CheckAttrRfc3339(resourceName, "finding_criteria.0.criterion.2.lt"),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "finding_criteria.0.criterion.*", map[string]string{
						"field": "sample",
						"neq.#": "2",
