...
func testSweepDbInstances(region string) error {
	...
	return atest.TestSweepResourceOrchestrator(sweepResources)
}
...
func TestAccAWSDBInstance_ReplicateSourceDb_DbSubnetGroupName_RamShared(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		ErrorCheck:        atest.ErrorCheck(t, rds.EndpointsID),
		ProviderFactories: atest.ProviderFactoriesAlternateAccountAndAlternateRegion(&providers),
		CheckDestroy:      testAccCheckAWSDBInstanceDestroy,
		Steps: []resource.TestStep{
			{
...
func TestAccAWSDBInstance_ReplicateSourceDb_DeletionProtection(t *testing.T) {
	atest.Skip(t, "CreateDBInstanceReadReplica API currently ignores DeletionProtection=true with SourceDBInstanceIdentifier set")
...
func TestAccAWSDBInstance_SnapshotIdentifier_Tags_Unset(t *testing.T) {
	atest.Skip(t, "To be fixed: https://github.com/hashicorp/terraform-provider-aws/issues/5959")
...
func testAccCheckAWSDBInstanceSnapshot(s *terraform.State) error {
	for _, rs := range s.RootModule().Resources {
		...
		awsClient := atest.Provider.Meta().(*awsprovider.AWSClient)
...
func testAccCheckAWSDBInstanceEc2ClassicDestroy(s *terraform.State) error {
	conn := testAccProviderEc2Classic.Meta().(*awsprovider.AWSClient).RDSConn
...
func TestAccAWSDBInstance_PerformanceInsightsEnabled_DisabledToEnabled(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		PreCheck:     func() { atest.PreCheck(t); testAccRDSPerformanceInsightsDefaultVersionPreCheck(t, "mysql") },
		ErrorCheck:   atest.ErrorCheck(t, rds.EndpointsID),
		Providers:    atest.Providers,
...
func testAccAWSDBInstanceConfig_basic() string {
	return atest.ComposeConfig(testAccAWSDBInstanceConfig_orderableClassMysql(), `
...
func testAccAWSDBInstanceConfig_WithOptionGroup(rName string) string {
	return atest.ComposeConfig(testAccAWSDBInstanceConfig_orderableClassMysql(), fmt.Sprintf(`
...
func testAccAWSDBInstanceConfig_MariaDB(rName string) string {
	return atest.ComposeConfig(testAccAWSDBInstanceConfig_orderableClassMariadb(), fmt.Sprintf(`
resource "aws_db_instance" "test" {
  allocated_storage   = 5
  engine              = data.aws_rds_orderable_db_instance.test.engine
  identifier          = %q
...
func testAccAWSDBInstanceConfig_ReplicateSourceDb_DbSubnetGroupName(rName string) string {
	return atest.ComposeConfig(
		atest.ConfigProviderAlternateRegion(),
		testAccAvailableAZsNoOptInConfig(),
		fmt.Sprintf(`
data "aws_availability_zones" "alternate" {
  provider = "awsalternate"
...
func testAccAWSDBInstanceConfig_ReplicateSourceDb_DbSubnetGroupName_RamShared(rName string) string {
	return atest.ComposeConfig(atest.ConfigProviderAlternateAccountAndAlternateRegion() + fmt.Sprintf(`
