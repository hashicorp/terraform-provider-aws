		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aws_lb_listener.front_end", "last_rule_priority", "0"),
					resource.TestCheckResourceAttr("data.aws_lb_listener.front_end", "next_rule_priority", "1"),
					...
					resource.TestCheckResourceAttr("data.aws_lb_listener.from_lb_and_port", "last_rule_priority", "0"),
					resource.TestCheckResourceAttr("data.aws_lb_listener.from_lb_and_port", "next_rule_priority", "1"),
				),
			},
		},
	})
