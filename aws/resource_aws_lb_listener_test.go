...
func TestAccAWSLBListener_forwardWeighted(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		PreCheck:      func() { testAccPreCheck(t) },
		IDRefreshName: "aws_lb_listener.weighted",
		Providers:     testAccProviders,
		CheckDestroy:  testAccCheckAWSLBListenerDestroy,
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.forward.#", "1"),
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.forward.0.target_group.#", "2"),
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.forward.0.stickiness.0.enabled", "false"),
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.forward.0.stickiness.0.duration", "0"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.forward.#", "1"),
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.forward.0.target_group.#", "2"),
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.forward.0.stickiness.0.enabled", "true"),
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.forward.0.stickiness.0.duration", "3600"),
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.redirect.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener.weighted", "default_action.0.fixed_response.#", "0"),
				),
			},
