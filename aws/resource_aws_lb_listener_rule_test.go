...
func TestAccAWSLBListenerRule_forwardWeighted(t *testing.T) {
	var conf elbv2.Rule
	lbName := fmt.Sprintf("testrule-weighted-%s", acctest.RandStringFromCharSet(13, acctest.CharSetAlphaNum))
	...
	resource.ParallelTest(t, resource.TestCase{
		PreCheck:      func() { testAccPreCheck(t) },
		IDRefreshName: "aws_lb_listener_rule.weighted",
		Providers:     testAccProviders,
		CheckDestroy:  testAccCheckAWSLBListenerRuleDestroy,
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckAWSLBListenerRuleExists("aws_lb_listener_rule.weighted", &conf),
					testAccMatchResourceAttrRegionalARN("aws_lb_listener_rule.weighted", "arn", "elasticloadbalancing", regexp.MustCompile("listener-rule/.+$")),
					testAccMatchResourceAttrRegionalARN("aws_lb_listener_rule.weighted", "listener_arn", "elasticloadbalancing", regexp.MustCompile("listener/.+$")),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "priority", "100"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.#", "1"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.order", "1"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.type", "forward"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.forward.#", "1"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.forward.0.target_group.#", "2"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.forward.0.stickiness.0.enabled", "false"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.forward.0.stickiness.0.duration", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.redirect.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.fixed_response.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.authenticate_cognito.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.authenticate_oidc.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "condition.#", "1"),
				),
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.forward.#", "1"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.forward.0.target_group.#", "2"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.forward.0.stickiness.0.enabled", "true"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.forward.0.stickiness.0.duration", "3600"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.redirect.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.fixed_response.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.authenticate_cognito.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.authenticate_oidc.#", "0"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.order", "1"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.type", "forward"),
					testAccMatchResourceAttrRegionalARN("aws_lb_listener_rule.weighted", "action.0.target_group_arn", "elasticloadbalancing", regexp.MustCompile("targetgroup/.+$")),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.redirect.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.fixed_response.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.authenticate_cognito.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.weighted", "action.0.authenticate_oidc.#", "0"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testAccMatchResourceAttrRegionalARN("aws_lb_listener_rule.cognito", "action.1.target_group_arn", "cognito-idp", regexp.MustCompile("userpool/.+$")),
