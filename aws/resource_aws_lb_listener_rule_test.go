		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aws_lb_listener_rule.static", "condition.447032695.host_header_config.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.static", "condition.447032695.http_header_config.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.static", "condition.447032695.path_pattern_config.#", "1"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.static", "condition.447032695.path_pattern_config.0.values.#", "1"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.static", "condition.447032695.query_string_config.#", "0"),
					resource.TestCheckResourceAttr("aws_lb_listener_rule.static", "condition.447032695.source_ip_config.#", "0"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aws_alb_listener_rule.static", "condition.447032695.host_header_config.#", "0"),
					resource.TestCheckResourceAttr("aws_alb_listener_rule.static", "condition.447032695.http_header_config.#", "0"),
					resource.TestCheckResourceAttr("aws_alb_listener_rule.static", "condition.447032695.path_pattern_config.#", "1"),
					resource.TestCheckResourceAttr("aws_alb_listener_rule.static", "condition.447032695.path_pattern_config.0.values.#", "1"),
					resource.TestCheckResourceAttr("aws_alb_listener_rule.static", "condition.447032695.query_string_config.#", "0"),
					resource.TestCheckResourceAttr("aws_alb_listener_rule.static", "condition.447032695.source_ip_config.#", "0"),
