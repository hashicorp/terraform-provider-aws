...
func TestAccAWSDbInstancesDataSource_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: TestAccAWSDbInstancesDataSourceConfig(rInt),
...
func TestAccAWSDbInstancesDataSource_ec2Classic(t *testing.T) {
	rInt := acctest.RandInt()
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: TestAccAWSDbInstancesDataSourceConfig_ec2Classic(rInt),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccAWSDbInstancesDataSourceConfig(rInt int) string {
	return fmt.Sprintf(`
...
func TestAccAWSDbInstancesDataSourceConfig_ec2Classic(rInt int) string {
