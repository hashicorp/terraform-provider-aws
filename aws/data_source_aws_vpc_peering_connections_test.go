		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aws_vpc_peering_connections.test_by_filters", "cidr_blocks.#", "1"),
					resource.TestCheckResourceAttr("data.aws_vpc_peering_connections.test_by_filters", "peer_cidr_blocks.#", "2"),
				),
