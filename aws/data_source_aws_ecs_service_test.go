		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "health_check_grace_period_seconds", dataSourceName, "health_check_grace_period_seconds"),
					resource.TestCheckResourceAttrPair(resourceName, "propagate_tags", dataSourceName, "propagate_tags"),
