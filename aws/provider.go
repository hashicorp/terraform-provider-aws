...
func Provider() terraform.ResourceProvider {
	...
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aws_dx_private_vif":                           resourceAwsDxPrivateVif(),
			"aws_dx_private_vif_allocation":                resourceAwsDxPrivateVifAllocation(),
			"aws_dx_private_vif_confirmation":              resourceAwsDxPrivateVifConfirmation(),
