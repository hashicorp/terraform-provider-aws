...
func Provider() terraform.ResourceProvider {
	...
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aws_servicecatalog_launch_notification_constraint":       resourceAwsServiceCatalogLaunchNotificationConstraint(),
			"aws_servicecatalog_launch_role_constraint":               resourceAwsServiceCatalogLaunchRoleConstraint(),
			"aws_servicecatalog_launch_template_constraint":           resourceAwsServiceCatalogLaunchTemplateConstraint(),
