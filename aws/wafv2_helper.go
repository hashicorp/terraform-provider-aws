			...
			Schema: map[string]*schema.Schema{
				...
				"type": {
					...
					ValidateFunc: validation.StringInSlice([]string{
						...
						wafv2.TextTransformationTypeHexDecode,
						wafv2.TextTransformationTypeMd5,
						wafv2.TextTransformationTypeReplaceComments,
						wafv2.TextTransformationTypeEscapeSeqDecode,
						wafv2.TextTransformationTypeSqlHexDecode,
						wafv2.TextTransformationTypeCssDecode,
						wafv2.TextTransformationTypeJsDecode,
						wafv2.TextTransformationTypeNormalizePath,
						wafv2.TextTransformationTypeNormalizePathWin,
						wafv2.TextTransformationTypeRemoveNulls,
						wafv2.TextTransformationTypeReplaceNulls,
						wafv2.TextTransformationTypeBase64DecodeExt,
						wafv2.TextTransformationTypeUrlDecodeUni,
						wafv2.TextTransformationTypeUtf8ToUnicode,
					}, false),
				},
			},
		},
