...
func ConstOrQuote(constant string) string {
	allConstants := map[string]string{
		...
		"value":                             "AttrValue",
		"values":                            "AttrValues",
		"verified_access_group_arn":         "AttrVerifiedAccessGroupARN",
		"verified_access_group_id":          "AttrVerifiedAccessGroupID",
		"verified_access_instance_id":       "AttrVerifiedAccessInstanceID",
		"verified_access_trust_provider_id": "AttrVerifiedAccessTrustProviderID",
		"version":                           "AttrVersion",
