...
func ConstOrQuote(constant string) string {
	allConstants := map[string]string{
		...
		"last_modified_time":            "AttrLastModifiedTime",
		...
		"origin_protocol_policy":        "AttrOriginProtocolPolicy",
		"origin_ssl_protocols":          "AttrOriginSSLProtocols",
		"owner":                         "AttrOwner",
		...
		"vpc_id":                        "AttrVPCID",
		"vpc_origin_endpoint_config":    "AttrVPCOriginEndpointConfig",
		"vpc_origin_id":                 "AttrVPCOriginID",
