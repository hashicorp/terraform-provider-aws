...
func (c *Config) Client() (interface{}, error) {
	...
	client := &AWSClient{
		...
		DirectoryConn:                       directoryservice.New(sess.Copy(&aws.Config{Endpoint: aws.String(c.Endpoints["ds"])})),
	...
	if !c.SkipGetEC2Platforms {
		supportedPlatforms, err := SupportedEC2Platforms(client.EC2Conn)
		if err != nil {
...
type AWSClient struct {
	...
	DirectoryConn                       *directoryservice.DirectoryService
