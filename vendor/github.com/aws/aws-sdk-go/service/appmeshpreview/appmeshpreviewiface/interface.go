...
type AppMeshPreviewAPI interface {
	...
	ListMeshesPages(*appmeshpreview.ListMeshesInput, func(*appmeshpreview.ListMeshesOutput, bool) bool) error
	ListMeshesPagesWithContext(aws.Context, *appmeshpreview.ListMeshesInput, func(*appmeshpreview.ListMeshesOutput, bool) bool, ...request.Option) error
	...
	ListRoutesPages(*appmeshpreview.ListRoutesInput, func(*appmeshpreview.ListRoutesOutput, bool) bool) error
	ListRoutesPagesWithContext(aws.Context, *appmeshpreview.ListRoutesInput, func(*appmeshpreview.ListRoutesOutput, bool) bool, ...request.Option) error

	ListTagsForResource(*appmeshpreview.ListTagsForResourceInput) (*appmeshpreview.ListTagsForResourceOutput, error)
	ListTagsForResourceWithContext(aws.Context, *appmeshpreview.ListTagsForResourceInput, ...request.Option) (*appmeshpreview.ListTagsForResourceOutput, error)
	ListTagsForResourceRequest(*appmeshpreview.ListTagsForResourceInput) (*request.Request, *appmeshpreview.ListTagsForResourceOutput)

	ListTagsForResourcePages(*appmeshpreview.ListTagsForResourceInput, func(*appmeshpreview.ListTagsForResourceOutput, bool) bool) error
	ListTagsForResourcePagesWithContext(aws.Context, *appmeshpreview.ListTagsForResourceInput, func(*appmeshpreview.ListTagsForResourceOutput, bool) bool, ...request.Option) error
	...
	ListVirtualNodesPages(*appmeshpreview.ListVirtualNodesInput, func(*appmeshpreview.ListVirtualNodesOutput, bool) bool) error
	ListVirtualNodesPagesWithContext(aws.Context, *appmeshpreview.ListVirtualNodesInput, func(*appmeshpreview.ListVirtualNodesOutput, bool) bool, ...request.Option) error
	...
	ListVirtualRoutersPages(*appmeshpreview.ListVirtualRoutersInput, func(*appmeshpreview.ListVirtualRoutersOutput, bool) bool) error
	ListVirtualRoutersPagesWithContext(aws.Context, *appmeshpreview.ListVirtualRoutersInput, func(*appmeshpreview.ListVirtualRoutersOutput, bool) bool, ...request.Option) error
	...
	ListVirtualServicesPages(*appmeshpreview.ListVirtualServicesInput, func(*appmeshpreview.ListVirtualServicesOutput, bool) bool) error
	ListVirtualServicesPagesWithContext(aws.Context, *appmeshpreview.ListVirtualServicesInput, func(*appmeshpreview.ListVirtualServicesOutput, bool) bool, ...request.Option) error

	TagResource(*appmeshpreview.TagResourceInput) (*appmeshpreview.TagResourceOutput, error)
	TagResourceWithContext(aws.Context, *appmeshpreview.TagResourceInput, ...request.Option) (*appmeshpreview.TagResourceOutput, error)
	TagResourceRequest(*appmeshpreview.TagResourceInput) (*request.Request, *appmeshpreview.TagResourceOutput)

	UntagResource(*appmeshpreview.UntagResourceInput) (*appmeshpreview.UntagResourceOutput, error)
	UntagResourceWithContext(aws.Context, *appmeshpreview.UntagResourceInput, ...request.Option) (*appmeshpreview.UntagResourceOutput, error)
	UntagResourceRequest(*appmeshpreview.UntagResourceInput) (*request.Request, *appmeshpreview.UntagResourceOutput)
