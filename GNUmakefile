...
tfproviderdocs: go-build ## [CI] Provider Checks / tfproviderdocs
	...
	tfproviderdocs check \
		...
		-ignore-enhanced-region-check-data-sources aws_dx_gateway,aws_vpc_endpoint_service,aws_vpc_peering_connection,aws_ecr_lifecycle_policy_document,aws_cloudwatch_log_data_protection_policy_document,aws_arn,aws_default_tags,aws_ip_ranges,aws_partition,aws_regions,aws_s3_account_public_access_block,aws_servicequotas_templates,aws_ssmincidents_replication_set\
		-ignore-enhanced-region-check-resources aws_auditmanager_organization_admin_account_registration,aws_backup_global_settings,aws_chimesdkvoice_global_settings,aws_cloudformation_stack_set_instance,aws_cloudtrail_organization_delegated_admin_account,aws_config_aggregate_authorization,aws_detective_organization_admin_account,aws_dx_gateway,aws_dx_hosted_connection,aws_ec2_image_block_public_access,aws_vpc_ipam_organization_admin_account,aws_fms_admin_account,aws_guardduty_organization_admin_account,aws_inspector2_delegated_admin_account,aws_macie2_organization_admin_account,aws_macie2_organization_configuration,aws_ram_sharing_with_organization,aws_s3_account_public_access_block,aws_securityhub_organization_admin_account,aws_servicequotas_template,aws_ssmincidents_replication_set
