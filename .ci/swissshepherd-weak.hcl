...
check "banned_glosses" {
  ...
  ignore_targets = [
    ...
    "data_source/aws_bedrock_inference_profiles",
    ...
    "data_source/aws_efs_access_points",
    ...
    "data_source/aws_shield_protection",
    ...
    "data_source/aws_ssoadmin_instances",
