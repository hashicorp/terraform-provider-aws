...
func TestAccBCMDashboardsDashboardDataSource_tags(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/Dashboard/data.tags/"),
...
func TestAccBCMDashboardsDashboardDataSource_Tags_nullMap(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccBCMDashboardsDashboardDataSource_Tags_emptyMap(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccBCMDashboardsDashboardDataSource_Tags_DefaultTags_nonOverlapping(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Dashboard/data.tags_defaults/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccBCMDashboardsDashboardDataSource_Tags_IgnoreTags_Overlap_defaultTag(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Dashboard/data.tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
...
func TestAccBCMDashboardsDashboardDataSource_Tags_IgnoreTags_Overlap_resourceTag(t *testing.T) {
	ctx := acctest.Context(t)
