...
func TestAccKafkaKafkaVersionDataSource_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccKafkaVersionDataSourceConfig_basic(version),
...
func TestAccKafkaKafkaVersionDataSource_preferred(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccKafkaVersionDataSourceConfig_preferred(),
				Check: resource.ComposeTestCheckFunc(
...
func testAccKafkaVersionDataSourceConfig_basic(version string) string {
	return fmt.Sprintf(`
...
func testAccKafkaVersionDataSourceConfig_preferred() string {
	return `
data "aws_msk_kafka_version" "test" {
