...
func TestAccKafkaReplicator_Identity_basic(t *testing.T) {
	ctx := acctest.Context(t)

	var v kafka.DescribeReplicatorOutput
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckReplicatorExists(ctx, t, resourceName, &v),
				),
...
func TestAccKafkaReplicator_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/Replicator/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccKafkaReplicator_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/Replicator/basic_v6.49.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
// Resource Identity was added after v6.49.0
func TestAccKafkaReplicator_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
