...
func replicationTaskConfigMove(rName string) string {
	return acctest.ConfigCompose(
		acctest.ConfigAvailableAZsNoOptIn(),
		fmt.Sprintf(`
data "aws_partition" "current" {}
...
func testAccReplicationTaskConfig_move(rName, rInstanceArn string) string {

	return acctest.ConfigCompose(
		replicationTaskConfigMove(rName),
		fmt.Sprintf(`
resource "aws_dms_replication_task" "test" {
  migration_type            = "full-load"
