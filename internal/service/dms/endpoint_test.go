		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "postgres_settings.0.heartbeat_schema", acctest.CtTest),
					...
					resource.TestCheckResourceAttr(resourceName, "postgres_settings.0.slot_name", acctest.CtTest),
				),
			},
		},
	})
