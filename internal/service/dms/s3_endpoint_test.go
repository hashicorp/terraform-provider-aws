		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ignore_header_rows", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cdc_inserts_and_updates", "false"),
					resource.TestCheckResourceAttr(resourceName, "cdc_inserts_only", "false"),
					resource.TestCheckResourceAttr(resourceName, "cdc_max_batch_interval", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "cdc_min_file_size", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "data_page_size", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "dict_page_size_limit", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "enable_statistics", "true"),
					...
					resource.TestCheckResourceAttr(resourceName, "glue_catalog_generation", "false"),
					resource.TestCheckResourceAttr(resourceName, "ignore_header_rows", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "include_op_for_full_load", "false"),
					resource.TestCheckResourceAttr(resourceName, "max_file_size", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "preserve_transactions", "false"),
					resource.TestCheckResourceAttr(resourceName, "rfc_4180", "true"),
					resource.TestCheckResourceAttr(resourceName, "row_group_length", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cdc_min_file_size", "17"),
					resource.TestCheckResourceAttr(resourceName, "compression_type", "NONE"),
					resource.TestCheckResourceAttr(resourceName, "csv_null_value", acctest.CtZero),
