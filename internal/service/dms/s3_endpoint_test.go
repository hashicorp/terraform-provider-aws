		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cdc_max_batch_interval", acctest.Ct100),
					resource.TestCheckResourceAttr(resourceName, "cdc_min_file_size", acctest.Ct16),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "include_op_for_full_load", acctest.CtFalse),
					resource.TestCheckResourceAttr(resourceName, "max_file_size", acctest.Ct100),
					resource.TestCheckResourceAttr(resourceName, "row_group_length", acctest.Ct10000),
					resource.TestCheckResourceAttr(resourceName, "timestamp_column_name", "tx_commit_time2"),
					resource.TestCheckResourceAttr(resourceName, "use_task_start_time_for_full_load_timestamp", acctest.CtFalse),
				),
			},
