...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) *kinesisanalyticsv2_sdkv1.KinesisAnalyticsV2 {
	return kinesisanalyticsv2_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)}))
}
