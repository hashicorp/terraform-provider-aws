		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "schedule.0.duration_in_seconds", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "artifact_config.#", acctest.CtZero),
				),
			},
			{
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckCanaryExists(ctx, resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "run_config.0.environment_variables.%", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "run_config.0.environment_variables.test1", "result1"),
...
func TestAccSyntheticsCanary_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCanaryConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckCanaryExists(ctx, resourceName, &conf),
