...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*eks_sdkv1.EKS, error) {
	return eks_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
