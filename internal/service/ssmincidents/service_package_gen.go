...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*ssmincidents_sdkv2.Client, error) {
	...
	return ssmincidents_sdkv2.NewFromConfig(cfg,
		ssmincidents_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*ssmincidents_sdkv2.Options) {
	return func(o *ssmincidents_sdkv2.Options) {
		if endpoint != "" {
