...
func defaultEndpoint(region string) (url.URL, error) {
	r := secretsmanager_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), secretsmanager_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListSecrets(ctx, &secretsmanager_sdkv2.ListSecretsInput{},
		func(opts *secretsmanager_sdkv2.Options) {
