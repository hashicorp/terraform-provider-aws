...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*secretsmanager_sdkv1.SecretsManager, error) {
	return secretsmanager_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)})), nil
}
