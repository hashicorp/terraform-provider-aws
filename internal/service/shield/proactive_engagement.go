...
func (r *proactiveEngagementResource) Read(ctx context.Context, request resource.ReadRequest, response *resource.ReadResponse) {
	...
	data.EmergencyContactList = fwtypes.NewListNestedObjectValueOfValueSlice[emergencyContactModel](ctx, tfslices.ApplyToAll(emergencyContacts, func(apiObject awstypes.EmergencyContact) emergencyContactModel {
