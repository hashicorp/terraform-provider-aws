		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDRTAccessRoleARNAssociationExists(ctx, t, resourceName),
		...
		Steps: []resource.TestStep{
			{
				...
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectResourceAction("aws_shield_drt_access_role_arn_association.test", plancheck.ResourceActionCreate),
					},
...
func testAccCheckDRTAccessRoleARNAssociationExists(ctx context.Context, t *testing.T, n string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
