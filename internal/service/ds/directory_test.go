		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "connect_settings.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrDescription, ""),
					resource.TestCheckResourceAttr(resourceName, "desired_number_of_domain_controllers", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "vpc_settings.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "vpc_settings.0.availability_zones.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "vpc_settings.0.subnet_ids.#", acctest.CtTwo),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, "access_url"),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrAlias),
					resource.TestCheckResourceAttr(resourceName, "connect_settings.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "connect_settings.0.subnet_ids.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, names.AttrDescription, ""),
					resource.TestCheckResourceAttr(resourceName, "desired_number_of_domain_controllers", acctest.CtZero),
					acctest.CheckResourceAttrGreaterThanValue(resourceName, "dns_ip_addresses.#", 0),
					resource.TestCheckResourceAttr(resourceName, "edition", ""),
					resource.TestCheckResourceAttr(resourceName, "enable_sso", "false"),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, domainName),
					resource.TestCheckResourceAttr(resourceName, "radius_settings.#", acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, "security_group_id"),
					resource.TestCheckResourceAttrSet(resourceName, "short_name"),
					resource.TestCheckResourceAttr(resourceName, names.AttrSize, "Small"),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrType, "ADConnector"),
					resource.TestCheckResourceAttr(resourceName, "vpc_settings.#", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
