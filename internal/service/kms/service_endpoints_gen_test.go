...
func defaultEndpoint(region string) (url.URL, error) {
	r := kms_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), kms_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListKeys(ctx, &kms_sdkv2.ListKeysInput{},
		func(opts *kms_sdkv2.Options) {
