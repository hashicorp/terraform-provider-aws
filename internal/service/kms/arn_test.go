...
func TestAliasARNToKeyARN(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			InputARN:      "arn:aws:ec2:us-west-2:123456789012:alias/test-alias", //lintignore:AWSAT003
			ExpectedError: regexp.MustCompile(`expected service kms`),
		},
		{
			TestName:    "valid ARN",
			InputARN:    "arn:aws:kms:us-west-2:123456789012:alias/test-alias", //lintignore:AWSAT003
			ExpectedARN: "arn:aws:kms:us-west-2:123456789012:key/test-key",     //lintignore:AWSAT003
		},
	}
...
func TestKeyARNOrIDEqual(t *testing.T) {
	testCases := []struct {
		...
		{
			name:   "equal ARNs",
			first:  "arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab", //lintignore:AWSAT003
			second: "arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab", //lintignore:AWSAT003
			want:   true,
		},
		{
			name:   "not equal ARNs",
			first:  "arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab", //lintignore:AWSAT003
			second: "arn:aws:kms:us-east-2:111122224444:key/1234abcd-12ab-34cd-56ef-1234567890ab", //lintignore:AWSAT003
		},
		{
		...
		},
		{
			...
			first:  "1234abcd-12ab-34cd-56ef-1234567890ab",
			second: "arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ac", //lintignore:AWSAT003
		},
		{
		...
		},
		{
			...
			first:  "1234abcd-12ab-34cd-56ef-1234567890ab",
			second: "arn:aws:kms:us-east-2:111122223333:alias/1234abcd-12ab-34cd-56ef-1234567890ab", //lintignore:AWSAT003
		},
	}
