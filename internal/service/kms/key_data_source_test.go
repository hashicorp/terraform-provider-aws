		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "multi_region_configuration.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "multi_region_configuration.#", acctest.CtZero),
					resource.TestCheckResourceAttr(dataSourceName, "origin", "AWS_KMS"),
					resource.TestCheckResourceAttr(dataSourceName, "pending_deletion_window_in_days", acctest.CtZero),
					resource.TestCheckNoResourceAttr(dataSourceName, "valid_to"),
					resource.TestCheckResourceAttr(dataSourceName, "xks_key_configuration.#", acctest.CtZero),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(dataSourceName, "key_usage", resourceName, "key_usage"),
					resource.TestCheckResourceAttrPair(dataSourceName, "multi_region", resourceName, "multi_region"),
					resource.TestCheckResourceAttr(dataSourceName, "multi_region_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(dataSourceName, "multi_region_configuration.0.multi_region_key_type", "PRIMARY"),
					resource.TestCheckResourceAttr(dataSourceName, "multi_region_configuration.0.primary_key.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceName, "multi_region_configuration.0.replica_keys.#", acctest.CtZero),
					resource.TestCheckResourceAttr(dataSourceName, "origin", "AWS_KMS"),
					resource.TestCheckNoResourceAttr(dataSourceName, "valid_to"),
				),
			},
