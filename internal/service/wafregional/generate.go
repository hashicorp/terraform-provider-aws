...
//go:generate go run ../../generate/listpages/main.go -AWSSDKVersion=2 -ListOps=ListActivatedRulesInRuleGroup,ListByteMatchSets,ListRegexMatchSets,ListRegexPatternSets,ListRuleGroups -Paginator=NextMarker
