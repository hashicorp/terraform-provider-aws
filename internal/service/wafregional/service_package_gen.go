...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) *wafregional_sdkv1.WAFRegional {
	return wafregional_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)}))
}
