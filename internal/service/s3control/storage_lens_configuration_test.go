		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.activity_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.advanced_cost_optimization_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.advanced_data_protection_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.activity_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.advanced_cost_optimization_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.advanced_data_protection_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.detailed_status_code_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.prefix_level.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.detailed_status_code_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.aws_org.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.exclude.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.include.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.activity_metrics.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.activity_metrics.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.advanced_cost_optimization_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.advanced_data_protection_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.activity_metrics.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.advanced_data_protection_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.detailed_status_code_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.prefix_level.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.prefix_level.0.storage_metrics.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.prefix_level.0.storage_metrics.0.selection_criteria.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.prefix_level.0.storage_metrics.0.selection_criteria.0.max_depth", acctest.CtThree),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.detailed_status_code_metrics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.aws_org.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.0.cloud_watch_metrics.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.0.s3_bucket_destination.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.0.s3_bucket_destination.0.encryption.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.exclude.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.exclude.0.buckets.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.exclude.0.regions.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.include.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
				),
			},
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					acctest.CheckResourceAttrAccountID(resourceName, "storage_lens_configuration.0.data_export.0.s3_bucket_destination.0.account_id"),
					resource.TestCheckResourceAttrSet(resourceName, "storage_lens_configuration.0.data_export.0.s3_bucket_destination.0.arn"),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.0.s3_bucket_destination.0.encryption.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.0.s3_bucket_destination.0.encryption.0.sse_kms.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.0.s3_bucket_destination.0.encryption.0.sse_s3.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.exclude.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.include.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.include.0.buckets.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.include.0.regions.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.activity_metrics.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.activity_metrics.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.advanced_cost_optimization_metrics.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.advanced_data_protection_metrics.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.activity_metrics.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.activity_metrics.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.advanced_cost_optimization_metrics.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.advanced_data_protection_metrics.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.detailed_status_code_metrics.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.bucket_level.0.prefix_level.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.account_level.0.detailed_status_code_metrics.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.0.cloud_watch_metrics.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.0.cloud_watch_metrics.0.enabled", "false"),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.data_export.0.s3_bucket_destination.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.exclude.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "storage_lens_configuration.0.include.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
