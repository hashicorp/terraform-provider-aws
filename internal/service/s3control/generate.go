...
//go:generate go run ../../generate/tags/main.go -ListTags -ListTagsFunc=listTagsImpl -ServiceTagsSlice -TagResTypeIsAccountID -TagResTypeElem=AccountId -UpdateTags -UpdateTagsFunc=updateTagsImpl
