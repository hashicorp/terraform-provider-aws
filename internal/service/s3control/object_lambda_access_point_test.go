		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "configuration.0.allowed_features.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "configuration.0.transformation_configuration.#", acctest.CtOne),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "configuration.0.transformation_configuration.*", map[string]string{
						"actions.#":                             acctest.CtOne,
						"content_transformation.#":              acctest.CtOne,
						"content_transformation.0.aws_lambda.#": acctest.CtOne,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "s3-object-lambda", fmt.Sprintf("accesspoint/%s", rName)),
					resource.TestCheckResourceAttr(resourceName, "configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "configuration.0.allowed_features.#", acctest.CtTwo),
