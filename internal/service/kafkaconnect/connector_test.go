		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "capacity.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.autoscaling.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.autoscaling.0.max_worker_count", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.autoscaling.0.mcu_count", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.autoscaling.0.min_worker_count", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.autoscaling.0.scale_in_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttrSet(resourceName, "capacity.0.autoscaling.0.scale_in_policy.0.cpu_utilization_percentage"),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.autoscaling.0.scale_out_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttrSet(resourceName, "capacity.0.autoscaling.0.scale_out_policy.0.cpu_utilization_percentage"),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.provisioned_capacity.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "connector_configuration.%", acctest.CtThree),
					...
					resource.TestCheckResourceAttr(resourceName, "connector_configuration.tasks.max", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "connector_configuration.topics", "t1"),
					resource.TestCheckResourceAttr(resourceName, names.AttrDescription, ""),
					resource.TestCheckResourceAttr(resourceName, "kafka_cluster.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "kafka_cluster.0.apache_kafka_cluster.#", acctest.CtOne),
					resource.TestCheckResourceAttrSet(resourceName, "kafka_cluster.0.apache_kafka_cluster.0.bootstrap_servers"),
					resource.TestCheckResourceAttr(resourceName, "kafka_cluster.0.apache_kafka_cluster.0.vpc.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "kafka_cluster.0.apache_kafka_cluster.0.vpc.0.security_groups.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "kafka_cluster.0.apache_kafka_cluster.0.vpc.0.subnets.#", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, "kafka_cluster_client_authentication.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "kafka_cluster_client_authentication.0.authentication_type", "NONE"),
					resource.TestCheckResourceAttr(resourceName, "kafka_cluster_encryption_in_transit.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "log_delivery.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "plugin.#", acctest.CtOne),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "plugin.*", map[string]string{
						"custom_plugin.#": acctest.CtOne,
					}),
					resource.TestCheckResourceAttrSet(resourceName, "service_execution_role_arn"),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrVersion),
					resource.TestCheckResourceAttr(resourceName, "worker_configuration.#", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "capacity.0.autoscaling.0.mcu_count", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "kafka_cluster_encryption_in_transit.0.encryption_type", "TLS"),
					resource.TestCheckResourceAttr(resourceName, "kafkaconnect_version", "2.7.1"),
					resource.TestCheckResourceAttr(resourceName, "log_delivery.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "log_delivery.0.worker_log_delivery.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "log_delivery.0.worker_log_delivery.0.cloudwatch_logs.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "log_delivery.0.worker_log_delivery.0.firehose.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "log_delivery.0.worker_log_delivery.0.s3.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttrSet(resourceName, "service_execution_role_arn"),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrVersion),
					resource.TestCheckResourceAttr(resourceName, "worker_configuration.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, names.AttrARN),
					resource.TestCheckResourceAttr(resourceName, "capacity.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.autoscaling.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.provisioned_capacity.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "capacity.0.provisioned_capacity.0.mcu_count", acctest.CtOne),
