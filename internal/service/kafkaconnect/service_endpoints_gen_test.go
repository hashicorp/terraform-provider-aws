...
func defaultEndpoint(region string) (url.URL, error) {
	r := kafkaconnect_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), kafkaconnect_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListConnectors(ctx, &kafkaconnect_sdkv2.ListConnectorsInput{},
		func(opts *kafkaconnect_sdkv2.Options) {
