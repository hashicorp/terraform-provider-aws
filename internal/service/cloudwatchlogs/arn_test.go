...
func TestTrimLogGroupARNWildcardSuffix(t *testing.T) {
	testCases := []struct {
		...
		{
			TestName:    "No suffix",
			InputARN:    "arn:aws-us-gov:logs:us-gov-west-1:123456789012:log-group:tf-acc-test-6899758375212691725/1", //lintignore:AWSAT003
			ExpectedARN: "arn:aws-us-gov:logs:us-gov-west-1:123456789012:log-group:tf-acc-test-6899758375212691725/1", //lintignore:AWSAT003
		},
		{
