		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "action_threshold.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "definition.0.iam_action_definition.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "definition.0.iam_action_definition.0.roles.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "subscriber.#", acctest.CtOne),
