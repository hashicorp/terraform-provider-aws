...
func defaultEndpoint(region string) (url.URL, error) {
	r := inspector_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), inspector_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListRulesPackages(ctx, &inspector_sdkv2.ListRulesPackagesInput{},
		func(opts *inspector_sdkv2.Options) {
