		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "filter.0.tags.Environment", acctest.CtTest),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, names.AttrStatus, "Enabled"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "filter.0.tags.Environment1", acctest.CtTest),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "filter.0.tags.Environment2", acctest.CtTest),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, names.AttrStatus, "Enabled"),
					resource.TestCheckResourceAttr(resourceName, "tiering.#", acctest.Ct1),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "tiering.*", map[string]string{
