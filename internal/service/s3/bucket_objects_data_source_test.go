		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.aws_s3_objects.yesh", "keys.#", acctest.CtTwo),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.aws_s3_objects.yesh", "keys.#", acctest.CtOne),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.aws_s3_objects.yesh", "keys.#", acctest.CtTwo),
					resource.TestCheckResourceAttr("data.aws_s3_objects.yesh", "owners.#", acctest.CtTwo),
				),
			},
		},
	})
