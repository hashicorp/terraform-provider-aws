...
var (
	...
	ResourceBucketMetadataTableConfiguration        = newResourceBucketMetadataTableConfiguration
	...
	FindBucketMetadataTableConfigurationByBucket = findBucketMetadataTableConfigurationByBucket
