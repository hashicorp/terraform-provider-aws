			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						names.AttrStatus: string(types.ReplicationRuleStatusEnabled),
						"destination.#":  acctest.CtOne,
						"destination.0.encryption_configuration.#":                       acctest.CtOne,
						"destination.0.storage_class":                                    string(types.StorageClassStandard),
						"source_selection_criteria.#":                                    acctest.CtOne,
						"source_selection_criteria.0.sse_kms_encrypted_objects.#":        acctest.CtOne,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						"filter.0.and.0.tags.%":       acctest.CtOne,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						names.AttrStatus: string(types.ReplicationRuleStatusEnabled),
						"destination.#":  acctest.CtOne,
						"destination.0.access_control_translation.#":       acctest.CtOne,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						"delete_marker_replication.0.status": string(types.DeleteMarkerReplicationStatusEnabled),
						"source_selection_criteria.#":        acctest.CtOne,
						"source_selection_criteria.0.replica_modifications.#":        acctest.CtOne,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "rule.0.destination.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						"destination.0.metrics.#":                   acctest.CtOne,
						"destination.0.metrics.0.status":            string(types.MetricsStatusEnabled),
						"destination.0.metrics.0.event_threshold.#": acctest.CtZero,
					}),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "rule.*", map[string]string{
						...
						"delete_marker_replication.#":          acctest.CtOne,
						"delete_marker_replication.0.status":   string(types.DeleteMarkerReplicationStatusEnabled),
						"existing_object_replication.#":        acctest.CtOne,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "rule.0.status", string(types.ReplicationRuleStatusEnabled)),
					resource.TestCheckResourceAttr(resourceName, "rule.0.delete_marker_replication.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "rule.0.destination.#", acctest.CtOne),
					resource.TestCheckResourceAttrPair(resourceName, "rule.0.destination.0.bucket", dstBucketResourceName, names.AttrARN),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(bucketResourceName, "replication_configuration.0.rules.#", acctest.CtOne),
					resource.TestCheckTypeSetElemNestedAttrs(bucketResourceName, "replication_configuration.0.rules.*", map[string]string{
						"filter.#":        acctest.CtOne,
						"filter.0.prefix": "foo",
						"filter.0.tags.%": acctest.CtTwo,
					}),
				),
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "rule.0.filter.0.and.0.tags.%", acctest.CtTwo),
				),
			},
		},
	})
