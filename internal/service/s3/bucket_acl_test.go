		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "access_control_policy.0.grant.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "access_control_policy.0.owner.#", acctest.CtOne),
