		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "eventbridge", "true"),
					resource.TestCheckResourceAttr(resourceName, "lambda_function.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "queue.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "lambda_function.0.events.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "queue.0.events.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "topic.0.events.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "lambda_function.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "queue.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "topic.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "topic.0.events.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "topic.1.events.#", acctest.CtTwo),
