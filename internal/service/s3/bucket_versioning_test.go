...
func TestAccS3BucketVersioning_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccBucketVersioningConfig_basic2(rName, s3.BucketVersioningStatusEnabled),
...
func TestAccS3BucketVersioning_update(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccBucketVersioningConfig_basic2(rName, s3.BucketVersioningStatusSuspended),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckBucketVersioningExists(resourceName),
...
func TestAccS3BucketVersioning_MFADelete(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccBucketVersioningConfig_mfaDelete2(rName, s3.MFADeleteDisabled),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckBucketVersioningExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "versioning_configuration.#", "1"),
...
func TestAccS3BucketVersioning_Status_disabled(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccBucketVersioningConfig_basic2(rName, tfs3.BucketVersioningStatusDisabled),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckBucketVersioningExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "versioning_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "versioning_configuration.0.status", tfs3.BucketVersioningStatusDisabled),
...
func testAccBucketVersioningConfig_basic2(rName, status string) string {
	return fmt.Sprintf(`
...
func testAccBucketVersioningConfig_mfaDelete2(rName, mfaDelete string) string {
	return fmt.Sprintf(`
resource "aws_s3_bucket" "test" {
  bucket = %[1]q
}
