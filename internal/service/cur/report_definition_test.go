		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "additional_schema_elements.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "additional_artifacts.#", acctest.CtTwo),
				),
			},
			{
