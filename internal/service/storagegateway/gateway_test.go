		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "gateway_network_interface.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "smb_active_directory_settings.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayExists(ctx, resourceName, &gateway),
					resource.TestCheckResourceAttrPair(resourceName, "cloudwatch_log_group_arn", resourceName2, names.AttrARN),
				),
			},
			{
				ResourceName:            resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayExists(ctx, resourceName, &gateway),
					resource.TestCheckResourceAttr(resourceName, "smb_active_directory_settings.#", acctest.CtOne),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayExists(ctx, resourceName, &gateway),
					resource.TestCheckResourceAttr(resourceName, "average_upload_rate_limit_in_bits_per_sec", acctest.CtZero),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayExists(ctx, resourceName, &gateway),
					resource.TestCheckResourceAttr(resourceName, "average_upload_rate_limit_in_bits_per_sec", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "average_download_rate_limit_in_bits_per_sec", acctest.CtZero),
				),
			},
		},
	})
...
func TestAccStorageGatewayGateway_maintenanceStartTime(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccGatewayConfig_maintenanceStartTime(rName, 21, 10, acctest.CtZero, ""),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayExists(ctx, resourceName, &gateway),
					resource.TestCheckResourceAttr(resourceName, "maintenance_start_time.0.hour_of_day", "21"),
					resource.TestCheckResourceAttr(resourceName, "maintenance_start_time.0.minute_of_hour", "10"),
					resource.TestCheckResourceAttr(resourceName, "maintenance_start_time.0.day_of_week", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "maintenance_start_time.0.day_of_month", ""),
				),
			},
		},
