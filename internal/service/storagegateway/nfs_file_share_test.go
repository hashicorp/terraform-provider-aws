		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cache_attributes.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "nfs_file_share_defaults.#", acctest.CtZero),
...
func TestAccStorageGatewayNFSFileShare_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccNFSFileShareConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNFSFileShareExists(ctx, resourceName, &nfsFileShare),
					acctest.MatchResourceAttrRegionalARN(resourceName, names.AttrARN, "storagegateway", regexache.MustCompile(`share/share-.+`)),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNFSFileShareExists(ctx, resourceName, &nfsFileShare),
					resource.TestCheckResourceAttr(resourceName, "client_list.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "nfs_file_share_defaults.0.owner_id", acctest.CtTwo),
				),
			},
			{
