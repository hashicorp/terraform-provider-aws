		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "bootstrap_action.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "kerberos_attributes.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "auto_termination_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "step.#", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &cluster1),
					resource.TestCheckResourceAttr(resourceName, "core_instance_group.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "core_instance_group.0.instance_count", acctest.CtTwo),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "step.0.hadoop_jar_step.0.properties.%", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &cluster),
					resource.TestCheckResourceAttr(resourceName, "step.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "step.0.action_on_failure", "TERMINATE_CLUSTER"),
					resource.TestCheckResourceAttr(resourceName, "step.0.hadoop_jar_step.0.args.0", "state-pusher-script"),
					resource.TestCheckResourceAttr(resourceName, "step.0.hadoop_jar_step.0.jar", "command-runner.jar"),
					resource.TestCheckResourceAttr(resourceName, "step.0.name", "Setup Hadoop Debugging"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &cluster),
					resource.TestCheckResourceAttr(resourceName, "bootstrap_action.#", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "bootstrap_action.2.args.#", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "bootstrap_action.1.args.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &cluster),
					resource.TestCheckResourceAttr(resourceName, "step_concurrency_level", acctest.CtTwo),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &cluster),
					resource.TestCheckResourceAttr(resourceName, "master_instance_group.0.ebs_config.0.volumes_per_instance", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "core_instance_group.0.ebs_config.0.volumes_per_instance", acctest.CtTwo),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "master_instance_group.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "core_instance_group.#", acctest.CtZero),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "core_instance_fleet.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "ec2_attributes.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "ec2_attributes.0.subnet_ids.#", acctest.CtTwo),
					resource.TestCheckTypeSetElemAttrPair(resourceName, "ec2_attributes.0.subnet_ids.*", subnetResourceName, names.AttrID),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(ctx, resourceName, &cluster),
					resource.TestCheckResourceAttr(resourceName, "master_instance_fleet.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "core_instance_fleet.#", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
