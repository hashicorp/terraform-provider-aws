...
func TestAccEventsConnection_Identity_basic(t *testing.T) {
...
func TestAccEventsConnection_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccEventsConnection_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/Connection/basic_v6.53.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
// Resource Identity was added after v6.53.0
func TestAccEventsConnection_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
