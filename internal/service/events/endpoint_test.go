		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "event_bus.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "replication_config.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "routing_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "routing_config.0.failover_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "routing_config.0.failover_config.0.primary.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "routing_config.0.failover_config.0.secondary.#", acctest.CtOne),
