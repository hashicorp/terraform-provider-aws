...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*eventbridge_sdkv1.EventBridge, error) {
	return eventbridge_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
