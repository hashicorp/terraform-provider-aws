		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "http_target.0.header_parameters.X-Test", acctest.CtTest),
					resource.TestCheckResourceAttr(resourceName, "http_target.0.query_string_parameters.%", acctest.Ct2),
					resource.TestCheckResourceAttr(resourceName, "http_target.0.query_string_parameters.Env", acctest.CtTest),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "http_target.0.path_parameter_values.0", acctest.CtTest),
					resource.TestCheckResourceAttr(resourceName, "http_target.0.header_parameters.%", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "http_target.0.header_parameters.X-Test", acctest.CtTest),
					resource.TestCheckResourceAttr(resourceName, "http_target.0.query_string_parameters.%", acctest.Ct2),
					resource.TestCheckResourceAttr(resourceName, "http_target.0.query_string_parameters.Env", acctest.CtTest),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ecs_target.0.capacity_provider_strategy.0.capacity_provider", acctest.CtTest),
				),
			},
			{
				ResourceName:            resourceName,
