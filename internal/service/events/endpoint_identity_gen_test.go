...
func TestAccEventsEndpoint_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/Endpoint/basic_v6.53.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName:    config.StringVariable(rName),
					"secondary_region": config.StringVariable(acctest.AlternateRegion()),
				},
...
// Resource Identity was added after v6.53.0
func TestAccEventsEndpoint_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
