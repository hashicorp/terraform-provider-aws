		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMetricStreamExists(resourceName),
					resource.TestMatchResourceAttr(resourceName, "firehose_arn", regexp.MustCompile(`^.*deliverystream/S1$`)),
					resource.TestMatchResourceAttr(resourceName, "role_arn", regexp.MustCompile(`^.*role/S1$`)),
					resource.TestCheckResourceAttr(resourceName, "tags.%", "0"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMetricStreamExists(resourceName),
					resource.TestMatchResourceAttr(resourceName, "firehose_arn", regexp.MustCompile(`^.*deliverystream/S2$`)),
					resource.TestMatchResourceAttr(resourceName, "role_arn", regexp.MustCompile(`^.*role/S2$`)),
					resource.TestCheckResourceAttr(resourceName, "tags.%", "0"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMetricStreamExists(resourceName),
					resource.TestMatchResourceAttr(resourceName, "firehose_arn", regexp.MustCompile(`^.*deliverystream/S3$`)),
					resource.TestMatchResourceAttr(resourceName, "role_arn", regexp.MustCompile(`^.*role/S3$`)),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMetricStreamExists(resourceName),
					resource.TestMatchResourceAttr(resourceName, "firehose_arn", regexp.MustCompile(`^.*deliverystream/S4$`)),
					resource.TestMatchResourceAttr(resourceName, "role_arn", regexp.MustCompile(`^.*role/S4$`)),
					resource.TestCheckResourceAttr(resourceName, "tags.%", "1"),
					resource.TestCheckResourceAttr(resourceName, "tags.key1", "value1"),
				),
			},
