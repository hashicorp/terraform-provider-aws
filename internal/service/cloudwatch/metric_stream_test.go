		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "exclude_filter.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "include_filter.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "statistics_configuration.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "output_format", names.AttrJSON),
					resource.TestCheckResourceAttr(resourceName, "include_filter.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "include_filter.0.metric_names.#", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "output_format", names.AttrJSON),
					resource.TestCheckResourceAttr(resourceName, "include_filter.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "include_filter.0.metric_names.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "include_filter.0.metric_names.0", "CPUUtilization"),
					resource.TestCheckResourceAttr(resourceName, "include_filter.1.metric_names.#", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "output_format", names.AttrJSON),
					resource.TestCheckResourceAttr(resourceName, "exclude_filter.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "exclude_filter.0.metric_names.#", acctest.CtZero)),
			},
			{
				ResourceName:      resourceName,
				ImportState:       true,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "output_format", names.AttrJSON),
					resource.TestCheckResourceAttr(resourceName, "exclude_filter.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "exclude_filter.0.metric_names.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "exclude_filter.0.metric_names.0", "CPUUtilization"),
					resource.TestCheckResourceAttr(resourceName, "exclude_filter.1.metric_names.#", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
...
func TestAccCloudWatchMetricStream_update(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccMetricStreamConfig_arnsWithTag(rName, "S4", acctest.CtKey1, "value1updated"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMetricStreamExists(ctx, resourceName),
					acctest.MatchResourceAttrRegionalARN(resourceName, "firehose_arn", "firehose", regexache.MustCompile(`deliverystream/S4$`)),
					acctest.MatchResourceAttrGlobalARN(resourceName, names.AttrRoleARN, "iam", regexache.MustCompile(`role/S4$`)),
...
func TestAccCloudWatchMetricStream_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccMetricStreamConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMetricStreamExists(ctx, resourceName),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckMetricStreamExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "statistics_configuration.#", acctest.CtTwo),
				),
			},
			{
