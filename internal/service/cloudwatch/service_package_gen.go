...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*cloudwatch_sdkv1.CloudWatch, error) {
	return cloudwatch_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)})), nil
}
