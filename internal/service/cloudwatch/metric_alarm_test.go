		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "threshold", acctest.Ct80),
					resource.TestCheckResourceAttr(resourceName, "period", acctest.Ct120),
