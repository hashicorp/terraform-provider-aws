		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "arns.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "names.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "types.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "values.#", acctest.CtTwo),
