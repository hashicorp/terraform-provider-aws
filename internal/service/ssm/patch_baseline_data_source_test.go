		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr(dataSourceName, "approved_patches.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(dataSourceName, "approval_rule.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceName, "global_filter.#", acctest.CtZero),
					resource.TestCheckResourceAttr(dataSourceName, names.AttrName, "AWS-CentOSDefaultPatchBaseline"),
					resource.TestCheckResourceAttr(dataSourceName, "rejected_patches.#", acctest.CtZero),
					resource.TestCheckResourceAttr(dataSourceName, "rejected_patches_action", "ALLOW_AS_DEPENDENCY"),
					resource.TestCheckResourceAttr(dataSourceName, "source.#", acctest.CtZero),
					acctest.CheckResourceAttrJMES(dataSourceName, names.AttrJSON, "ApprovedPatches|length(@)", acctest.CtZero),
