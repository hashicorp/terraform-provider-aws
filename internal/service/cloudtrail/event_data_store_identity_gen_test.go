...
func TestAccCloudTrailEventDataStore_Identity_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckEventDataStoreDestroy(ctx, t),
...
func TestAccCloudTrailEventDataStore_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/EventDataStore/basic_v5.100.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/EventDataStore/basic_v6.0.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccCloudTrailEventDataStore_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
