...
func defaultEndpoint(region string) (url.URL, error) {
	r := kinesisanalytics_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), kinesisanalytics_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListApplications(ctx, &kinesisanalytics_sdkv2.ListApplicationsInput{},
		func(opts *kinesisanalytics_sdkv2.Options) {
