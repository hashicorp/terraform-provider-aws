		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "inputs.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "outputs.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, "last_update_timestamp"),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "inputs.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.stream_names.#", acctest.CtOne),
					resource.TestCheckResourceAttrSet(resourceName, "inputs.0.id"),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_columns.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_format.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_format.0.mapping_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_format.0.mapping_parameters.0.csv.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_format.0.mapping_parameters.0.json.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "inputs.0.parallelism.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.parallelism.0.count", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.processing_configuration.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.kinesis_firehose.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "inputs.0.kinesis_stream.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.starting_position_configuration.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, "inputs.0.id"),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_columns.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_format.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_format.0.mapping_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_format.0.mapping_parameters.0.csv.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.schema.0.record_format.0.mapping_parameters.0.json.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "inputs.0.processing_configuration.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.kinesis_firehose.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.kinesis_stream.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "inputs.0.parallelism.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.parallelism.0.count", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.processing_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "inputs.0.processing_configuration.0.lambda.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "outputs.*", map[string]string{
						...
						"schema.#":                    acctest.CtOne,
						"schema.0.record_format_type": "CSV",
						"kinesis_firehose.#":          acctest.CtOne,
						"kinesis_stream.#":            acctest.CtZero,
						"lambda.#":                    acctest.CtZero,
					}),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "outputs.*", map[string]string{
						...
						"kinesis_firehose.#":          acctest.CtZero,
						"kinesis_stream.#":            acctest.CtOne,
						"lambda.#":                    acctest.CtZero,
					}),
					...
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_columns.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_format.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_format.0.mapping_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_format.0.mapping_parameters.0.csv.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_format.0.mapping_parameters.0.json.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_format.0.record_format_type", "CSV"),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.s3.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_columns.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_format.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_format.0.mapping_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_format.0.mapping_parameters.0.csv.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "reference_data_sources.0.schema.0.record_format.0.mapping_parameters.0.json.#", acctest.CtOne),
