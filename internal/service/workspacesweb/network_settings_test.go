		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "subnet_ids.0", subnetResourceName1, "id"),
					resource.TestCheckResourceAttrPair(resourceName, "subnet_ids.1", subnetResourceName2, "id"),
					resource.TestCheckResourceAttr(resourceName, "security_group_ids.#", "2"),
					resource.TestCheckResourceAttrPair(resourceName, "security_group_ids.0", securityGroupResourceName1, "id"),
					resource.TestCheckResourceAttrPair(resourceName, "security_group_ids.1", securityGroupResourceName2, "id"),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckNetworkSettingsExists(ctx, resourceName, &networkSettings),
					resource.TestCheckResourceAttrPair(resourceName, "vpc_id", vpcResourceName2, "id"),
					resource.TestCheckResourceAttr(resourceName, "subnet_ids.#", "2"),
					resource.TestCheckResourceAttrPair(resourceName, "subnet_ids.0", subnetResourceName3, "id"),
					resource.TestCheckResourceAttrPair(resourceName, "subnet_ids.1", subnetResourceName4, "id"),
					resource.TestCheckResourceAttr(resourceName, "security_group_ids.#", "2"),
					resource.TestCheckResourceAttrPair(resourceName, "security_group_ids.0", securityGroupResourceName3, "id"),
					resource.TestCheckResourceAttrPair(resourceName, "security_group_ids.1", securityGroupResourceName4, "id"),
				),
			},
			{
				ResourceName:                         resourceName,
