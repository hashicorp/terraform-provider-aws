...
const (
	packageName = "mgn"
	awsEnvVar   = "AWS_ENDPOINT_URL_APPLICATION_MIGRATION_SERVICE"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "application_migration_service"
)
...
func callServiceV2(ctx context.Context, t *testing.T, meta *conns.AWSClient) string {
	...
	_, err := client.DescribeLaunchConfigurationTemplates(ctx, &mgn_sdkv2.DescribeLaunchConfigurationTemplatesInput{},
...
func callServiceV1(ctx context.Context, t *testing.T, meta *conns.AWSClient) string {
	...
	client := meta.MGNConn(ctx)

	req, _ := client.DescribeLaunchConfigurationTemplatesRequest(&mgn_sdkv1.DescribeLaunchConfigurationTemplatesInput{})
