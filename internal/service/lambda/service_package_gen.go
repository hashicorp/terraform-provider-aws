...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*lambda_sdkv1.Lambda, error) {
	return lambda_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)})), nil
}

// NewClient returns a new AWS SDK for Go v2 client for this service package's AWS API.
func (p *servicePackage) NewClient(ctx context.Context, cfg aws_sdkv2.Config) (*lambda_sdkv2.Client, error) {
