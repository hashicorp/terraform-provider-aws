		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cors.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cors.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "cors.0.allow_credentials", "true"),
					resource.TestCheckResourceAttr(resourceName, "cors.0.allow_headers.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "cors.0.allow_methods.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "cors.0.allow_methods.*", "*"),
					resource.TestCheckResourceAttr(resourceName, "cors.0.allow_origins.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "cors.0.allow_origins.*", "*"),
					resource.TestCheckResourceAttr(resourceName, "cors.0.expose_headers.#", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cors.0.allow_headers.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "cors.0.allow_headers.*", "x-custom-header"),
					resource.TestCheckResourceAttr(resourceName, "cors.0.allow_methods.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "cors.0.allow_origins.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "cors.0.expose_headers.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "cors.0.expose_headers.*", "date"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(latestResourceName, "cors.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(liveResourceName, "cors.#", acctest.CtZero),
