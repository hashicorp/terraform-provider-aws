...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*accessanalyzer_sdkv2.Client, error) {
	...
	return accessanalyzer_sdkv2.NewFromConfig(cfg,
		accessanalyzer_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*accessanalyzer_sdkv2.Options) {
	return func(o *accessanalyzer_sdkv2.Options) {
		if endpoint != "" {
