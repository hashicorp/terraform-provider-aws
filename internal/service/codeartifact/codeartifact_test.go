...
func TestAccCodeArtifact_serial(t *testing.T) {
	...
	testCases := map[string]map[string]func(t *testing.T){
		...
		"Domain": {
			...
			"Identity_ExistingResource":     testAccDomain_Identity_ExistingResource,
		},
		"DomainPermissionsPolicy": {
			...
			"Identity_ExistingResource": testAccDomainPermissionsPolicy_Identity_ExistingResource,
		},
		"Repository": {
			...
			"Identity_ExistingResource": testAccRepository_Identity_ExistingResource,
		},
		...
		"RepositoryPermissionsPolicy": {
			...
			"Identity_ExistingResource": testAccRepositoryPermissionsPolicy_Identity_ExistingResource,
		},
	}
