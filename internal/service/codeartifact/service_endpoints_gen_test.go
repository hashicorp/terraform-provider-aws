...
func defaultEndpoint(region string) (url.URL, error) {
	r := codeartifact_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), codeartifact_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDomains(ctx, &codeartifact_sdkv2.ListDomainsInput{},
		func(opts *codeartifact_sdkv2.Options) {
