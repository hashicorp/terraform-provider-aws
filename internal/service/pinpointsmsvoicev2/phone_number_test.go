		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "number_capabilities.#", acctest.Ct1),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "self_managed_opt_outs_enabled", acctest.CtFalse),
					resource.TestCheckResourceAttr(resourceName, "two_way_channel_enabled", acctest.CtTrue),
					resource.TestCheckResourceAttr(resourceName, "number_capabilities.#", acctest.Ct2),
					resource.TestCheckResourceAttr(resourceName, "number_capabilities.0", "SMS"),
