...
func TestAccPinpointSMSVoiceV2ResourcePolicy_Identity_basic(t *testing.T) {
	ctx := acctest.Context(t)

	var v pinpointsmsvoicev2.GetResourcePolicyOutput
...
func TestAccPinpointSMSVoiceV2ResourcePolicy_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
