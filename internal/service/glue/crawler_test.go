		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "classifiers.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "dynamodb_target.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, names.AttrRole, rName),
					resource.TestCheckResourceAttr(resourceName, "s3_target.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrSchedule, ""),
					resource.TestCheckResourceAttr(resourceName, "schema_change_policy.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrDatabaseName, rName),
					resource.TestCheckResourceAttr(resourceName, names.AttrDescription, ""),
					resource.TestCheckResourceAttr(resourceName, "dynamodb_target.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.connection_name", rName),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.exclusions.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.path", "database-name/%"),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.enable_additional_metadata.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, names.AttrRole, rName),
					resource.TestCheckResourceAttr(resourceName, "s3_target.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrSchedule, ""),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.exclusions.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.path", "database-name/table-name"),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.enable_additional_metadata.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, names.AttrRole, rName),
					resource.TestCheckResourceAttr(resourceName, "s3_target.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrSchedule, ""),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "glue", fmt.Sprintf("crawler/%s", rName)),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.exclusions.#", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "glue", fmt.Sprintf("crawler/%s", rName)),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.exclusions.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.exclusions.0", "exclusion1"),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "glue", fmt.Sprintf("crawler/%s", rName)),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.connection_name", rName),
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.0.exclusions.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "jdbc_target.1.exclusions.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "mongodb_target.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "mongodb_target.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "mongodb_target.0.connection_name", rName),
					resource.TestCheckResourceAttr(resourceName, "mongodb_target.0.scan_all", "true"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "delta_target.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "delta_target.0.delta_tables.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "hudi_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "hudi_target.0.connection_name", rName),
					resource.TestCheckResourceAttr(resourceName, "hudi_target.0.maximum_traversal_depth", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "hudi_target.0.paths.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "hudi_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "hudi_target.0.connection_name", rName),
					resource.TestCheckResourceAttr(resourceName, "hudi_target.0.maximum_traversal_depth", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "hudi_target.0.paths.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "iceberg_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "iceberg_target.0.connection_name", rName),
					resource.TestCheckResourceAttr(resourceName, "iceberg_target.0.maximum_traversal_depth", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "iceberg_target.0.paths.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "iceberg_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "iceberg_target.0.connection_name", rName),
					resource.TestCheckResourceAttr(resourceName, "iceberg_target.0.maximum_traversal_depth", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "iceberg_target.0.paths.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, names.AttrRole, rName),
					resource.TestCheckResourceAttr(resourceName, "s3_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "s3_target.0.exclusions.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "s3_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "s3_target.0.sample_size", acctest.CtOne),
				),
			},
			{
				ResourceName:      resourceName,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "s3_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "s3_target.0.sample_size", acctest.CtTwo),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "glue", fmt.Sprintf("crawler/%s", rName)),
					resource.TestCheckResourceAttr(resourceName, "s3_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "s3_target.0.exclusions.#", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "glue", fmt.Sprintf("crawler/%s", rName)),
					resource.TestCheckResourceAttr(resourceName, "s3_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "s3_target.0.exclusions.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "s3_target.0.exclusions.0", "exclusion1"),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "glue", fmt.Sprintf("crawler/%s", rName)),
					resource.TestCheckResourceAttr(resourceName, "catalog_target.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "glue", fmt.Sprintf("crawler/%s", rName)),
					resource.TestCheckResourceAttr(resourceName, "s3_target.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "s3_target.0.exclusions.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "s3_target.0.path", "s3://bucket1"),
					resource.TestCheckResourceAttr(resourceName, "s3_target.1.exclusions.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "catalog_target.0.tables.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "catalog_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "catalog_target.0.database_name", rName),
					resource.TestCheckResourceAttr(resourceName, "catalog_target.0.tables.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "catalog_target.0.tables.0", fmt.Sprintf("%s_table_0", rName)),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "glue", fmt.Sprintf("crawler/%s", rName)),
					resource.TestCheckResourceAttr(resourceName, "catalog_target.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "catalog_target.0.tables.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "catalog_target.0.tables.0", fmt.Sprintf("%s_table_0", rName)),
					resource.TestCheckResourceAttr(resourceName, "catalog_target.1.tables.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "classifiers.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "classifiers.0", rName+acctest.CtOne),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "classifiers.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "classifiers.0", rName+acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "classifiers.1", rName+acctest.CtTwo),
				),
			},
			{
				Config: testAccCrawlerConfig_classifiersSingle(rName),
...
func TestAccGlueCrawler_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCrawlerConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "lineage_configuration.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "lake_formation_configuration.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrawlerExists(ctx, resourceName, &crawler),
					resource.TestCheckResourceAttr(resourceName, "recrawl_policy.#", acctest.CtOne),
...
`, rName, rName+acctest.CtOne, rName+acctest.CtTwo, rName))
}
