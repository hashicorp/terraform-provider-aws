...
var _ glue_sdkv2.EndpointResolverV2 = resolverSDKv2{}

type resolverSDKv2 struct {
	defaultResolver glue_sdkv2.EndpointResolverV2
}

func newEndpointResolverSDKv2() resolverSDKv2 {
	return resolverSDKv2{
		defaultResolver: glue_sdkv2.NewDefaultEndpointResolverV2(),
	}
}

func (r resolverSDKv2) ResolveEndpoint(ctx context.Context, params glue_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
...
func withBaseEndpoint(endpoint string) func(*glue_sdkv2.Options) {
	return func(o *glue_sdkv2.Options) {
		if endpoint != "" {
