...
import (
	...
	glue_sdkv1 "github.com/aws/aws-sdk-go-v2/service/glue"
...
func defaultEndpoint(region string) (url.URL, error) {
	...
	ep, err := r.EndpointFor(glue_sdkv1.EndpointsID, region)
	if err != nil {
		return url.URL{}, err
	}
...
func defaultFIPSEndpoint(region string) (url.URL, error) {
	...
	ep, err := r.EndpointFor(glue_sdkv1.EndpointsID, region, func(opt *endpoints.Options) {
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	req, _ := client.ListRegistriesRequest(&glue_sdkv1.ListRegistriesInput{})
