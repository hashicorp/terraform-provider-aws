		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "actions.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "actions.0.job_name", rName),
					resource.TestCheckResourceAttr(resourceName, "actions.0.notification_property.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "event_batching_condition.#", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "predicate.0.conditions.#", acctest.CtOne),
...
func TestAccGlueTrigger_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccTriggerConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "actions.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "actions.0.job_name", rName),
					resource.TestCheckResourceAttr(resourceName, "actions.0.notification_property.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "actions.0.notification_property.0.notify_delay_after", acctest.CtOne),
				),
			},
			{
				ResourceName:            resourceName,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "actions.0.job_name", rName),
					resource.TestCheckResourceAttr(resourceName, "actions.0.notification_property.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "actions.0.notification_property.0.notify_delay_after", acctest.CtTwo),
				),
			},
			{
				Config: testAccTriggerConfig_actionsNotification(rName, 1),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTriggerExists(ctx, resourceName, &trigger),
					resource.TestCheckResourceAttr(resourceName, "event_batching_condition.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "event_batching_condition.0.batch_size", acctest.CtOne),
