		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.backend.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.backend_defaults.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					acctest.CheckResourceAttrAccountID(resourceName, "mesh_owner"),
					resource.TestCheckResourceAttr(resourceName, "spec.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.backend.#", acctest.CtOne),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.backend.*", map[string]string{
						"virtual_service.#":                                                                acctest.CtOne,
						"virtual_service.0.client_policy.#":                                                acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.#":                                          acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.certificate.#":                            acctest.CtZero,
						"virtual_service.0.client_policy.0.tls.0.enforce":                                  "true",
						"virtual_service.0.client_policy.0.tls.0.ports.#":                                  acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.#":                             acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.0.subject_alternative_names.#": acctest.CtZero,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.#":                     acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.0.acm.#":               acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.0.file.#":              acctest.CtZero,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.0.sds.#":               acctest.CtZero,
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.service_discovery.0.dns.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.backend.*", map[string]string{
						...
						"virtual_service.0.client_policy.0.tls.0.validation.0.subject_alternative_names.#":      acctest.CtZero,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.#":                          acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.0.acm.#":                    acctest.CtZero,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.0.file.#":                   acctest.CtOne,
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.backend.*", map[string]string{
						...
						"virtual_service.0.client_policy.0.tls.#":                                                          acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.enforce":                                                  "true",
						"virtual_service.0.client_policy.0.tls.0.ports.#":                                                  acctest.CtTwo,
						"virtual_service.0.client_policy.0.tls.0.validation.#":                                             acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.0.subject_alternative_names.#":                 acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.0.subject_alternative_names.0.match.#":         acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.0.subject_alternative_names.0.match.0.exact.#": acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.#":                                     acctest.CtOne,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.0.acm.#":                               acctest.CtZero,
						"virtual_service.0.client_policy.0.tls.0.validation.0.trust.0.file.#":                              acctest.CtOne,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.backend_defaults.0.client_policy.0.tls.0.validation.0.subject_alternative_names.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.service_discovery.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.service_discovery.0.aws_cloud_map.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.service_discovery.0.aws_cloud_map.0.attributes.%", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.connection_pool.0.tcp.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.connection_pool.0.http2.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.connection_pool.0.tcp.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.port_mapping.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.port_mapping.0.port", "8080"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.port_mapping.0.protocol", "http"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.logging.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.backend.*", map[string]string{
						"virtual_service.#":                      acctest.CtOne,
						"virtual_service.0.client_policy.#":      acctest.CtZero,
						"virtual_service.0.virtual_service_name": "servicea.simpleapp.local",
					}),
					resource.TestCheckResourceAttr(resourceName, "spec.0.backend_defaults.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.tls.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.logging.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.service_discovery.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.service_discovery.0.dns.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					acctest.CheckResourceAttrAccountID(resourceName, "mesh_owner"),
					resource.TestCheckResourceAttr(resourceName, "spec.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.backend.#", acctest.CtTwo),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.backend.*", map[string]string{
						"virtual_service.#":                      acctest.CtOne,
						"virtual_service.0.client_policy.#":      acctest.CtZero,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.outlier_detection.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.outlier_detection.0.base_ejection_duration.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.outlier_detection.0.interval.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.port_mapping.0.port", "8080"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.port_mapping.0.protocol", "tcp"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.grpc.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.http.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.http2.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.tcp.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.tcp.0.idle.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.grpc.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.http.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.http.0.idle.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.http.0.per_request.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.http2.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.0.timeout.0.tcp.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.logging.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.service_discovery.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.service_discovery.0.dns.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.service_discovery.0.dns.0.hostname", "serviceb.simpleapp.local"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.1.outlier_detection.#", acctest.CtZero),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.1.tls.0.mode", "PERMISSIVE"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.1.tls.0.validation.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.1.tls.0.validation.0.subject_alternative_names.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.1.tls.0.validation.0.trust.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.1.tls.0.validation.0.trust.0.acm.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.1.tls.0.validation.0.trust.0.file.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.1.tls.0.validation.0.trust.0.sds.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.1.tls.0.validation.0.trust.0.sds.0.secret_name", "confidential"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.connection_pool.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.health_check.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.outlier_detection.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.port_mapping.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.certificate.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.certificate.0.acm.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.certificate.0.file.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.certificate.0.sds.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.validation.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.validation.0.subject_alternative_names.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.validation.0.trust.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.validation.0.trust.0.acm.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.validation.0.trust.0.file.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.listener.2.tls.0.validation.0.trust.0.sds.#", acctest.CtOne),
