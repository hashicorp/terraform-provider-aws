		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.action.0.weighted_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.#", acctest.CtOne),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.grpc_route.0.match.0.metadata.*", map[string]string{
						"invert":       "false",
						"match.#":      acctest.CtZero,
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.grpc_retry_events.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.http_retry_events.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.http_retry_events.*", "server-error"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.max_retries", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.per_retry_timeout.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.tcp_retry_events.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.timeout.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtZero),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.action.0.weighted_target.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.#", acctest.CtTwo),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.grpc_route.0.match.0.metadata.*", map[string]string{
						"invert":       "true",
						"match.#":      acctest.CtZero,
						names.AttrName: "X-Testing1",
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.grpc_route.0.match.0.metadata.*", map[string]string{
						"invert":                "false",
						"match.#":               acctest.CtOne,
						"match.0.range.#":       acctest.CtOne,
						"match.0.range.0.end":   "7",
						"match.0.range.0.start": acctest.CtTwo,
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.grpc_retry_events.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.grpc_retry_events.*", "cancelled"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.http_retry_events.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.max_retries", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.per_retry_timeout.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.tcp_retry_events.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.http_retry_events.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.http_retry_events.*", "server-error"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.max_retries", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.per_retry_timeout.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.per_retry_timeout.0.unit", "s"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.per_retry_timeout.0.value", "15"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.0.tcp_retry_events.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.method_name", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.service_name", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.timeout.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.timeout.0.idle.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.timeout.0.per_request.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.timeout.0.per_request.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.action.0.weighted_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.metadata.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.method_name", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.match.0.service_name", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.retry_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.timeout.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "virtual_router_name", vrName),
					resource.TestCheckResourceAttr(resourceName, "spec.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.weighted_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.path.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.port", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.prefix", "/"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.query_parameter.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.scheme", "http"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.0.http_retry_events.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "spec.0.http2_route.0.retry_policy.0.http_retry_events.*", "server-error"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.0.max_retries", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.0.per_retry_timeout.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.0.tcp_retry_events.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.timeout.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrCreatedDate),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.weighted_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.#", acctest.CtTwo),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.http2_route.0.match.0.header.*", map[string]string{
						"invert":       "true",
						"match.#":      acctest.CtZero,
						names.AttrName: "X-Testing1",
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.0.http_retry_events.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.0.max_retries", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.0.per_retry_timeout.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.0.tcp_retry_events.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.prefix", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.scheme", "http"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.path.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.prefix", "/"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.scheme", "http"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.retry_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.timeout.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.timeout.0.idle.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.timeout.0.per_request.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrCreatedDate),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.timeout.0.per_request.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.weighted_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.header.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.method", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.path.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.port", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.prefix", "/"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.query_parameter.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.scheme", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.timeout.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.priority", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrCreatedDate),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrLastUpdatedDate),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.weighted_target.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.header.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.method", ""),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.scheme", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.port", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.query_parameter.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.scheme", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.timeout.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.timeout.0.idle.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.timeout.0.per_request.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.priority", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrCreatedDate),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.timeout.0.per_request.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.priority", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.action.0.weighted_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.timeout.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrCreatedDate),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrLastUpdatedDate),
					acctest.CheckResourceAttrAccountID(resourceName, "resource_owner"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.action.0.weighted_target.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.timeout.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrCreatedDate),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrLastUpdatedDate),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.match.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.action.0.weighted_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.timeout.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.0.timeout.0.idle.#", acctest.CtOne),
...
func testAccRoute_tags(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccRouteConfig_tags1(meshName, vrName, vn1Name, vn2Name, rName, acctest.CtKey1, acctest.CtValue1),
			...
			{
				Config: testAccRouteConfig_tags2(meshName, vrName, vn1Name, vn2Name, rName, acctest.CtKey1, acctest.CtValue1Updated, acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRouteExists(ctx, resourceName, &r),
			...
			{
				Config: testAccRouteConfig_tags1(meshName, vrName, vn1Name, vn2Name, rName, acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRouteExists(ctx, resourceName, &r),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsKey2, acctest.CtValue2),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.weighted_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.header.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.weighted_target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.header.#", acctest.CtTwo),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "spec.0.http_route.0.match.0.header.*", map[string]string{
						"invert":       "true",
						"match.#":      acctest.CtZero,
						names.AttrName: "X-Testing1",
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.prefix", "/"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.scheme", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.http_retry_events.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "spec.0.http_route.0.retry_policy.0.http_retry_events.*", "server-error"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.max_retries", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.per_retry_timeout.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.tcp_retry_events.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.tcp_route.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrCreatedDate),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrLastUpdatedDate),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.http_retry_events.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "spec.0.http_route.0.retry_policy.0.http_retry_events.*", "server-error"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.max_retries", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.per_retry_timeout.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.per_retry_timeout.0.unit", "s"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.per_retry_timeout.0.value", "15"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.tcp_retry_events.#", acctest.CtZero),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.scheme", ""),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.http_retry_events.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.max_retries", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.per_retry_timeout.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.retry_policy.0.tcp_retry_events.#", acctest.CtOne),
