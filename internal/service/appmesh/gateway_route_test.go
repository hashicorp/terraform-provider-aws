		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.target.0.virtual_service.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.hostname.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.action.0.target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.grpc_route.0.action.0.target.0.virtual_service.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "spec.0.http_route.0.action.0.target.0.virtual_service.0.virtual_service_name", vs1ResourceName, names.AttrName),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.hostname.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.target.0.virtual_service.#", acctest.CtOne),
					resource.TestCheckResourceAttrPair(resourceName, "spec.0.http_route.0.action.0.target.0.virtual_service.0.virtual_service_name", vs1ResourceName, names.AttrName),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.rewrite.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.rewrite.0.hostname.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.rewrite.0.prefix.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "spec.0.http_route.0.action.0.target.0.virtual_service.0.virtual_service_name", vs1ResourceName, names.AttrName),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.rewrite.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.rewrite.0.hostname.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.rewrite.0.prefix.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.rewrite.0.path.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.action.0.rewrite.0.path.0.exact", "/rewrite_path"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http_route.0.match.0.path.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.target.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.target.0.virtual_service.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.hostname.#", acctest.CtZero),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "spec.0.http2_route.0.action.0.target.0.virtual_service.0.virtual_service_name", vs1ResourceName, names.AttrName),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.hostname.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.target.0.virtual_service.#", acctest.CtOne),
					resource.TestCheckResourceAttrPair(resourceName, "spec.0.http2_route.0.action.0.target.0.virtual_service.0.virtual_service_name", vs1ResourceName, names.AttrName),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.rewrite.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.rewrite.0.hostname.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.rewrite.0.prefix.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "spec.0.http2_route.0.action.0.target.0.virtual_service.0.virtual_service_name", vs1ResourceName, names.AttrName),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.rewrite.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.rewrite.0.hostname.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.rewrite.0.prefix.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.action.0.rewrite.0.path.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.header.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.hostname.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.path.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.port", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.prefix", "/"),
					resource.TestCheckResourceAttr(resourceName, "spec.0.http2_route.0.match.0.query_parameter.#", acctest.CtOne),
...
func testAccGatewayRoute_tags(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccGatewayRouteConfig_tags1(meshName, vgName, grName, acctest.CtKey1, acctest.CtValue1),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayRouteExists(ctx, resourceName, &v),
			...
			{
				Config: testAccGatewayRouteConfig_tags2(meshName, vgName, grName, acctest.CtKey1, acctest.CtValue1Updated, acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayRouteExists(ctx, resourceName, &v),
			...
			{
				Config: testAccGatewayRouteConfig_tags1(meshName, vgName, grName, acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayRouteExists(ctx, resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsKey2, acctest.CtValue2),
