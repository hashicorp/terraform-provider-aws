...
func testAccGatewayRoute_HTTPRoute(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccGatewayRouteConfig_httpRouteUpdatedMatchHostname(meshName, vgName, grName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayRouteExists(resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "mesh_name", meshName),
					acctest.CheckResourceAttrAccountID(resourceName, "mesh_owner"),
...
func testAccGatewayRoute_HTTP2Route(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccGatewayRouteConfig_http2RouteUpdatedMatchHostname(meshName, vgName, grName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGatewayRouteExists(resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "mesh_name", meshName),
					acctest.CheckResourceAttrAccountID(resourceName, "mesh_owner"),
...
func testAccGatewayRouteConfig_httpRouteUpdatedMatchHostname(meshName, vgName, grName string) string {
	return acctest.ConfigCompose(testAccGatewayRouteConfigBase(meshName, vgName), fmt.Sprintf(`
resource "aws_appmesh_gateway_route" "test" {
  name                 = %[1]q
  mesh_name            = aws_appmesh_mesh.test.name
...
func testAccGatewayRouteConfig_http2RouteUpdatedMatchHostname(meshName, vgName, grName string) string {
	return acctest.ConfigCompose(testAccGatewayRouteConfigBase(meshName, vgName), fmt.Sprintf(`
resource "aws_appmesh_gateway_route" "test" {
  name                 = %[1]q
  mesh_name            = aws_appmesh_mesh.test.name
