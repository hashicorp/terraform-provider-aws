...
func defaultEndpoint(region string) (url.URL, error) {
	r := emrserverless_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), emrserverless_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListApplications(ctx, &emrserverless_sdkv2.ListApplicationsInput{},
		func(opts *emrserverless_sdkv2.Options) {
