		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "finding_publishing_frequency", awstypes.FindingPublishingFrequencyFifteenMinutes),
					resource.TestCheckResourceAttr(resourceName, names.AttrStatus, awstypes.MacieStatusEnabled),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAccountExists(ctx, resourceName, &macie2Output),
					resource.TestCheckResourceAttr(resourceName, "finding_publishing_frequency", awstypes.FindingPublishingFrequencyOneHour),
					resource.TestCheckResourceAttr(resourceName, names.AttrStatus, awstypes.MacieStatusEnabled),
					acctest.CheckResourceAttrGlobalARN(resourceName, names.AttrServiceRole, "iam", "role/aws-service-role/macie.amazonaws.com/AWSServiceRoleForAmazonMacie"),
					acctest.CheckResourceAttrRFC3339(resourceName, names.AttrCreatedAt),
					acctest.CheckResourceAttrRFC3339(resourceName, "updated_at"),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAccountExists(ctx, resourceName, &macie2Output),
					resource.TestCheckResourceAttr(resourceName, "finding_publishing_frequency", awstypes.FindingPublishingFrequencyFifteenMinutes),
					resource.TestCheckResourceAttr(resourceName, names.AttrStatus, awstypes.MacieStatusPaused),
					acctest.CheckResourceAttrGlobalARN(resourceName, names.AttrServiceRole, "iam", "role/aws-service-role/macie.amazonaws.com/AWSServiceRoleForAmazonMacie"),
					acctest.CheckResourceAttrRFC3339(resourceName, names.AttrCreatedAt),
					acctest.CheckResourceAttrRFC3339(resourceName, "updated_at"),
				),
