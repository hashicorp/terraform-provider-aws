...
func TestAccCodeBuildResourcePolicy_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCodeBuildResourcePolicy_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
