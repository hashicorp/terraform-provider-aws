...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*cognitoidentity_sdkv1.CognitoIdentity, error) {
	return cognitoidentity_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
