...
func TestAccIAMSAMLProvider_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/SAMLProvider/tags/"),
...
func TestAccIAMSAMLProvider_tags_null(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_EmptyMap(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_AddOnUpdate(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_EmptyTag_OnCreate(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_EmptyTag_OnUpdate_Add(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_EmptyTag_OnUpdate_Replace(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_DefaultTags_providerOnly(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/SAMLProvider/tags_defaults/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccIAMSAMLProvider_tags_DefaultTags_nonOverlapping(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_DefaultTags_overlapping(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_DefaultTags_updateToProviderOnly(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_DefaultTags_updateToResourceOnly(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_DefaultTags_emptyResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_DefaultTags_emptyProviderOnlyTag(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_DefaultTags_nullOverlappingResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_DefaultTags_nullNonOverlappingResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_ComputedTag_OnCreate(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/SAMLProvider/tagsComputed1/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccIAMSAMLProvider_tags_ComputedTag_OnUpdate_Add(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/SAMLProvider/tagsComputed2/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func TestAccIAMSAMLProvider_tags_ComputedTag_OnUpdate_Replace(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccIAMSAMLProvider_tags_IgnoreTags_Overlap_DefaultTag(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/SAMLProvider/tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
...
func TestAccIAMSAMLProvider_tags_IgnoreTags_Overlap_ResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_iam_saml_provider.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
