...
func testAccBedrockEnforcedGuardrailConfiguration_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccBedrockEnforcedGuardrailConfiguration_Identity_basic,
		"RegionOverride": testAccBedrockEnforcedGuardrailConfiguration_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccBedrockEnforcedGuardrailConfiguration_Identity_basic(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/EnforcedGuardrailConfiguration/basic/"),
...
func testAccBedrockEnforcedGuardrailConfiguration_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/EnforcedGuardrailConfiguration/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
