...
func defaultEndpoint(region string) (url.URL, error) {
	r := swf_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), swf_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDomains(ctx, &swf_sdkv2.ListDomainsInput{
		RegistrationStatus: "REGISTERED",
	},
		func(opts *swf_sdkv2.Options) {
