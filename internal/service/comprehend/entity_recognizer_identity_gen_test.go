		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckEntityRecognizerExists(ctx, t, resourceName, &v),
				),
...
func TestAccComprehendEntityRecognizer_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccComprehendEntityRecognizer_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
