...
func (p *servicePackage) NewClient(ctx context.Context, cfg aws_sdkv2.Config) (*comprehend_sdkv2.Client, error) {
	return comprehend_sdkv2.NewFromConfig(cfg, func(o *comprehend_sdkv2.Options) {
		if p.endpoint != "" {
			o.EndpointResolver = comprehend_sdkv2.EndpointResolverFromURL(p.endpoint)
		}
	}), nil
}
