...
func (p *servicePackage) NewClient(ctx context.Context, cfg aws_sdkv2.Config) (*identitystore_sdkv2.Client, error) {
	return identitystore_sdkv2.NewFromConfig(cfg, func(o *identitystore_sdkv2.Options) {
		if p.endpoint != "" {
			o.EndpointResolver = identitystore_sdkv2.EndpointResolverFromURL(p.endpoint)
		}
	}), nil
}
