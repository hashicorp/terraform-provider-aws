...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*identitystore_sdkv2.Client, error) {
	...
	return identitystore_sdkv2.NewFromConfig(cfg,
		identitystore_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*identitystore_sdkv2.Options) {
	return func(o *identitystore_sdkv2.Options) {
		if endpoint != "" {
