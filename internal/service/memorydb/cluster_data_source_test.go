		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "security_group_ids.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttrPair(dataSourceName, "security_group_ids.*", resourceName, "security_group_ids.0"),
					resource.TestCheckResourceAttr(dataSourceName, "shards.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(dataSourceName, "shards.0.nodes.#", acctest.CtTwo),
