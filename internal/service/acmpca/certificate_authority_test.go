		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "certificate_authority_configuration.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "certificate_authority_configuration.0.subject.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "revocation_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "revocation_configuration.0.crl_configuration.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			// Test creating revocation configuration on resource creation
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "revocation_configuration.0.crl_configuration.0.expiration_in_days", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			...
			// Test updating revocation configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "revocation_configuration.0.crl_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "revocation_configuration.0.crl_configuration.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "revocation_configuration.0.crl_configuration.0.expiration_in_days", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "revocation_configuration.0.crl_configuration.0.s3_bucket_name", rName),
				),
			},
			// Test removing revocation configuration on resource update
		...
		Steps: []resource.TestStep{
			// Test creating OCSP revocation configuration on resource creation
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCertificateAuthorityExists(ctx, resourceName, &certificateAuthority),
					resource.TestCheckResourceAttr(resourceName, "revocation_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "revocation_configuration.0.ocsp_configuration.#", acctest.CtOne),
