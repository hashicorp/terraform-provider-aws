...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*acmpca_sdkv1.ACMPCA, error) {
	sess := config["session"].(*session_sdkv1.Session)

	return acmpca_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(config["endpoint"].(string))})), nil
}
