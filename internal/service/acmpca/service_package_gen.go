...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*acmpca_sdkv2.Client, error) {
	...
	return acmpca_sdkv2.NewFromConfig(cfg,
		acmpca_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*acmpca_sdkv2.Options) {
	return func(o *acmpca_sdkv2.Options) {
		if endpoint != "" {
