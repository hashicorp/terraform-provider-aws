		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "resource_creation_limit_policy.0.policy_period_in_minutes", acctest.Ct15),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.server_process.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.server_process.0.concurrent_executions", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.server_process.0.launch_path", launchPath),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "resource_creation_limit_policy.0.policy_period_in_minutes", acctest.Ct25),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.game_session_activation_timeout_seconds", acctest.Ct35),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.max_concurrent_game_session_activations", acctest.Ct99),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.server_process.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.server_process.0.concurrent_executions", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.server_process.0.launch_path", launchPath),
