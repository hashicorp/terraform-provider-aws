		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "certificate_configuration.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "log_paths.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "metric_groups.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "resource_creation_limit_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.server_process.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "runtime_configuration.0.server_process.0.concurrent_executions", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "resource_creation_limit_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "resource_creation_limit_policy.0.new_game_sessions_per_creator", acctest.CtTwo),
