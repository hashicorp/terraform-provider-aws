		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestMatchResourceAttr(resourceName, names.AttrARN, regexache.MustCompile(`containergroupdefinition/.+:\d+`)),
					resource.TestMatchResourceAttr(resourceName, "creation_time", regexache.MustCompile(acctest.RFC3339RegexPattern)),
				),
			},
			{
