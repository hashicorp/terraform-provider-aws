		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "destinations.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "player_latency_policy.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "player_latency_policy.1.policy_duration_seconds", acctest.CtZero),
...
func TestAccGameLiftGameSessionQueue_tags(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccGameSessionQueueConfig_basicTags2(queueName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGameSessionQueueExists(ctx, resourceName, &conf),
