...
func (p *servicePackage) NewClient(ctx context.Context, cfg aws_sdkv2.Config) (*sesv2_sdkv2.Client, error) {
	return sesv2_sdkv2.NewFromConfig(cfg, func(o *sesv2_sdkv2.Options) {
		if p.endpoint != "" {
			o.EndpointResolver = sesv2_sdkv2.EndpointResolverFromURL(p.endpoint)
		}
	}), nil
}
