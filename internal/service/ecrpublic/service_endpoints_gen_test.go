...
func defaultEndpoint(region string) (url.URL, error) {
	r := ecrpublic_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ecrpublic_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeRepositories(ctx, &ecrpublic_sdkv2.DescribeRepositoriesInput{},
		func(opts *ecrpublic_sdkv2.Options) {
