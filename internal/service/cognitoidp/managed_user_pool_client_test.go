		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "access_token_validity", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "allowed_oauth_flows.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "callback_urls.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "explicit_auth_flows.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "id_token_validity", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "read_attributes.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "refresh_token_validity", "30"),
					resource.TestCheckResourceAttr(resourceName, "supported_identity_providers.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "write_attributes.#", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "allowed_oauth_flows.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "callback_urls.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "callback_urls.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "explicit_auth_flows.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "logout_urls.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "read_attributes.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "supported_identity_providers.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "write_attributes.#", acctest.CtZero),
				),
			},
			{
