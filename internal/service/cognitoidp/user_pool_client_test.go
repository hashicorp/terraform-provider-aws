...
func TestAccCognitoIDPUserPoolClient_accessTokenValidity_error(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testAccUserPoolClientConfig_accessTokenValidityUnit(rName, 2, awstypes.TimeUnitsTypeDays),
			...
			{
				Config:      testAccUserPoolClientConfig_accessTokenValidityUnit(rName, 4, awstypes.TimeUnitsTypeMinutes),
...
func TestAccCognitoIDPUserPoolClient_idTokenValidity_error(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testAccUserPoolClientConfig_idTokenValidityUnit(rName, 2, awstypes.TimeUnitsTypeDays),
			...
			{
				Config:      testAccUserPoolClientConfig_idTokenValidityUnit(rName, 4, awstypes.TimeUnitsTypeMinutes),
...
func TestAccCognitoIDPUserPoolClient_refreshTokenValidity_error(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:      testAccUserPoolClientConfig_refreshTokenValidityUnit(rName, 59, awstypes.TimeUnitsTypeMinutes),
...
func testAccCheckUserPoolClientExists(ctx context.Context, name string, client *awstypes.UserPoolClientType) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
func testAccUserPoolClientConfig_accessTokenValidityUnit(rName string, validity int, unit awstypes.TimeUnitsType) string {
	return acctest.ConfigCompose(
		testAccUserPoolClientBaseConfig(rName),
		fmt.Sprintf(`
resource "aws_cognito_user_pool_client" "test" {
...
func testAccUserPoolClientConfig_idTokenValidityUnit(rName string, validity int, unit awstypes.TimeUnitsType) string {
	return acctest.ConfigCompose(
		testAccUserPoolClientBaseConfig(rName),
		fmt.Sprintf(`
resource "aws_cognito_user_pool_client" "test" {
...
func testAccUserPoolClientConfig_refreshTokenValidityUnit(rName string, refreshTokenValidity int, unit awstypes.TimeUnitsType) string {
	return acctest.ConfigCompose(
		testAccUserPoolClientBaseConfig(rName),
		fmt.Sprintf(`
resource "aws_cognito_user_pool_client" "test" {
