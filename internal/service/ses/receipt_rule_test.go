		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "add_header_action.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "bounce_action.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "lambda_action.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "s3_action.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "sns_action.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "stop_action.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "workmail_action.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "recipients.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckReceiptRuleExists(ctx, resourceName, &rule),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "s3_action.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckReceiptRuleExists(ctx, resourceName, &rule),
					resource.TestCheckResourceAttr(resourceName, "sns_action.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckReceiptRuleExists(ctx, resourceName, &rule),
					resource.TestCheckResourceAttr(resourceName, "lambda_action.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckReceiptRuleExists(ctx, resourceName, &rule),
					resource.TestCheckResourceAttr(resourceName, "stop_action.#", acctest.CtOne),
