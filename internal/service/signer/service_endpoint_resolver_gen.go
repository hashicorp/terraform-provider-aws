...
var _ signer_sdkv2.EndpointResolverV2 = &resolver{}

type resolver struct {
	defaultResolver signer_sdkv2.EndpointResolverV2
}

func (r *resolver) ResolveEndpoint(ctx context.Context, params signer_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
