...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) *elasticsearchservice_sdkv1.ElasticsearchService {
	return elasticsearchservice_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)}))
}
