		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "vpc_options.0.availability_zones.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "vpc_options.0.security_group_ids.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "vpc_options.0.subnet_ids.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "vpc_options.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "vpc_options.0.availability_zones.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "vpc_options.0.security_group_ids.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "vpc_options.0.subnet_ids.#", acctest.CtTwo),
					resource.TestCheckResourceAttrSet(resourceName, "vpc_options.0.vpc_id"),
				),
			},
