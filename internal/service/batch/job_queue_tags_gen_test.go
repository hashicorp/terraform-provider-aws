...
func TestAccBatchJobQueue_tags_IgnoreTags_OnCreate_DefaultTag(t *testing.T) {
	ctx := acctest.Context(t)
	var v types.JobQueueDetail
	resourceName := "aws_batch_job_queue.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccBatchJobQueue_tags_IgnoreTags_OnCreate_ResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
	var v types.JobQueueDetail
	resourceName := "aws_batch_job_queue.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
		...
		Steps: []resource.TestStep{
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					expectAllTags(resourceName, knownvalue.MapExact(map[string]knownvalue.Check{
						acctest.CtResourceKey1: knownvalue.StringExact(acctest.CtResourceValue1),
						acctest.CtResourceKey2: knownvalue.StringExact(acctest.CtResourceValue2),
					})),
				},
