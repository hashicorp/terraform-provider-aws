		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "timeout.0.attempt_duration_seconds", acctest.Ct120),
					resource.TestCheckResourceAttr(resourceName, names.AttrType, "container"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, "0"),
					resource.TestCheckResourceAttr(resourceName, "timeout.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "timeout.0.attempt_duration_seconds", acctest.Ct60),
					resource.TestCheckResourceAttr(resourceName, names.AttrType, "container"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					acctest.CheckResourceAttrJMES(resourceName, "container_properties", "resourceRequirements[?type=='MEMORY'].value | [0]", acctest.Ct512),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "parameters.%", "0"),
					resource.TestCheckResourceAttr(resourceName, "platform_capabilities.#", acctest.Ct1),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckJobDefinitionExists(ctx, resourceName, &jd),
					testAccCheckJobDefinitionPreviousDeregistered(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "revision", acctest.Ct5),
				),
			},
		},
	})
