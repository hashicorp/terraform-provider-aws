		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "platform_capabilities.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrPropagateTags, "false"),
					resource.TestCheckResourceAttr(resourceName, "retry_strategy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "revision", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "scheduling_priority", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "timeout.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "parameters.%", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "platform_capabilities.#", acctest.CtOne),
					resource.TestCheckTypeSetElemAttr(resourceName, "platform_capabilities.*", "EC2"),
					resource.TestCheckResourceAttr(resourceName, names.AttrPropagateTags, "true"),
					resource.TestCheckResourceAttr(resourceName, "retry_strategy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "retry_strategy.0.attempts", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, "revision", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "timeout.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "timeout.0.attempt_duration_seconds", "120"),
					resource.TestCheckResourceAttr(resourceName, names.AttrType, "container"),
					resource.TestCheckResourceAttr(resourceName, "scheduling_priority", acctest.CtTwo),
				),
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "revision", acctest.CtTwo),
				),
			},
			{
				Config: testAccJobDefinitionConfig_name(rName),
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "platform_capabilities.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "retry_strategy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "revision", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "timeout.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrType, "container"),
				),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrPropagateTags, "false"),
					resource.TestCheckResourceAttr(resourceName, "retry_strategy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "retry_strategy.0.attempts", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrType, "container"),
					resource.TestCheckResourceAttr(resourceName, "scheduling_priority", acctest.CtOne),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckJobDefinitionExists(ctx, resourceName, &jd),
					acctest.MatchResourceAttrRegionalARN(resourceName, names.AttrARN, "batch", regexache.MustCompile(fmt.Sprintf(`job-definition/%s:\d+`, rName))),
					acctest.CheckResourceAttrJMES(resourceName, "container_properties", "length(command)", acctest.CtZero),
					...
					acctest.CheckResourceAttrJMES(resourceName, "container_properties", "length(resourceRequirements)", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckJobDefinitionExists(ctx, resourceName, &jd),
					acctest.CheckResourceAttrJMES(resourceName, "container_properties", "length(environment)", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckJobDefinitionExists(ctx, resourceName, &jd),
					resource.TestCheckResourceAttr(resourceName, "eks_properties.0.pod_properties.0.containers.#", acctest.CtOne),
