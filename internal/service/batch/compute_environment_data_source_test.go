		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceName, "update_policy.#", acctest.CtZero),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrPair(datasourceName, names.AttrARN, resourceName, names.AttrARN),
					resource.TestCheckResourceAttr(datasourceName, "update_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(datasourceName, "update_policy.0.%", acctest.CtTwo),
