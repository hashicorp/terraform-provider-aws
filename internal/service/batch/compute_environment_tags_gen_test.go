...
func TestAccBatchComputeEnvironment_tags_IgnoreTags_OnCreate_DefaultTag(t *testing.T) {
	ctx := acctest.Context(t)
	var v types.ComputeEnvironmentDetail
	resourceName := "aws_batch_compute_environment.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccBatchComputeEnvironment_tags_IgnoreTags_OnCreate_ResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
	var v types.ComputeEnvironmentDetail
	resourceName := "aws_batch_compute_environment.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
