...
func TestAccODBExascaleDBStorageVault_Identity_basic(t *testing.T) {
	ctx := acctest.Context(t)

	var v awstypes.ExascaleDbStorageVault
	resourceName := "aws_odb_exascale_db_storage_vault.test"
	rName := testAccRandomExascaleDBStorageVaultDisplayName(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/ExascaleDBStorageVault/basic/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckExascaleDBStorageVaultExists(ctx, t, resourceName, &v),
				),
...
func TestAccODBExascaleDBStorageVault_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/ExascaleDBStorageVault/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
