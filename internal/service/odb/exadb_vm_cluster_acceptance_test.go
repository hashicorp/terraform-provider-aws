		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "gi_version", "data.aws_odb_gi_minor_versions.test", "gi_minor_versions.0.version"),
					...
					resource.TestCheckResourceAttrSet(resourceName, "grid_image_type"),
					...
					resource.TestCheckResourceAttrSet(resourceName, "listener_port"),
					...
					resource.TestCheckResourceAttrSet(resourceName, "oci_resource_anchor_name"),
					resource.TestCheckResourceAttrSet(resourceName, "oci_url"),
					...
					resource.TestCheckResourceAttrSet(resourceName, "scan_dns_name"),
					resource.TestCheckResourceAttrSet(resourceName, "scan_dns_record_id"),
					resource.TestCheckResourceAttrSet(resourceName, "scan_ip_ids.#"),
					resource.TestCheckResourceAttrSet(resourceName, "scan_listener_port_tcp"),
					resource.TestCheckResourceAttrSet(resourceName, "scan_listener_port_tcp_ssl"),
					resource.TestCheckResourceAttr(resourceName, "shape", testAccExaDBVMClusterShapeCanonical),
					resource.TestCheckResourceAttrSet(resourceName, "shape_attribute"),
					resource.TestCheckResourceAttrSet(resourceName, "snapshot_file_system_storage.0.total_size_in_gbs"),
					...
					resource.TestCheckResourceAttrSet(resourceName, "total_file_system_storage.0.total_size_in_gbs"),
				...
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("data_collection_options"), knownvalue.ListSizeExact(0)),
					statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("iam_roles"), knownvalue.Null()),
					statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("iorm_config_cache"), knownvalue.Null()),
					statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("last_update_history_entry_id"), knownvalue.Null()),
					statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("percent_progress"), knownvalue.Null()),
					...
					statecheck.ExpectKnownValue(resourceName, tfjsonpath.New("vip_ids"), knownvalue.Null()),
				},
			},
			{
