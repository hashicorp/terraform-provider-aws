		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "dynamodb_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "elasticsearch_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "event_bridge_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "http_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "lambda_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "opensearchservice_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "relational_database_config.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckExistsDataSource(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "dynamodb_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckExistsDataSource(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "elasticsearch_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckExistsDataSource(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "opensearchservice_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckExistsDataSource(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "http_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "http_config.0.authorization_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "http_config.0.authorization_config.0.authorization_type", "AWS_IAM"),
					resource.TestCheckResourceAttr(resourceName, "http_config.0.authorization_config.0.aws_iam_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckExistsDataSource(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "event_bridge_config.#", acctest.CtOne),
