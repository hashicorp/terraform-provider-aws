		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckResolverExists(ctx, resourceName+acctest.Ct5, &resolver),
					testAccCheckResolverExists(ctx, resourceName+acctest.Ct6, &resolver),
					testAccCheckResolverExists(ctx, resourceName+acctest.Ct7, &resolver),
					testAccCheckResolverExists(ctx, resourceName+acctest.Ct8, &resolver),
					testAccCheckResolverExists(ctx, resourceName+acctest.Ct9, &resolver),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "caching_config.0.ttl", acctest.Ct60),
				),
			},
			{
				ResourceName:      resourceName,
