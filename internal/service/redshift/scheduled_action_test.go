		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "target_action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_action.0.pause_cluster.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_action.0.resize_cluster.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_action.0.resume_cluster.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrStartTime, ""),
					resource.TestCheckResourceAttr(resourceName, "target_action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_action.0.pause_cluster.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_action.0.resize_cluster.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_action.0.resume_cluster.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "target_action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_action.0.pause_cluster.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_action.0.resize_cluster.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_action.0.resume_cluster.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "target_action.0.resize_cluster.0.number_of_nodes", acctest.CtTwo),
				),
			},
			{
				ResourceName:      resourceName,
