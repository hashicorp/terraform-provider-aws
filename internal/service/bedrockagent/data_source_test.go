		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "data_source_configuration.0.s3_configuration.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "data_source_configuration.0.s3_configuration.0.inclusion_prefixes.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "server_side_encryption_configuration.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "vector_ingestion_configuration.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, "data_source_configuration.0.s3_configuration.0.bucket_arn"),
					resource.TestCheckNoResourceAttr(resourceName, "data_source_configuration.0.s3_configuration.0.bucket_owner_account_id"),
					resource.TestCheckResourceAttr(resourceName, "data_source_configuration.0.s3_configuration.0.inclusion_prefixes.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "data_source_configuration.0.type", "S3"),
					resource.TestCheckResourceAttrSet(resourceName, "data_source_id"),
					resource.TestCheckNoResourceAttr(resourceName, names.AttrDescription),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "server_side_encryption_configuration.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "vector_ingestion_configuration.#", acctest.CtZero),
				),
			},
			{
