...
func TestAccDataSyncLocationFSxOpenZFSFileSystem_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckLocationFSxforOpenZFSFileSystemDestroy(ctx, t),
		Steps: []resource.TestStep{
			{
				Config: testAccLocationFSxOpenZFSFileSystemConfig_basic(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLocationFSxforOpenZFSFileSystemExists(ctx, t, resourceName, &v),
...
func testAccCheckLocationFSxforOpenZFSFileSystemDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
...
func testAccCheckLocationFSxforOpenZFSFileSystemExists(ctx context.Context, t *testing.T, n string, v *datasync.DescribeLocationFsxOpenZfsOutput) resource.TestCheckFunc {
	return func(s *terraform.State) error {
