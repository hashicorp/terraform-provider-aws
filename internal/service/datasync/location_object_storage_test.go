...
func testAccCheckLocationObjectStorageDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
...
func testAccCheckLocationObjectStorageExists(ctx context.Context, t *testing.T, n string, v *datasync.DescribeLocationObjectStorageOutput) resource.TestCheckFunc {
	return func(s *terraform.State) error {
