	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateIdFunc:       testAccWSLocationFSxWindowsImportStateIdFunc(resourceName),
...
func testAccWSLocationFSxWindowsImportStateIdFunc(resourceName string) resource.ImportStateIdFunc {
