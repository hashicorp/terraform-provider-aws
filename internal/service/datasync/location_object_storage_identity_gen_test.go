...
func TestAccDataSyncLocationObjectStorage_Identity_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/LocationObjectStorage/basic/"),
...
func TestAccDataSyncLocationObjectStorage_Identity_regionOverride(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/LocationObjectStorage/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"domain":        config.StringVariable(domain),
...
func TestAccDataSyncLocationObjectStorage_Identity_ExistingResource_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/LocationObjectStorage/basic_v5.100.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"domain":        config.StringVariable(domain),
				},
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/LocationObjectStorage/basic_v6.0.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"domain":        config.StringVariable(domain),
				},
