...
func defaultEndpoint(region string) string {
	...
	ep, err := r.EndpointFor(applicationautoscaling_sdkv1.EndpointsID, region)
	if err != nil {
		return err.Error()
	}
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) string {
	...
	client := meta.AppAutoScalingConn(ctx)

	req, _ := client.DescribeScalableTargetsRequest(&applicationautoscaling_sdkv1.DescribeScalableTargetsInput{})
