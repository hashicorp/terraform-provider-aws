...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*transcribe_sdkv2.Client, error) {
	...
	return transcribe_sdkv2.NewFromConfig(cfg,
		transcribe_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*transcribe_sdkv2.Options) {
	return func(o *transcribe_sdkv2.Options) {
		if endpoint != "" {
