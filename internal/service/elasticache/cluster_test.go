...
func TestAccElasticacheCluster_Engine_Redis_LogDeliveryConfigurations_Cloudwatch_EnableDisable(t *testing.T) {
	var ec elasticache.CacheCluster
	rName := sdkacctest.RandomWithPrefix("tf-acc-test")
	resourceName := "aws_elasticache_cluster.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccClusterConfig_Engine_Redis_LogDeliveryConfigurations_Cloudwatch(rName, false),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(resourceName, &ec),
					resource.TestCheckResourceAttr(resourceName, "engine", "redis"),
...
func TestAccElasticacheCluster_Engine_Redis_LogDeliveryConfigurations_KinesisFirehose_EnableDisable(t *testing.T) {
	var ec elasticache.CacheCluster
	rName := sdkacctest.RandomWithPrefix("tf-acc-test")
	resourceName := "aws_elasticache_cluster.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccClusterConfig_Engine_Redis_LogDeliveryConfigurations_KinesisFirehose(rName, false),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckClusterExists(resourceName, &ec),
					resource.TestCheckResourceAttr(resourceName, "engine", "redis"),
...
func testAccClusterConfig_Engine_Redis_LogDeliveryConfigurations_KinesisFirehose(rName string, enableLogDelivery bool) string {
	return fmt.Sprintf(`
