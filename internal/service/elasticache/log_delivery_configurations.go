...
func getLogDeliveryConfigurationsSchema() *schema.Resource {
...
func expandLogDeliveryConfigurations(d *schema.ResourceData) []*elasticache.LogDeliveryConfigurationRequest {
	...
	if _, ok := d.GetOk("log_delivery_configurations.0.destination_details"); ok {
		logDeliveryConfigurationRequest.DestinationDetails = expandDestinationDetails(d)
	}
...
func expandDestinationDetails(d *schema.ResourceData) *elasticache.DestinationDetails {
