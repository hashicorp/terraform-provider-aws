...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) *elasticache_sdkv1.ElastiCache {
	return elasticache_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)}))
}
