...
func TestAccDataCluster_Engine_Redis_LogDeliveryConfigurations_Cloudwatch(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCluster_Engine_Redis_LogDeliveryConfigurations_Cloudwatch(rName, true),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccDataCluster_Engine_Redis_LogDeliveryConfigurations_KinesisFirehose(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCluster_Engine_Redis_LogDeliveryConfigurations_KinesisFirehose(rName, true),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func testAccCluster_Engine_Redis_LogDeliveryConfigurations_Cloudwatch(rName string, enableLogDelivery bool) string {
	return fmt.Sprintf(`
...
func testAccCluster_Engine_Redis_LogDeliveryConfigurations_KinesisFirehose(rName string, enableLogDelivery bool) string {
	return fmt.Sprintf(`
