		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "log_delivery_configurations.0.log_type", "engine-log"),
					...
					resource.TestCheckResourceAttr(dataSourceName, "log_delivery_configurations.1.log_type", "slow-log"),
				),
			},
		},
	})
