...
func testAccAppFabricAppBundle_tagsSerial(t *testing.T) {
	t.Helper()
...
func testAccAppFabricAppBundle_Tags_DefaultTags_providerOnly(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/AppBundle/tags_defaults/"),
				ConfigVariables: config.Variables{
...
func testAccAppFabricAppBundle_Tags_ComputedTag_onCreate(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/AppBundle/tagsComputed1/"),
				ConfigVariables: config.Variables{
...
func testAccAppFabricAppBundle_Tags_ComputedTag_OnUpdate_add(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/AppBundle/tagsComputed2/"),
				ConfigVariables: config.Variables{
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func testAccAppFabricAppBundle_Tags_IgnoreTags_Overlap_defaultTag(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/AppBundle/tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
					}),
