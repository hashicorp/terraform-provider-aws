		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "lustre_configuration.0.per_unit_storage_throughput", acctest.Ct1000),
					resource.TestCheckResourceAttr(resourceName, "lustre_configuration.0.weekly_maintenance_start_time", "2:05:00"),
					resource.TestCheckResourceAttr(resourceName, "storage_capacity", acctest.Ct1200),
