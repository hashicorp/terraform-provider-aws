...
func defaultEndpoint(region string) (url.URL, error) {
	r := pcaconnectorad_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), pcaconnectorad_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListConnectors(ctx, &pcaconnectorad_sdkv2.ListConnectorsInput{},
		func(opts *pcaconnectorad_sdkv2.Options) {
