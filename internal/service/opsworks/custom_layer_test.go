		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ebs_volume.#", acctest.CtOne),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "ebs_volume.*", map[string]string{
						names.AttrType:      "gp2",
						"number_of_disks":   acctest.CtTwo,
						"mount_point":       "/home",
						names.AttrSize:      "100",
					...
					resource.TestCheckResourceAttr(resourceName, "load_based_auto_scaling.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "system_packages.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "custom_security_group_ids.#", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, "custom_setup_recipes.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "custom_shutdown_recipes.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "custom_undeploy_recipes.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "drain_elb_on_shutdown", "false"),
					resource.TestCheckResourceAttr(resourceName, "ebs_volume.#", acctest.CtTwo),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "ebs_volume.*", map[string]string{
						names.AttrType:    "gp2",
						"number_of_disks": acctest.CtTwo,
						"mount_point":     "/home",
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "short_name", "tf-ops-acc-custom-layer"),
					resource.TestCheckResourceAttr(resourceName, "system_packages.#", acctest.CtThree),
					resource.TestCheckTypeSetElemAttr(resourceName, "system_packages.*", "git"),
					resource.TestCheckTypeSetElemAttr(resourceName, "system_packages.*", "golang"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cloudwatch_configuration.0.log_streams.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "cloudwatch_configuration.0.log_streams.0.file_fingerprint_lines", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cloudwatch_configuration.0.log_streams.0.file_fingerprint_lines", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "load_based_auto_scaling.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "load_based_auto_scaling.0.downscaling.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "load_based_auto_scaling.0.downscaling.0.alarms.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "load_based_auto_scaling.0.downscaling.0.instance_count", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "load_based_auto_scaling.0.upscaling.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "load_based_auto_scaling.0.upscaling.0.alarms.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "load_based_auto_scaling.0.upscaling.0.instance_count", acctest.CtThree),
