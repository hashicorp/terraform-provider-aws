...
func TestAccCloudFrontConnectionGroup_tags(t *testing.T) {
	...
	var v awstypes.ConnectionGroup
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/ConnectionGroup/tags/"),
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckConnectionGroupExists(ctx, t, resourceName, &v),
				),
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{
					"wait_for_deployment", names.AttrStatus,
				},
			},
			{
				ConfigDirectory: config.StaticDirectory("testdata/ConnectionGroup/tags/"),
...
func TestAccCloudFrontConnectionGroup_Tags_null(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_emptyMap(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_addOnUpdate(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_EmptyTag_onCreate(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_EmptyTag_OnUpdate_add(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_EmptyTag_OnUpdate_replace(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_DefaultTags_providerOnly(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/ConnectionGroup/tags_defaults/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccCloudFrontConnectionGroup_Tags_DefaultTags_nonOverlapping(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_DefaultTags_overlapping(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_DefaultTags_updateToProviderOnly(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_DefaultTags_updateToResourceOnly(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_DefaultTags_emptyResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_DefaultTags_emptyProviderOnlyTag(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_DefaultTags_nullOverlappingResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_DefaultTags_nullNonOverlappingResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_ComputedTag_onCreate(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/ConnectionGroup/tagsComputed1/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccCloudFrontConnectionGroup_Tags_ComputedTag_OnUpdate_add(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/ConnectionGroup/tagsComputed2/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func TestAccCloudFrontConnectionGroup_Tags_ComputedTag_OnUpdate_replace(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCloudFrontConnectionGroup_Tags_IgnoreTags_Overlap_defaultTag(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/ConnectionGroup/tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
...
func TestAccCloudFrontConnectionGroup_Tags_IgnoreTags_Overlap_resourceTag(t *testing.T) {
	ctx := acctest.Context(t)
