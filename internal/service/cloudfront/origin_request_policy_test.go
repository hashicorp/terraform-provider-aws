		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cookies_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "cookies_config.0.cookie_behavior", "none"),
					resource.TestCheckResourceAttr(resourceName, "cookies_config.0.cookies.#", acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, "etag"),
					resource.TestCheckResourceAttr(resourceName, "headers_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "headers_config.0.header_behavior", "none"),
					resource.TestCheckResourceAttr(resourceName, "headers_config.0.headers.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "query_strings_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "query_strings_config.0.query_string_behavior", "none"),
					resource.TestCheckResourceAttr(resourceName, "query_strings_config.0.query_strings.#", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cookies_config.0.cookies.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "cookies_config.0.cookies.0.items.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "headers_config.0.headers.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "headers_config.0.headers.0.items.#", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cookies_config.0.cookie_behavior", "whitelist"),
					resource.TestCheckResourceAttr(resourceName, "cookies_config.0.cookies.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "cookies_config.0.cookies.0.items.#", acctest.CtTwo),
					resource.TestCheckTypeSetElemAttr(resourceName, "cookies_config.0.cookies.0.items.*", "test1"),
					...
					resource.TestCheckResourceAttr(resourceName, "headers_config.0.headers.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "headers_config.0.headers.0.items.#", acctest.CtOne),
