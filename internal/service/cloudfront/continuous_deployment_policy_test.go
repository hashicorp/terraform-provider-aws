			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "traffic_config.*", map[string]string{
						...
						"single_weight_config.0.session_stickiness_config.0.idle_ttl":    acctest.Ct300,
						"single_weight_config.0.session_stickiness_config.0.maximum_ttl": acctest.Ct600,
					}),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "traffic_config.*", map[string]string{
						...
						"single_weight_config.0.session_stickiness_config.#":             acctest.Ct1,
						"single_weight_config.0.session_stickiness_config.0.idle_ttl":    acctest.Ct600,
						"single_weight_config.0.session_stickiness_config.0.maximum_ttl": acctest.Ct1200,
					}),
				),
			},
			{
