		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "security_headers_config.0.strict_transport_security.0.access_control_max_age_sec", acctest.Ct90),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "server_timing_headers_config.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "server_timing_headers_config.0.enabled", acctest.CtTrue),
					resource.TestCheckResourceAttr(resourceName, "server_timing_headers_config.0.sampling_rate", acctest.Ct90),
				),
			},
			{
