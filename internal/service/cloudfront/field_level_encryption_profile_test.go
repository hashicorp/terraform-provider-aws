		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "encryption_entities.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "encryption_entities.0.items.#", acctest.CtOne),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "encryption_entities.0.items.*", map[string]string{
						...
						"field_patterns.0.items.#": acctest.CtOne,
					}),
