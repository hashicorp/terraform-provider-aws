		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "export.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "export.0.name", rName),
					resource.TestCheckResourceAttr(resourceName, "export.0.data_query.#", acctest.CtOne),
					resource.TestCheckResourceAttrSet(resourceName, "export.0.data_query.0.query_statement"),
					resource.TestCheckResourceAttr(resourceName, "export.0.data_query.0.table_configurations.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "export.0.destination_configurations.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "export.0.destination_configurations.0.s3_destination.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "export.0.refresh_cadence.#", acctest.CtOne),
