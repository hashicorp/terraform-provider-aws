...
func defaultEndpoint(region string) (url.URL, error) {
	r := bcmdataexports_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), bcmdataexports_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListExports(ctx, &bcmdataexports_sdkv2.ListExportsInput{},
		func(opts *bcmdataexports_sdkv2.Options) {
