...
// findConnectionByName returns the Connection corresponding to the specified name.
func findConnectionByName(conn *codestarconnections.CodeStarConnections, name string) (*codestarconnections.Connection, error) {
