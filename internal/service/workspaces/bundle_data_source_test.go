		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "root_storage.0.capacity", acctest.Ct80),
					resource.TestCheckResourceAttr(dataSourceName, "user_storage.#", acctest.Ct1),
					resource.TestCheckResourceAttr(dataSourceName, "user_storage.0.capacity", acctest.Ct100),
				),
			},
		},
	})
