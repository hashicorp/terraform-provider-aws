		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "compute_type.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceName, "root_storage.#", acctest.CtOne),
					resource.TestCheckResourceAttr(dataSourceName, "root_storage.0.capacity", "80"),
					resource.TestCheckResourceAttr(dataSourceName, "user_storage.#", acctest.CtOne),
