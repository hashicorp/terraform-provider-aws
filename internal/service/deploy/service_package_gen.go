...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*codedeploy_sdkv2.Client, error) {
	...
	return codedeploy_sdkv2.NewFromConfig(cfg,
		codedeploy_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*codedeploy_sdkv2.Options) {
	return func(o *codedeploy_sdkv2.Options) {
		if endpoint != "" {
