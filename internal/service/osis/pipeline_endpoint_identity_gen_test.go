...
func TestAccOpenSearchIngestionPipelineEndpoint_Identity_basic(t *testing.T) {
	ctx := acctest.Context(t)

	var v awstypes.PipelineEndpoint
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/PipelineEndpoint/basic/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckPipelineEndpointExists(ctx, t, resourceName, &v),
				),
...
func TestAccOpenSearchIngestionPipelineEndpoint_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/PipelineEndpoint/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
