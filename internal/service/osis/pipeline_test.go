		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "buffer_options.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "encryption_at_rest_options.#", acctest.CtZero),
					acctest.CheckResourceAttrGreaterThanOrEqualValue(resourceName, "ingest_endpoint_urls.#", 1),
					resource.TestCheckResourceAttr(resourceName, "log_publishing_options.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "max_units", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "min_units", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckPipelineExists(ctx, resourceName, &pipeline),
					resource.TestCheckResourceAttr(resourceName, "pipeline_name", rName),
					resource.TestCheckResourceAttr(resourceName, "buffer_options.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckPipelineExists(ctx, resourceName, &pipeline),
					resource.TestCheckResourceAttr(resourceName, "pipeline_name", rName),
					resource.TestCheckResourceAttr(resourceName, "encryption_at_rest_options.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "log_publishing_options.0.cloudwatch_log_destination.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "vpc_options.0.subnet_ids.#", acctest.CtOne),
