...
func testAccNetworkSecurityManagerTemplate_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic: testAccNetworkSecurityManagerTemplate_Identity_basic,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccNetworkSecurityManagerTemplate_Identity_basic(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/Template/basic/"),
