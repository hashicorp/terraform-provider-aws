...
func testAccNetworkSecurityManagerPolicy_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic: testAccNetworkSecurityManagerPolicy_Identity_basic,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccNetworkSecurityManagerPolicy_Identity_basic(t *testing.T) {
