		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckConfigurationRecorderExists(ctx, resourceName, &cr),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "recording_group.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "recording_group.0.resource_types.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "recording_mode.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "recording_mode.0.recording_frequency", "DAILY"),
					resource.TestCheckResourceAttr(resourceName, "recording_mode.0.recording_mode_override.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "recording_mode.0.recording_mode_override.0.recording_frequency", "CONTINUOUS"),
					resource.TestCheckResourceAttr(resourceName, "recording_mode.0.recording_mode_override.0.resource_types.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "recording_group.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "recording_group.0.all_supported", "false"),
					resource.TestCheckResourceAttr(resourceName, "recording_group.0.exclusion_by_resource_types.0.resource_types.#", acctest.CtTwo),
