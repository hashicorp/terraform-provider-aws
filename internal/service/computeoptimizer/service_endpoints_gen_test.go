...
func defaultEndpoint(region string) (url.URL, error) {
	r := computeoptimizer_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), computeoptimizer_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.GetEnrollmentStatus(ctx, &computeoptimizer_sdkv2.GetEnrollmentStatusInput{},
		func(opts *computeoptimizer_sdkv2.Options) {
