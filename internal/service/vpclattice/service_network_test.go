...
func TestAccVPCLatticeServiceNetwork_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckServiceNetworkDestroy(ctx, t),
		Steps: []resource.TestStep{
			{
				Config: testAccServiceNetworkConfig_basic(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceNetworkExists(ctx, t, resourceName, &servicenetwork),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceNetworkExists(ctx, t, resourceName, &serviceNetwork1),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceNetworkExists(ctx, t, resourceName, &serviceNetwork2),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceNetworkExists(ctx, t, resourceName, &serviceNetwork3),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, "1"),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsKey2, acctest.CtValue2),
				),
			},
...
func testAccCheckServiceNetworkDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
...
func testAccCheckServiceNetworkExists(ctx context.Context, t *testing.T, n string, v *vpclattice.GetServiceNetworkOutput) resource.TestCheckFunc {
	return func(s *terraform.State) error {
