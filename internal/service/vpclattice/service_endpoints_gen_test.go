...
func defaultEndpoint(region string) (url.URL, error) {
	r := vpclattice_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), vpclattice_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListServices(ctx, &vpclattice_sdkv2.ListServicesInput{},
		func(opts *vpclattice_sdkv2.Options) {
