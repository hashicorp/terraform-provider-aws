		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "number_of_associated_services", acctest.CtZero),
					resource.TestCheckResourceAttr(dataSourceName, "number_of_associated_vpcs", acctest.CtZero),
