		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "backup_retention_period", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "enabled_cloudwatch_logs_exports.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrIOPS, acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "license_model", "general-public-license"),
					resource.TestCheckResourceAttr(resourceName, "listener_endpoint.#", acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, "maintenance_window"),
					resource.TestCheckResourceAttr(resourceName, "max_allocated_storage", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "replicas.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "storage_throughput", acctest.CtZero),
...
func TestAccRDSInstance_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccInstanceConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckInstanceExists(ctx, resourceName, &v),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "master_user_secret.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(sourceResourceName, "replicas.#", acctest.CtZero), // Before refreshing source, it will not be aware of replicas
				),
			},
			{
				...
				RefreshState: true,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr(sourceResourceName, "replicas.#", acctest.CtOne),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "parameter_group_name", parameterGroupResourceName, names.AttrName),
					testAccCheckInstanceParameterApplyStatusInSync(&dbInstance),
					testAccCheckInstanceParameterApplyStatusInSync(&sourceDbInstance),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "parameter_group_name", "aws_db_parameter_group.test", names.AttrName),
					testAccCheckInstanceParameterApplyStatusInSync(&dbInstance),
					testAccCheckInstanceParameterApplyStatusInSync(&sourceDbInstance),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testAccCheckDBSnapshotExists(ctx, snapshotResourceName, &dbSnapshot),
					testAccCheckInstanceExists(ctx, resourceName, &dbInstance),
					resource.TestCheckResourceAttr(resourceName, "listener_endpoint.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "multi_az", "true"),
				),
			},
		},
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckInstanceExists(ctx, resourceName, &dbInstance),
					resource.TestCheckResourceAttr(resourceName, "monitoring_interval", acctest.CtZero),
				),
			},
			{
				Config: testAccInstanceConfig_monitoringInterval(rName, 30),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "domain_dns_ips.#", acctest.CtTwo),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckInstanceExists(ctx, resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "enabled_cloudwatch_logs_exports.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckInstanceExists(ctx, resourceName, &v1),
					resource.TestCheckResourceAttr(resourceName, "backup_retention_period", acctest.CtOne),
					resource.TestCheckResourceAttrPair(resourceName, "parameter_group_name", parameterGroupDataSource, names.AttrName),
				),
			},
			{
...
func TestAccRDSInstance_BlueGreenDeployment_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccInstanceConfig_BlueGreenDeployment_tags1(rName, acctest.CtKey1, "value1updated"),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckInstanceExists(ctx, resourceName, &v2),
					testAccCheckDBInstanceNotRecreated(&v1, &v2),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtOne),
...
func testAccCheckInstanceExistsWithProvider(ctx context.Context, n string, v *rds.DBInstance, providerF func() *schema.Provider) resource.TestCheckFunc {
	return func(s *terraform.State) error {
