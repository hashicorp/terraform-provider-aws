...
func TestAccRDSTenantDatabase_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/TenantDatabase/tags/"),
...
func TestAccRDSTenantDatabase_tags_null(t *testing.T) {
...
func TestAccRDSTenantDatabase_tags_AddOnUpdate(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_EmptyTag_OnCreate(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_EmptyTag_OnUpdate_Add(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_EmptyTag_OnUpdate_Replace(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_DefaultTags_providerOnly(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/TenantDatabase/tags_defaults/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccRDSTenantDatabase_tags_DefaultTags_nonOverlapping(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_DefaultTags_overlapping(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_DefaultTags_updateToProviderOnly(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_DefaultTags_updateToResourceOnly(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_DefaultTags_emptyResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_DefaultTags_emptyProviderOnlyTag(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
...
func TestAccRDSTenantDatabase_tags_DefaultTags_nullOverlappingResourceTag(t *testing.T) {
	t.Skip("Tags with null values are not correctly handled with the Plugin Framework")
...
func TestAccRDSTenantDatabase_tags_DefaultTags_nullNonOverlappingResourceTag(t *testing.T) {
	t.Skip("Tags with null values are not correctly handled with the Plugin Framework")
...
func TestAccRDSTenantDatabase_tags_ComputedTag_OnCreate(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/TenantDatabase/tagsComputed1/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccRDSTenantDatabase_tags_ComputedTag_OnUpdate_Add(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/TenantDatabase/tagsComputed2/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func TestAccRDSTenantDatabase_tags_ComputedTag_OnUpdate_Replace(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName := "aws_db_tenant_database.test"
	rName := sdkacctest.RandomWithPrefix(acctest.ResourcePrefix)
