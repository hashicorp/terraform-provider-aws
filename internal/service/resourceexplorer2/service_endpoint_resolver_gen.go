...
var _ resourceexplorer2_sdkv2.EndpointResolverV2 = &resolver{}

type resolver struct {
	defaultResolver resourceexplorer2_sdkv2.EndpointResolverV2
}

func (r *resolver) ResolveEndpoint(ctx context.Context, params resourceexplorer2_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
