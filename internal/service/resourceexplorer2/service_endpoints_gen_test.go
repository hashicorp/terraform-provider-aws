...
func defaultEndpoint(region string) (url.URL, error) {
	r := resourceexplorer2_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), resourceexplorer2_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListIndexes(ctx, &resourceexplorer2_sdkv2.ListIndexesInput{},
		func(opts *resourceexplorer2_sdkv2.Options) {
