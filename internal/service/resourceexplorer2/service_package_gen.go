...
func (p *servicePackage) NewClient(ctx context.Context, cfg aws_sdkv2.Config) (*resourceexplorer2_sdkv2.Client, error) {
	return resourceexplorer2_sdkv2.NewFromConfig(cfg, func(o *resourceexplorer2_sdkv2.Options) {
		if p.endpoint != "" {
			o.EndpointResolver = resourceexplorer2_sdkv2.EndpointResolverFromURL(p.endpoint)
		}
	}), nil
}
