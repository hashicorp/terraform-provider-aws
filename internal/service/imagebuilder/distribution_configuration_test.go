...
func TestAccImageBuilderDistributionConfiguration_DistributionAMIDistributionLaunchPermission_organizationArns(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDistributionConfigurationDistributionAMIDistributionConfigurationLaunchPermissionOrganizationArnsConfig(rName, "arn:aws:organizations::111111111111:organization/o-123example"), //lintignore:AWSAT005
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDistributionConfigurationExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "distribution.#", "1"),
					resource.TestCheckTypeSetElemAttr(resourceName, "distribution.*.ami_distribution_configuration.0.launch_permission.0.organization_arns.*", "arn:aws:organizations::111111111111:organization/o-123example"), //lintignore:AWSAT005
				),
			},
			{
				ResourceName:      resourceName,
			...
			{
				Config: testAccDistributionConfigurationDistributionAMIDistributionConfigurationLaunchPermissionOrganizationArnsConfig(rName, "arn:aws:organizations::222222222222:organization/o-123example"), //lintignore:AWSAT005
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDistributionConfigurationExists(resourceName),
					acctest.CheckResourceAttrRFC3339(resourceName, "date_updated"),
					resource.TestCheckResourceAttr(resourceName, "distribution.#", "1"),
					resource.TestCheckTypeSetElemAttr(resourceName, "distribution.*.ami_distribution_configuration.0.launch_permission.0.organization_arns.*", "arn:aws:organizations::222222222222:organization/o-123example"), //lintignore:AWSAT005
				),
			},
		},
	})
...
func TestAccImageBuilderDistributionConfiguration_DistributionAMIDistributionLaunchPermission_organizationalUnitArns(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDistributionConfigurationDistributionAMIDistributionConfigurationLaunchPermissionOrganizationalUnitArnsConfig(rName, "arn:aws:organizations::111111111111:ou/o-123example/ou-1234-5example"), //lintignore:AWSAT005
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDistributionConfigurationExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "distribution.#", "1"),
					resource.TestCheckTypeSetElemAttr(resourceName, "distribution.*.ami_distribution_configuration.0.launch_permission.0.organizational_unit_arns.*", "arn:aws:organizations::111111111111:ou/o-123example/ou-1234-5example"), //lintignore:AWSAT005
				),
			},
			{
				ResourceName:      resourceName,
			...
			{
				Config: testAccDistributionConfigurationDistributionAMIDistributionConfigurationLaunchPermissionOrganizationalUnitArnsConfig(rName, "arn:aws:organizations::222222222222:ou/o-123example/ou-1234-5example"), //lintignore:AWSAT005
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDistributionConfigurationExists(resourceName),
					acctest.CheckResourceAttrRFC3339(resourceName, "date_updated"),
					resource.TestCheckResourceAttr(resourceName, "distribution.#", "1"),
					resource.TestCheckTypeSetElemAttr(resourceName, "distribution.*.ami_distribution_configuration.0.launch_permission.0.organizational_unit_arns.*", "arn:aws:organizations::222222222222:ou/o-123example/ou-1234-5example"), //lintignore:AWSAT005
				),
			},
		},
	})
