		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "image_scanning_configuration.#", acctest.CtZero),
					resource.TestCheckResourceAttr(dataSourceName, "image_tests_configuration.#", acctest.CtZero),
