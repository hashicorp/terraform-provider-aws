		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "block_device_mapping.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImageRecipeExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "block_device_mapping.#", acctest.CtOne),
...
func TestAccImageBuilderImageRecipe_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccImageRecipeConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImageRecipeExists(ctx, resourceName),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImageRecipeExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "systems_manager_agent.#", acctest.CtOne),
