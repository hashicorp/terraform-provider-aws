		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAnomalyMonitorExists(ctx, t, resourceName, &monitor),
...
func testAccCheckAnomalyMonitorExists(ctx context.Context, t *testing.T, n string, v *awstypes.AnomalyMonitor) resource.TestCheckFunc {
...
func testAccCheckAnomalyMonitorDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		conn := acctest.ProviderMeta(ctx, t).CEClient(ctx)
