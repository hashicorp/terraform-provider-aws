...
var _ mq_sdkv2.EndpointResolverV2 = &resolver{}
...
func (r *resolver) ResolveEndpoint(ctx context.Context, params mq_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
