...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) *mq_sdkv1.MQ {
	return mq_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)}))
}
