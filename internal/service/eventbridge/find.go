...
func FindConnectionByName(conn *events.EventBridge, name string) (*events.DescribeConnectionOutput, error) {
...
func FindRuleByEventBusAndRuleNames(conn *events.EventBridge, eventBusName, ruleName string) (*events.DescribeRuleOutput, error) {
...
func FindRuleByResourceID(conn *events.EventBridge, id string) (*events.DescribeRuleOutput, error) {
...
func FindTarget(conn *events.EventBridge, busName, ruleName, targetId string) (*events.Target, error) {
