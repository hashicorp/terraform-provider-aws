...
func TestPermissionParseResourceID(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			ExpectedPart0: tfeventbridge.DefaultEventBusName,
			ExpectedPart1: "TestStatement",
		},
		{
			TestName:      "two parts",
			InputID:       tfeventbridge.PermissionCreateResourceID("TestEventBus", "TestStatement"),
			ExpectedPart0: "TestEventBus",
			ExpectedPart1: "TestStatement",
		},
		{
			TestName:      "two parts with default event bus",
			InputID:       tfeventbridge.PermissionCreateResourceID(tfeventbridge.DefaultEventBusName, "TestStatement"),
			ExpectedPart0: tfeventbridge.DefaultEventBusName,
			ExpectedPart1: "TestStatement",
		},
		{
	...
	for _, testCase := range testCases {
		t.Run(testCase.TestName, func(t *testing.T) {
			gotPart0, gotPart1, err := tfeventbridge.PermissionParseResourceID(testCase.InputID)
...
func TestRuleParseResourceID(t *testing.T) {
	testCases := []struct {
		...
		{
			TestName:      "two parts",
			InputID:       tfeventbridge.RuleCreateResourceID("TestEventBus", "TestRule"),
			ExpectedPart0: "TestEventBus",
			ExpectedPart1: "TestRule",
		},
		{
			TestName:      "two parts with default event bus",
			InputID:       tfeventbridge.RuleCreateResourceID(tfeventbridge.DefaultEventBusName, "TestRule"),
			ExpectedPart0: tfeventbridge.DefaultEventBusName,
			ExpectedPart1: "TestRule",
		},
		{
		...
		},
		{
			...
			InputID: tfeventbridge.RuleCreateResourceID("arn:aws:events:us-east-2:123456789012:event-bus/default", "TestRule"),
			//lintignore:AWSAT003,AWSAT005
	...
	for _, testCase := range testCases {
		t.Run(testCase.TestName, func(t *testing.T) {
			gotPart0, gotPart1, err := tfeventbridge.RuleParseResourceID(testCase.InputID)
...
func TestTargetParseImportID(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			InputID:       tfeventbridge.DefaultEventBusName + "/TestRule/TestTarget",
			ExpectedPart0: tfeventbridge.DefaultEventBusName,
			ExpectedPart1: "TestRule",
			ExpectedPart2: "TestTarget",
		},
	...
	for _, testCase := range testCases {
		t.Run(testCase.TestName, func(t *testing.T) {
			gotPart0, gotPart1, gotPart2, err := tfeventbridge.TargetParseImportID(testCase.InputID)
