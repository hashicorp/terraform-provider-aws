		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cloudwatch_alarm.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "cloudwatch_logs.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "cloudwatch_metric.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrDescription, ""),
					resource.TestCheckResourceAttr(resourceName, "dynamodb.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "firehose.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "http.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "iot_analytics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "iot_events.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "kafka.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "kinesis.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "lambda.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "republish.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "s3.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "sns.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "sqs.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "step_functions.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "timestream.#", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTopicRuleExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "cloudwatch_alarm.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "cloudwatch_logs.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "error_action.0.cloudwatch_alarm.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.cloudwatch_logs.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.cloudwatch_metric.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.dynamodb.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.dynamodbv2.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.elasticsearch.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.firehose.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "error_action.0.iot_analytics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.iot_events.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.kafka.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.kinesis.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.lambda.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.republish.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.s3.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.sns.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.sqs.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.step_functions.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.timestream.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "firehose.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "http.#", acctest.CtOne),
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "http.*", map[string]string{
						"confirmation_url": "",
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "error_action.0.elasticsearch.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.firehose.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.http.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.iot_analytics.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.iot_events.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "error_action.0.kafka.#", acctest.CtZero),
