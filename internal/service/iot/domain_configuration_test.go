...
func TestAccIoTDomainConfiguration_update(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDomainConfigurationConfig_securityPolicy(rName, rootDomain, domain, "IoTSecurityPolicy_TLS13_1_3_2022_10", true, "DEFAULT"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDomainConfigurationExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "authentication_type", "DEFAULT"),
			...
			{
				Config: testAccDomainConfigurationConfig_securityPolicy(rName, rootDomain, domain, "IoTSecurityPolicy_TLS13_1_2_2022_10", false, "AWS_X509"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDomainConfigurationExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "authentication_type", "AWS_X509"),
					resource.TestCheckResourceAttr(resourceName, "authorizer_config.#", "1"),
...
func testAccDomainConfigurationConfig_securityPolicy(rName, rootDomain, domain, securityPolicy string, allowAuthorizerOverride bool, authenticationType string) string {
...
`, rName, domain, securityPolicy, allowAuthorizerOverride, authenticationType))
}
