...
func defaultEndpoint(region string) (url.URL, error) {
	r := mediapackagev2_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), mediapackagev2_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListChannelGroups(ctx, &mediapackagev2_sdkv2.ListChannelGroupsInput{},
		func(opts *mediapackagev2_sdkv2.Options) {
