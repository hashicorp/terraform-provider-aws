		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceName, "consumption_configuration.#", acctest.CtOne),
					acctest.CheckResourceAttrRFC3339(datasourceName, names.AttrCreateTime),
					resource.TestCheckResourceAttr(datasourceName, "entitlements.#", acctest.CtOne),
					resource.TestCheckResourceAttr(datasourceName, "home_region", homeRegion),
					resource.TestCheckResourceAttr(datasourceName, "issuer.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(datasourceName, "received_metadata.#", acctest.CtOne),
					resource.TestCheckResourceAttrSet(datasourceName, names.AttrStatus),
					resource.TestCheckResourceAttr(datasourceName, "validity.#", acctest.CtOne),
