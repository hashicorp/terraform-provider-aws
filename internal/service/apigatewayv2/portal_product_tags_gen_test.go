...
func TestAccAPIGatewayV2PortalProduct_tags(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/PortalProduct/tags/"),
...
func TestAccAPIGatewayV2PortalProduct_Tags_emptyMap(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccAPIGatewayV2PortalProduct_Tags_addOnUpdate(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccAPIGatewayV2PortalProduct_Tags_DefaultTags_providerOnly(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/PortalProduct/tags_defaults/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccAPIGatewayV2PortalProduct_Tags_DefaultTags_nonOverlapping(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccAPIGatewayV2PortalProduct_Tags_DefaultTags_overlapping(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccAPIGatewayV2PortalProduct_Tags_DefaultTags_updateToProviderOnly(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccAPIGatewayV2PortalProduct_Tags_DefaultTags_updateToResourceOnly(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccAPIGatewayV2PortalProduct_Tags_ComputedTag_onCreate(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/PortalProduct/tagsComputed1/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccAPIGatewayV2PortalProduct_Tags_ComputedTag_OnUpdate_add(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/PortalProduct/tagsComputed2/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func TestAccAPIGatewayV2PortalProduct_Tags_ComputedTag_OnUpdate_replace(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccAPIGatewayV2PortalProduct_Tags_IgnoreTags_Overlap_defaultTag(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/PortalProduct/tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
...
func TestAccAPIGatewayV2PortalProduct_Tags_IgnoreTags_Overlap_resourceTag(t *testing.T) {
	ctx := acctest.Context(t)
