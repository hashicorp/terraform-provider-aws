...
func TestAccAPIGatewayV2API_Identity_basic(t *testing.T) {
...
func TestAccAPIGatewayV2API_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccAPIGatewayV2API_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/API/basic_v6.40.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
// Resource Identity was added after v6.40.0
func TestAccAPIGatewayV2API_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
