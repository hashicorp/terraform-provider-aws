...
const (
	packageName = "kinesisvideo"
	awsEnvVar   = "AWS_ENDPOINT_URL_KINESIS_VIDEO"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "kinesis_video"
)
...
func defaultEndpoint(region string) (url.URL, error) {
	r := kinesisvideo_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), kinesisvideo_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListStreams(ctx, &kinesisvideo_sdkv2.ListStreamsInput{},
		func(opts *kinesisvideo_sdkv2.Options) {
