		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceNameByARN, "tags.%", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(datasourceNameByName, "tags.%", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceNameArn, "tags.%", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceMatchFirstTag, "tags.%", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceMatchSecondTag, "tags.%", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceMatchFirstTagAndName, "tags.%", acctest.CtOne),
