		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceNameByARN, names.AttrPort, acctest.Ct8080),
					...
					resource.TestCheckResourceAttr(datasourceNameByARN, "deregistration_delay", acctest.Ct300),
					...
					resource.TestCheckResourceAttr(datasourceNameByName, names.AttrPort, acctest.Ct8080),
					...
					resource.TestCheckResourceAttr(datasourceNameByName, "deregistration_delay", acctest.Ct300),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceNameArn, names.AttrPort, acctest.Ct8080),
					...
					resource.TestCheckResourceAttr(resourceNameArn, "deregistration_delay", acctest.Ct300),
					...
					resource.TestCheckResourceAttr(resourceNameArn, "stickiness.0.cookie_duration", acctest.Ct600),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrPort, acctest.Ct8080),
