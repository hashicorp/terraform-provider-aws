		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceNameByARN, "lb_arns.#", "0"),
					...
					resource.TestCheckResourceAttr(datasourceNameByName, "lb_arns.#", "0"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceNameArn, "lb_arns.#", "0"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(dataSourceMatchFirstTag, "lb_arns.#", resourceTg1, "lb_arns.#"),
					...
					resource.TestCheckResourceAttrPair(dataSourceMatchSecondTag, "lb_arns.#", resourceTg2, "lb_arns.#"),
					...
					resource.TestCheckResourceAttrPair(dataSourceMatchFirstTagAndName, "lb_arns.#", resourceTg1, "lb_arns.#"),
