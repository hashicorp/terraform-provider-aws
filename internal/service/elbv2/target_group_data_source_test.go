		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceNameByARN, "load_balancer_arns.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(datasourceNameByARN, "slow_start", acctest.CtZero),
					resource.TestCheckResourceAttr(datasourceNameByARN, acctest.CtTagsPercent, acctest.CtOne),
					resource.TestCheckResourceAttr(datasourceNameByARN, "tags.Name", rName),
					resource.TestCheckResourceAttr(datasourceNameByARN, "stickiness.#", acctest.CtOne),
					resource.TestCheckResourceAttr(datasourceNameByARN, "health_check.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(datasourceNameByARN, "health_check.0.timeout", acctest.CtThree),
					resource.TestCheckResourceAttr(datasourceNameByARN, "health_check.0.healthy_threshold", acctest.CtThree),
					resource.TestCheckResourceAttr(datasourceNameByARN, "health_check.0.unhealthy_threshold", acctest.CtThree),
					...
					resource.TestCheckResourceAttr(datasourceNameByName, "load_balancer_arns.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(datasourceNameByName, "slow_start", acctest.CtZero),
					resource.TestCheckResourceAttr(datasourceNameByName, acctest.CtTagsPercent, acctest.CtOne),
					resource.TestCheckResourceAttr(datasourceNameByName, "tags.Name", rName),
					resource.TestCheckResourceAttr(datasourceNameByName, "stickiness.#", acctest.CtOne),
					resource.TestCheckResourceAttr(datasourceNameByName, "health_check.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(datasourceNameByName, "health_check.0.timeout", acctest.CtThree),
					resource.TestCheckResourceAttr(datasourceNameByName, "health_check.0.healthy_threshold", acctest.CtThree),
					resource.TestCheckResourceAttr(datasourceNameByName, "health_check.0.unhealthy_threshold", acctest.CtThree),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceNameArn, "load_balancer_arns.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceNameArn, "slow_start", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceNameArn, acctest.CtTagsPercent, acctest.CtOne),
					resource.TestCheckResourceAttr(resourceNameArn, "tags.Name", rName),
					resource.TestCheckResourceAttr(resourceNameArn, "stickiness.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceNameArn, "health_check.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceNameArn, "health_check.0.timeout", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceNameArn, "health_check.0.healthy_threshold", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceNameArn, "health_check.0.unhealthy_threshold", acctest.CtThree),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceMatchFirstTag, acctest.CtTagsPercent, acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceMatchSecondTag, acctest.CtTagsPercent, acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceMatchFirstTagAndName, acctest.CtTagsPercent, acctest.CtOne),
