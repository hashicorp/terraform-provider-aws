		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "load_balancer_arns.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "slow_start", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "stickiness.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "health_check.0.timeout", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, "health_check.0.healthy_threshold", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, "health_check.0.unhealthy_threshold", acctest.CtThree),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "health_check.0.healthy_threshold", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "health_check.0.unhealthy_threshold", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "tags.Name", rName),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckTargetGroupExists(ctx, resourceName, &conf),
					resource.TestCheckResourceAttrSet(resourceName, names.AttrARN),
					resource.TestCheckResourceAttr(resourceName, "deregistration_delay", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "slow_start", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, names.AttrProtocol, "TCP"),
					resource.TestCheckResourceAttr(resourceName, "target_health_state.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckTargetGroupExists(ctx, resourceName, &targetGroup),
					resource.TestCheckResourceAttr(resourceName, "target_type", elbv2.TargetTypeEnumLambda),
					resource.TestCheckResourceAttr(resourceName, names.AttrPort, acctest.CtZero), // Should be Null
				),
			},
		},
	})
