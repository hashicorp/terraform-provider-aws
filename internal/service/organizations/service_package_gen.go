...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*organizations_sdkv1.Organizations, error) {
	return organizations_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
