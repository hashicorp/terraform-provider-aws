...
func testAccOrganizationsResourcePolicy_tagsSerial(t *testing.T) {
	t.Helper()
		...
		Steps: []resource.TestStep{
			{
				...
				ConfigDirectory:          config.StaticDirectory("testdata/ResourcePolicy/tags/"),
...
func testAccOrganizationsResourcePolicy_Tags_DefaultTags_providerOnly(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5FactoriesNamedAlternate(ctx, t, providers),
				ConfigDirectory:          config.StaticDirectory("testdata/ResourcePolicy/tags_defaults/"),
				ConfigVariables: config.Variables{
...
func testAccOrganizationsResourcePolicy_Tags_ComputedTag_onCreate(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5FactoriesNamedAlternate(ctx, t, providers),
				ConfigDirectory:          config.StaticDirectory("testdata/ResourcePolicy/tagsComputed1/"),
				ConfigVariables: config.Variables{
...
func testAccOrganizationsResourcePolicy_Tags_ComputedTag_OnUpdate_add(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5FactoriesNamedAlternate(ctx, t, providers),
				ConfigDirectory:          config.StaticDirectory("testdata/ResourcePolicy/tagsComputed2/"),
				ConfigVariables: config.Variables{
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func testAccOrganizationsResourcePolicy_Tags_IgnoreTags_Overlap_defaultTag(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5FactoriesNamedAlternate(ctx, t, providers),
				ConfigDirectory:          config.StaticDirectory("testdata/ResourcePolicy/tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
					}),
