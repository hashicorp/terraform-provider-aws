		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, names.AttrParentID),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAccountExists(ctx, resourceName, &v),
					resource.TestCheckResourceAttrPair(resourceName, names.AttrParentID, parentIdResourceName1, names.AttrID),
				),
			},
			testAccAccountImportStep(resourceName),
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAccountExists(ctx, resourceName, &v),
					resource.TestCheckResourceAttrPair(resourceName, names.AttrParentID, parentIdResourceName2, names.AttrID),
				),
			},
		},
	})
