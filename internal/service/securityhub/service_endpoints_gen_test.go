...
func defaultEndpoint(region string) string {
	r := securityhub_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.TODO(), securityhub_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) string {
	...
	_, err := client.ListAutomationRules(ctx, &securityhub_sdkv2.ListAutomationRulesInput{},
		func(opts *securityhub_sdkv2.Options) {
