		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.enabled_standard_arns.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.security_controls_configuration.#", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.security_controls_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.security_controls_configuration.0.security_control_custom_parameter.#", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "configuration_policy.0.security_controls_configuration.0.security_control_custom_parameter.0.parameter.*", map[string]string{
						...
						"value_type":          "CUSTOM",
						"enum_list.0.value.#": acctest.CtTwo,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "configuration_policy.0.security_controls_configuration.0.security_control_custom_parameter.0.parameter.*", map[string]string{
						...
						"value_type":         "CUSTOM",
						"int_list.0.value.#": acctest.CtTwo,
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.security_controls_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.security_controls_configuration.0.disabled_control_identifiers.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.security_controls_configuration.0.enabled_control_identifiers.#", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.security_controls_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.security_controls_configuration.0.enabled_control_identifiers.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "configuration_policy.0.security_controls_configuration.0.disabled_control_identifiers.#", acctest.CtZero),
				),
			},
		},
	})
