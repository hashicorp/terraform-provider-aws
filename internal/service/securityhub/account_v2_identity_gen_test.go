...
func testAccSecurityHubAccountV2_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccSecurityHubAccountV2_Identity_basic,
		"RegionOverride": testAccSecurityHubAccountV2_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccSecurityHubAccountV2_Identity_basic(t *testing.T) {
	ctx := acctest.Context(t)

	var v securityhub.DescribeSecurityHubV2Output
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/AccountV2/basic/"),
				ConfigVariables: config.Variables{},
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckAccountV2Exists(ctx, t, resourceName, &v),
				),
...
func testAccSecurityHubAccountV2_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/AccountV2/region_override/"),
				ConfigVariables: config.Variables{
