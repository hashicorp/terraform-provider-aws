...
func testAccSecurityHubAutomationRuleV2_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccSecurityHubAutomationRuleV2_Identity_basic,
		"RegionOverride": testAccSecurityHubAutomationRuleV2_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccSecurityHubAutomationRuleV2_Identity_basic(t *testing.T) {
...
func testAccSecurityHubAutomationRuleV2_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
