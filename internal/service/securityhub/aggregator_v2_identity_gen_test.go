...
func testAccSecurityHubAggregatorV2_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccSecurityHubAggregatorV2_Identity_basic,
		"RegionOverride": testAccSecurityHubAggregatorV2_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccSecurityHubAggregatorV2_Identity_basic(t *testing.T) {
	ctx := acctest.Context(t)

	var v securityhub.GetAggregatorV2Output
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/AggregatorV2/basic/"),
				ConfigVariables: config.Variables{},
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckAggregatorV2Exists(ctx, t, resourceName, &v),
				),
...
func testAccSecurityHubAggregatorV2_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/AggregatorV2/region_override/"),
				ConfigVariables: config.Variables{
