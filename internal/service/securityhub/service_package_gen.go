...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*securityhub_sdkv2.Client, error) {
	...
	return securityhub_sdkv2.NewFromConfig(cfg,
		securityhub_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*securityhub_sdkv2.Options) {
	return func(o *securityhub_sdkv2.Options) {
		if endpoint != "" {
