...
func testAccObservabilityAdminTelemetryRuleForOrganization_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccObservabilityAdminTelemetryRuleForOrganization_Identity_basic,
		"RegionOverride": testAccObservabilityAdminTelemetryRuleForOrganization_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccObservabilityAdminTelemetryRuleForOrganization_Identity_basic(t *testing.T) {
...
func testAccObservabilityAdminTelemetryRuleForOrganization_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/TelemetryRuleForOrganization/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
