...
func testAccObservabilityAdminTelemetryEvaluationForOrganization_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccObservabilityAdminTelemetryEvaluationForOrganization_Identity_basic,
		"RegionOverride": testAccObservabilityAdminTelemetryEvaluationForOrganization_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccObservabilityAdminTelemetryEvaluationForOrganization_Identity_basic(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/TelemetryEvaluationForOrganization/basic/"),
...
func testAccObservabilityAdminTelemetryEvaluationForOrganization_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/TelemetryEvaluationForOrganization/region_override/"),
				ConfigVariables: config.Variables{
