...
func TestAccSchedulerSchedule_basic(t *testing.T) {
	...
	acctest.ParallelTest(t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckScheduleDestroy(t),
		Steps: []resource.TestStep{
			{
				Config: testAccScheduleConfig_basic(name),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckScheduleExists(t, resourceName, &schedule),
...
func testAccCheckScheduleDestroy(t *testing.T) resource.TestCheckFunc {
...
func testAccCheckScheduleExists(t *testing.T, name string, v *scheduler.GetScheduleOutput) resource.TestCheckFunc {
	return func(s *terraform.State) error {
