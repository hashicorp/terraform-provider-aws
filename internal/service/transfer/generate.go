...
//go:generate go run ../../generate/tags/main.go -GetTag -ListTags -ListTagsOpPaginated -ListTagsInIDElem=Arn -ServiceTagsSlice -TagInIDElem=Arn -UpdateTags -KeyValueTagsFunc=KeyValueTags
