		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "on_exception_steps.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "steps.0.copy_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.custom_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.decrypt_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.delete_step_details.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "steps.0.tag_step_details.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckWorkflowExists(ctx, resourceName, &conf),
					acctest.MatchResourceAttrRegionalARN(resourceName, names.AttrARN, "transfer", regexache.MustCompile(`workflow/.+`)),
					resource.TestCheckResourceAttr(resourceName, "on_exception_steps.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "on_exception_steps.0.copy_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "on_exception_steps.0.custom_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "on_exception_steps.0.decrypt_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "on_exception_steps.0.type", "DELETE"),
					resource.TestCheckResourceAttr(resourceName, "on_exception_steps.0.delete_step_details.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "on_exception_steps.0.tag_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "steps.0.copy_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.custom_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.decrypt_step_details.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "steps.0.copy_step_details.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "steps.0.copy_step_details.0.destination_file_location.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "steps.0.copy_step_details.0.destination_file_location.0.efs_file_location.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.copy_step_details.0.destination_file_location.0.s3_file_location.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "steps.0.custom_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.decrypt_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.delete_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.tag_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.0.type", "COPY"),
					resource.TestCheckResourceAttr(resourceName, "steps.1.copy_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.1.custom_step_details.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "steps.1.decrypt_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.1.delete_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.1.tag_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.1.type", "CUSTOM"),
					resource.TestCheckResourceAttr(resourceName, "steps.2.copy_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.2.custom_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.2.decrypt_step_details.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "steps.2.decrypt_step_details.0.destination_file_location.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "steps.2.decrypt_step_details.0.destination_file_location.0.efs_file_location.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "steps.2.decrypt_step_details.0.destination_file_location.0.s3_file_location.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "steps.2.delete_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.2.tag_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.2.type", "DECRYPT"),
					resource.TestCheckResourceAttr(resourceName, "steps.3.copy_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.3.custom_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.3.decrypt_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.3.delete_step_details.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "steps.3.tag_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.3.type", "DELETE"),
					resource.TestCheckResourceAttr(resourceName, "steps.4.copy_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.4.custom_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.4.decrypt_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.4.delete_step_details.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "steps.4.tag_step_details.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "steps.4.tag_step_details.0.tags.#", acctest.CtTwo),
