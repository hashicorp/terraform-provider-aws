		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "encoder_settings.0.video_descriptions.0.codec_settings.0.h264_settings.*", map[string]string{
						...
						"framerate_denominator":   acctest.CtOne,
						"framerate_numerator":     "50",
						"gop_b_reference":         "DISABLED",
						"gop_closed_cadence":      acctest.CtOne,
						"gop_num_b_frames":        acctest.CtOne,
						"gop_size":                "1.92",
						"gop_size_units":          "SECONDS",
						"level":                   "H264_LEVEL_AUTO",
						"look_ahead_rate_control": "HIGH",
						"max_bitrate":             acctest.CtZero,
						"min_i_interval":          acctest.CtZero,
						"num_ref_frames":          acctest.CtThree,
						"par_control":             "INITIALIZE_FROM_SOURCE",
						"par_denominator":         acctest.CtZero,
						"par_numerator":           acctest.CtZero,
						names.AttrProfile:         "HIGH",
						"quality_level":           "",
						"qvbr_quality_level":      acctest.CtZero,
						"rate_control_mode":       "CBR",
						"scan_type":               "PROGRESSIVE",
						"scene_change_detect":     "DISABLED",
						"slices":                  acctest.CtOne,
						"spatial_aq":              acctest.CtZero,
						"subgop_length":           "FIXED",
						"syntax":                  "DEFAULT",
						"temporal_aq":             "ENABLED",
