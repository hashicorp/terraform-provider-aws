...
func TestAccMediaLiveInputSecurityGroup_Identity_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/InputSecurityGroup/basic/"),
...
func TestAccMediaLiveInputSecurityGroup_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/InputSecurityGroup/region_override/"),
				ConfigVariables: config.Variables{
...
func TestAccMediaLiveInputSecurityGroup_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/InputSecurityGroup/basic_v6.60.0/"),
				ConfigVariables: config.Variables{},
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckInputSecurityGroupExists(ctx, t, resourceName, &v),
				),
...
// Resource Identity was added after v6.60.0
func TestAccMediaLiveInputSecurityGroup_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
