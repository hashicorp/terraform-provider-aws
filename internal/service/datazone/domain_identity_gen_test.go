...
func TestAccDataZoneDomain_Identity_basic(t *testing.T) {
	ctx := acctest.Context(t)

	var v datazone.GetDomainOutput
...
func TestAccDataZoneDomain_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccDataZoneDomain_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/Domain/basic_v6.47.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
// Resource Identity was added after v6.47.0
func TestAccDataZoneDomain_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
