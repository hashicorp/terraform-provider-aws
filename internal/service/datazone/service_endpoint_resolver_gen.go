...
var _ datazone_sdkv2.EndpointResolverV2 = &resolver{}

type resolver struct {
	defaultResolver datazone_sdkv2.EndpointResolverV2
}

func (r *resolver) ResolveEndpoint(ctx context.Context, params datazone_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
