		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "deployment_targets.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "parameter_overrides.%", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "stack_instance_summaries.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "parameter_overrides.%", acctest.CtTwo),
