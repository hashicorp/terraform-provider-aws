...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*healthlake_sdkv2.Client, error) {
	...
	return healthlake_sdkv2.NewFromConfig(cfg,
		healthlake_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*healthlake_sdkv2.Options) {
	return func(o *healthlake_sdkv2.Options) {
		if endpoint != "" {
