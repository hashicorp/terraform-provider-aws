...
func defaultEndpoint(region string) (url.URL, error) {
	r := route53domains_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), route53domains_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDomains(ctx, &route53domains_sdkv2.ListDomainsInput{},
		func(opts *route53domains_sdkv2.Options) {
