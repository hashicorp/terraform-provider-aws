...
func TestAccEFSMountTarget_List_basic(t *testing.T) {
		...
		Steps: []resource.TestStep{
			...
			// Step 2: Query
			{
				...
				QueryResultChecks: []querycheck.QueryResultCheck{
					tfquerycheck.ExpectIdentityFunc("aws_efs_mount_target.test", identity1.Checks()),
					querycheck.ExpectResourceDisplayName("aws_efs_mount_target.test", tfqueryfilter.ByResourceIdentityFunc(identity1.Checks()), knownvalue.NotNull()),
					querycheck.ExpectResourceKnownValues("aws_efs_mount_target.test", tfqueryfilter.ByResourceIdentityFunc(identity1.Checks()), []querycheck.KnownValueCheck{
						tfquerycheck.KnownValueCheck(tfjsonpath.New("availability_zone_id"), tfknownvalue.StringNotEmpty()),
						tfquerycheck.KnownValueCheck(tfjsonpath.New("availability_zone_name"), tfknownvalue.StringNotEmpty()),
						tfquerycheck.KnownValueCheck(tfjsonpath.New(names.AttrDNSName), checkFileSystemDNSName),
						tfquerycheck.KnownValueCheck(tfjsonpath.New("file_system_arn"), checkFileSystemARN),
						tfquerycheck.KnownValueCheck(tfjsonpath.New(names.AttrID), knownvalue.NotNull()),
						tfquerycheck.KnownValueCheck(tfjsonpath.New(names.AttrIPAddressType), tfknownvalue.StringExact(awstypes.IpAddressTypeIpv4Only)),
						tfquerycheck.KnownValueCheck(tfjsonpath.New("mount_target_dns_name"), tfknownvalue.StringNotEmpty()),
						tfquerycheck.KnownValueCheck(tfjsonpath.New(names.AttrNetworkInterfaceID), tfknownvalue.StringNotEmpty()),
...
func TestAccEFSMountTarget_List_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	resourceName1 := "aws_efs_mount_target.test[0]"
	resourceName2 := "aws_efs_mount_target.test[1]"
	rName := acctest.RandomWithPrefix(t, acctest.ResourcePrefix)
