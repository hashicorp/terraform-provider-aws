...
// Code generated by internal/generate/identitytests/main.go and then edited.
...
func TestAccEFSReplicationConfiguration_Identity_basic(t *testing.T) {
...
func TestAccEFSReplicationConfiguration_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/ReplicationConfiguration/region_override/"),
				ConfigVariables: config.Variables{
					"region":             config.StringVariable(acctest.AlternateRegion()),
					"destination_region": config.StringVariable(acctest.Region()),
				},
				ConfigStateChecks: []statecheck.StateCheck{
