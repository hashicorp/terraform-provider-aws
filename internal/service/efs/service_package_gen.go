...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*efs_sdkv1.EFS, error) {
	return efs_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
