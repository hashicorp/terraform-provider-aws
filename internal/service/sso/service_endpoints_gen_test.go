...
func defaultEndpoint(region string) (url.URL, error) {
	r := sso_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), sso_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListAccounts(ctx, &sso_sdkv2.ListAccountsInput{
		AccessToken: aws_sdkv2.String("mock-access-token"),
	},
		func(opts *sso_sdkv2.Options) {
