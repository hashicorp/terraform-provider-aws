...
func defaultEndpoint(region string) string {
	r := codepipeline_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.TODO(), codepipeline_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) string {
	...
	_, err := client.ListPipelines(ctx, &codepipeline_sdkv2.ListPipelinesInput{},
		func(opts *codepipeline_sdkv2.Options) {
