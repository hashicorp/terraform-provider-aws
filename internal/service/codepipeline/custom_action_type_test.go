		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "configuration_property.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "input_artifact_details.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "input_artifact_details.0.maximum_count", "5"),
					resource.TestCheckResourceAttr(resourceName, "input_artifact_details.0.minimum_count", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "output_artifact_details.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "output_artifact_details.0.maximum_count", "4"),
					resource.TestCheckResourceAttr(resourceName, "output_artifact_details.0.minimum_count", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "settings.#", acctest.CtZero),
...
func TestAccCodePipelineCustomActionType_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCustomActionTypeConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckCustomActionTypeExists(ctx, resourceName, &v),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					acctest.CheckResourceAttrRegionalARN(resourceName, names.AttrARN, "codepipeline", fmt.Sprintf("actiontype:Custom/Test/%s/1", rName)),
					resource.TestCheckResourceAttr(resourceName, "category", "Test"),
					resource.TestCheckResourceAttr(resourceName, "configuration_property.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "input_artifact_details.0.minimum_count", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "output_artifact_details.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrOwner, "Custom"),
					resource.TestCheckResourceAttr(resourceName, "provider_name", rName),
					resource.TestCheckResourceAttr(resourceName, "settings.#", acctest.CtOne),
