		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "input_artifact_details.0.maximum_count", acctest.Ct5),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "output_artifact_details.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "output_artifact_details.0.maximum_count", acctest.Ct5),
