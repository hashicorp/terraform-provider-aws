...
func testAccCodepipelineConfig_basic(rName string) string {
...
func testAccCodepipelineConfig_basicUpdated(rName string) string {
	return acctest.ConfigCompose(
		testAccS3DefaultBucket(rName),
...
func testAccCodepipelineConfig_emptyStageArtifacts(rName string) string {
	return acctest.ConfigCompose(
		testAccS3DefaultBucket(rName),
		testAccServiceIAMRole(rName),
		fmt.Sprintf(`
...
func testAccCodepipelineConfig_deployServiceRole(rName string) string {
	return acctest.ConfigCompose(
		testAccS3DefaultBucket(rName),
...
func testAccCodepipelineConfig_tags(rName, tag1, tag2 string) string {
	return acctest.ConfigCompose(
		testAccS3DefaultBucket(rName),
		testAccServiceIAMRole(rName),
		fmt.Sprintf(`
...
func testAccCodepipelineConfig_multiregion(rName string) string {
	return acctest.ConfigCompose(
...
func testAccCodepipelineConfig_multiregionUpdated(rName string) string {
	return acctest.ConfigCompose(
		acctest.ConfigAlternateRegionProvider(),
		testAccS3DefaultBucket(rName),
		testAccServiceIAMRole(rName),
...
func testAccCodepipelineConfig_backToBasic(rName string) string {
	return acctest.ConfigCompose(
		acctest.ConfigAlternateRegionProvider(),
...
func testAccCodepipelineConfig_namespace(rName string) string {
	return acctest.ConfigCompose(
		testAccS3DefaultBucket(rName),
		testAccServiceIAMRole(rName),
		fmt.Sprintf(`
...
func testAccCodepipelineConfig_gitHubv1SourceAction(rName, githubToken string) string {
	return acctest.ConfigCompose(
		testAccS3DefaultBucket(rName),
		testAccServiceIAMRole(rName),
		fmt.Sprintf(`
...
func testAccCodepipelineConfig_gitHubv1SourceActionUpdated(rName, githubToken string) string {
	return acctest.ConfigCompose(
		testAccS3DefaultBucket(rName),
		testAccServiceIAMRole(rName),
		fmt.Sprintf(`
