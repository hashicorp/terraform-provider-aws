...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*codepipeline_sdkv2.Client, error) {
	...
	return codepipeline_sdkv2.NewFromConfig(cfg,
		codepipeline_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*codepipeline_sdkv2.Options) {
	return func(o *codepipeline_sdkv2.Options) {
		if endpoint != "" {
