		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "container.0.command.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "container.0.environment.%", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "container.0.ports.%", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrState, string(types.ContainerServiceDeploymentStateActive)),
					resource.TestCheckResourceAttr(resourceName, names.AttrVersion, acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "container.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrVersion, acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "container.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "container.0.environment.%", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrVersion, acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "container.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "container.0.ports.%", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "container.0.ports.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "container.0.ports.80", string(types.ContainerServiceProtocolHttp)),
					resource.TestCheckResourceAttr(resourceName, "public_endpoint.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "public_endpoint.0.health_check.0.healthy_threshold", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "public_endpoint.0.health_check.0.timeout_seconds", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "public_endpoint.0.health_check.0.unhealthy_threshold", acctest.CtTwo),
				),
			},
			{
				ResourceName:      resourceName,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "public_endpoint.#", acctest.CtZero),
				),
			},
		},
	})
