...
func TestAccLightsailContainerServiceDeploymentVersion_container_ports(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerServiceDeploymentVersionConfig_Container_ports1(rName, containerName, acctest.Ct80, string(types.ContainerServiceProtocolHttp)),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckContainerServiceDeploymentVersionExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, names.AttrState, string(types.ContainerServiceDeploymentStateActive)),
					resource.TestCheckResourceAttr(resourceName, names.AttrVersion, acctest.Ct1),
			...
			{
				Config: testAccContainerServiceDeploymentVersionConfig_Container_ports1(rName, containerName, acctest.Ct90, string(types.ContainerServiceProtocolTcp)),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckContainerServiceDeploymentVersionExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, names.AttrState, string(types.ContainerServiceDeploymentStateActive)),
					resource.TestCheckResourceAttr(resourceName, names.AttrVersion, acctest.Ct2),
			...
			{
				Config: testAccContainerServiceDeploymentVersionConfig_Container_ports2(rName, containerName, acctest.Ct80, string(types.ContainerServiceProtocolHttp), acctest.Ct90, string(types.ContainerServiceProtocolTcp)),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckContainerServiceDeploymentVersionExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, names.AttrState, string(types.ContainerServiceDeploymentStateActive)),
					resource.TestCheckResourceAttr(resourceName, names.AttrVersion, acctest.Ct3),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "public_endpoint.0.container_port", acctest.Ct80),
					...
					resource.TestCheckResourceAttr(resourceName, "public_endpoint.0.health_check.0.interval_seconds", acctest.Ct5),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "public_endpoint.0.health_check.0.interval_seconds", acctest.Ct6),
					resource.TestCheckResourceAttr(resourceName, "public_endpoint.0.health_check.0.path", "/."),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckContainerServiceDeploymentVersionExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, names.AttrState, string(types.ContainerServiceDeploymentStateActive)),
					resource.TestCheckResourceAttr(resourceName, names.AttrVersion, acctest.Ct5),
