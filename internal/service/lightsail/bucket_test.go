		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckBucketExists(ctx, t, resourceName),
					acctest.CheckSDKResourceDisappears(ctx, t, tflightsail.ResourceBucket(), resourceName),
				),
...
func testAccCheckBucketExists(ctx context.Context, t *testing.T, resourceName string) resource.TestCheckFunc {
