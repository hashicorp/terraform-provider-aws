			...
			// Step 2: Query
			{
				...
				QueryResultChecks: []querycheck.QueryResultCheck{
					...
					querycheck.ExpectResourceKnownValues("aws_bedrockagentcore_harness.test", tfqueryfilter.ByResourceIdentityFunc(identity1.Checks()), []querycheck.KnownValueCheck{
						tfquerycheck.KnownValueCheck(tfjsonpath.New("allowed_tools"), knownvalue.ListExact([]knownvalue.Check{
						...
						tfquerycheck.KnownValueCheck(tfjsonpath.New(names.AttrEnvironment), knownvalue.ListExact([]knownvalue.Check{
							knownvalue.ObjectExact(map[string]knownvalue.Check{
								"agentcore_runtime_environment": knownvalue.ListExact([]knownvalue.Check{
									knownvalue.ObjectExact(map[string]knownvalue.Check{
										"agent_runtime_arn":        tfknownvalue.RegionalARNRegexp("bedrock-agentcore", regexache.MustCompile(`runtime/harness_`+rName+`_0-[a-zA-Z0-9]+`)),
										"agent_runtime_id":         knownvalue.StringRegexp(regexache.MustCompile(`^harness_` + rName + `_0-[a-zA-Z0-9]+$`)),
										"agent_runtime_name":       knownvalue.StringExact("harness_" + rName + "_0"),
						...
						tfquerycheck.KnownValueCheck(tfjsonpath.New("max_iterations"), knownvalue.Int32Exact(75)),
						...
						tfquerycheck.KnownValueCheck(tfjsonpath.New("timeout_seconds"), knownvalue.Int32Exact(3600)),
