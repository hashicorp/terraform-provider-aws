...
func TestAccBedrockAgentCoreRegistryRecord_Identity_basic(t *testing.T) {
			...
			// Step 1: Setup
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectIdentity(resourceName, map[string]knownvalue.Check{
						...
						"record_id":         knownvalue.NotNull(),
					}),
					statecheck.ExpectIdentityValueMatchesState(resourceName, tfjsonpath.New("registry_id")),
					statecheck.ExpectIdentityValueMatchesState(resourceName, tfjsonpath.New("record_id")),
				},
			},
			...
			// Step 3: Import block with Import ID
			{
				...
				ImportPlanChecks: resource.ImportPlanChecks{
					PreApply: []plancheck.PlanCheck{
						...
						plancheck.ExpectKnownValue(resourceName, tfjsonpath.New("record_id"), knownvalue.NotNull()),
...
func TestAccBedrockAgentCoreRegistryRecord_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/RegistryRecord/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
