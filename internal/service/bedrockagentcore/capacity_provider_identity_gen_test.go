...
func TestAccBedrockAgentCoreCapacityProvider_Identity_basic(t *testing.T) {
...
func TestAccBedrockAgentCoreCapacityProvider_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
