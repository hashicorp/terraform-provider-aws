...
func TestAccBedrockAgentCoreHarness_Identity_basic(t *testing.T) {
			...
			// Step 1: Setup
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectIdentity(resourceName, map[string]knownvalue.Check{
						...
						"harness_id":        knownvalue.NotNull(),
					}),
					statecheck.ExpectIdentityValueMatchesState(resourceName, tfjsonpath.New("harness_id")),
				},
			},
...
func TestAccBedrockAgentCoreHarness_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/Harness/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
