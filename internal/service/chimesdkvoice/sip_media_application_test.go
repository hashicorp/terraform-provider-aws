...
func TestAccChimeSDKVoiceSipMediaApplication_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckSipMediaApplicationDestroy(ctx, t),
		Steps: []resource.TestStep{
			{
				Config: testAccSipMediaApplicationConfig_basic(rName),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckSipMediaApplicationExists(ctx, t, resourceName, &chimeSipMediaApplication),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckSipMediaApplicationExists(ctx, t, resourceName, &sipMediaApplication),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
...
func testAccCheckSipMediaApplicationExists(ctx context.Context, t *testing.T, name string, vc *awstypes.SipMediaApplication) resource.TestCheckFunc {
...
func testAccCheckSipMediaApplicationDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
	return func(s *terraform.State) error {
