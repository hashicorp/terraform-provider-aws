		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "target_applications.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_applications.0.priority", acctest.CtOne),
