...
func defaultEndpoint(region string) (url.URL, error) {
	r := chimesdkvoice_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), chimesdkvoice_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListPhoneNumbers(ctx, &chimesdkvoice_sdkv2.ListPhoneNumbersInput{},
		func(opts *chimesdkvoice_sdkv2.Options) {
