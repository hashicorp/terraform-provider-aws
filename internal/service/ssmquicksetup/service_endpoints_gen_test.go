...
func defaultEndpoint(region string) (url.URL, error) {
	r := ssmquicksetup_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), ssmquicksetup_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListConfigurationManagers(ctx, &ssmquicksetup_sdkv2.ListConfigurationManagersInput{},
		func(opts *ssmquicksetup_sdkv2.Options) {
