		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.action.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.event_source.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.schedule.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.schedule.0.deprecate_rule.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, names.AttrExecutionRoleARN),
					resource.TestCheckResourceAttr(resourceName, names.AttrState, "ENABLED"),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.resource_types.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.policy_type", "EVENT_BASED_POLICY"),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.schedule.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.action.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.action.0.name", "tf-acc-basic"),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.action.0.cross_region_copy.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.action.0.cross_region_copy.0.target", acctest.AlternateRegion()),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.action.0.cross_region_copy.0.encryption_configuration.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.action.0.cross_region_copy.0.retain_rule.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.event_source.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.event_source.0.type", "MANAGED_CWE"),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.event_source.0.parameters.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					checkLifecyclePolicyExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.schedule.0.retain_rule.0.interval", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					checkLifecyclePolicyExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.parameters.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					checkLifecyclePolicyExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.schedule.0.fast_restore_rule.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					checkLifecyclePolicyExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.schedule.0.share_rule.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					checkLifecyclePolicyExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.parameters.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					checkLifecyclePolicyExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.schedule.0.cross_region_copy_rule.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					checkLifecyclePolicyExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "policy_details.0.schedule.0.cross_region_copy_rule.#", acctest.CtZero),
				),
			},
		},
	})
...
func TestAccDLMLifecyclePolicy_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccLifecyclePolicyConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					checkLifecyclePolicyExists(ctx, resourceName),
