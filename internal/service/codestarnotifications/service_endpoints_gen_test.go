...
func defaultEndpoint(region string) (url.URL, error) {
	r := codestarnotifications_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), codestarnotifications_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListTargets(ctx, &codestarnotifications_sdkv2.ListTargetsInput{},
		func(opts *codestarnotifications_sdkv2.Options) {
