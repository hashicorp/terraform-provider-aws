...
func testAccCheckClusterDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		conn := acctest.ProviderMeta(ctx, t).DocDBElasticClient(ctx)
...
func testAccCheckClusterExists(ctx context.Context, t *testing.T, name string, cluster *awstypes.Cluster) resource.TestCheckFunc {
	return func(s *terraform.State) error {
