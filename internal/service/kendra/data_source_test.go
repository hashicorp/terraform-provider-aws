		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDataSourceExists(ctx, t, resourceName),
...
func TestAccKendraDataSource_roleARN(t *testing.T) {
	...
	rName4 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName5 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName6 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName7 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	resourceName := "aws_kendra_data_source.test"
...
func TestAccKendraDataSource_Configuration_S3_Bucket(t *testing.T) {
	...
	rName6 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName7 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName8 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	resourceName := "aws_kendra_data_source.test"
...
func TestAccKendraDataSource_CustomDocumentEnrichmentConfiguration_ExtractionHookConfiguration_InvocationCondition(t *testing.T) {
	...
	rName7 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName8 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName9 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName10 := acctest.RandomWithPrefix(t, "resource-test-terraform")
...
func TestAccKendraDataSource_CustomDocumentEnrichmentConfiguration_ExtractionHookConfiguration_RoleARN(t *testing.T) {
	...
	rName9 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName10 := acctest.RandomWithPrefix(t, "resource-test-terraform")
	rName11 := acctest.RandomWithPrefix(t, "resource-test-terraform")
...
func testAccCheckDataSourceExists(ctx context.Context, t *testing.T, name string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
