...
func defaultEndpoint(region string) (url.URL, error) {
	r := kendra_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), kendra_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListIndices(ctx, &kendra_sdkv2.ListIndicesInput{},
		func(opts *kendra_sdkv2.Options) {
