...
func (p *servicePackage) NewClient(ctx context.Context, cfg aws_sdkv2.Config) (*kendra_sdkv2.Client, error) {
	return kendra_sdkv2.NewFromConfig(cfg, func(o *kendra_sdkv2.Options) {
		if p.endpoint != "" {
			o.EndpointResolver = kendra_sdkv2.EndpointResolverFromURL(p.endpoint)
		}
	}), nil
}
