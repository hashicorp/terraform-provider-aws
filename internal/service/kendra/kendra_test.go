...
func TestAccKendra_serial(t *testing.T) {
	testCases := map[string]map[string]func(t *testing.T){
		"DataSource": {
			...
			"Configuration_WebCrawler_ProxyConfigurationCredentials":                                testAccDataSource_Configuration_WebCrawler_ProxyConfigurationCredentials,
			"Configuration_WebCrawler_ProxyConfigurationHostPort":                                   testAccDataSource_Configuration_WebCrawler_ProxyConfigurationHostPort,
			...
			"Configuration_WebCrawler_UrlsWebCrawlerMode":                                           testAccDataSource_Configuration_WebCrawler_UrlsWebCrawlerMode,
			...
			"CustomDocumentEnrichmentConfiguration_ExtractionHookConfiguration_S3Bucket":            testAccDataSource_CustomDocumentEnrichmentConfiguration_ExtractionHookConfiguration_S3Bucket,
