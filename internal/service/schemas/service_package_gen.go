...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*schemas_sdkv1.Schemas, error) {
	return schemas_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
