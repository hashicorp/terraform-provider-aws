...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*route53_sdkv1.Route53, error) {
	return route53_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)})), nil
}
