		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "regions.#", "8"),
					resource.TestCheckTypeSetElemAttr(resourceName, "regions.*", string(awstypes.HealthCheckRegionUsEast1)),
					resource.TestCheckTypeSetElemAttr(resourceName, "regions.*", string(awstypes.HealthCheckRegionUsWest1)),
					...
					resource.TestCheckTypeSetElemAttr(resourceName, "regions.*", string(awstypes.HealthCheckRegionApSoutheast1)),
					resource.TestCheckTypeSetElemAttr(resourceName, "regions.*", string(awstypes.HealthCheckRegionApSoutheast2)),
					resource.TestCheckTypeSetElemAttr(resourceName, "regions.*", string(awstypes.HealthCheckRegionApNortheast1)),
					resource.TestCheckTypeSetElemAttr(resourceName, "regions.*", string(awstypes.HealthCheckRegionSaEast1)),
