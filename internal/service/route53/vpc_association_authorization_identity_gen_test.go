...
func TestAccRoute53VPCAssociationAuthorization_Identity_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				...
				ConfigDirectory:          config.StaticDirectory("testdata/VPCAssociationAuthorization/basic/"),
...
func TestAccRoute53VPCAssociationAuthorization_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Create pre-Identity
			{
				...
				ConfigDirectory:          config.StaticDirectory("testdata/VPCAssociationAuthorization/basic_v6.45.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
// Resource Identity was added after v6.45.0
func TestAccRoute53VPCAssociationAuthorization_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
