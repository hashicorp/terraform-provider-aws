		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "alias.#", acctest.CtZero),
					resource.TestCheckNoResourceAttr(resourceName, "allow_overwrite"),
					resource.TestCheckResourceAttr(resourceName, "cidr_routing_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "failover_routing_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "fqdn", recordName.String()),
					resource.TestCheckResourceAttr(resourceName, "geolocation_routing_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "geoproximity_routing_policy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "health_check_id", ""),
					resource.TestCheckResourceAttr(resourceName, "latency_routing_policy.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "records.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "weighted_routing_policy.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "alias.#", acctest.CtZero),
					resource.TestCheckNoResourceAttr(resourceName, "allow_overwrite"),
					resource.TestCheckResourceAttr(resourceName, "cidr_routing_policy.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "multivalue_answer_routing_policy", "false"),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, recordName.String()),
					resource.TestCheckResourceAttr(resourceName, "records.#", acctest.CtOne),
