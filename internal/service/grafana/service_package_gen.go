...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*managedgrafana_sdkv1.ManagedGrafana, error) {
	return managedgrafana_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)})), nil
}
