...
func defaultEndpoint(region string) (url.URL, error) {
	r := autoscalingplans_sdkv2.NewDefaultEndpointResolverV2()
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.DescribeScalingPlans(ctx, &autoscalingplans_sdkv2.DescribeScalingPlansInput{},
		func(opts *autoscalingplans_sdkv2.Options) {
