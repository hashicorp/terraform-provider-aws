...
func TestAccKinesisChannel_Identity_basic(t *testing.T) {
			...
			// Step 1: Setup
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectIdentity(resourceName, map[string]knownvalue.Check{
						"channel_arn": knownvalue.NotNull(),
					}),
					statecheck.ExpectIdentityValueMatchesState(resourceName, tfjsonpath.New("channel_arn")),
				},
			},
			...
			// Step 3: Import block with Import ID
			{
				...
				ImportPlanChecks: resource.ImportPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectKnownValue(resourceName, tfjsonpath.New("channel_arn"), knownvalue.NotNull()),
...
func TestAccKinesisChannel_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/Channel/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
			...
			// Step 2: Import command with appended "@<region>"
			{
				...
				ImportStateKind:                      resource.ImportCommandWithID,
				ImportStateIdFunc:                    acctest.CrossRegionAttrImportStateIdFunc(resourceName, "channel_arn"),
				ResourceName:                         resourceName,
				ImportState:                          true,
				ImportStateVerify:                    true,
				ImportStateVerifyIdentifierAttribute: "channel_arn",
