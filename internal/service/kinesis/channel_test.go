		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "service_execution_role_arn", "aws_iam_role.role", names.AttrARN),
					resource.TestCheckResourceAttr(resourceName, "stream_configuration_list.#", "1"),
					resource.TestCheckResourceAttrPair(resourceName, "stream_configuration_list.0.stream_arn", "aws_kinesis_stream.stream", names.AttrARN),
					...
					resource.TestCheckResourceAttrPair(resourceName, "s3_destination_configuration.0.storage_configuration.0.bucket_arn", "aws_s3_bucket.bucket", names.AttrARN),
					resource.TestCheckResourceAttrPair(resourceName, "s3_destination_configuration.0.storage_configuration.0.expected_bucket_owner", "data.aws_caller_identity.current", names.AttrAccountID),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "logging_configuration.0.cloudwatch_logs.0.enabled", acctest.CtTrue),
					resource.TestCheckResourceAttrPair(resourceName, "logging_configuration.0.cloudwatch_logs.0.log_group_name", "aws_cloudwatch_log_group.test", names.AttrName),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "stream_configuration_list.0.record_configuration.0.gsr_schema_arn", "aws_glue_schema.test", names.AttrARN),
					...
					resource.TestCheckResourceAttrPair(resourceName, "s3_tables_destination_configuration.0.dead_letter_queue_s3_configuration.0.bucket_arn", "aws_s3_bucket.bucket", names.AttrARN),
					resource.TestCheckResourceAttrPair(resourceName, "s3_tables_destination_configuration.0.dead_letter_queue_s3_configuration.0.expected_bucket_owner", "data.aws_caller_identity.current", names.AttrAccountID),
					...
					resource.TestCheckResourceAttrPair(resourceName, "s3_tables_destination_configuration.0.s3_tables_configuration_list.0.table_bucket_arn", "aws_s3tables_table_bucket.test", names.AttrARN),
					resource.TestCheckResourceAttrPair(resourceName, "s3_tables_destination_configuration.0.s3_tables_configuration_list.0.namespace", "aws_s3tables_namespace.test", names.AttrNamespace),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "encryption_configuration.0.key_id", "aws_kms_key.test", names.AttrARN),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, "0"),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsAllPercent, "0"),
				),
			},
