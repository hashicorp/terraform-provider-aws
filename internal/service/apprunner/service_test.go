		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "network_configuration.o.egress_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "network_configuration.o.egress_configuration.0.egress_type", "DEFAULT"),
					resource.TestCheckResourceAttr(resourceName, "network_configuration.o.egress_configuration.0.vpc_connector_arn", ""),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "network_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "network_configuration.o.egress_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "network_configuration.o.egress_configuration.0.egress_type", "VPC"),
					resource.TestCheckResourceAttrPair(resourceName, "network_configuration.o.egress_configuration.0.vpc_connector_arn", vpcConnectorResourceName, "arn"),
				),
			},
			{
				ResourceName:      resourceName,
