...
func TestAccAppRunnerService_ImageRepository_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccService_imageRepository(rName),
...
func TestAccAppRunnerService_ImageRepository_autoScaling(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccService_imageRepository_autoScalingConfiguration(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
...
func TestAccAppRunnerService_ImageRepository_encryption(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccService_imageRepository_encryptionConfiguration(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
...
func TestAccAppRunnerService_ImageRepository_healthCheck(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccService_imageRepository_healthCheckConfiguration(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "health_check_configuration.#", "1"),
			...
			},
			{
				...
				Config: testAccService_imageRepository_updateHealthCheckConfiguration(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "health_check_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "health_check_configuration.0.healthy_threshold", "2"),
...
func TestAccAppRunnerService_ImageRepository_instance_NoInstanceRole(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccService_imageRepository_instanceConfiguration_NoInstanceRole(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "instance_configuration.#", "1"),
...
func TestAccAppRunnerService_ImageRepository_instance_Update(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccService_imageRepository_instanceConfiguration(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "instance_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "instance_configuration.0.cpu", "1024"),
			...
			{
				Config: testAccService_imageRepository_updateInstanceConfiguration(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "instance_configuration.#", "1"),
...
func TestAccAppRunnerService_ImageRepository_networkConfiguration(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccService_imageRepository_networkConfiguration(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "network_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "network_configuration.0.egress_configuration.#", "1"),
...
func TestAccAppRunnerService_ImageRepository_runtimeEnvironmentVars(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccService_imageRepository_runtimeEnvVars(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "source_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "source_configuration.0.image_repository.#", "1"),
...
func TestAccAppRunnerService_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccServiceConfigTags1(rName, "key1", "value1"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
			...
			{
				Config: testAccServiceConfigTags2(rName, "key1", "value1updated", "key2", "value2"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
			...
			{
				Config: testAccServiceConfigTags1(rName, "key2", "value2"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "tags.%", "1"),
					resource.TestCheckResourceAttr(resourceName, "tags.key2", "value2"),
...
func testAccService_imageRepository(rName string) string {
	return fmt.Sprintf(`
...
func testAccService_imageRepository_runtimeEnvVars(rName string) string {
	return fmt.Sprintf(`
resource "aws_apprunner_service" "test" {
  service_name = %[1]q
  source_configuration {
...
func testAccService_imageRepository_autoScalingConfiguration(rName string) string {
	return fmt.Sprintf(`
...
func testAccService_imageRepository_encryptionConfiguration(rName string) string {
	return fmt.Sprintf(`
...
func testAccService_imageRepository_healthCheckConfiguration(rName string) string {
	return fmt.Sprintf(`
resource "aws_apprunner_service" "test" {
  service_name = %[1]q
...
func testAccService_imageRepository_updateHealthCheckConfiguration(rName string) string {
	return fmt.Sprintf(`
resource "aws_apprunner_service" "test" {
  service_name = %[1]q
...
func testAccService_imageRepository_networkConfiguration(rName string) string {
	return fmt.Sprintf(`
...
func testAccService_imageRepository_instanceConfiguration(rName string) string {
...
func testAccService_imageRepository_instanceConfiguration_NoInstanceRole(rName string) string {
	return fmt.Sprintf(`
resource "aws_apprunner_service" "test" {
  service_name = %[1]q
...
func testAccService_imageRepository_updateInstanceConfiguration(rName string) string {
	return acctest.ConfigCompose(
		testAccIAMRole(rName),
		fmt.Sprintf(`
resource "aws_apprunner_service" "test" {
...
func testAccServiceConfigTags1(rName string, tagKey1 string, tagValue1 string) string {
	return fmt.Sprintf(`
resource "aws_apprunner_service" "test" {
  service_name = %[1]q
  source_configuration {
...
func testAccServiceConfigTags2(rName string, tagKey1 string, tagValue1 string, tagKey2 string, tagValue2 string) string {
	return fmt.Sprintf(`
resource "aws_apprunner_service" "test" {
  service_name = %[1]q
  source_configuration {
