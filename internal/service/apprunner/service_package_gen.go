...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*apprunner_sdkv1.AppRunner, error) {
	return apprunner_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
