		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "max_concurrency", acctest.Ct100),
					resource.TestCheckResourceAttr(resourceName, "max_size", acctest.Ct25),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "auto_scaling_configuration_revision", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "latest", acctest.CtTrue),
					resource.TestCheckResourceAttr(resourceName, "max_concurrency", acctest.Ct50),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "auto_scaling_configuration_revision", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "latest", acctest.CtTrue),
					resource.TestCheckResourceAttr(resourceName, "max_concurrency", acctest.Ct150),
					resource.TestCheckResourceAttr(resourceName, "max_size", acctest.Ct20),
					resource.TestCheckResourceAttr(resourceName, "min_size", acctest.Ct5),
					resource.TestCheckResourceAttr(resourceName, names.AttrStatus, "active"),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(otherResourceName, "max_concurrency", acctest.Ct100),
					resource.TestCheckResourceAttr(otherResourceName, "max_size", acctest.Ct25),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(otherResourceName, "auto_scaling_configuration_revision", acctest.Ct2),
					resource.TestCheckResourceAttr(otherResourceName, "latest", acctest.CtTrue),
					resource.TestCheckResourceAttr(otherResourceName, "max_concurrency", acctest.Ct125),
					resource.TestCheckResourceAttr(otherResourceName, "max_size", acctest.Ct20),
					resource.TestCheckResourceAttr(otherResourceName, "min_size", acctest.Ct1),
					resource.TestCheckResourceAttr(otherResourceName, names.AttrStatus, "active"),
				),
			},
