...
func TestAccAppRunnerVpcConnector_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVpcConnector_basic(rName),
...
func TestAccAppRunnerVpcConnector_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVpcConnectorConfigTags1(rName, "key1", "value1"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckVpcConnectorExists(resourceName),
...
func testAccVpcConnector_basic(rName string) string {
	return fmt.Sprintf(`
...
func testAccVpcConnectorConfigTags1(rName string, tagKey1 string, tagValue1 string) string {
	return fmt.Sprintf(`
resource "aws_vpc" "test" {
  cidr_block = "10.1.0.0/16"
