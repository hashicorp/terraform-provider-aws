...
func defaultEndpoint(region string) (url.URL, error) {
	r := athena_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), athena_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListDataCatalogs(ctx, &athena_sdkv2.ListDataCatalogsInput{},
		func(opts *athena_sdkv2.Options) {
