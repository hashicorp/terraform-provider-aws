		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.number_of_on_calls", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.recurrence_multiplier", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.daily_settings.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.daily_settings.0.hour_of_day", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.daily_settings.0.minute_of_hour", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "contact_ids.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.recurrence_multiplier", acctest.CtTwo),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRotationExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "contact_ids.#", acctest.CtTwo),
				),
			},
			{
				ResourceName:      resourceName,
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRotationExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.monthly_settings.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.monthly_settings.0.hand_off_time.0.minute_of_hour", acctest.CtZero),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRotationExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.monthly_settings.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.monthly_settings.0.day_of_month", "20"),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.monthly_settings.0.hand_off_time.0.hour_of_day", "8"),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.monthly_settings.0.hand_off_time.0.minute_of_hour", acctest.CtZero),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRotationExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.weekly_settings.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRotationExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.weekly_settings.#", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRotationExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.0.coverage_times.0.end.0.minute_of_hour", acctest.CtZero),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.1.coverage_times.0.start.0.hour_of_day", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.1.coverage_times.0.start.0.minute_of_hour", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.1.coverage_times.0.end.0.hour_of_day", "23"),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.1.coverage_times.0.end.0.minute_of_hour", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.2.map_block_key", "FRI"),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.2.coverage_times.0.start.0.hour_of_day", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.2.coverage_times.0.start.0.minute_of_hour", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.2.coverage_times.0.end.0.hour_of_day", "23"),
					resource.TestCheckResourceAttr(resourceName, "recurrence.0.shift_coverages.2.coverage_times.0.end.0.minute_of_hour", acctest.CtZero),
				),
			},
		},
	})
