			...
			},
			{
				...
				QueryResultChecks: []querycheck.QueryResultCheck{
					...
					querycheck.ExpectResourceKnownValues("aws_wafv2_web_acl_rule.test", tfqueryfilter.ByResourceIdentityFunc(identity1.Checks()), []querycheck.KnownValueCheck{
						...
						tfquerycheck.KnownValueCheck(tfjsonpath.New("action"), knownvalue.ListSizeExact(1)),
						tfquerycheck.KnownValueCheck(tfjsonpath.New("action").AtSliceIndex(0).AtMapKey("allow"), knownvalue.ListSizeExact(0)),
						tfquerycheck.KnownValueCheck(tfjsonpath.New("action").AtSliceIndex(0).AtMapKey("block"), knownvalue.ListSizeExact(1)),
						tfquerycheck.KnownValueCheck(tfjsonpath.New("action").AtSliceIndex(0).AtMapKey("captcha"), knownvalue.ListSizeExact(0)),
						tfquerycheck.KnownValueCheck(tfjsonpath.New("action").AtSliceIndex(0).AtMapKey("challenge"), knownvalue.ListSizeExact(0)),
						tfquerycheck.KnownValueCheck(tfjsonpath.New("action").AtSliceIndex(0).AtMapKey("count"), knownvalue.ListSizeExact(0)),
						...
						tfquerycheck.KnownValueCheck(tfjsonpath.New("visibility_config").AtSliceIndex(0).AtMapKey("metric_name"), knownvalue.StringExact(rName)),
