...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*wafv2_sdkv1.WAFV2, error) {
	return wafv2_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
