...
var _ wafv2_sdkv2.EndpointResolverV2 = &resolver{}

type resolver struct {
	defaultResolver wafv2_sdkv2.EndpointResolverV2
}

func (r *resolver) ResolveEndpoint(ctx context.Context, params wafv2_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
