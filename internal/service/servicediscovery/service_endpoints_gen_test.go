...
func defaultEndpoint(region string) (url.URL, error) {
	r := servicediscovery_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), servicediscovery_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListNamespaces(ctx, &servicediscovery_sdkv2.ListNamespacesInput{},
		func(opts *servicediscovery_sdkv2.Options) {
