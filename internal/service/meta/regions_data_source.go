...
func init() {
	registerFWDataSourceFactory(newDataSourceRegions)
}

// newDataSourceRegions instantiates a new DataSource for the aws_regions data source.
func newDataSourceRegions(context.Context) (datasource.DataSource, error) {
...
// examplecloud_thing.
func (d *dataSourceRegions) Metadata(_ context.Context, request datasource.MetadataRequest, response *datasource.MetadataResponse) {
