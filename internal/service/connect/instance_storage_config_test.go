		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "storage_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_config.0.s3_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "storage_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_config.0.kinesis_firehose_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrResourceType, connect.InstanceStorageResourceTypeContactTraceRecords),
					resource.TestCheckResourceAttr(resourceName, "storage_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_config.0.kinesis_stream_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "storage_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_config.0.kinesis_video_stream_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "storage_config.0.kinesis_video_stream_config.0.encryption_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "storage_config.0.s3_config.0.bucket_name", "aws_s3_bucket.test", names.AttrID),
					resource.TestCheckResourceAttr(resourceName, "storage_config.0.s3_config.0.bucket_prefix", "tf-test-Chat-Transcripts"),
					resource.TestCheckResourceAttr(resourceName, "storage_config.0.s3_config.0.encryption_config.#", acctest.CtOne),
