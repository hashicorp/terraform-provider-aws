		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "hierarchy_path.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "level_id", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, names.AttrInstanceID, "aws_connect_instance.test", names.AttrID),
					resource.TestCheckResourceAttr(resourceName, "level_id", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName3),
