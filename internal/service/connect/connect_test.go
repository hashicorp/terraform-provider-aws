...
func TestAccConnect_serial(t *testing.T) {
	...
	testCases := map[string]map[string]func(t *testing.T){
		...
		"PhoneNumber": {
			...
			"identity_Basic":            testAccConnectPhoneNumber_Identity_Basic,
			"identity_ExistingResource": testAccConnectPhoneNumber_Identity_ExistingResource,
			"identity_RegionOverride":   testAccConnectPhoneNumber_Identity_RegionOverride,
		},
