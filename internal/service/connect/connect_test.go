...
func TestAccConnect_serial(t *testing.T) {
	...
	testCases := map[string]map[string]func(t *testing.T){
		...
		"Instance": {
			...
			"identity_Basic":            testAccConnectInstance_Identity_Basic,
			"identity_ExistingResource": testAccConnectInstance_Identity_ExistingResource,
			"identity_RegionOverride":   testAccConnectInstance_Identity_RegionOverride,
		},
