		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "identity_info.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "phone_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "phone_config.0.after_contact_work_time_limit", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "security_profile_ids.#", acctest.CtOne),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckUserExists(ctx, resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "security_profile_ids.#", acctest.CtTwo),
					resource.TestCheckTypeSetElemAttrPair(resourceName, "security_profile_ids.*", "data.aws_connect_security_profile.agent", "security_profile_id"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckUserExists(ctx, resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "security_profile_ids.#", acctest.CtThree),
					resource.TestCheckTypeSetElemAttrPair(resourceName, "security_profile_ids.*", "data.aws_connect_security_profile.agent", "security_profile_id"),
					resource.TestCheckTypeSetElemAttrPair(resourceName, "security_profile_ids.*", "data.aws_connect_security_profile.call_center_manager", "security_profile_id"),
