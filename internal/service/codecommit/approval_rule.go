...
func ResourceApprovalRule() *schema.Resource {
	return &schema.Resource{
		Create: resourceApprovalRuleCreate,
		Read:   resourceApprovalRuleRead,
		Update: resourceApprovalRuleUpdate,
		Delete: resourceApprovalRuleDelete,
...
func resourceApprovalRuleCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceApprovalRuleRead(d, meta)
}

func resourceApprovalRuleRead(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*conns.AWSClient).CodeCommitConn
...
func resourceApprovalRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*conns.AWSClient).CodeCommitConn
...
func resourceApprovalRuleDelete(d *schema.ResourceData, meta interface{}) error {
	conn := meta.(*conns.AWSClient).CodeCommitConn
