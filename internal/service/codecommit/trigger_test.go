		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "trigger.0.branches.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTriggerExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "trigger.0.branches.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "trigger.0.events.#", acctest.CtTwo),
