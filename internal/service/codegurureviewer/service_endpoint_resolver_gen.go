...
var _ codegurureviewer_sdkv2.EndpointResolverV2 = &resolver{}

type resolver struct {
	defaultResolver codegurureviewer_sdkv2.EndpointResolverV2
}

func (r *resolver) ResolveEndpoint(ctx context.Context, params codegurureviewer_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
