		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "repository.0.bitbucket.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "repository.0.codecommit.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "repository.0.github_enterprise_server.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "repository.0.s3_bucket.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "repository.0.codecommit.0.name", rName),
					resource.TestCheckResourceAttr(resourceName, "kms_key_details.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.MatchResourceAttrRegionalARN(resourceName, names.AttrID, "codeguru-reviewer", regexache.MustCompile(`association:+.`)),
					resource.TestCheckResourceAttr(resourceName, "repository.0.bitbucket.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "repository.0.codecommit.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "repository.0.github_enterprise_server.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "repository.0.s3_bucket.#", acctest.CtOne),
...
func TestAccCodeGuruReviewerRepositoryAssociation_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccRepositoryAssociationConfig_tags_2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckRepositoryAssociationExists(ctx, resourceName, &repositoryassociation),
