...
func (p *servicePackage) NewConn(ctx context.Context, config map[string]any) (*route53recoverycontrolconfig.Route53RecoveryControlConfig, error) {
	...
	return route53recoverycontrolconfig.New(sess.Copy(&cfg)), nil
}
