...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*route53recoverycontrolconfig_sdkv1.Route53RecoveryControlConfig, error) {
	return route53recoverycontrolconfig_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)})), nil
}
