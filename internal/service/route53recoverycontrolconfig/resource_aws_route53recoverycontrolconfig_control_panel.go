...
func resourceControlPanelCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if _, err := tfroute53recoverycontrolconfig.waitRoute53RecoveryControlConfigControlPanelCreated(conn, d.Id()); err != nil {
...
func resourceControlPanelDelete(d *schema.ResourceData, meta interface{}) error {
	...
	_, err = tfroute53recoverycontrolconfig.waitRoute53RecoveryControlConfigControlPanelDeleted(conn, d.Id())
