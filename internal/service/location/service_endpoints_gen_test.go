...
func defaultEndpoint(region string) (url.URL, error) {
	r := location_sdkv2.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(context.Background(), location_sdkv2.EndpointParameters{
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	client := meta.LocationClient(ctx)

	var result apiCallParams

	_, err := client.ListGeofenceCollections(ctx, &location_sdkv2.ListGeofenceCollectionsInput{},
		func(opts *location_sdkv2.Options) {
