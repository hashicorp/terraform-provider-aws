		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.group_weights.Variation1", acctest.Ct15),
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.1.group_weights.Variation1", acctest.Ct20),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.1.group_weights.Variation2", acctest.Ct25),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.group_weights.%", acctest.Ct2),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.group_weights.Variation1", acctest.Ct60),
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.1.group_weights.%", acctest.Ct2),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.1.group_weights.Variation1", acctest.Ct11),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.1.group_weights.Variation2", acctest.Ct12),
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.2.group_weights.Variation2", acctest.Ct40),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.0.weights.Variation1", acctest.Ct20000),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.start_time", startTime),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.0.weights.%", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.0.weights.Variation2", acctest.Ct10000),
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.1.weights.Variation2", acctest.Ct30000),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.start_time", startTime),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.0.segment", "aws_evidently_segment.test", names.AttrARN),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.0.weights.%", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.0.weights.Variation2", acctest.Ct5000),
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.2.weights.Variation1", acctest.Ct10000),
