		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "groups.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.group_weights.%", acctest.CtOne),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchExists(ctx, resourceName, &launch),
					resource.TestCheckResourceAttr(resourceName, "groups.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchExists(ctx, resourceName, &launch),
					resource.TestCheckResourceAttr(resourceName, "metric_monitors.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchExists(ctx, resourceName, &launch),
					resource.TestCheckResourceAttr(resourceName, "metric_monitors.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "metric_monitors.0.metric_definition.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "metric_monitors.1.metric_definition.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "metric_monitors.2.metric_definition.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchExists(ctx, resourceName, &launch),
					resource.TestCheckResourceAttr(resourceName, "metric_monitors.#", acctest.CtZero),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchExists(ctx, resourceName, &launch),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.1.group_weights.%", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.2.group_weights.%", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.group_weights.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.group_weights.Variation1", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.group_weights.%", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.group_weights.Variation1", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.0.evaluation_order", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.1.evaluation_order", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scheduled_splits_config.0.steps.0.segment_overrides.2.weights.%", acctest.CtTwo),
