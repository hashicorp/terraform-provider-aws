...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) *cloudwatchevidently_sdkv1.CloudWatchEvidently {
	return cloudwatchevidently_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)}))
}
