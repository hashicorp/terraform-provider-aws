  ...
  "TagFilters": [
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccGroupConfig_resourceBasic(n, desc1, testAccResourceGroupQueryConfig),
			...
			{
				Config: testAccGroupConfig_resourceBasic(n, desc2, query2),
				Check: resource.ComposeTestCheckFunc(
...
func TestAccResourceGroupsGroup_Resource_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccGroupConfig_resourceTags1(n, desc1, testAccResourceGroupQueryConfig, "key1", "value1"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckResourceGroupExists(resourceName, &v),
			...
			{
				Config: testAccGroupConfig_resourceTags2(n, desc1, testAccResourceGroupQueryConfig, "key1", "value1updated", "key2", "value2"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckResourceGroupExists(resourceName, &v),
			...
			{
				Config: testAccGroupConfig_resourceTags1(n, desc1, testAccResourceGroupQueryConfig, "key2", "value2"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckResourceGroupExists(resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "tags.%", "1"),
					resource.TestCheckResourceAttr(resourceName, "tags.key2", "value2"),
...
func testAccGroupConfig_resourceBasic(rName, desc, query string) string {
	return fmt.Sprintf(`
...
func testAccGroupConfig_resourceTags1(rName, desc, query, tag1Key, tag1Value string) string {
	return fmt.Sprintf(`
resource "aws_resourcegroups_group" "test" {
  name        = "%s"
  description = "%s"
...
func testAccGroupConfig_resourceTags2(rName, desc, query, tag1Key, tag1Value, tag2Key, tag2Value string) string {
	return fmt.Sprintf(`
resource "aws_resourcegroups_group" "test" {
  name        = "%s"
  description = "%s"
