...
func defaultEndpoint(region string) (url.URL, error) {
	r := lakeformation_sdkv2.NewDefaultEndpointResolverV2()
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	_, err := client.ListResources(ctx, &lakeformation_sdkv2.ListResourcesInput{},
		func(opts *lakeformation_sdkv2.Options) {
