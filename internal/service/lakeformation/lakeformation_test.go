...
func TestAccLakeFormation_serial(t *testing.T) {
	...
	testCases := map[string]map[string]func(t *testing.T){
		...
		"PermissionsBasic": {
			...
			"dataCellsFilterCrossAccount":   testAccPermissions_dataCellsFilterCrossAccount,
			...
			"lfTagExpression":               testAccPermissions_lfTagExpression,
		...
		"PermissionsDataSource": {
			...
			"lfTagExpression":  testAccPermissionsDataSource_lfTagExpression,
