		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cognito_config.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "oidc_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_ip_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_ip_config.0.cidrs.#", acctest.CtZero),
					resource.TestCheckResourceAttrSet(resourceName, "subdomain"),
					resource.TestCheckResourceAttr(resourceName, "workforce_vpc_config.#", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "workforce_name", rName),
					acctest.MatchResourceAttrRegionalARN(resourceName, names.AttrARN, "sagemaker", regexache.MustCompile(`workforce/.+`)),
					resource.TestCheckResourceAttr(resourceName, "cognito_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "oidc_config.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckWorkforceExists(ctx, resourceName, &workforce),
					resource.TestCheckResourceAttr(resourceName, "source_ip_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_ip_config.0.cidrs.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckWorkforceExists(ctx, resourceName, &workforce),
					resource.TestCheckResourceAttr(resourceName, "workforce_vpc_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "workforce_vpc_config.0.security_group_ids.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "workforce_vpc_config.0.subnets.#", acctest.CtOne),
				),
			},
			{
				ResourceName:      resourceName,
