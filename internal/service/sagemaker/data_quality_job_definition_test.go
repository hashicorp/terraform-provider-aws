		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "data_quality_app_specification.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_input.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_input.0.endpoint_input.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_output_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_output_config.0.monitoring_outputs.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_output_config.0.monitoring_outputs.0.s3_output.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "job_resources.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "job_resources.0.cluster_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "job_resources.0.cluster_config.0.instance_count", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "data_quality_baseline_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "network_config.#", acctest.CtZero),
					resource.TestCheckResourceAttrPair(resourceName, names.AttrRoleARN, "aws_iam_role.test", names.AttrARN),
					resource.TestCheckResourceAttr(resourceName, "stopping_condition.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "data_quality_app_specification.#", acctest.CtOne),
					resource.TestCheckResourceAttrPair(resourceName, "data_quality_app_specification.0.image_uri", "data.aws_sagemaker_prebuilt_ecr_image.monitor", "registry_path"),
					resource.TestCheckResourceAttr(resourceName, "data_quality_app_specification.0.environment.%", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDataQualityJobDefinitionExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
					resource.TestCheckResourceAttr(resourceName, "data_quality_baseline_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "data_quality_baseline_config.0.constraints_resource.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "data_quality_baseline_config.0.statistics_resource.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDataQualityJobDefinitionExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_input.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_input.0.batch_transform_input.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_input.0.batch_transform_input.0.dataset_format.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_input.0.batch_transform_input.0.dataset_format.0.csv.#", acctest.CtOne),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_input.0.batch_transform_input.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_input.0.batch_transform_input.0.dataset_format.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "data_quality_job_input.0.batch_transform_input.0.dataset_format.0.json.#", acctest.CtOne),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDataQualityJobDefinitionExists(ctx, resourceName),
					resource.TestCheckResourceAttr(resourceName, "network_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "network_config.0.vpc_config.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "network_config.0.vpc_config.0.security_group_ids.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "network_config.0.vpc_config.0.subnets.#", acctest.CtOne),
				),
			},
			{
				ResourceName:      resourceName,
...
func TestAccSageMakerDataQualityJobDefinition_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDataQualityJobDefinitionConfig_tags2(rName, acctest.CtKey1, "value1updated", acctest.CtKey2, acctest.CtValue2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDataQualityJobDefinitionExists(ctx, resourceName),
