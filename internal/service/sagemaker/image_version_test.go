...
// sagemakerBaseImageEnvVar is the environment variable which must be
...
const sagemakerBaseImageEnvVar = "SAGEMAKER_IMAGE_VERSION_BASE_IMAGE"
...
func TestAccSageMakerImageVersion_basic(t *testing.T) {
	...
	baseImage := acctest.SkipIfEnvVarNotSet(t, sagemakerBaseImageEnvVar)
