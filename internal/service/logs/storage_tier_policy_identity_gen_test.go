...
func testAccLogsStorageTierPolicy_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccLogsStorageTierPolicy_Identity_basic,
		"RegionOverride": testAccLogsStorageTierPolicy_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccLogsStorageTierPolicy_Identity_basic(t *testing.T) {
...
func testAccLogsStorageTierPolicy_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
