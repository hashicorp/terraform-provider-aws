		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "transformer_config.1.rename_keys.0.entries.0.key", "key1"),
					...
					resource.TestCheckResourceAttr(resourceName, "transformer_config.1.rename_keys.0.entries.1.key", "key2"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "transformer_config.1.upper_case_string.0.with_keys.0", "key1"),
					resource.TestCheckResourceAttr(resourceName, "transformer_config.1.upper_case_string.0.with_keys.1", "key2"),
				),
			},
			{
				ResourceName:                         resourceName,
