		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "metric_transformation.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "metric_transformation.0.default_value", ""),
					resource.TestCheckResourceAttr(resourceName, "metric_transformation.0.dimensions.%", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "metric_transformation.0.value", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "metric_transformation.0.value", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, rName),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "metric_transformation.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "metric_transformation.0.default_value", ""),
					resource.TestCheckResourceAttr(resourceName, "metric_transformation.0.dimensions.%", acctest.CtThree),
