...
func TestAccXRaySamplingRule_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tags1_gen.tf"),
			...
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tags2_gen.tf"),
				ConfigVariables: config.Variables{
					"rName":     config.StringVariable(rName),
					"tagKey1":   config.StringVariable("key1"),
			...
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tags0_gen.tf"),
				ConfigVariables: config.Variables{
					"rName": config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccXRaySamplingRule_tags_null(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tagsNull_gen.tf"),
				ConfigVariables: config.Variables{
					"rName":   config.StringVariable(rName),
					"tagKey1": config.StringVariable("key1"),
				},
...
func TestAccXRaySamplingRule_tags_DefaultTags_providerOnly(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tags0_default1_gen.tf"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
			...
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tags0_default2_gen.tf"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
					"providerTagKey1":   config.StringVariable("key1"),
...
func TestAccXRaySamplingRule_tags_DefaultTags_nonOverlapping(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tags1_default1_gen.tf"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
			...
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tags2_default1_gen.tf"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
					"providerTagKey1":   config.StringVariable("providerkey1"),
...
func TestAccXRaySamplingRule_tags_DefaultTags_overlapping(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tags2_default2_gen.tf"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
					"providerTagKey1":   config.StringVariable("overlapkey1"),
					"providerTagValue1": config.StringVariable("providervalue1"),
...
func TestAccXRaySamplingRule_tags_DefaultTags_nullOverlappingResourceTag(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigFile: config.StaticFile("testdata/SamplingRule/tagsNull_default1_gen.tf"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
					"providerTagKey1":   config.StringVariable("key1"),
					"providerTagValue1": config.StringVariable("providervalue1"),
