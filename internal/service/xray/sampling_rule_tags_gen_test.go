...
func TestAccXRaySamplingRule_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tags1/"),
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tags2/"),
				ConfigVariables: config.Variables{
					"rName":     config.StringVariable(rName),
					"tagKey1":   config.StringVariable("key1"),
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tags0/"),
				ConfigVariables: config.Variables{
					"rName": config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccXRaySamplingRule_tags_null(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tagsNull/"),
				ConfigVariables: config.Variables{
					"rName":   config.StringVariable(rName),
					"tagKey1": config.StringVariable("key1"),
				},
...
func TestAccXRaySamplingRule_tags_DefaultTags_providerOnly(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tags0_default1/"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tags0_default2/"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
					"providerTagKey1":   config.StringVariable("key1"),
...
func TestAccXRaySamplingRule_tags_DefaultTags_nonOverlapping(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tags1_default1/"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tags2_default1/"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
					"providerTagKey1":   config.StringVariable("providerkey1"),
...
func TestAccXRaySamplingRule_tags_DefaultTags_overlapping(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tags2_default2/"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
					"providerTagKey1":   config.StringVariable("overlapkey1"),
					"providerTagValue1": config.StringVariable("providervalue1"),
...
func TestAccXRaySamplingRule_tags_DefaultTags_nullOverlappingResourceTag(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/SamplingRule/tagsNull_default1/"),
				ConfigVariables: config.Variables{
					"rName":             config.StringVariable(rName),
					"providerTagKey1":   config.StringVariable("key1"),
					"providerTagValue1": config.StringVariable("providervalue1"),
