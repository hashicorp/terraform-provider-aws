...
func testAccXRayTraceSegmentDestination_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccXRayTraceSegmentDestination_Identity_basic,
		"RegionOverride": testAccXRayTraceSegmentDestination_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccXRayTraceSegmentDestination_Identity_basic(t *testing.T) {
...
func testAccXRayTraceSegmentDestination_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/TraceSegmentDestination/region_override/"),
				ConfigVariables: config.Variables{
