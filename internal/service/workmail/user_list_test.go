...
func TestAccWorkMailUser_List_basic(t *testing.T) {
	ctx := acctest.Context(t)

	resourceName1 := "aws_workmail_user.test[0]"
	resourceName2 := "aws_workmail_user.test[1]"
		...
		Steps: []resource.TestStep{
			...
			// Step 2: Query
			{
				...
				QueryResultChecks: []querycheck.QueryResultCheck{
					tfquerycheck.ExpectIdentityFunc("aws_workmail_user.test", identity1.Checks()),
					querycheck.ExpectResourceDisplayName("aws_workmail_user.test", tfqueryfilter.ByResourceIdentityFunc(identity1.Checks()), knownvalue.StringExact(rName+"-0")),
					tfquerycheck.ExpectNoResourceObject("aws_workmail_user.test", tfqueryfilter.ByResourceIdentityFunc(identity1.Checks())),

					tfquerycheck.ExpectIdentityFunc("aws_workmail_user.test", identity2.Checks()),
					querycheck.ExpectResourceDisplayName("aws_workmail_user.test", tfqueryfilter.ByResourceIdentityFunc(identity2.Checks()), knownvalue.StringExact(rName+"-1")),
					tfquerycheck.ExpectNoResourceObject("aws_workmail_user.test", tfqueryfilter.ByResourceIdentityFunc(identity2.Checks())),
				},
			},
		},
	})
...
func TestAccWorkMailUser_List_includeResource(t *testing.T) {
	ctx := acctest.Context(t)
			...
			// Step 2: Query
			{
				...
				QueryResultChecks: []querycheck.QueryResultCheck{
					...
					querycheck.ExpectResourceKnownValues("aws_workmail_user.test", tfqueryfilter.ByResourceIdentityFunc(identity1.Checks()), []querycheck.KnownValueCheck{
						...
						tfquerycheck.KnownValueCheck(tfjsonpath.New("user_id"), knownvalue.NotNull()),
						tfquerycheck.KnownValueCheck(tfjsonpath.New("user_role"), knownvalue.StringExact("USER")),
					}),
				},
			},
		},
...
func TestAccWorkMailUser_List_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
