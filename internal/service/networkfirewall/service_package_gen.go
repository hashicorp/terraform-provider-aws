...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*networkfirewall_sdkv1.NetworkFirewall, error) {
	return networkfirewall_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)})), nil
}
