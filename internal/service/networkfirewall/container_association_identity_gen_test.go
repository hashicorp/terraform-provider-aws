...
func TestAccNetworkFirewallContainerAssociation_Identity_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/ContainerAssociation/basic/"),
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectIdentity(resourceName, map[string]knownvalue.Check{
						"container_association_arn": knownvalue.NotNull(),
					}),
					statecheck.ExpectIdentityValueMatchesState(resourceName, tfjsonpath.New("container_association_arn")),
				},
			},
			...
			// Step 3: Import block with Import ID
			{
				...
				ImportPlanChecks: resource.ImportPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectKnownValue(resourceName, tfjsonpath.New("container_association_arn"), knownvalue.NotNull()),
...
func TestAccNetworkFirewallContainerAssociation_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/ContainerAssociation/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
			...
			// Step 2: Import command with appended "@<region>"
			{
				...
				ImportStateKind:                      resource.ImportCommandWithID,
				ImportStateIdFunc:                    acctest.CrossRegionAttrImportStateIdFunc(resourceName, "container_association_arn"),
				ResourceName:                         resourceName,
				ImportState:                          true,
				ImportStateVerify:                    true,
				ImportStateVerifyIdentifierAttribute: "container_association_arn",
