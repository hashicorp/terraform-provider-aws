		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "encryption_configuration.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceName, "firewall_status.#", acctest.CtOne),
					resource.TestCheckResourceAttr(dataSourceName, "firewall_status.0.capacity_usage_summary.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(dataSourceName, "firewall_status.0.sync_states.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceName, "subnet_mapping.#", acctest.CtOne),
