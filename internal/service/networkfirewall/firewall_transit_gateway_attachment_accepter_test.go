...
func testAccCheckFirewallTransitGatewayAttachmentAccepterExists(ctx context.Context, name string, v *ec2awstypes.TransitGatewayAttachment) resource.TestCheckFunc {
	return func(s *terraform.State) error {
