		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "configuration.0.crawler_configuration.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "configuration.0.provider_identity.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "provider_details.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckCustomLogSourceExists(ctx, resourceName, &customLogSource),
					resource.TestCheckResourceAttr(resourceName, "event_classes.#", acctest.CtOne),
