		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "matching.0.auto_merging.0.conflict_resolution.0.%", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "matching.0.auto_merging.0.consolidation.0.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "matching.0.auto_merging.0.consolidation.0.matching_attributes_list.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "matching.0.auto_merging.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "matching.0.auto_merging.0.min_allowed_confidence_score_for_merging", "0.1"),
					resource.TestCheckResourceAttr(resourceName, "matching.0.exporting_config.0.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "matching.0.exporting_config.0.s3_exporting.0.%", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "matching.0.job_schedule.0.%", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.attribute_types_selector.0.address.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.attribute_types_selector.0.email_address.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.attribute_types_selector.0.phone_number.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.conflict_resolution.0.%", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.enabled", "true"),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.exporting_config.0.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.exporting_config.0.s3_exporting.0.%", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.matching_rules.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.max_allowed_rule_level_for_matching", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.max_allowed_rule_level_for_merging", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "matching.0.auto_merging.0.consolidation.0.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "matching.0.auto_merging.0.consolidation.0.matching_attributes_list.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "matching.0.auto_merging.0.enabled", "true"),
					...
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.attribute_types_selector.0.email_address.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.attribute_types_selector.0.phone_number.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.conflict_resolution.0.%", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.matching_rules.#", acctest.CtThree),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.max_allowed_rule_level_for_matching", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "rule_based_matching.0.max_allowed_rule_level_for_merging", acctest.CtTwo),
					resource.TestCheckResourceAttrSet(resourceName, "rule_based_matching.0.status"),
				),
			},
		},
