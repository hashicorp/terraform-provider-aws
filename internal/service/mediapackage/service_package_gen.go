...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*mediapackage_sdkv2.Client, error) {
	...
	return mediapackage_sdkv2.NewFromConfig(cfg,
		mediapackage_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*mediapackage_sdkv2.Options) {
	return func(o *mediapackage_sdkv2.Options) {
		if endpoint != "" {
