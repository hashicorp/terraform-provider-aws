...
func TestAccNetworkManagerSite_tags(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/Site/tags/"),
...
func TestAccNetworkManagerSite_Tags_null(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_emptyMap(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_addOnUpdate(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_EmptyTag_onCreate(t *testing.T) {
	t.Skip("Resource Site does not support empty tags")
...
func TestAccNetworkManagerSite_Tags_EmptyTag_OnUpdate_add(t *testing.T) {
	t.Skip("Resource Site does not support empty tags")
...
func TestAccNetworkManagerSite_Tags_EmptyTag_OnUpdate_replace(t *testing.T) {
	t.Skip("Resource Site does not support empty tags")
...
func TestAccNetworkManagerSite_Tags_DefaultTags_providerOnly(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Site/tags_defaults/"),
				ConfigVariables: config.Variables{
...
func TestAccNetworkManagerSite_Tags_DefaultTags_nonOverlapping(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_DefaultTags_overlapping(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_DefaultTags_updateToProviderOnly(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_DefaultTags_updateToResourceOnly(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_DefaultTags_emptyResourceTag(t *testing.T) {
	t.Skip("Resource Site does not support empty tags")
...
func TestAccNetworkManagerSite_Tags_DefaultTags_emptyProviderOnlyTag(t *testing.T) {
	t.Skip("Resource Site does not support empty tags")
...
func TestAccNetworkManagerSite_Tags_DefaultTags_nullOverlappingResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_DefaultTags_nullNonOverlappingResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_ComputedTag_onCreate(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Site/tagsComputed1/"),
				ConfigVariables: config.Variables{
...
func TestAccNetworkManagerSite_Tags_ComputedTag_OnUpdate_add(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Site/tagsComputed2/"),
				ConfigVariables: config.Variables{
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func TestAccNetworkManagerSite_Tags_ComputedTag_OnUpdate_replace(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerSite_Tags_IgnoreTags_Overlap_defaultTag(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Site/tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
					}),
...
func TestAccNetworkManagerSite_Tags_IgnoreTags_Overlap_resourceTag(t *testing.T) {
	ctx := acctest.Context(t)
