...
func (p *servicePackage) NewClient(ctx context.Context, cfg aws_sdkv2.Config) (*pipes_sdkv2.Client, error) {
	return pipes_sdkv2.NewFromConfig(cfg, func(o *pipes_sdkv2.Options) {
		if p.endpoint != "" {
			o.EndpointResolver = pipes_sdkv2.EndpointResolverFromURL(p.endpoint)
		}
	}), nil
}
