		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.activemq_broker_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.filter_criteria.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.kinesis_stream_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.managed_streaming_kafka_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.rabbitmq_broker_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.sqs_queue_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.sqs_queue_parameters.0.batch_size", "10"),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.sqs_queue_parameters.0.maximum_batching_window_in_seconds", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttrPair(resourceName, names.AttrTarget, "aws_sqs_queue.target", names.AttrARN),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.#", acctest.CtZero),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.0.header_parameters.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.0.header_parameters.X-Test-1", "Val1"),
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.0.path_parameter_values.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.0.path_parameter_values.0", "p1"),
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.0.query_string_parameters.%", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.0.header_parameters.%", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.0.header_parameters.X-Test-1", "Val1"),
					...
					resource.TestCheckResourceAttr(resourceName, "enrichment_parameters.0.http_parameters.0.query_string_parameters.%", acctest.CtZero),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckPipeExists(ctx, resourceName, &pipe),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.filter_criteria.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.filter_criteria.0.filter.#", acctest.CtOne),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.filter_criteria.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.filter_criteria.0.filter.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.filter_criteria.0.filter.0.pattern", `{"source":["test1"]}`),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.filter_criteria.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.kinesis_stream_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.kinesis_stream_parameters.0.batch_size", "100"),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.kinesis_stream_parameters.0.dead_letter_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.kinesis_stream_parameters.0.maximum_batching_window_in_seconds", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.kinesis_stream_parameters.0.maximum_record_age_in_seconds", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.kinesis_stream_parameters.0.maximum_retry_attempts", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.kinesis_stream_parameters.0.parallelization_factor", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.rabbitmq_broker_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.sqs_queue_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					resource.TestCheckResourceAttrPair(resourceName, names.AttrTarget, "aws_kinesis_stream.target", names.AttrARN),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.cloudwatch_logs_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.eventbridge_event_bus_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.http_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.input_template", ""),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.kinesis_stream_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.kinesis_stream_parameters.0.partition_key", "test"),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.lambda_function_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.redshift_data_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.sagemaker_pipeline_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.sqs_queue_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.step_function_state_machine_parameters.#", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.activemq_broker_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.0.batch_size", "100"),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.0.dead_letter_config.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.0.maximum_batching_window_in_seconds", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.0.maximum_record_age_in_seconds", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.0.maximum_retry_attempts", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.0.parallelization_factor", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.cloudwatch_logs_parameters.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.http_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.input_template", ""),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.kinesis_stream_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.lambda_function_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.redshift_data_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.sagemaker_pipeline_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.sqs_queue_parameters.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.activemq_broker_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.activemq_broker_parameters.0.batch_size", "100"),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.activemq_broker_parameters.0.credentials.#", acctest.CtOne),
					resource.TestCheckResourceAttrSet(resourceName, "source_parameters.0.activemq_broker_parameters.0.credentials.0.basic_auth"),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.activemq_broker_parameters.0.maximum_batching_window_in_seconds", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.sagemaker_pipeline_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.sqs_queue_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.step_function_state_machine_parameters.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.filter_criteria.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.managed_streaming_kafka_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.rabbitmq_broker_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.rabbitmq_broker_parameters.0.batch_size", "10"),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.rabbitmq_broker_parameters.0.credentials.#", acctest.CtOne),
					resource.TestCheckResourceAttrSet(resourceName, "source_parameters.0.rabbitmq_broker_parameters.0.credentials.0.basic_auth"),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.rabbitmq_broker_parameters.0.maximum_batching_window_in_seconds", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.dynamodb_stream_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.filter_criteria.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.managed_streaming_kafka_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.managed_streaming_kafka_parameters.0.batch_size", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.managed_streaming_kafka_parameters.0.consumer_group_id", ""),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.managed_streaming_kafka_parameters.0.credentials.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.managed_streaming_kafka_parameters.0.maximum_batching_window_in_seconds", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.eventbridge_event_bus_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.http_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.http_parameters.0.header_parameters.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.http_parameters.0.header_parameters.X-Test", "test"),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.http_parameters.0.path_parameter_values.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.http_parameters.0.path_parameter_values.0", "p1"),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.http_parameters.0.query_string_parameters.%", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.managed_streaming_kafka_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.rabbitmq_broker_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.0.additional_bootstrap_servers.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.0.credentials.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.0.maximum_batching_window_in_seconds", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.0.vpc.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.0.vpc.0.security_groups.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.0.vpc.0.subnets.#", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.sqs_queue_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, acctest.CtTagsPercent, acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.input_template", ""),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.kinesis_stream_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.lambda_function_parameters.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.self_managed_kafka_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.sqs_queue_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "source_parameters.0.sqs_queue_parameters.0.batch_size", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.kinesis_stream_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.lambda_function_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.redshift_data_parameters.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.redshift_data_parameters.0.sqls.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.lambda_function_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.redshift_data_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.sagemaker_pipeline_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.sagemaker_pipeline_parameters.0.pipeline_parameter.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.0.container_overrides.0.environment.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.0.container_overrides.0.resource_requirement.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.0.container_overrides.0.resource_requirement.0.value", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.0.depends_on.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.0.parameters.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.0.parameters.Key1", "Value1"),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.0.retry_strategy.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.cloudwatch_logs_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.eventbridge_event_bus_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.http_parameters.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.batch_job_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.cloudwatch_logs_parameters.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.capacity_provider_strategy.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.network_configuration.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.network_configuration.0.aws_vpc_configuration.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.network_configuration.0.aws_vpc_configuration.0.security_groups.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.network_configuration.0.aws_vpc_configuration.0.subnets.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.container_override.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.container_override.0.command.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.container_override.0.cpu", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.container_override.0.environment.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.container_override.0.environment_file.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.container_override.0.memory", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.container_override.0.resource_requirement.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.container_override.0.resource_requirement.0.value", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.cpu", ""),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.ephemeral_storage.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.overrides.0.inference_accelerator_override.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.placement_constraint.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.placement_strategy.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.tags.%", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.tags.Name", rName),
					resource.TestCheckResourceAttr(resourceName, "target_parameters.0.ecs_task_parameters.0.task_count", acctest.CtOne),
