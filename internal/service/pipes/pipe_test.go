...
// TODO
// Enrichment: HTTP
// Sources: self_managed_kafka_parameters
// Targets: batch_job_parameters, ecs_task_parameters, lambda_function_parameters, redshift_data_parameters, sagemaker_pipeline_parameters
