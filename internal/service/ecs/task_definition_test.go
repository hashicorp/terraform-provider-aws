		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(resourceName, "volume.*", map[string]string{
						...
						"docker_volume_configuration.0.driver_opts.uid":    acctest.Ct1000,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "memory", acctest.Ct512),
				),
			},
			{
				ResourceName:            resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ephemeral_storage.0.size_in_gib", acctest.Ct30),
				),
			},
			{
				ResourceName:            resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					acctest.CheckResourceAttrJMES(resourceName, "container_definitions", "[0].memory", acctest.Ct512),
					...
					acctest.CheckResourceAttrJMES(resourceName, "container_definitions", "[0].portMappings[0].containerPort", acctest.Ct80),
					acctest.CheckResourceAttrJMES(resourceName, "container_definitions", "[0].portMappings[0].hostPort", acctest.Ct80),
