	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Step 2: Import command
			{
				...
				ImportStateKind:   resource.ImportCommandWithID,
				ImportStateIdFunc: acctest.CrossRegionImportStateIdFuncAdapter(resourceName, testAccClusterImportStateIdFunc),
				ResourceName:      resourceName,
				ImportState:       true,
				ImportStateVerify: true,
			},
...
func TestAccECSCluster_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
...
// Resource Identity was added after v6.61.0
func TestAccECSCluster_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
