		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "registered_container_instances_count", acctest.CtZero),
					resource.TestCheckResourceAttr(dataSourceName, "running_tasks_count", acctest.CtZero),
