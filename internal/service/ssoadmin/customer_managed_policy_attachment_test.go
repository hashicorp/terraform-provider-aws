...
func TestAccSSOAdminCustomerManagedPolicyAttachment_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckCustomerManagedPolicyAttachmentDestroy(ctx, t),
		Steps: []resource.TestStep{
			{
				Config: testAccCustomerManagedPolicyAttachmentConfig_basic(rName, rNamePolicy1, rNamePolicy2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCustomerManagedPolicyAttachmentExists(ctx, t, resourceName),
...
func TestAccSSOAdminCustomerManagedPolicyAttachment_multipleManagedPolicies(t *testing.T) {
	...
	rNamePolicy1 := acctest.RandomWithPrefix(t, acctest.ResourcePrefix)
	rNamePolicy2 := acctest.RandomWithPrefix(t, acctest.ResourcePrefix)
	rNamePolicy3 := acctest.RandomWithPrefix(t, acctest.ResourcePrefix)
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCustomerManagedPolicyAttachmentConfig_basic(rName, rNamePolicy1, rNamePolicy2),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCustomerManagedPolicyAttachmentExists(ctx, t, resource1Name),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCustomerManagedPolicyAttachmentExists(ctx, t, resource1Name),
					testAccCheckCustomerManagedPolicyAttachmentExists(ctx, t, resource2Name),
...
func testAccCheckCustomerManagedPolicyAttachmentDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
...
func testAccCheckCustomerManagedPolicyAttachmentExists(ctx context.Context, t *testing.T, n string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
