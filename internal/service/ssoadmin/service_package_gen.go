...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*ssoadmin_sdkv1.SSOAdmin, error) {
	return ssoadmin_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
