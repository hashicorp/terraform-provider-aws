		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "logging_configuration.0.dag_processing_logs.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "logging_configuration.0.scheduler_logs.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "logging_configuration.0.task_logs.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "logging_configuration.0.webserver_logs.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "logging_configuration.0.worker_logs.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "min_workers", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "schedulers", acctest.CtTwo),
...
func TestAccMWAAEnvironment_airflowOptions(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccEnvironmentConfig_airflowOptions(rName, acctest.CtOne, "16"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckEnvironmentExists(ctx, resourceName, &environment),
					resource.TestCheckResourceAttr(resourceName, "airflow_configuration_options.%", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "airflow_configuration_options.core.default_task_retries", acctest.CtOne),
			...
			{
				Config: testAccEnvironmentConfig_airflowOptions(rName, acctest.CtTwo, "32"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckEnvironmentExists(ctx, resourceName, &environment),
					resource.TestCheckResourceAttr(resourceName, "airflow_configuration_options.%", acctest.CtTwo),
					resource.TestCheckResourceAttr(resourceName, "airflow_configuration_options.core.default_task_retries", acctest.CtTwo),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckEnvironmentExists(ctx, resourceName, &environment),
					resource.TestCheckResourceAttr(resourceName, "airflow_configuration_options.%", acctest.CtZero),
				),
			},
		},
	})
