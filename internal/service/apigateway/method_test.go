...
resource "aws_iam_role" "invocation_role" {
  name = "tf_acc_apigateway_auth_invocation_role-%d"
  path = "/"
...
resource "aws_iam_role" "iam_for_lambda" {
  name = "tf_acc_iam_for_lambda_apigateway_authorizer-%d"
...
resource "aws_lambda_function" "authorizer" {
  ...
  function_name    = "tf_acc_apigateway_authorizer_%d"
...
resource "aws_apigateway_authorizer" "test" {
  ...
  provider_arns   = [aws_cognitoidp_user_pool.pool.arn]
