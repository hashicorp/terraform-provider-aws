...
func testAccCheckDomainNameAccessAssociationExists(ctx context.Context, t *testing.T, n string, v *types.DomainNameAccessAssociation) resource.TestCheckFunc {
...
func testAccCheckDomainNameAccessAssociationDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		conn := acctest.ProviderMeta(ctx, t).APIGatewayClient(ctx)
