		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cloudformation.#", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "cloudformation.0.stack_names.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "tags.0.tag_values.#", acctest.CtOne),
