		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ephemeral_block_device.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "metadata_options.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchConfigurationExists(ctx, resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "ebs_block_device.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "ephemeral_block_device.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchConfigurationExists(ctx, resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata_options.#", acctest.CtOne),
