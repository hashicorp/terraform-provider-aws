		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceSimpleName, "scaling_adjustment", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceTargetTrackingName, "target_tracking_configuration.0.customized_metric_specification.#", acctest.CtZero),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceTargetTrackingName, "target_tracking_configuration.0.predefined_metric_specification.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceSimpleName, "predictive_scaling_configuration.0.max_capacity_buffer", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "predictive_scaling_configuration.0.max_capacity_buffer", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "predictive_scaling_configuration.0.metric_specification.0.customized_capacity_metric_specification.0.metric_data_queries.1.metric_stat.0.metric.0.dimensions.#", acctest.CtTwo),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckScalingPolicyExists(ctx, resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "predictive_scaling_configuration.#", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "scaling_adjustment", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceSimpleName, "cooldown", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceSimpleName, "scaling_adjustment", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceStepName, "min_adjustment_magnitude", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceStepName, "estimated_instance_warmup", acctest.CtZero),
				),
			},
			{
				ResourceName:      resourceSimpleName,
