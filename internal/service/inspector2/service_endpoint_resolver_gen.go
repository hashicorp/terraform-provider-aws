...
var _ inspector2_sdkv2.EndpointResolverV2 = &resolver{}

type resolver struct {
	defaultResolver inspector2_sdkv2.EndpointResolverV2
}

func (r *resolver) ResolveEndpoint(ctx context.Context, params inspector2_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
