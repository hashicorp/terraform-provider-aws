		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKeyspaceExists(ctx, resourceName),
					acctest.CheckResourceAttrRegionalARN(resourceName, "arn", "cassandra", "/keyspace/"+acctest.CtName+"/"),
					resource.TestCheckResourceAttr(resourceName, names.AttrName, acctest.CtName),
					resource.TestCheckResourceAttr(resourceName, "tags.%", acctest.CtTagsPercent),
