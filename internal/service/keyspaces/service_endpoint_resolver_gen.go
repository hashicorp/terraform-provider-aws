...
var _ keyspaces_sdkv2.EndpointResolverV2 = &resolver{}
...
func (r *resolver) ResolveEndpoint(ctx context.Context, params keyspaces_sdkv2.EndpointParameters) (endpoint smithyendpoints.Endpoint, err error) {
