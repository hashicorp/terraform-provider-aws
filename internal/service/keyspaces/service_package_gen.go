...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) *keyspaces_sdkv1.Keyspaces {
	return keyspaces_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)}))
}
