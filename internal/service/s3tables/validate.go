...
var (
	...
	stringMustContainLowerCaseLettersNumbersHyphensUnderscores = stringvalidator.RegexMatches(regexache.MustCompile(`^[0-9a-z-_]+$`), "must contain only lowercase letters, numbers, hyphens or underscores")
