...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*redshiftserverless_sdkv1.RedshiftServerless, error) {
	return redshiftserverless_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.config["endpoint"].(string))})), nil
}
