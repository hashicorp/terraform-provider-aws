...
func (p *servicePackage) NewClient(ctx context.Context, config map[string]any) (*finspace_sdkv2.Client, error) {
	...
	return finspace_sdkv2.NewFromConfig(cfg,
		finspace_sdkv2.WithEndpointResolverV2(newEndpointResolver()),
		withBaseEndpoint(config[names.AttrEndpoint].(string)),
	), nil
}

func withBaseEndpoint(endpoint string) func(*finspace_sdkv2.Options) {
	return func(o *finspace_sdkv2.Options) {
		if endpoint != "" {
