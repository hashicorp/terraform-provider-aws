		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "usage_metric.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceName, "usage_metric.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(dataSourceName, "usage_metric.0.metric_dimensions.#", acctest.CtOne),
