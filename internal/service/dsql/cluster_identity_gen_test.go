...
func TestAccDSQLCluster_Identity_basic(t *testing.T) {
...
func TestAccDSQLCluster_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccDSQLCluster_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/Cluster/basic_v6.61.0/"),
				ConfigVariables: config.Variables{},
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckClusterExists(ctx, t, resourceName, &v),
				),
...
// Resource Identity was added after v6.61.0
func TestAccDSQLCluster_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
