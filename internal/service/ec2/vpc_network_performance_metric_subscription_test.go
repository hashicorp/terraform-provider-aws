...
func testAccNetworkPerformanceMetricSubscription_basic(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckNetworkPerformanceMetricSubscriptionDestroy(ctx, t),
		Steps: []resource.TestStep{
			{
				Config: testAccVPCNetworkPerformanceMetricSubscription_basic(src, dst),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckNetworkPerformanceMetricSubscriptionExists(ctx, t, resourceName),
...
func testAccCheckNetworkPerformanceMetricSubscriptionExists(ctx context.Context, t *testing.T, n string) resource.TestCheckFunc {
...
func testAccCheckNetworkPerformanceMetricSubscriptionDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		conn := acctest.ProviderMeta(ctx, t).EC2Client(ctx)
