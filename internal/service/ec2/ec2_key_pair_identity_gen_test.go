		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.CompareValuePairs(resourceName, tfjsonpath.New(names.AttrID), resourceName, tfjsonpath.New("key_name"), compare.ValuesSame()),
...
func TestAccEC2KeyPair_Identity_ExistingResource_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/KeyPair/basic_v6.61.0/"),
				ConfigVariables: config.Variables{
					"rTlsEcdsaPublicKeyPem": config.StringVariable(rTlsEcdsaPublicKeyPem),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
