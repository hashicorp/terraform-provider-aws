...
func TestAccWavelengthCarrierGateway_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccWavelengthCarrierGatewayConfig_carrierGateway(rName),
...
func TestAccWavelengthCarrierGateway_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccWavelengthCarrierGatewayConfig_carrierGatewayTags1(rName, "key1", "value1"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCarrierGatewayExists(resourceName, &v),
			...
			{
				Config: testAccWavelengthCarrierGatewayConfig_carrierGatewayTags2(rName, "key1", "value1updated", "key2", "value2"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCarrierGatewayExists(resourceName, &v),
			...
			{
				Config: testAccWavelengthCarrierGatewayConfig_carrierGatewayTags1(rName, "key2", "value2"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCarrierGatewayExists(resourceName, &v),
					resource.TestCheckResourceAttr(resourceName, "tags.%", "1"),
					resource.TestCheckResourceAttr(resourceName, "tags.key2", "value2"),
...
func testAccWavelengthCarrierGatewayConfig_carrierGateway(rName string) string {
	return fmt.Sprintf(`
...
func testAccWavelengthCarrierGatewayConfig_carrierGatewayTags1(rName, tagKey1, tagValue1 string) string {
	return fmt.Sprintf(`
resource "aws_vpc" "test" {
  cidr_block = "10.0.0.0/16"
...
func testAccWavelengthCarrierGatewayConfig_carrierGatewayTags2(rName, tagKey1, tagValue1, tagKey2, tagValue2 string) string {
	return fmt.Sprintf(`
resource "aws_vpc" "test" {
  cidr_block = "10.0.0.0/16"
