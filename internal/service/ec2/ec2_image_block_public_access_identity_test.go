...
func testAccEC2ImageBlockPublicAccess_identitySerial(t *testing.T) {
	...
	testCases := map[string]func(t *testing.T){
		...
		"ExistingResource":          testAccEC2ImageBlockPublicAccess_Identity_ExistingResource_basic,
		"ExistingResourceNoRefresh": testAccEC2ImageBlockPublicAccess_Identity_ExistingResource_basic_NoRefresh_NoChange,
...
func testAccEC2ImageBlockPublicAccess_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/ImageBlockPublicAccess/basic_v6.0.0/"),
				ConfigVariables: config.Variables{},
...
func testAccEC2ImageBlockPublicAccess_Identity_ExistingResource_basic_NoRefresh_NoChange(t *testing.T) {
	ctx := acctest.Context(t)
