...
func TestAccVPCIPv4CIDRBlockAssociation_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckVPCIPv4CIDRBlockAssociationDestroy(ctx, t),
		Steps: []resource.TestStep{
			{
				Config: testAccVPCIPv4CIDRBlockAssociationConfig_basic(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckVPCIPv4CIDRBlockAssociationExists(ctx, t, resource1Name, &associationSecondary),
					testAccCheckVPCIPv4CIDRBlockAssociationExists(ctx, t, resource2Name, &associationTertiary),
				),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckVPCIPv4CIDRBlockAssociationExists(ctx, t, resourceName, &associationSecondary),
				),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
			...
			},
			{
				Config: testAccVPCIPv4CIDRBlockAssociationConfig_ipam(rName, 28),
				Check: resource.ComposeTestCheckFunc(
					acctest.CheckSDKResourceDisappears(ctx, t, tfec2.ResourceVPC(), vpcResourceName), // nosemgrep:disappears-expect-resource-action
					testAccCheckVPCIPv4CIDRBlockAssociationWaitVPCIPAMPoolAllocationDeleted(ctx, t, ipamPoolResourceName, vpcResourceName),
				),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
...
func testAccCheckVPCIPv4CIDRBlockAssociationDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
...
func testAccCheckVPCIPv4CIDRBlockAssociationExists(ctx context.Context, t *testing.T, n string, v *awstypes.VpcCidrBlockAssociation) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
func testAccCheckVPCIPv4CIDRBlockAssociationWaitVPCIPAMPoolAllocationDeleted(ctx context.Context, t *testing.T, nIPAMPool, nVPC string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
