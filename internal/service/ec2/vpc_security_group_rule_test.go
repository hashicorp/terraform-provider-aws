		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resource1Name, names.AttrProtocol, acctest.CtNegative1),
					...
					resource.TestCheckResourceAttr(resource2Name, "from_port", acctest.Ct443),
					...
					resource.TestCheckNoResourceAttr(resource2Name, "source_security_group_id"),
					resource.TestCheckResourceAttr(resource2Name, "to_port", acctest.Ct443),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resource2Name, "from_port", acctest.Ct22),
					...
					resource.TestCheckResourceAttr(resource2Name, "self", acctest.CtFalse),
					resource.TestCheckNoResourceAttr(resource2Name, "source_security_group_id"),
					resource.TestCheckResourceAttr(resource2Name, "to_port", acctest.Ct22),
					resource.TestCheckResourceAttr(resource2Name, names.AttrType, "ingress"),
					...
					resource.TestCheckResourceAttr(resource3Name, "from_port", acctest.Ct22),
					...
					resource.TestCheckResourceAttr(resource3Name, "to_port", acctest.Ct22),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resource4Name, "from_port", acctest.Ct22),
					...
					resource.TestCheckResourceAttr(resource4Name, "to_port", acctest.Ct22),
