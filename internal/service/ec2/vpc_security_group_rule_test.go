		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "cidr_blocks.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrProtocol, "tcp"),
					resource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "from_port", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resourceName, "to_port", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrType, "ingress"),
				),
			},
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrProtocol, "-1"),
					resource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckSecurityGroupExists(ctx, sgResourceName, &group),
					resource.TestCheckResourceAttr(resource1Name, "cidr_blocks.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resource1Name, "from_port", acctest.CtZero),
					resource.TestCheckResourceAttr(resource1Name, "ipv6_cidr_blocks.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resource1Name, names.AttrProtocol, "-1"),
					resource.TestCheckResourceAttr(resource1Name, "prefix_list_ids.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resource2Name, "ipv6_cidr_blocks.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resource2Name, names.AttrProtocol, "tcp"),
					resource.TestCheckResourceAttr(resource2Name, "prefix_list_ids.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resource1Name, names.AttrType, "ingress"),
					resource.TestCheckResourceAttr(resource2Name, "cidr_blocks.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resource2Name, "ipv6_cidr_blocks.#", acctest.CtOne),
					...
					resource.TestCheckResourceAttr(resource2Name, names.AttrType, "ingress"),
					resource.TestCheckResourceAttr(resource3Name, "cidr_blocks.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resource3Name, "ipv6_cidr_blocks.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resource3Name, names.AttrProtocol, "tcp"),
					resource.TestCheckResourceAttr(resource3Name, "prefix_list_ids.#", acctest.CtZero),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resource4Name, "cidr_blocks.#", acctest.CtZero),
					...
					resource.TestCheckResourceAttr(resource4Name, "ipv6_cidr_blocks.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resource4Name, names.AttrProtocol, "tcp"),
					resource.TestCheckResourceAttr(resource4Name, "prefix_list_ids.#", acctest.CtOne),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr(resourceName, names.AttrDescription),
					resource.TestCheckResourceAttr(resourceName, "from_port", "80"),
					resource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.#", acctest.CtTwo),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ipv6_cidr_blocks.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, names.AttrProtocol, "tcp"),
					resource.TestCheckResourceAttr(resourceName, "prefix_list_ids.#", acctest.CtTwo),
					resource.TestCheckResourceAttrPair(resourceName, "security_group_id", sgResourceName, names.AttrID),
					resource.TestCheckResourceAttr(resourceName, "security_group_rule_id", ""),
					resource.TestCheckResourceAttr(resourceName, "self", "false"),
					resource.TestCheckNoResourceAttr(resourceName, "source_security_group_id"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrProtocol, "tcp"),
					resource.TestCheckResourceAttr(resourceName, names.AttrType, "ingress"),
					resource.TestCheckResourceAttr(resourceName2, "cidr_blocks.#", acctest.CtOne),
...
func testAccSecurityGroupRuleImportGetAttrs(attrs map[string]string, key string) (*[]string, error) {
	var values []string
	if countStr, ok := attrs[fmt.Sprintf("%s.#", key)]; ok && countStr != acctest.CtZero {
