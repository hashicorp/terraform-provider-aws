		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(datasourceName, "associations.0.resource_arn", resourceConfigName, "arn"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrPair(datasourceName, names.AttrID, resourceName, names.AttrID),
					resource.TestCheckResourceAttr(datasourceName, "associations.#", "1"),
					resource.TestCheckResourceAttrPair(datasourceName, "associations.0.service_network_arn", resourceServiceNetwork, "arn"),
					resource.TestCheckResourceAttrPair(datasourceName, "associations.0.resource_arn", resourceConfigName, "arn"),
