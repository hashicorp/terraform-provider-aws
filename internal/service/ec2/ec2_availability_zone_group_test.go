...
func TestAccEC2AvailabilityZoneGroup_optInStatus(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccEC2AvailabilityZoneGroupConfig_availabilityZoneGroupOptInStatus(localZone, ec2.AvailabilityZoneOptInStatusOptedIn),
...
func testAccEC2AvailabilityZoneGroupConfig_availabilityZoneGroupOptInStatus(name, optInStatus string) string {
	return fmt.Sprintf(`
