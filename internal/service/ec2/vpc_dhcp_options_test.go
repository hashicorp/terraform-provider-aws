		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "domain_name_servers.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "ipv6_address_preferred_lease_time", ""),
					resource.TestCheckResourceAttr(resourceName, "netbios_name_servers.#", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceName, "netbios_node_type", acctest.CtOne),
					resource.TestCheckResourceAttr(resourceName, "ntp_servers.#", acctest.CtZero),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "domain_name_servers.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(resourceName, "netbios_node_type", acctest.CtTwo),
