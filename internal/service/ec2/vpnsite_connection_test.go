		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel1_bgp_holdtime", acctest.Ct30),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel2_bgp_holdtime", acctest.Ct30),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel1_dpd_timeout_seconds", acctest.Ct30),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel1_inside_cidr", "169.254.8.0/30"),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_inside_ipv6_cidr", ""),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_phase1_dh_group_numbers.#", acctest.Ct8),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase1_dh_group_numbers.*", acctest.Ct14),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase1_dh_group_numbers.*", acctest.Ct15),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase1_dh_group_numbers.*", acctest.Ct16),
					...
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase1_dh_group_numbers.*", acctest.Ct20),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel1_phase2_dh_group_numbers.#", acctest.Ct5),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase2_dh_group_numbers.*", acctest.Ct2),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase2_dh_group_numbers.*", acctest.Ct5),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase2_dh_group_numbers.*", acctest.Ct22),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel1_phase2_lifetime_seconds", acctest.Ct3600),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_preshared_key", "12345678"),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_rekey_fuzz_percentage", acctest.Ct100),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_rekey_margin_time_seconds", "540"),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_replay_window_size", acctest.Ct1024),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel2_inside_cidr", "169.254.9.0/30"),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_inside_ipv6_cidr", ""),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_phase1_dh_group_numbers.#", acctest.Ct7),
					...
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase1_dh_group_numbers.*", acctest.Ct20),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase1_dh_group_numbers.*", "21"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase1_dh_group_numbers.*", acctest.Ct22),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel2_phase2_dh_group_numbers.#", acctest.Ct8),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase2_dh_group_numbers.*", acctest.Ct15),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase2_dh_group_numbers.*", acctest.Ct16),
					...
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase2_dh_group_numbers.*", acctest.Ct20),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase2_dh_group_numbers.*", "21"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase2_dh_group_numbers.*", acctest.Ct22),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel2_phase2_lifetime_seconds", acctest.Ct1200),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_preshared_key", "abcdefgh"),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_rekey_fuzz_percentage", acctest.Ct90),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_rekey_margin_time_seconds", "360"),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_replay_window_size", acctest.Ct512),
			...
			// Update just tunnel1.
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel1_inside_cidr", "169.254.8.0/30"),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_inside_ipv6_cidr", ""),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_phase1_dh_group_numbers.#", acctest.Ct7),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase1_dh_group_numbers.*", "18"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase1_dh_group_numbers.*", "19"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase1_dh_group_numbers.*", acctest.Ct20),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase1_dh_group_numbers.*", "21"),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase1_dh_group_numbers.*", acctest.Ct22),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel1_phase2_dh_group_numbers.#", acctest.Ct8),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase2_dh_group_numbers.*", acctest.Ct15),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase2_dh_group_numbers.*", acctest.Ct16),
					...
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel1_phase2_dh_group_numbers.*", acctest.Ct20),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel1_phase2_lifetime_seconds", acctest.Ct1200),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_preshared_key", "abcdefgh"),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_rekey_fuzz_percentage", acctest.Ct90),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_rekey_margin_time_seconds", "360"),
					resource.TestCheckResourceAttr(resourceName, "tunnel1_replay_window_size", acctest.Ct512),
			...
			// Update just tunnel2.
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel2_dpd_timeout_seconds", acctest.Ct30),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel2_inside_cidr", "169.254.9.0/30"),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_inside_ipv6_cidr", ""),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_phase1_dh_group_numbers.#", acctest.Ct8),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase1_dh_group_numbers.*", acctest.Ct14),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase1_dh_group_numbers.*", acctest.Ct15),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase1_dh_group_numbers.*", acctest.Ct16),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel2_phase2_dh_group_numbers.#", acctest.Ct5),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase2_dh_group_numbers.*", acctest.Ct2),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase2_dh_group_numbers.*", acctest.Ct5),
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase2_dh_group_numbers.*", acctest.Ct22),
					...
					resource.TestCheckTypeSetElemAttr(resourceName, "tunnel2_phase2_integrity_algorithms.*", "SHA2-256"),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_phase2_lifetime_seconds", acctest.Ct3600),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_preshared_key", "12345678"),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_rekey_fuzz_percentage", acctest.Ct100),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_rekey_margin_time_seconds", "540"),
					resource.TestCheckResourceAttr(resourceName, "tunnel2_replay_window_size", acctest.Ct1024),
