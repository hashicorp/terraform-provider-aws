		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel1_log_options.0.cloudwatch_log_options.0.log_group_arn", "json"),
					...
					resource.TestCheckResourceAttr(resourceName, "tunnel2_log_options.0.cloudwatch_log_options.0.log_group_arn", "json"),
					resource.TestCheckResourceAttrPair(resourceName, "tunnel1_log_options.0.cloudwatch_log_options.0.log_group_arn", "aws_cloudwatch_log_group.default", "arn"),
					resource.TestCheckResourceAttrSet(resourceName, "tunnel2_vgw_inside_address"),
					resource.TestCheckResourceAttr(resourceName, "tunnel_inside_ip_version", "ipv4"),
					resource.TestCheckResourceAttr(resourceName, "vgw_telemetry.#", "2"),
