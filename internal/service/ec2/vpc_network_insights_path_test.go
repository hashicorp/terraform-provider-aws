...
func TestAccVPCNetworkInsightsPath_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPath(rName, "tcp"),
...
func TestAccVPCNetworkInsightsPath_disappears(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPath(rName, "udp"),
...
func TestAccVPCNetworkInsightsPath_tags(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPathTags1(rName, "key1", "value1"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkInsightsPathExists(resourceName),
			...
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPathTags2(rName, "key1", "value1updated", "key2", "value2"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkInsightsPathExists(resourceName),
			...
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPathTags1(rName, "key2", "value2"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkInsightsPathExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "tags.%", "1"),
					resource.TestCheckResourceAttr(resourceName, "tags.key2", "value2"),
...
func TestAccVPCNetworkInsightsPath_sourceIP(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPathSourceIP(rName, "1.1.1.1"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkInsightsPathExists(resourceName),
			...
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPathSourceIP(rName, "8.8.8.8"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkInsightsPathExists(resourceName),
...
func TestAccVPCNetworkInsightsPath_destinationIP(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPathDestinationIP(rName, "1.1.1.1"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkInsightsPathExists(resourceName),
			...
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPathDestinationIP(rName, "8.8.8.8"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkInsightsPathExists(resourceName),
...
func TestAccVPCNetworkInsightsPath_destinationPort(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPathDestinationPort(rName, 80),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkInsightsPathExists(resourceName),
			...
			{
				Config: testAccVPCNetworkInsightsPathConfig_networkInsightsPathDestinationPort(rName, 443),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkInsightsPathExists(resourceName),
...
func testAccVPCNetworkInsightsPathConfig_networkInsightsPath(rName, protocol string) string {
	return fmt.Sprintf(`
...
func testAccVPCNetworkInsightsPathConfig_networkInsightsPathTags1(rName, tagKey1, tagValue1 string) string {
	return fmt.Sprintf(`
resource "aws_vpc" "test" {
  cidr_block = "10.0.0.0/16"
...
func testAccVPCNetworkInsightsPathConfig_networkInsightsPathTags2(rName, tagKey1, tagValue1, tagKey2, tagValue2 string) string {
	return fmt.Sprintf(`
resource "aws_vpc" "test" {
  cidr_block = "10.0.0.0/16"
...
func testAccVPCNetworkInsightsPathConfig_networkInsightsPathSourceIP(rName, sourceIP string) string {
	return fmt.Sprintf(`
resource "aws_vpc" "test" {
  cidr_block = "10.0.0.0/16"
...
func testAccVPCNetworkInsightsPathConfig_networkInsightsPathDestinationIP(rName, destinationIP string) string {
	return fmt.Sprintf(`
resource "aws_vpc" "test" {
  cidr_block = "10.0.0.0/16"
...
func testAccVPCNetworkInsightsPathConfig_networkInsightsPathDestinationPort(rName string, destinationPort int) string {
	return fmt.Sprintf(`
resource "aws_vpc" "test" {
  cidr_block = "10.0.0.0/16"
