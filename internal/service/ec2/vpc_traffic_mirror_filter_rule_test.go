...
func TestAccVPCTrafficMirrorFilterRule_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			//create
			{
				Config: testAccVPCTrafficMirrorFilterRuleConfig_trafficMirrorFilterRule(dstCidr, srcCidr, action, direction, ruleNum),
			...
			// Add all optionals
			{
				Config: testAccVPCTrafficMirrorFilterRuleConfig_trafficMirrorFilterRuleFull(dstCidr, srcCidr, action, direction, description, ruleNum, srcPortFrom, srcPortTo, dstPortFrom, dstPortTo, protocol),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTrafficMirrorFilterRuleExists(resourceName),
					resource.TestMatchResourceAttr(resourceName, "traffic_mirror_filter_id", regexp.MustCompile("tmf-.*")),
					resource.TestCheckResourceAttr(resourceName, "destination_cidr_block", dstCidr),
...
func testAccVPCTrafficMirrorFilterRuleConfig_trafficMirrorFilterRule(dstCidr, srcCidr, action, dir string, num int) string {
	return fmt.Sprintf(`
...
func testAccVPCTrafficMirrorFilterRuleConfig_trafficMirrorFilterRuleFull(dstCidr, srcCidr, action, dir, description string, ruleNum, srcPortFrom, srcPortTo, dstPortFrom, dstPortTo, protocol int) string {
	return fmt.Sprintf(`
resource "aws_ec2_traffic_mirror_filter" "test" {}
