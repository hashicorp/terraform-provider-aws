		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "block_device_mappings.0.ebs.0.volume_size", acctest.Ct15),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "block_device_mappings.0.device_name", "/dev/xvda"),
					resource.TestCheckResourceAttr(resourceName, "block_device_mappings.0.ebs.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "block_device_mappings.0.ebs.0.iops", acctest.Ct4000),
					resource.TestCheckResourceAttr(resourceName, "block_device_mappings.0.ebs.0.throughput", acctest.Ct500),
					resource.TestCheckResourceAttr(resourceName, "block_device_mappings.0.ebs.0.volume_size", acctest.Ct15),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.memory_mib.0.min", acctest.Ct500),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.memory_mib.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.memory_mib.0.min", acctest.Ct500),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.memory_mib.0.max", acctest.Ct4000),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.vcpu_count.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.vcpu_count.0.min", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.vcpu_count.0.max", acctest.Ct8),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchTemplateExists(ctx, resourceName, &template),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.accelerator_names.#", acctest.Ct7),
					resource.TestCheckTypeSetElemAttr(resourceName, "instance_requirements.0.accelerator_names.*", "a100"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.accelerator_total_memory_mib.0.min", acctest.Ct1000),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.baseline_ebs_bandwidth_mbps.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.baseline_ebs_bandwidth_mbps.0.max", acctest.Ct20000),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchTemplateExists(ctx, resourceName, &template),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.max_spot_price_as_percentage_of_optimal_on_demand_price", acctest.Ct75),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.memory_gib_per_vcpu.0.min", acctest.Ct0Point5),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.network_bandwidth_gbps.0.min", acctest.Ct1Point5),
				),
			},
			{
				ResourceName:      resourceName,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.network_bandwidth_gbps.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.network_bandwidth_gbps.0.max", acctest.Ct200),
				),
			},
			{
				ResourceName:      resourceName,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.network_bandwidth_gbps.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.network_bandwidth_gbps.0.min", acctest.Ct2Point5),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.network_bandwidth_gbps.0.max", acctest.Ct250),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchTemplateExists(ctx, resourceName, &template),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.on_demand_max_price_percentage_over_lowest_price", acctest.Ct50),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLaunchTemplateExists(ctx, resourceName, &template),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.#", acctest.Ct1),
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.spot_max_price_percentage_over_lowest_price", acctest.Ct75),
				),
			},
			{
				ResourceName:      resourceName,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "instance_requirements.0.total_local_storage_gb.0.min", acctest.Ct0Point5),
				),
			},
			{
				ResourceName:      resourceName,
