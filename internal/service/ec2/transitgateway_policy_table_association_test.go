...
func testAccTransitGatewayPolicyTableAssociation_basic(t *testing.T, semaphore tfsync.Semaphore) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckTransitGatewayPolicyTableAssociationDestroy(ctx, t),
		Steps: []resource.TestStep{
			{
				Config: testAccTransitGatewayPolicyTableAssociationConfig_basic(rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckTransitGatewayPolicyTableAssociationExists(ctx, t, resourceName, &v),
...
func testAccCheckTransitGatewayPolicyTableAssociationExists(ctx context.Context, t *testing.T, n string, v *awstypes.TransitGatewayPolicyTableAssociation) resource.TestCheckFunc {
...
func testAccCheckTransitGatewayPolicyTableAssociationDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		conn := acctest.ProviderMeta(ctx, t).EC2Client(ctx)
