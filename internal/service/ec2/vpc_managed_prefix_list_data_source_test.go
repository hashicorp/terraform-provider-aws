		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceByName, "max_entries", acctest.CtZero),
					resource.TestCheckResourceAttr(resourceByName, names.AttrVersion, acctest.CtZero),
					resource.TestCheckResourceAttr(resourceByName, acctest.CtTagsPercent, acctest.CtZero),
