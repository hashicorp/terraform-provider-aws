		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resource1Name, "from_port", acctest.Ct22),
					resource.TestCheckResourceAttr(resource1Name, "ipv6_cidr_block", ""),
					resource.TestCheckResourceAttr(resource1Name, names.AttrProtocol, acctest.Ct6),
					resource.TestCheckResourceAttr(resource1Name, "rule_action", "allow"),
					resource.TestCheckResourceAttr(resource1Name, "rule_number", acctest.Ct200),
					resource.TestCheckResourceAttr(resource1Name, "to_port", acctest.Ct22),
					...
					resource.TestCheckResourceAttr(resource2Name, "icmp_code", acctest.CtNegative1),
					...
					resource.TestCheckResourceAttr(resource2Name, "rule_number", acctest.Ct300),
					...
					resource.TestCheckResourceAttr(resource3Name, "icmp_code", acctest.CtNegative1),
					resource.TestCheckResourceAttr(resource3Name, "icmp_type", acctest.CtNegative1),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "from_port", acctest.Ct22),
					resource.TestCheckResourceAttr(resourceName, "ipv6_cidr_block", "::/0"),
					resource.TestCheckResourceAttr(resourceName, names.AttrProtocol, acctest.Ct6),
					resource.TestCheckResourceAttr(resourceName, "rule_action", "allow"),
					resource.TestCheckResourceAttr(resourceName, "rule_number", acctest.Ct150),
					resource.TestCheckResourceAttr(resourceName, "to_port", acctest.Ct22),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrCIDRBlock, ""),
					resource.TestCheckResourceAttr(resourceName, "egress", acctest.CtFalse),
					resource.TestCheckResourceAttr(resourceName, "icmp_code", acctest.CtNegative1),
					resource.TestCheckResourceAttr(resourceName, "icmp_type", acctest.CtNegative1),
					resource.TestCheckResourceAttr(resourceName, "ipv6_cidr_block", "::/0"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, names.AttrProtocol, acctest.CtNegative1),
					resource.TestCheckResourceAttr(resourceName, "rule_action", "allow"),
					resource.TestCheckResourceAttr(resourceName, "rule_number", acctest.Ct150),
					resource.TestCheckResourceAttr(resourceName, "to_port", acctest.Ct22),
				),
