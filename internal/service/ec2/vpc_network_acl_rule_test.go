		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckNetworkACLRuleExists(ctx, t, resource1Name),
					testAccCheckNetworkACLRuleExists(ctx, t, resource2Name),
					testAccCheckNetworkACLRuleExists(ctx, t, resource3Name),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					acctest.CheckVPCExists(ctx, t, vpcResourceName, &v),
...
func testAccCheckNetworkACLRuleDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
...
func testAccCheckNetworkACLRuleExists(ctx context.Context, t *testing.T, n string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		conn := acctest.ProviderMeta(ctx, t).EC2Client(ctx)
