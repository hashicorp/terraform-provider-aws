		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(datasourceName, "connections.0.vpc_endpoint_id"),
					resource.TestCheckResourceAttrSet(datasourceName, "connections.0.vpc_endpoint_owner"),
					resource.TestCheckResourceAttrSet(datasourceName, "connections.0.vpc_endpoint_state"),
