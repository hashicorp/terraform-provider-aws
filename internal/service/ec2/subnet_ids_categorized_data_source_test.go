		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aws_subnet_ids_categorized.categorized", "private_subnet_nat_ids.#", "0"),
					resource.TestCheckResourceAttr("data.aws_subnet_ids_categorized.categorized", "private_subnet_nonat_ids.#", "4"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aws_subnet_ids_categorized.categorized", "private_subnet_nat_ids.#", "0"),
					resource.TestCheckResourceAttr("data.aws_subnet_ids_categorized.categorized", "private_subnet_nonat_ids.#", "3"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aws_subnet_ids_categorized.categorized", "private_subnet_nat_ids.#", "0"),
					resource.TestCheckResourceAttr("data.aws_subnet_ids_categorized.categorized", "private_subnet_nonat_ids.#", "1"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.aws_subnet_ids_categorized.categorized", "private_subnet_ids.#", "3"),
					resource.TestCheckResourceAttr("data.aws_subnet_ids_categorized.categorized", "private_subnet_nat_ids.#", "2"),
					resource.TestCheckResourceAttr("data.aws_subnet_ids_categorized.categorized", "private_subnet_nonat_ids.#", "1"),
				),
			},
		},
