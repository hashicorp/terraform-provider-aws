...
func (d *dataSourceAwsVpcIpams) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			"ipams": framework.DataSourceComputedListOfObjectAttribute[dataSourceAwsVpcIpamModel](ctx),
...
type dataSourceAwsVpcIpamsModel struct {
	Ipams   fwtypes.ListNestedObjectValueOf[dataSourceAwsVpcIpamModel] `tfsdk:"ipams"`
