		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasource1Name, "associations.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(datasource2Name, "associations.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(datasource3Name, "associations.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(datasource4Name, "associations.#", acctest.CtTwo),
					...
					resource.TestCheckResourceAttr(datasource5Name, "associations.#", acctest.CtTwo),
