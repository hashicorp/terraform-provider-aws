...
func testAccEC2CapacityManagerSettings_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccEC2CapacityManagerSettings_Identity_basic,
		"RegionOverride": testAccEC2CapacityManagerSettings_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccEC2CapacityManagerSettings_Identity_basic(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/CapacityManagerSettings/basic/"),
...
func testAccEC2CapacityManagerSettings_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/CapacityManagerSettings/region_override/"),
				ConfigVariables: config.Variables{
