...
func testAccEC2SerialConsoleAccess_identitySerial(t *testing.T) {
	...
	testCases := map[string]func(t *testing.T){
		...
		"ExistingResource":          testAccEC2SerialConsoleAccess_Identity_ExistingResource_basic,
		"ExistingResourceNoRefresh": testAccEC2SerialConsoleAccess_Identity_ExistingResource_basic_NoRefresh_NoChange,
...
func testAccEC2SerialConsoleAccess_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
...
func testAccEC2SerialConsoleAccess_Identity_ExistingResource_basic_NoRefresh_NoChange(t *testing.T) {
	ctx := acctest.Context(t)
