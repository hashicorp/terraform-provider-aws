...
func testAccClientVPNNetworkAssociation_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNetworkAssociationConfig_basic(rName),
...
func testAccClientVPNNetworkAssociation_multipleSubnets(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNetworkAssociationConfig_multipleSubnets(rName),
				Check: resource.ComposeTestCheckFunc(
...
func testAccClientVPNNetworkAssociation_securityGroups(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNetworkAssociationConfig_twoSecurityGroups(rName),
			...
			{
				Config: testAccNetworkAssociationConfig_oneSecurityGroup(rName),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func testAccClientVPNNetworkAssociation_securityGroupsOnEndpoint(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNetworkAssociationConfig_twoSecurityGroupsOnEndpoint(rName),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckClientVPNNetworkAssociationExists(resourceName, &assoc),
					resource.TestCheckResourceAttr(resourceName, "security_groups.#", "2"),
...
func testAccNetworkAssociationConfig_basic(rName string) string {
...
func testAccNetworkAssociationConfig_multipleSubnets(rName string) string {
	return acctest.ConfigCompose(testAccClientVPNNetworkAssociationConfigBase(rName), `
...
func testAccNetworkAssociationConfig_twoSecurityGroups(rName string) string {
...
func testAccNetworkAssociationConfig_oneSecurityGroup(rName string) string {
	return acctest.ConfigCompose(testAccClientVPNNetworkAssociationConfigBase(rName), fmt.Sprintf(`
resource "aws_ec2_client_vpn_network_association" "test" {
  client_vpn_endpoint_id = aws_ec2_client_vpn_endpoint.test.id
  subnet_id              = aws_subnet.test1.id
...
func testAccNetworkAssociationConfig_twoSecurityGroupsOnEndpoint(rName string) string {
	return acctest.ConfigCompose(testAccEndpointConfig_securityGroups(rName, 2), `
resource "aws_ec2_client_vpn_network_association" "test" {
  client_vpn_endpoint_id = aws_ec2_client_vpn_endpoint.test.id
