		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(resourceNames[0], "subnet_id", subnetResourceNames[0], names.AttrID),
					resource.TestCheckResourceAttrPair(resourceNames[1], "subnet_id", subnetResourceNames[1], names.AttrID),
