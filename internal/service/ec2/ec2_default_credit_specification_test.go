		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckDefaultCreditSpecificationExists(ctx, t, resourceName, &defaultcreditspecification),
...
func testAccCheckDefaultCreditSpecificationExists(ctx context.Context, t *testing.T, n string, v *awstypes.InstanceFamilyCreditSpecification) resource.TestCheckFunc {
