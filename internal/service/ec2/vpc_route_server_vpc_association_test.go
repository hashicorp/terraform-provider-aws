...
func TestAccVPCRouteServerVPCAssociation_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckVPCRouteServerVPCAssociationDestroy(ctx, t),
		Steps: []resource.TestStep{
			{
				Config: testAccVPCRouteServerVPCAssociationConfig_basic(rName, rAsn),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckVPCRouteServerVPCAssociationExists(ctx, t, resourceName, &v),
				),
			},
			{
...
func testAccCheckVPCRouteServerVPCAssociationDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
...
func testAccCheckVPCRouteServerVPCAssociationExists(ctx context.Context, t *testing.T, n string, v *awstypes.RouteServerAssociation) resource.TestCheckFunc {
	return func(s *terraform.State) error {
