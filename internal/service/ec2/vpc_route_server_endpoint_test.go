...
func TestAccVPCRouteServerEndpoint_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		CheckDestroy:             testAccCheckVPCRouteServerEndpointDestroy(ctx, t),
		Steps: []resource.TestStep{
			{
				Config: testAccVPCRouteServerEndpointConfig_basic(rName, rAsn),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckVPCRouteServerEndpointExists(ctx, t, resourceName, &v),
				),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckVPCRouteServerEndpointExists(ctx, t, resourceName, &v),
					acctest.CheckFrameworkResourceDisappears(ctx, t, tfec2.ResourceVPCRouteServerEndpoint, resourceName),
				),
...
func testAccCheckVPCRouteServerEndpointDestroy(ctx context.Context, t *testing.T) resource.TestCheckFunc {
...
func testAccCheckVPCRouteServerEndpointExists(ctx context.Context, t *testing.T, n string, v *awstypes.RouteServerEndpoint) resource.TestCheckFunc {
	return func(s *terraform.State) error {
