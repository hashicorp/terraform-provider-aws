...
func (p *servicePackage) NewConn(ctx context.Context, sess *session_sdkv1.Session) (*ec2_sdkv1.EC2, error) {
	return ec2_sdkv1.New(sess.Copy(&aws_sdkv1.Config{Endpoint: aws_sdkv1.String(p.endpoint)})), nil
}

// NewClient returns a new AWS SDK for Go v2 client for this service package's AWS API.
func (p *servicePackage) NewClient(ctx context.Context, cfg aws_sdkv2.Config) (*ec2_sdkv2.Client, error) {
	return ec2_sdkv2.NewFromConfig(cfg, func(o *ec2_sdkv2.Options) {
		if p.endpoint != "" {
			o.EndpointResolver = ec2_sdkv2.EndpointResolverFromURL(p.endpoint)
		}
	}), nil
}
