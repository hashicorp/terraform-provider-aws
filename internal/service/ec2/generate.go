...
//go:generate go run ../../generate/listpages/main.go -ListOps=DescribeApplicationStatusCheckAssociations,DescribeApplicationStatusChecks,DescribeServiceLinkVirtualInterfaces,DescribeSpotFleetInstances,DescribeSpotFleetRequestHistory,DescribeTransitGatewayMeteringPolicies,DescribeVpcBlockPublicAccessExclusions,DescribeVpcEndpointAssociations,DescribeVpcEndpointServices,GetSubnetCidrReservations,GetTransitGatewayMeteringPolicyEntries
