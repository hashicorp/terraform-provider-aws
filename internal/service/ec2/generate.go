...
//go:generate go run ../../generate/listpages/main.go -ListOps=DescribeServiceLinkVirtualInterfaces,DescribeSpotFleetInstances,DescribeSpotFleetRequestHistory,DescribeTransitGatewayMeteringPolicies,DescribeVpcBlockPublicAccessExclusions,DescribeVpcEndpointAssociations,DescribeVpcEndpointServices,GetSubnetCidrReservations,GetTransitGatewayMeteringPolicyEntries,GetTransitGatewayPolicyTableEntries
