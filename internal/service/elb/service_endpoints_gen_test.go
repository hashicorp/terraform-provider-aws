...
import (
	...
	elb_sdkv1 "github.com/aws/aws-sdk-go-v2/service/elasticloadbalancing"
...
func defaultEndpoint(region string) (url.URL, error) {
	...
	ep, err := r.EndpointFor(elb_sdkv1.EndpointsID, region)
	if err != nil {
		return url.URL{}, err
	}
...
func defaultFIPSEndpoint(region string) (url.URL, error) {
	...
	ep, err := r.EndpointFor(elb_sdkv1.EndpointsID, region, func(opt *endpoints.Options) {
...
func callService(ctx context.Context, t *testing.T, meta *conns.AWSClient) apiCallParams {
	...
	req, _ := client.DescribeLoadBalancersRequest(&elb_sdkv1.DescribeLoadBalancersInput{})
