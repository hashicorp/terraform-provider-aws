...
type AWSClient struct {
	...
	appconfigClient lazyClient[*appconfig_sdkv2.Client]
...
func (client *AWSClient) AppConfigClient(context.Context) *appconfig_sdkv2.Client {
	return client.appconfigClient.Client()
}
