...
func Provider() *schema.Provider {
	...
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"aws_elb_lb":              elb.DataSourceLoadBalancer(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aws_elb_lb":                              elb.ResourceLoadBalancer(),
			"aws_elb_lb_attachment":                   elb.ResourceAttachment(),
			"aws_elb_lb_backend_server_policy":        elb.ResourceBackendServerPolicy(),
			"aws_elb_lb_cookie_stickiness_policy":     elb.ResourceCookieStickinessPolicy(),
			"aws_elb_lb_listener_policy":              elb.ResourceListenerPolicy(),
			"aws_elb_lb_policy":                       elb.ResourcePolicy(),
