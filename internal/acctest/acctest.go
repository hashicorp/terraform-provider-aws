...
func ProtoV5FactoriesPlusProvidersAlternatePlusProvidersThird(ctx context.Context, t *testing.T, providers *[]*schema.Provider) map[string]func() (tfprotov5.ProviderServer, error) {
