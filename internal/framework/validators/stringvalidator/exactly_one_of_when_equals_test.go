...
func TestExactlyOneOfWhenEquals(t *testing.T) {
	t.Parallel()
	...
	testCases := map[string]testCase{
		...
		"self-equals-multiple-targets-one-null": {
			configValue: types.StringValue("A"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "A", "value", nil) },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   0,
		},
		"self-equals-multiple-targets-other-null": {
			configValue: types.StringValue("A"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "A", nil, "value") },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   0,
		},
		"self-equals-multiple-targets-all-null": {
			configValue: types.StringValue("A"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "A", nil, nil) },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   1,
		},
		"self-equals-multiple-targets-all-set": {
			configValue: types.StringValue("A"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "A", "valueA", "valueB") },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   1,
		},
		"self-equals-multiple-targets-one-unknown-other-null": {
			configValue: types.StringValue("A"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "A", tftypes.UnknownValue, nil) },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   0,
		},
		"self-equals-multiple-targets-one-null-other-unknown": {
			configValue: types.StringValue("A"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "A", nil, tftypes.UnknownValue) },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   0,
		},
		"self-equals-multiple-targets-all-unknown": {
			configValue: types.StringValue("A"),
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			tfstringvalidator.ExactlyOneOfWhenEquals("A", tc.expressions...).ValidateString(t.Context(), request, &response)
