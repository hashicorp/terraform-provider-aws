...
func TestExactlyOneOfWhenNotEquals(t *testing.T) {
	t.Parallel()
	...
	testCases := map[string]testCase{
		...
		"self-not-equals-multiple-targets-one-null": {
			configValue: types.StringValue("B"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "B", "value", nil) },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   0,
		},
		"self-not-equals-multiple-targets-other-null": {
			configValue: types.StringValue("B"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "B", nil, "value") },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   0,
		},
		"self-not-equals-multiple-targets-all-null": {
			configValue: types.StringValue("B"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "B", nil, nil) },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   1,
		},
		"self-not-equals-multiple-targets-all-set": {
			configValue: types.StringValue("B"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "B", "valueA", "valueB") },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   1,
		},
		"self-not-equals-multiple-targets-one-unknown-other-null": {
			configValue: types.StringValue("B"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "B", tftypes.UnknownValue, nil) },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   0,
		},
		"self-not-equals-multiple-targets-one-null-other-unknown": {
			configValue: types.StringValue("B"),
			config:      func(t *testing.T) tfsdk.Config { return testConfig(t, "B", nil, tftypes.UnknownValue) },
			expressions: []path.Expression{path.MatchRoot("a"), path.MatchRoot("b")},
			expErrors:   0,
		},
		"self-not-equals-multiple-targets-all-unknown": {
			configValue: types.StringValue("B"),
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			tfstringvalidator.ExactlyOneOfWhenNotEquals("A", tc.expressions...).ValidateString(t.Context(), request, &response)
