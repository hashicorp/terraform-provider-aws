...
func TestARNValidateAttribute(t *testing.T) {
	...
	tests := map[string]testCase{
		...
		"valid arn": {
			val: fwtypes.ARNValueMust("arn:aws:rds:us-east-1:123456789012:db:test"), // lintignore:AWSAT003,AWSAT005
		},
		// TODO: merging of ARNValue/ARNValueMust needs to happen first
		// "invalid arn": {
		// 	val:         fwtypes.ARNValueMust("not ok"), // lintignore:AWSAT003,AWSAT005
		// 	expectError: true,
		// },
	}
