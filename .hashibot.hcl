poll "closed_issue_locker" "locker" {
  ...
  message = <<-EOF
    ...
    If you feel this issue should be reopened, we encourage creating a new issue linking back to this one for added context. If you feel I made an error 🤖 🙉 , please reach out to my human friends 👉  team-terraform-aws@hashicorp.com. Thanks!
  EOF
}
