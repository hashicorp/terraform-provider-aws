...
val services = mapOf(
    ...
    "ec2" to ServiceSpec("EC2 (Elastic Compute Cloud)", vpcLock = true, patternOverride = "TestAccEC2(?:[^E]|E[^B]|EB[^S])*$"),
    "ec2ebs" to ServiceSpec("EBS (EC2)"),
    "ec2outposts" to ServiceSpec("Outposts (EC2)"),
    ...
    "ipam" to ServiceSpec("VPC IPAM (IP Address Manager)"),
    ...
    "verifiedaccess" to ServiceSpec("Verified Access"),
    "verifiedpermissions" to ServiceSpec("Verified Permissions"),
    "vpc" to ServiceSpec("VPC (Virtual Private Cloud)"),
    "vpclattice" to ServiceSpec("VPC Lattice"),
    "vpnclient" to ServiceSpec("VPN (Client)"),
    "vpnsite" to ServiceSpec("VPN (Site-to-Site)"),
    ...
    "wavelength" to ServiceSpec("Wavelength"),
