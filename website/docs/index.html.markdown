...
* `skip_requesting_account_id` - (Optional) Skip requesting the account
  ...
  the following:
    ...
    - [`aws_cognitoidentity_pool` resource](/docs/providers/aws/r/cognito_identity_pool.html)
    ...
    - [`aws_directconnect_connection` resource](/docs/providers/aws/r/dx_connection.html)
    - [`aws_directconnect_hosted_private_virtual_interface_accepter` resource](/docs/providers/aws/r/dx_hosted_private_virtual_interface_accepter.html)
    - [`aws_directconnect_hosted_private_virtual_interface` resource](/docs/providers/aws/r/dx_hosted_private_virtual_interface.html)
    - [`aws_directconnect_hosted_public_virtual_interface_accepter` resource](/docs/providers/aws/r/dx_hosted_public_virtual_interface_accepter.html)
    - [`aws_directconnect_hosted_public_virtual_interface` resource](/docs/providers/aws/r/dx_hosted_public_virtual_interface.html)
    - [`aws_directconnect_hosted_transit_virtual_interface_accepter` resource](/docs/providers/aws/r/dx_hosted_transit_virtual_interface_accepter.html)
    - [`aws_directconnect_hosted_transit_virtual_interface` resource](/docs/providers/aws/r/dx_hosted_transit_virtual_interface.html)
    - [`aws_directconnect_lag` resource](/docs/providers/aws/r/dx_lag.html)
    - [`aws_directconnect_private_virtual_interface` resource](/docs/providers/aws/r/dx_private_virtual_interface.html)
    - [`aws_directconnect_public_virtual_interface` resource](/docs/providers/aws/r/dx_public_virtual_interface.html)
    - [`aws_directconnect_transit_virtual_interface` resource](/docs/providers/aws/r/dx_transit_virtual_interface.html)
