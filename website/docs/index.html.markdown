...
* `skip_requesting_account_id` - (Optional) Skip requesting the account
  ...
  - [`aws_ebs_snapshot` data source](/docs/providers/aws/d/ebs_snapshot.html)
  - [`aws_ebs_snapshot` resource](/docs/providers/aws/r/ebs_snapshot.html)    
  - [`aws_ebs_snapshot_copy` resource](/docs/providers/aws/r/ebs_snapshot_copy.html)    
