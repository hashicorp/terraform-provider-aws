...
* `skip_requesting_account_id` - (Optional) Whether to skip requesting the account ID.  Useful for AWS API implementations that do not have the IAM, STS API, or metadata API.  When set to `true` and not determined previously, returns an empty account ID when manually constructing ARN attributes with the following:
    - [`aws_api_gateway_deployment` resource](/docs/providers/aws/r/apigateway_deployment.html)
    - [`aws_api_gateway_rest_api` resource](/docs/providers/aws/r/apigateway_rest_api.html)
    - [`aws_api_gateway_stage` resource](/docs/providers/aws/r/apigateway_stage.html)
    ...
    - [`aws_codedeploy_app` resource](/docs/providers/aws/r/deploy_app.html)
    - [`aws_codedeploy_deployment_group` resource](/docs/providers/aws/r/deploy_deployment_group.html)
    - [`aws_cognito_identity_pool` resource](/docs/providers/aws/r/cognitoidentity_pool.html)
    - [`aws_cognito_user_pools` data source](/docs/providers/aws/d/cognitoidp_user_pools.html)
    - [`aws_default_vpc_dhcp_options`](/docs/providers/aws/r/vpc_default_vpc_dhcp_options.html)
    ...
    - [`aws_dx_connection` resource](/docs/providers/aws/r/directconnect_connection.html)
    - [`aws_dx_hosted_private_virtual_interface_accepter` resource](/docs/providers/aws/r/directconnect_hosted_private_virtual_interface_accepter.html)
    - [`aws_dx_hosted_private_virtual_interface` resource](/docs/providers/aws/r/directconnect_hosted_private_virtual_interface.html)
    - [`aws_dx_hosted_public_virtual_interface_accepter` resource](/docs/providers/aws/r/directconnect_hosted_public_virtual_interface_accepter.html)
    - [`aws_dx_hosted_public_virtual_interface` resource](/docs/providers/aws/r/directconnect_hosted_public_virtual_interface.html)
    - [`aws_dx_hosted_transit_virtual_interface_accepter` resource](/docs/providers/aws/r/directconnect_hosted_transit_virtual_interface_accepter.html)
    - [`aws_dx_hosted_transit_virtual_interface` resource](/docs/providers/aws/r/directconnect_hosted_transit_virtual_interface.html)
    - [`aws_dx_lag` resource](/docs/providers/aws/r/directconnect_lag.html)
    - [`aws_dx_private_virtual_interface` resource](/docs/providers/aws/r/directconnect_private_virtual_interface.html)
    - [`aws_dx_public_virtual_interface` resource](/docs/providers/aws/r/directconnect_public_virtual_interface.html)
    - [`aws_dx_transit_virtual_interface` resource](/docs/providers/aws/r/directconnect_transit_virtual_interface.html)
    - [`aws_ebs_volume` data source](/docs/providers/aws/d/ec2ebs_volume.html)
    - [`aws_ec2_client_vpn_endpoint` resource](/docs/providers/aws/r/vpnclient_endpoint.html)
    - [`aws_ec2_traffic_mirror_filter` resource](/docs/providers/aws/r/vpc_traffic_mirror_filter.html)
    - [`aws_ec2_traffic_mirror_filter_rule` resource](/docs/providers/aws/r/vpc_traffic_mirror_filter_rule.html)
    - [`aws_ec2_traffic_mirror_session` resource](/docs/providers/aws/r/vpc_traffic_mirror_session.html)
    - [`aws_ec2_traffic_mirror_target` resource](/docs/providers/aws/r/vpc_traffic_mirror_target.html)
    - [`aws_ec2_transit_gateway_route_table` data source](/docs/providers/aws/d/transitgateway_route_table.html)
    - [`aws_ec2_transit_gateway_route_table` resource](/docs/providers/aws/r/transitgateway_route_table.html)
    ...
    - [`aws_customer_gateway` data source](/docs/providers/aws/d/vpnsite_customer_gateway.html)
    - [`aws_customer_gateway` resource](/docs/providers/aws/r/vpnsite_customer_gateway.html)
    ...
    - [`aws_flow_log` resource](/docs/providers/aws/r/vpc_flow_log.html)
    ...
    - [`aws_instance` data source](/docs/providers/aws/d/ec2_instance.html)
    - [`aws_instance` resource](/docs/providers/aws/r/ec2_instance.html)
    - [`aws_key_pair` resource](/docs/providers/aws/r/ec2_key_pair.html)
    - [`aws_launch_template` data source](/docs/providers/aws/d/ec2_launch_template.html)
    - [`aws_launch_template` resource](/docs/providers/aws/r/ec2_launch_template.html)
    - [`aws_placement_group` resource](/docs/providers/aws/r/ec2_placement_group.html)
    ...
    - [`aws_s3_account_public_access_block` resource](/docs/providers/aws/r/s3control_account_public_access_block.html)
    ...
    - [`aws_vpn_connection` resource](/docs/providers/aws/r/vpnsite_connection.html)
    - [`aws_vpn_gateway` data source](/docs/providers/aws/d/vpnsite_gateway.html)
    - [`aws_vpn_gateway` resource](/docs/providers/aws/r/vpnsite_gateway.html)
