...
- `inference_profile_summaries` - List of inference profile summary objects. See [`inference_profile_summaries` Block](#inference_profile_summaries-block).

### `inference_profile_summaries` Block
