...
* `schema` - Object containing the following attributes to describe the schema of the table.
    * `composite_partition_key` - Object containing the attributes to describe a composite partition key for the table.
        * `enforcement_in_record` - Level of enforcement for the specification of a dimension key in ingested records.
