...
* `account_id` - (Optional) AWS account ID of the S3 Multi-Region Access Point. Defaults to automatically determined account ID of the Terraform AWS provider.
...
* `bucket_account_id` - AWS account ID that owns the bucket.
