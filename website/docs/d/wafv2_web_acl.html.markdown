...
* `name` - (Optional) Name of the WAFv2 Web ACL. Required if `resource_arn` is not provided.
* `resource_arn` - (Optional) Name of a resource associated with a WAF. Required if `name` is not provided.
