...
* `source_endpoint_arn` - ARN string that uniquely identifies the source endpoint.
...
* `target_endpoint_arn` - ARN string that uniquely identifies the target endpoint.
