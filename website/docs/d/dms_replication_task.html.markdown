...
* `source_endpoint_arn` - The ARN string that uniquely identifies the source endpoint.
...
* `target_endpoint_arn` - The ARN string that uniquely identifies the target endpoint.
* `replication_task_arn` - The ARN for the replication task.
