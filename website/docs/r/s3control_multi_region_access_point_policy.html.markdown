...
* `details` - (Required) Configuration block containing details about the policy for the Multi-Region Access Point. See [`details` Block](#details-block) below for more details
