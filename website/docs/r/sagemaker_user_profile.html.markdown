...
* `default_resource_spec` - (Optional) The default instance type and the ARN of the SageMaker AI image created on the instance. see [Default Resource Spec](#default_resource_spec) below.
