...
* `vpc_id` - (Optional) The VPC ID to create in.  See the [aws_internet_gateway_attachment](vpc_internet_gateway_attachment.html) resource for an alternate way to attach an Internet Gateway to a VPC.
