...
* `s3_storage_class` - (Optional) Configuration block containing information about S3 storage class.[valid values](https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html#using-storage-classes)  
