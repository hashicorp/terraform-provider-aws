...
* `consumer_arn` - (Required) The ARN for the geofence collection to be associated to tracker resource. Used when you need to specify a resource across all AWS.
