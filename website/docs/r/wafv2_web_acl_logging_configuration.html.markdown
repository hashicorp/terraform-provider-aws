...
* `log_destination_configs` - (Required) The Amazon Kinesis Data Firehose Amazon Resource Name (ARNs), S3 or Cloudwatch Logs groups(ARNs) that you want to associate with the web ACL. 
