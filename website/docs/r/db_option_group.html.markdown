...
* `engine_name` - (Required) Name of the engine that this option group should be associated with.
* `major_engine_version` - (Required) Major version of the engine that this option group should be associated with.
...
* `option` - (Optional) Options to apply. See [`option` Block](#option-block) below for more details.
...
* `option_settings` - (Optional) Option settings to apply. See [`option_settings` Block](#option_settings-block) below for more details.
