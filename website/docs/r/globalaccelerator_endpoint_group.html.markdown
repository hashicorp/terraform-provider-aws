...
**Note:** when client IP address preservation is enabled, the Global Accelerator service creates a security group that is not deleted when the accelerator is deleted.
