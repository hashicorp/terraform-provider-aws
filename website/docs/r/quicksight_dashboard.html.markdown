...
In Terraform v1.5.0 and later, use an `import` block to import a QuickSight Dashboard using the AWS account ID and dashboard ID separated by a comma (`,`). For example:
