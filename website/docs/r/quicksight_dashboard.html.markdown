...
* `version_description` - (Required) Description of the current dashboard version being created or updated.

The following arguments are optional:

* `aws_account_id` - (Optional, Forces new resource) AWS account ID. Defaults to automatically determined account ID of the Terraform AWS provider.
* `dashboard_publish_options` - (Optional) Options for publishing the dashboard. See [`dashboard_publish_options` Block](#dashboard_publish_options-block) below.
* `definition` - (Optional) Dashboard definition. Only one of `definition` or `source_entity` should be configured. See [`definition` Block](#definition-block) below.
* `parameters` - (Optional) Parameters for the creation of the dashboard, which you want to use to override the default settings. See [`parameters` Block](#parameters-block) below.
* `permissions` - (Optional) Set of resource permissions on the dashboard. Maximum of 64 items. See [`permissions` Block](#permissions-block) below.
* `region` - (Optional) Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
* `source_entity` - (Optional) Entity that you are using as a source when you create the dashboard (template). Only one of `definition` or `source_entity` should be configured. See [`source_entity` Block](#source_entity-block) below.
...
* `availability_status` - (Optional) Availability status.
...
* `ad_hoc_filtering_option` - (Optional) Ad hoc filtering option. See [`ad_hoc_filtering_option` Block](#ad_hoc_filtering_option-block) below.
* `data_point_drill_up_down_option` - (Optional) Data point drill up down option. See [`data_point_drill_up_down_option` Block](#data_point_drill_up_down_option-block) below.
* `data_point_menu_label_option` - (Optional) Data point menu label option. See [`data_point_menu_label_option` Block](#data_point_menu_label_option-block) below.
* `data_point_tooltip_option` - (Optional) Data point tooltip option. See [`data_point_tooltip_option` Block](#data_point_tooltip_option-block) below.
* `export_to_csv_option` - (Optional) Export to CSV option. See [`export_to_csv_option` Block](#export_to_csv_option-block) below.
* `export_with_hidden_fields_option` - (Optional) Export with hidden fields option. See [`export_with_hidden_fields_option` Block](#export_with_hidden_fields_option-block) below.
* `sheet_controls_option` - (Optional) Sheet controls option. See [`sheet_controls_option` Block](#sheet_controls_option-block) below.
* `sheet_layout_element_maximization_option` - (Optional) Sheet layout element maximization option. See [`sheet_layout_element_maximization_option` Block](#sheet_layout_element_maximization_option-block) below.
* `visual_axis_sort_option` - (Optional) Visual axis sort option. See [`visual_axis_sort_option` Block](#visual_axis_sort_option-block) below.
* `visual_menu_option` - (Optional) Visual menu option. See [`visual_menu_option` Block](#visual_menu_option-block) below.
...
* `visibility_state` - (Optional) Visibility state.
