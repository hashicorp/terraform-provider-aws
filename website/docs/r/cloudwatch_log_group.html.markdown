...
* `skip_existing` - (Optional) Set to true if you wish to skip creating this resource if a log group with the same name already exists, and instead do an update.
