...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import DataZone Project using the `example_id_arg`. For example:
...
Using `terraform import`, import DataZone Project using the `example_id_arg`. For example:

```console
% terraform import aws_datazone_project.example project-id-12345678
```
