...
In Terraform v1.5.0 and later, use an `import` block to import  Route 53 Resolver DNS Firewall domain lists using the Route 53 Resolver DNS Firewall domain list ID. For example:
