...
layout: "aws"
page_title: "AWS: aws_directconnect_hosted_transit_virtual_interface"
description: |-
  Provides a Direct Connect hosted transit virtual interface resource.
---

# Resource: aws_directconnect_hosted_transit_virtual_interface
...
```terraform
resource "aws_directconnect_hosted_transit_virtual_interface" "example" {
...
`aws_directconnect_hosted_transit_virtual_interface` provides the following
...
```
$ terraform import aws_directconnect_hosted_transit_virtual_interface.test dxvif-33cc44dd
```
