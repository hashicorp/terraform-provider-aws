...
* `outpost_arn` - (Optional) The ARN of the Outpost on which to create the Capacity Reservation.
* `placement_group_arn` - (Optional) The ARN of the cluster placement group in which to create the Capacity Reservation.
