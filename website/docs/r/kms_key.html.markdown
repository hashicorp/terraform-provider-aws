...
* `enable_key_rotation` - (Optional) Specifies whether [key rotation](https://docs.aws.amazon.com/kms/latest/developerguide/rotate-keys.html) is enabled. Defaults to `false`.
