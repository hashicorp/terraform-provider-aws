...
layout: "aws"
page_title: "AWS: aws_directconnect_gateway_association_proposal"
description: |-
...
Manages a Direct Connect Gateway Association Proposal, typically for enabling cross-account associations. For single account associations, see the [`aws_directconnect_gateway_association` resource](/docs/providers/aws/r/dx_gateway_association.html).
...
```
$ terraform import aws_directconnect_gateway_association_proposal.example ac90e981-b718-4364-872d-65478c84fafe
```

or

```
$ terraform import aws_directconnect_gateway_association_proposal.example ac90e981-b718-4364-872d-65478c84fafe/abcd1234-dcba-5678-be23-cdef9876ab45/vgw-12345678
```

The latter case is useful when a previous proposal has been accepted and deleted by AWS.
The `aws_directconnect_gateway_association_proposal` resource will then represent a pseudo-proposal for the same Direct Connect Gateway and associated gateway.
