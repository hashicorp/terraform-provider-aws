...
* `grafana_version` - (Optional) Specifies the version of Grafana to support in the new workspace. Supported values are 8.4 and 9.4. If not specified, will use the 8.4.
