...
```terraform
resource "aws_codecatalyst_devenvironment" "example" {
}
```
...
* `arn` - ARN of the Devenvironment. Do not begin the description with "An", "The", "Defines", "Indicates", or "Specifies," as these are verbose. In other words, "Indicates the amount of storage," can be rewritten as "Amount of storage," without losing any information.
