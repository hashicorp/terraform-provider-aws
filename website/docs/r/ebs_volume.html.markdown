...
~> **NOTE:** When changing the `size`, `iops` or `type` of an instance, there are [considerations](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/considerations.html) to be aware of.
