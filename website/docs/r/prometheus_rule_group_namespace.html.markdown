...
* `name` - (Required) Name of the rule group namespace.
...
* `arn` - ARN of the rule group namespace.
...
import {
  ...
  identity = {
    "arn" = "arn:aws:aps:us-west-2:123456789012:rulegroupsnamespace/IDstring/namespace_name"
  }
}
