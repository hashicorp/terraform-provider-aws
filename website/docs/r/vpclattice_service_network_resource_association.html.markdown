...
The `dns_entry` block exports the following attributes:

* `domain_name` - Domain name of the association in the service network.
* `hosted_zone_id` - ID of the hosted zone containing the domain name.
