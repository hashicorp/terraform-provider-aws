...
* `data_source_arn` - (Optional) The ARN of the OpenSearch domain or collection. Must be between 20 and 2048 characters.
...
* `iam_identity_center_instance_arn` - (Optional) The ARN of the IAM Identity Center instance. Must be between 20 and 2048 characters.
...
* `arn` - The ARN of the OpenSearch application.
