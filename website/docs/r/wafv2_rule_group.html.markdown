...
* `challenge_config` - (Optional) Specifies how AWS WAF should handle Challenge evaluations. See [Challenge Configuration](#challenge-configuration) below for details.
