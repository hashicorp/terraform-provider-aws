...
* `managed_policy_arn` - (Required, Forces new resource) The IAM managed policy ARN to be attached to the Permission Set.
...
* `id` - The ARNs of the Managed Policy, Permission Set, and SSO Instance, separated by a comma (`,`).
