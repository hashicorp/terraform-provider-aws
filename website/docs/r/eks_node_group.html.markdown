...
* `node_group_name` – (Optional) Name of the EKS Node Group. By default generated by Terraform.
* `node_group_name_prefix` - (Optional) Creates a unique name beginning with the specified
  prefix. Conflicts with `node_group_name`.
