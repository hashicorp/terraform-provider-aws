...
* `resource_identifier` - (Optional) A friendly name for the resource identifier at the end of the ReplicationTaskArn response parameter that is returned in the created ReplicationTask object.
