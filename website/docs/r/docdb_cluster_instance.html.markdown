...
* `certificate_rotation_restart` - (Optional) Specifies whether the DB instance is restarted when you rotate your SSL/TLS certificate. By default, the DB instance is restarted when you rotate your SSL/TLS certificate. The certificate is not updated until the DB instance is restarted. If you are using SSL/TLS to connect to the DB instance, follow the instructions for your DB engine to rotate your SSL/TLS certificate. This parameter doesn't apply to RDS Custom DB instances.
