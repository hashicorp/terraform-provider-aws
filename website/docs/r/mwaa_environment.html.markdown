...
* `max_webservers` - (Optional) The maximum number of web servers that you want to run in your environment. Value need to be between `1` and `5`. Will be `2` by default, `1` in case of `environment_class = "mw1.micro"`.
...
* `min_webservers` - (Optional) The minimum number of web servers that you want to run in your environment. Value need to be between `1` and `5`. Will be `2` by default, `1` in case of `environment_class = "mw1.micro"`.
