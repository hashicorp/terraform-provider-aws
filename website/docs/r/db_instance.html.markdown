...
* `disable_master_user_password_rotation` - (Optional) Used together with manage_master_user_password. Set to true to disable password rotation in Secrets Manager. Default is `false`.
