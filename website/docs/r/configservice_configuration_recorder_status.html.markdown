...
~> **Note:** Starting Configuration Recorder requires a [Delivery Channel](/docs/providers/aws/r/configservice_delivery_channel.html) to be present. Use of `depends_on` (as shown below) is recommended to avoid race conditions.
