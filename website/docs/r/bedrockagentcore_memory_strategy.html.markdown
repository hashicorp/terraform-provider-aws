...
* `memory_record_schema` - (Optional) Schema for metadata fields on records generated by this strategy. Valid for all strategy types. See [`memory_record_schema` Block](#memory_record_schema-block) below.
...
* `metadata_schema` - (Optional) List of metadata field definitions for records generated by this strategy. See [`metadata_schema` Block](#metadata_schema-block) below.
...
* `llm_extraction_config` - (Optional) Model-based extraction configuration. See [`llm_extraction_config` Block](#llm_extraction_config-block) below.
...
* `validation` - (Optional) Validation rules to constrain extracted values. See [`validation` Block](#validation-block) below.

### `validation` Block

Each `validation` block specifies exactly one of the following nested blocks:

* `number_validation` - (Optional) Validation for `NUMBER` fields. See [`number_validation` Block](#number_validation-block) below.
* `string_list_validation` - (Optional) Validation for `STRINGLIST` fields. See [`string_list_validation` Block](#string_list_validation-block) below.
* `string_validation` - (Optional) Validation for `STRING` fields. See [`string_validation` Block](#string_validation-block) below.
