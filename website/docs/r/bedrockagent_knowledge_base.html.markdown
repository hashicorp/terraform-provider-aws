...
import {
  ...
  id = "knowledge_base-id-12345678"
}
```

Using `terraform import`, import Agents for Amazon Bedrock Knowledge Base using the `example_id_arg`. For example:

```console
% terraform import aws_bedrockagent_knowledge_base.example knowledge_base-id-12345678
```
