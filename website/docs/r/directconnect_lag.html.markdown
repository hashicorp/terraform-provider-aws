...
Provides a Direct Connect LAG. Connections can be added to the LAG via the [`aws_dx_connection`](/docs/providers/aws/r/directconnect_connection.html) and [`aws_dx_connection_association`](/docs/providers/aws/r/directconnect_connection_association.html) resources.
