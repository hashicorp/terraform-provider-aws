...
* `key_prefix` - (Optional) Prefix value of the location within the bucket that you want the information to be published to.
...
* `stream_processor_arn` - (**Deprecated**) ARN of the Stream Processor. Use `arn` instead.
