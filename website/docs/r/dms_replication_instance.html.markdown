...
* `resource_identifier` - (Optional) A friendly name for the resource identifier at the end of the ReplicationInstanceArn response parameter that is returned in the created ReplicationInstance object.
