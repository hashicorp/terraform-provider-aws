...
~> **NOTE:** Creating an `aws_ebs_default_kms_key` resource does not enable default EBS encryption. Use the [`aws_ebs_encryption_by_default`](ec2ebs_encryption_by_default.html) to enable default EBS encryption.
