...
* `amazon_managed_kafka_config` - (Optional) Additional configuration block for Amazon Managed Kafka sources. Incompatible with "self_managed_event_source" and "self_managed_kafka_config". Detailed below.
...
* `self_managed_kafka_config` - (Optional) Additional configuration block for Self Managed Kafka sources. Incompatible with "event_source_arn" and "amazon_managed_kafka_config". Detailed below.
...
### amazon_managed_kafka_config Configuration Block
...
### self_managed_kafka_config Configuration Block
