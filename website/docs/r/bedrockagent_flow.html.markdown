...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import Bedrock Agents Flow using the `example_id_arg`. For example:
...
Using `terraform import`, import Bedrock Agents Flow using the `example_id_arg`. For example:
