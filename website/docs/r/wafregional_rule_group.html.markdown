...
* `rule_id` - (Required) The ID of a [rule](/docs/r/wafregional_rule.html)
* `type` - (Optional) The rule type, either [`REGULAR`](/docs/r/wafregional_rule.html), [`RATE_BASED`]((/docs/r/wafregional_rate_based_rule.html), or `GROUP`. Defaults to `REGULAR`.
