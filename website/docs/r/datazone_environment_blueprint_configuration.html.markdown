...
resource "aws_datazone_environment_blueprint_configuration" "example" {
  ...
  environment_blueprint_id = "bqeie8ctnion36" # DefaultDataLake
...
* `environment_blueprint_id` - (Required) ID of the Environment Blueprint. Two managed blueprints exist at present, DefaultDataLake with ID `bqeie8ctnion36` and DefaultDataWarehouse with ID `3h7p7srvxih55u`.
