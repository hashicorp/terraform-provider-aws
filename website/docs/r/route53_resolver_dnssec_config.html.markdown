...
* `resource_id` - (Required) The ID of the VPC that you're updating the DNSSEC validation status for.
...
* `owner_id` - The owner account ID of the VPC for a configuration for DNSSEC validation.
