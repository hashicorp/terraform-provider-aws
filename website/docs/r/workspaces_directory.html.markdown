...
* `certificate_based_auth_properties` - (Optional) Configuration of Certificate-Based Authentication (CBA) integration.
  Requires SAML authentication to be enabled. Defined below.
  Defined below.
