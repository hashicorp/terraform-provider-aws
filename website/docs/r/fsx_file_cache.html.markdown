...
This argument supports the following arguments:for `data_repository_association` configuration block:
...
This argument supports the following arguments:for `nfs` configuration block:
...
This argument supports the following arguments:for `lustre_configuration` configuration block:
...
This argument supports the following arguments:for `metadata_configuration` configuration block:
