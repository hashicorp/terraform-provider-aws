...
layout: "aws"
page_title: "AWS: aws_rekognition_stream _processor"
description: |-
...
--->`
# Resource: aws_rekognition_stream _processor
...
```terraform
resource "aws_rekognition_stream _processor" "example" {
}
```
...
```terraform
import {
  to = aws_rekognition_stream _processor.example
  id = "stream _processor-id-12345678"
}
```
...
```console
% terraform import aws_rekognition_stream _processor.example stream _processor-id-12345678
```
