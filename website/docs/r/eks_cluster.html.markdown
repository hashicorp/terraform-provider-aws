...
This argument supports the following arguments:in the `encryption_config` configuration block:
...
This argument supports the following arguments:in the `provider` configuration block:
...
This argument supports the following arguments:in the `kubernetes_network_config` configuration block:
...
This argument supports the following arguments:in the `outpost_config` configuration block:
...
This argument supports the following arguments:in the `control_plane_placement` configuration block:
