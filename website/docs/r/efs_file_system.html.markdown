...
system creation. By default generated by Terraform. See [Elastic File System](https://docs.aws.amazon.com/efs/latest/ug/)
...
* `dns_name` - The DNS name for the filesystem per [documented convention](https://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html).
