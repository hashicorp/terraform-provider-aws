...
* `resource_arn` - (Required, Forces new resource) The ARN of the rule group or firewall policy.

## Attribute Reference

This resource exports the following attributes in addition to the arguments above:

* `id` - The ARN of the rule group or firewall policy associated with the resource policy.
