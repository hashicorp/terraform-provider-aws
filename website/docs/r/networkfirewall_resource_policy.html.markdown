...
* `resource_arn` - (Required, Forces new resource) ARN of the rule group or firewall policy.

## Attribute Reference

This resource exports the following attributes in addition to the arguments above:

* `id` - ARN of the rule group or firewall policy associated with the resource policy.
