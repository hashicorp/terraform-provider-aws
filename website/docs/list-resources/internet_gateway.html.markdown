...
* `name` - (Required) Name of the filter. For a full reference of filter names, see [describe-internet-gateways in the AWS CLI reference](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-internet-gateways.html).
