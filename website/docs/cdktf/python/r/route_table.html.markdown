...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        RouteTable.generate_config_for_import(self, "publicRt", "rtb-4e616f6d69")
```
...
<!-- cache-key: cdktf-0.20.9 input-d300bb2babcdde7f3a257080c421d049a58a89200afecf3485288c3ad0d30c6d -->