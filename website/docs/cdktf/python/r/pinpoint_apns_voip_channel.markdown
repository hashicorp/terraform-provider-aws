...
#
from imports.aws.pinpoint_apns_voip_channel import PinpointApnsVoipChannel
from imports.aws.pinpoint_app import PinpointApp
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        app = PinpointApp(self, "app")
        PinpointApnsVoipChannel(self, "apns_voip",
...
<!-- cache-key: cdktf-0.18.0 input-0ffc83fe4540fc67436e7989e5cf3564705d88e89adc4f3fda68412be44cfc00 -->