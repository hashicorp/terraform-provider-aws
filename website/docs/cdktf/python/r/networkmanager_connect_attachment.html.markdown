...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        example = NetworkmanagerVpcAttachment(self, "example",
            ...
            subnet_arns=Token.as_list(property_access(aws_subnet_example, ["*", "arn"])),
...
<!-- cache-key: cdktf-0.17.1 input-aff96c8ae537cd62a917606111eb125059a122ec722bd3f330b4184ecaa33ba9 -->