...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        NetworkmanagerLinkAssociation.generate_config_for_import(self, "example", "global-network-0d47f6t230mz46dy4,link-444555aaabbb11223,device-07f6fd08867abc123")
```
...
<!-- cache-key: cdktf-0.20.8 input-40890ea635a372c98a61314c53c85c42d78dfac875eaa1ee3c91ed911965df30 -->