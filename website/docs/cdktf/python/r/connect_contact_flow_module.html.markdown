...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        ConnectContactFlowModule(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ConnectContactFlowModule.generate_config_for_import(self, "example", "f1288a1f-6193-445a-b47e-af739b2:c1d4e5f6-1b3c-1b3c-1b3c-c1d4e5f6c1d4e5")
```
...
<!-- cache-key: cdktf-0.20.9 input-fad5a83f3f5a5cf193df0637530e1bc1f6d891f07b57ab8518ef971ee9d23841 -->