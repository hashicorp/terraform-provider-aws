...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DbSnapshotCopy.generate_config_for_import(self, "example", "my-snapshot")
```
...
<!-- cache-key: cdktf-0.20.8 input-87679e3d8354206f97dd29326004a5f1a2bdfd8a1fdffc339cd45861c2e6ad96 -->