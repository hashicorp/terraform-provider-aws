...
#
from imports.aws.servicecatalog_constraint import ServicecatalogConstraint
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ServicecatalogConstraint(self, "example",
            description="Back off, man. I'm a scientist.",
            parameters=Token.as_string(
                Fn.jsonencode({
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ServicecatalogConstraint.generate_config_for_import(self, "example", "cons-nmdkb6cgxfcrs")
```
...
<!-- cache-key: cdktf-0.20.9 input-f391e00f1f29453b1e81c01e36db6ce37af9e3b44513a1ffefd379e9b7d4ba13 -->