...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53RecoveryreadinessCell.generate_config_for_import(self, "usWest2FailoverCell", "us-west-2-failover-cell")
```
...
<!-- cache-key: cdktf-0.20.1 input-d2ac826652336fbe8c626518574803e2477f46155743addd2076ff30e66c3364 -->