...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        SagemakerImage.generate_config_for_import(self, "testImage", "my-code-repo")
```
...
<!-- cache-key: cdktf-0.20.1 input-472a9b03f1ba8f793494df35ff1917699a39c258036a86d840cd026d9a0bfc60 -->