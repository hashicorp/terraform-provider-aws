...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        AppstreamImageBuilder.generate_config_for_import(self, "example", "imageBuilderExample")
```
...
<!-- cache-key: cdktf-0.20.1 input-e224096195102b3c0af9044d63f0d830019264e7ca702c4ea0f8e3d678b94b3a -->