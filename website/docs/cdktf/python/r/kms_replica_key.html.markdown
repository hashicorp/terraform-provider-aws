...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        KmsReplicaKey.generate_config_for_import(self, "example", "1234abcd-12ab-34cd-56ef-1234567890ab")
```
...
<!-- cache-key: cdktf-0.20.1 input-d9e0bf46edfbeab8b46e2d9e97a2d761d4db8938a03b29da3f959636cabf71c7 -->