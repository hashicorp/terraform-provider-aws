...
#
from imports.aws.opsworks_custom_layer import OpsworksCustomLayer
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        OpsworksCustomLayer(self, "custlayer",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        OpsworksCustomLayer.generate_config_for_import(self, "bar", "00000000-0000-0000-0000-000000000000")
```
...
<!-- cache-key: cdktf-0.20.1 input-8a4b8054a10e74606cd1ea0e8f3f2e390b16a4d6d2acbbb8ade4b0281ed80aa3 -->