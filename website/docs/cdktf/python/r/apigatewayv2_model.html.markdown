...
#
from imports.aws.apigatewayv2_model import Apigatewayv2Model
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Apigatewayv2Model(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Apigatewayv2Model.generate_config_for_import(self, "example", "aabbccddee/1122334")
```
