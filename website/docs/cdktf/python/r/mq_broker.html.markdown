...
#
from imports.aws.mq_broker import MqBroker
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        MqBroker(self, "example",
            broker_name="example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        MqBroker(self, "example_primary",
            ...
            security_groups=[Token.as_string(aws_security_group_example_primary.id)],
            user=[MqBrokerUser(
                password="MindTheGap",
                username="ExampleUser"
            ), MqBrokerUser(
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        MqBroker.generate_config_for_import(self, "example", "a1b2c3d4-d5f6-7777-8888-9999aaaabbbbcccc")
```
