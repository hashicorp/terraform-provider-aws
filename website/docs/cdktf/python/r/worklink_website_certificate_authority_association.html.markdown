...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        WorklinkWebsiteCertificateAuthorityAssociation.generate_config_for_import(self, "example", "arn:aws:worklink::123456789012:fleet/example,abcdefghijk")
```
...
<!-- cache-key: cdktf-0.20.9 input-1c77d09bf1fe3139ae62ef8fba5ba9b5bdbdd9cd32c1eafe3e14e9fd3498131b -->