...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        MedialiveMultiplex(self, "example",
            availability_zones=[
                Token.as_string(property_access(available.names, ["0"])),
                Token.as_string(property_access(available.names, ["1"]))
            ],
...
<!-- cache-key: cdktf-0.17.1 input-ef0b0248360f7c92f3d75bdb422730873d3e865bff521828049e013dc339473a -->