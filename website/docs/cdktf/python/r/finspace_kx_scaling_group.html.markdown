...
#
from imports.aws.finspace_kx_scaling_group import FinspaceKxScalingGroup
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        FinspaceKxScalingGroup(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        FinspaceKxScalingGroup.generate_config_for_import(self, "example", "n3ceo7wqxoxcti5tujqwzs,my-tf-kx-scalinggroup")
```
