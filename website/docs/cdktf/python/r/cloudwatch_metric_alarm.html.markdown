...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        CloudwatchMetricAlarm(self, "foobar",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        bat = AutoscalingPolicy(self, "bat",
        ...
        aws_cloudwatch_metric_alarm_bat = CloudwatchMetricAlarm(self, "bat_1",
        ...
        aws_cloudwatch_metric_alarm_bat.override_logical_id("bat")
```
    ...
    def __init__(self, scope, name):
        ...
        CloudwatchMetricAlarm(self, "foobar",
            ...
            metric_query=[CloudwatchMetricAlarmMetricQuery(
                ...
                id="e1",
                label="Error Rate",
                return_data=Token.as_boolean("true")
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CloudwatchMetricAlarm(self, "xx_anomaly_detection",
            alarm_description="This metric monitors ec2 cpu utilization",
            alarm_name="terraform-test-foobar",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CloudwatchMetricAlarm(self, "nlb_healthyhosts",
            actions_enabled=Token.as_boolean("true"),
            ...
            period=60,
            statistic="Average",
            threshold=logstash_servers_count.number_value
        )
```
