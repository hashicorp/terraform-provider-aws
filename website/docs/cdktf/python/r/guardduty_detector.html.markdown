...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        GuarddutyDetector.generate_config_for_import(self, "myDetector", "00b00fd5aecc0ab60a708659477e9617")
```
...
<!-- cache-key: cdktf-0.20.1 input-302ad3286e382870d4c5a91d3567a07ae8a6c0466169ed1648e2acc9f1c51eaf -->