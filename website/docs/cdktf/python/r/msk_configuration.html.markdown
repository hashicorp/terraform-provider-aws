...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        MskConfiguration.generate_config_for_import(self, "example", "arn:aws:kafka:us-west-2:123456789012:configuration/example/279c0212-d057-4dba-9aa9-1c4e5a25bfc7-3")
```
...
<!-- cache-key: cdktf-0.20.9 input-ffedd2e9eeefe3b9ec5b99c0db9745971668563dc15c5b00cae5765298088443 -->