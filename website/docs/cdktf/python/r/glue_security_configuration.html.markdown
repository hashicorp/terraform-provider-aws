...
#
from imports.aws.glue_security_configuration import GlueSecurityConfiguration
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        GlueSecurityConfiguration(self, "example",
            encryption_configuration=GlueSecurityConfigurationEncryptionConfiguration(
                ...
                s3_encryption=GlueSecurityConfigurationEncryptionConfigurationS3Encryption(
                    kms_key_arn=Token.as_string(data_aws_kms_key_example.arn),
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        GlueSecurityConfiguration.generate_config_for_import(self, "example", "example")
```
...
<!-- cache-key: cdktf-0.20.9 input-648d5a94dbcbfce0a30b8db8178f35b6d6f0e3b9f5501dfc1bc90378045104ee -->