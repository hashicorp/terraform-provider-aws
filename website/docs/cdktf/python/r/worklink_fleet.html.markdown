...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        WorklinkFleet.generate_config_for_import(self, "test", "arn:aws:worklink::123456789012:fleet/example")
```
...
<!-- cache-key: cdktf-0.20.1 input-e7ee1bb443346fba441c55fe6024eae415cbde38eca738fd5b316c9affc96fc9 -->