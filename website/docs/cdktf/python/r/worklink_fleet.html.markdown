    ...
    def __init__(self, scope, name):
        ...
        WorklinkFleet(self, "example",
            ...
            network=WorklinkFleetNetwork(
                ...
                subnet_ids=[Token.as_string(property_access(aws_subnet_test, ["*", "id"]))],
...
<!-- cache-key: cdktf-0.17.1 input-e7ee1bb443346fba441c55fe6024eae415cbde38eca738fd5b316c9affc96fc9 -->