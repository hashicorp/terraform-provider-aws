    ...
    def __init__(self, scope, name):
        ...
        Route53Record(self, "example",
            ...
            name=Token.as_string(
                property_access(example_for_each_iterator.value, ["name"])),
            records=[
                Token.as_string(
                    property_access(example_for_each_iterator.value, ["record"]))
            ],
            ttl=60,
            type=Token.as_string(
                property_access(example_for_each_iterator.value, ["type"])),
...
<!-- cache-key: cdktf-0.17.1 input-e4c3a7735ec99f4007d8e7e7e89139f9d730f0e5d51221b59505955d1de5da60 -->