        ...
        aws_route53_record_example = Route53Record(self, "example_1",
            alias=Route53RecordAlias(
                ...
                name=Token.as_string(
                    property_access(example.domain_name_configuration, ["0", "target_domain_name"
                    ])),
                zone_id=Token.as_string(
                    property_access(example.domain_name_configuration, ["0", "hosted_zone_id"
                    ]))
            ),
...
<!-- cache-key: cdktf-0.17.1 input-590fddf6e18ec896623edea239e232e92d9d62cdcbd1d648d652e4699c95dd9a -->