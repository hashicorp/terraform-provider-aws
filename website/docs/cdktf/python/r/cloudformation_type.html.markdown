...
#
from imports.aws.cloudformation_type import CloudformationType
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CloudformationType(self, "example",
            ...
            logging_config=CloudformationTypeLoggingConfig(
                ...
                log_role_arn=Token.as_string(aws_iam_role_example.arn)
            ),
            schema_handler_package="s3://${" + aws_s3_object_example.bucket + "}/${" + aws_s3_object_example.key + "}",
            type="RESOURCE",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CloudformationType.generate_config_for_import(self, "example", "arn:aws:cloudformation:us-east-1:123456789012:type/resource/ExampleCompany-ExampleService-ExampleType/1")
```
...
<!-- cache-key: cdktf-0.20.8 input-4738423c73768d212dce00b4674e015861f2836ad18ef9b55653e2e9fd2462e5 -->