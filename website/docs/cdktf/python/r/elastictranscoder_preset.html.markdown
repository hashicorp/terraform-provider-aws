...
#
from imports.aws.elastictranscoder_preset import ElastictranscoderPreset
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ElastictranscoderPreset(self, "bar",
            audio=ElastictranscoderPresetAudio(
                audio_packing_mode="SingleTrack",
                bit_rate=Token.as_string(96),
                channels=Token.as_string(2),
                codec="AAC",
                sample_rate=Token.as_string(44100)
            ),
            ...
            video=ElastictranscoderPresetVideo(
                ...
                fixed_gop="false",
                frame_rate="auto",
                keyframes_max_dist=Token.as_string(240),
                max_frame_rate="60",
                max_height="auto",
                max_width="auto",
                padding_policy="Pad",
            ...
            video_codec_options={
                ...
                "Level": "2.2",
                "MaxReferenceFrames": Token.as_string(3),
                "Profile": "main"
            },
            video_watermarks=[ElastictranscoderPresetVideoWatermarks(
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ElastictranscoderPreset.generate_config_for_import(self, "basicPreset", "1407981661351-cttk8b")
```
