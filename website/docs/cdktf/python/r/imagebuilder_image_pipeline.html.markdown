...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        example = ImagebuilderImageRecipe(self, "example",
        ...
        aws_imagebuilder_image_pipeline_example = ImagebuilderImagePipeline(self, "example_1",
            image_recipe_arn=example.arn,
        ...
        aws_imagebuilder_image_pipeline_example.override_logical_id("example")
```
