...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        CloudhsmV2Hsm(self, "cloudhsm_v2_hsm",
            ...
            subnet_id=Token.as_string(property_access(cluster.subnet_ids, ["0"]))
        )
```
...
<!-- cache-key: cdktf-0.17.1 input-3969951d1910a8cfdfc7ba1e038e8b5797479bc0a89a46b5174ec4142d750a5c -->