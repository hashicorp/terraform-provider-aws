...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        NetworkInterface(self, "test",
            attachment=[NetworkInterfaceAttachment(
                device_index=1,
                instance=Token.as_string(aws_instance_test.id)
            )
            ],
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        NetworkInterface.generate_config_for_import(self, "test", "eni-e5aa89a3")
```
...
<!-- cache-key: cdktf-0.20.9 input-7f2ff19c4ccb49477839bee2fe3fa02741d97eacf5edb9c2e7ff7560c3a15031 -->