...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        test = FsxWindowsFileSystem(self, "test",
            ...
            storage_capacity=32,
            subnet_ids=[Token.as_string(property_access(aws_subnet_test, ["0", "id"]))],
        ...
        aws_instance_test = Instance(self, "test_2",
            ...
            subnet_id=Token.as_string(property_access(aws_subnet_test, ["0", "id"])),
...
<!-- cache-key: cdktf-0.17.1 input-25ffcf0143f211628c624df50a48a4f56f62a6e23545b746731989404c66e06e -->