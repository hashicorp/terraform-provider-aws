...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        S3ObjectCopy(self, "test",
            bucket="destination_bucket",
            key="destination_key",
            override_provider=S3ObjectCopyOverrideProvider(
                default_tags=S3ObjectCopyOverrideProviderDefaultTags(
                    tags={}
                )
            ),
            source="source_bucket/source_key"
...
<!-- cache-key: cdktf-0.20.8 input-d2be2538c11fb87765411543de07456e8f074cdf723dc145ecbf9803faac0e96 -->