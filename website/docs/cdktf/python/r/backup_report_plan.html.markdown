...
#
from imports.aws.backup_report_plan import BackupReportPlan
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        BackupReportPlan(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        BackupReportPlan.generate_config_for_import(self, "test", "<id>")
```
...
<!-- cache-key: cdktf-0.20.9 input-bd959edfce1b301196f86382fc18f07f59bfcba90604113c6790f12cd75715da -->