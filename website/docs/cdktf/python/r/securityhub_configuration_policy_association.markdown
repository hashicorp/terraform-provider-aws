...
#
from imports.aws. import SecurityhubConfigurationPolicy, SecurityhubConfigurationPolicyAssociation
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        SecurityhubConfigurationPolicyAssociation(self, "account_example",
            policy_id=aws_securityhub_configuration_policy_example.id,
...
# See https://cdk.tf/provider-generation for more details.
#
from imports.aws. import SecurityhubConfigurationPolicyAssociation
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
