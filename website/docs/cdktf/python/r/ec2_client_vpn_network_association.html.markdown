...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Ec2ClientVpnNetworkAssociation.generate_config_for_import(self, "example", "cvpn-endpoint-0ac3a1abbccddd666,vpn-assoc-0b8db902465d069ad")
```
...
<!-- cache-key: cdktf-0.20.1 input-93b06b3eb31b248a508f1acf81dceb795b39cf3f2e929e8af4cfbaad6365e994 -->