...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Ec2ClientVpnNetworkAssociation.generate_config_for_import(self, "example", "cvpn-endpoint-0ac3a1abbccddd666,cvpn-assoc-0b8db902465d069ad")
```
...
<!-- cache-key: cdktf-0.20.9 input-3516daa1a8b964892b817b662d1092c9051df485ef6975797faf258ed31b7bb3 -->