...
from imports.aws.emr_instance_group import EmrInstanceGroup
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name, *, clusterId, instanceType):
        super().__init__(scope, name)
        EmrInstanceGroup(self, "task",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        EmrInstanceGroup.generate_config_for_import(self, "taskGroup", "j-123456ABCDEF/ig-15EK4O09RZLNR")
```
...
<!-- cache-key: cdktf-0.20.1 input-81ea0e37ef071af4b0b3288229252058d70fdfc3a60046cd4d509292a38b32f0 -->