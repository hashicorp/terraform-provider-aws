        ...
        AppconfigHostedConfigurationVersion(self, "example",
            ...
            content=Token.as_string(
                Fn.jsonencode({
                    ...
                    "values": {
                        "loggingenabled": {
                            "_variants": Fn.concat(["${[ for user_id in ${" + appcfg_enable_logging_user_ids.value + "} : { # Flat list of userIds\n            enabled = true,\n            name    = \"usersWithLoggingEnabled_${user_id}\",\n            rule    = \"(or (eq $userId \\\"${user_id}\\\"))\"\n          }]}", [{
                                "enabled": False,
                                "name": "Default"
                            }
                            ]
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        AppconfigHostedConfigurationVersion.generate_config_for_import(self, "example", "71abcde/11xxxxx/2")
```
...
<!-- cache-key: cdktf-0.20.8 input-3238e0ba03eb168243e9ebb7f2bbc40ef8fd9bc246ae641084e69aab438e47ae -->