...
from imports.aws.imagebuilder_lifecycle_policy import ImagebuilderLifecyclePolicy
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        ImagebuilderLifecyclePolicy(self, "example_4",
            ...
            name="name",
            policy_detail=[ImagebuilderLifecyclePolicyPolicyDetail(
                action=[ImagebuilderLifecyclePolicyPolicyDetailAction(
                    type="DELETE"
                )
                ],
                filter=[ImagebuilderLifecyclePolicyPolicyDetailFilter(
                    retain_at_least=10,
                    type="AGE",
                    unit="YEARS",
                    value=6
