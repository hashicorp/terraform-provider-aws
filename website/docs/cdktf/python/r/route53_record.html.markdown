...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_route53_record_example = Route53Record(self, "example_1",
            ...
            name="test.example.com",
            records=[
                Token.as_string(property_access(example.name_servers, ["0"])),
                Token.as_string(property_access(example.name_servers, ["1"])),
                Token.as_string(property_access(example.name_servers, ["2"])),
                Token.as_string(property_access(example.name_servers, ["3"]))
            ],
            ttl=172800,
            type="NS",
