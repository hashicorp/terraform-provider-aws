...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53Record.generate_config_for_import(self, "example", "Z4KAPRWWNC7JR_dev.example.com_NS")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53Record.generate_config_for_import(self, "example", "Z4KAPRWWNC7JR_dev.example.com_NS_dev")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53Record.generate_config_for_import(self, "example", "Z4KAPRWWNC7JR__NS")
```
