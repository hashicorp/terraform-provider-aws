    ...
    def __init__(self, scope, name):
        ...
        Route53Record(self, "www",
            geoproximity_routing_policy=Route53RecordGeoproximityRoutingPolicy(
                coordinates=[Route53RecordGeoproximityRoutingPolicyCoordinates(
                    latitude="49.22",
                    longitude="-74.01"
                )
                ]
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        main = GlobalacceleratorAccelerator(self, "main",
            enabled=True,
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_route53_record_example = Route53Record(self, "example_1",
            ...
            name="test.example.com",
            records=[
                Token.as_string(Fn.lookup_nested(example.name_servers, ["0"])),
                Token.as_string(Fn.lookup_nested(example.name_servers, ["1"])),
                Token.as_string(Fn.lookup_nested(example.name_servers, ["2"])),
                Token.as_string(Fn.lookup_nested(example.name_servers, ["3"]))
            ],
            ttl=172800,
            type="NS",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53Record.generate_config_for_import(self, "myrecord", "Z4KAPRWWNC7JR_dev.example.com_NS")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53Record.generate_config_for_import(self, "myrecord", "Z4KAPRWWNC7JR_dev.example.com_NS_dev")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53Record.generate_config_for_import(self, "myrecord", "Z4KAPRWWNC7JR__NS")
```
