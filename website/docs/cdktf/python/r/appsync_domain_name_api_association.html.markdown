...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        AppsyncDomainNameApiAssociation.generate_config_for_import(self, "example", "example.com")
```
...
<!-- cache-key: cdktf-0.20.9 input-20f8e537078df27312c2183f4ab0c0158ba5ec522ac3da6fb70fd599dad00b8f -->