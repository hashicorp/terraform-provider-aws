...
#
from imports.aws. import PrometheusScraper
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        PrometheusScraper(self, "example",
            destination=[{
                "amp": [{
                    "workspace_arn": aws_prometheus_workspace_example.arn
                }
                ]
            }
            ],
            ...
            source=[{
                "eks": [{
                    "cluster_arn": data_aws_eks_cluster_example.arn,
                    "subnet_ids": Fn.lookup_nested(data_aws_eks_cluster_example.vpc_config, ["0", "subnet_ids"
                    ])
                }
                ]
            }
...
<!-- cache-key: cdktf-0.20.0 input-23e61d8904e4b052740b6bfeb6844fd895e6c28ae89ebd0c2e5fce49746a5f97 -->