...
#
from imports.aws.datasync_location_nfs import DatasyncLocationNfs
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DatasyncLocationNfs(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DatasyncLocationNfs.generate_config_for_import(self, "example", "arn:aws:datasync:us-east-1:123456789012:location/loc-12345678901234567")
```
