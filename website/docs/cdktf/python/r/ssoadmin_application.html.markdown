...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        SsoadminApplication.generate_config_for_import(self, "example", "arn:aws:sso::123456789012:application/id-12345678")
```
...
<!-- cache-key: cdktf-0.20.8 input-e1e44450dc8d0416f422ef6457f09b628d3aac727334926f697a75b2e4bbdc43 -->