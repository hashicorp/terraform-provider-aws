...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        SignerSigningJob.generate_config_for_import(self, "testSignerSigningJob", "9ed7e5c3-b8d4-4da0-8459-44e0b068f7ee")
```
...
<!-- cache-key: cdktf-0.20.9 input-c1b438ff5be624709d7988f68eee2a0f8bb3759d4c25af0f1c443c2548e0904f -->