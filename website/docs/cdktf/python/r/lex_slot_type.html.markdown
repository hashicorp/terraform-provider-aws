...
#
from imports.aws.lex_slot_type import LexSlotType
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        LexSlotType(self, "flower_types",
            create_version=True,
            description="Types of flowers to order",
            enumeration_value=[LexSlotTypeEnumerationValue(
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        LexSlotType.generate_config_for_import(self, "flowerTypes", "FlowerTypes")
```
