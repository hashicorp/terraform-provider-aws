...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CeCostAllocationTag.generate_config_for_import(self, "example", "key")
```
...
<!-- cache-key: cdktf-0.20.8 input-544cfa0670b83ddbc9c2d5d5bbdf2b0ec54ea059c22ab29b2f86b8890060e8a5 -->