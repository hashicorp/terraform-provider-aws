...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        WorkspacesIpGroup.generate_config_for_import(self, "example", "wsipg-488lrtl3k")
```
...
<!-- cache-key: cdktf-0.20.8 input-4b601bcbe6ec03a647bced3e04fee24a2ec058d79738bc0ec9fc5dbfd30d43de -->