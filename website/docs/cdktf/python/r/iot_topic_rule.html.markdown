...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        mypolicy = DataAwsIamPolicyDocument(self, "mypolicy",
            statement=[DataAwsIamPolicyDocumentStatement(
                actions=["sns:Publish"],
                effect="Allow",
        ...
        myrole = IamRole(self, "myrole",
            assume_role_policy=Token.as_string(assume_role.json),
            name="myrole"
        )
        aws_iam_role_policy_mypolicy = IamRolePolicy(self, "mypolicy_5",
            name="mypolicy",
            policy=Token.as_string(mypolicy.json),
            role=myrole.id
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_iam_role_policy_mypolicy.override_logical_id("mypolicy")
...
<!-- cache-key: cdktf-0.20.9 input-ee820e8d0c64a28bff215e3aea3a653758f560996e79bc2b74ed2938a5d291c8 -->