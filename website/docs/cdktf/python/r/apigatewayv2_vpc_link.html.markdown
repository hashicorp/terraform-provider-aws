...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Apigatewayv2VpcLink.generate_config_for_import(self, "example", "aabbccddee")
```
...
<!-- cache-key: cdktf-0.20.9 input-7f7266061a30dbdd15dacececebef105a6b52be6446a7f4871237c0ef1b7c4b6 -->