    ...
    def __init__(self, scope, name):
        ...
        AutoscalingGroup(self, "test",
            ...
            tag=test_dynamic_iterator0.dynamic({
                "key": property_access(test_dynamic_iterator0.value, ["key"]),
                "propagate_at_launch": property_access(test_dynamic_iterator0.value, ["propagate_at_launch"
                ]),
                "value": property_access(test_dynamic_iterator0.value, ["value"])
            }),
            vpc_zone_identifier=[example1.id, example2.id]
        )
```
...
# Code generated by 'cdktf convert' - Please report bugs at https://cdk.tf/bug
from constructs import Construct
from cdktf import property_access, Token, TerraformIterator, TerraformStack
#
# Provider bindings are generated by running `cdktf get`.
# See https://cdk.tf/provider-generation for more details.
#
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        #     you need to keep this like it is.
        test_dynamic_iterator0 = TerraformIterator.from_list(
            Token.as_any(property_access(aws_vpclattice_target_group_test, ["*"])))
        AutoscalingGroup(self, "test",
            force_delete=True,
            max_size=1,
            min_size=1,
            ...
            traffic_source=test_dynamic_iterator0.dynamic({
                "identifier": property_access(test_dynamic_iterator0.value, ["arn"]),
                "type": "vpc-lattice"
            })
        )
```
