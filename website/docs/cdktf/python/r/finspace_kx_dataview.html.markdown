...
#
from imports.aws.finspace_kx_dataview import FinspaceKxDataview
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        FinspaceKxDataview(self, "example",
            auto_update=True,
            ...
            segment_configurations=[FinspaceKxDataviewSegmentConfigurations(
                db_paths=["/*"],
                volume_name=Token.as_string(aws_finspace_kx_volume_example.name)
            )
            ],
            timeouts=[{
                "create": "24h",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        FinspaceKxDataview.generate_config_for_import(self, "example", "n3ceo7wqxoxcti5tujqwzs,my-tf-kx-database,my-tf-kx-dataview")
```
...
<!-- cache-key: cdktf-0.20.8 input-5a3271854ee031025c68a96f6e5cacafb6953e695fa8365f00a76a6faf3ac92a -->