...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Macie2ClassificationExportConfiguration.generate_config_for_import(self, "example", "us-west-2")
```
...
<!-- cache-key: cdktf-0.20.8 input-da4b8731fa6f2df5c1c07c770c80dfd928bca8996af26987bd305da335b44485 -->