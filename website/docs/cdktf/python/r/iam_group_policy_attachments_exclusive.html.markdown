...
#
from imports.aws.iam_group_policy_attachments_exclusive import IamGroupPolicyAttachmentsExclusive
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        IamGroupPolicyAttachmentsExclusive(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        IamGroupPolicyAttachmentsExclusive.generate_config_for_import(self, "example", "MyGroup")
```
