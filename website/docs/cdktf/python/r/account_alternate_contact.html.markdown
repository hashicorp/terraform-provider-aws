...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        AccountAlternateContact.generate_config_for_import(self, "operations", "OPERATIONS")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        AccountAlternateContact.generate_config_for_import(self, "operations", "1234567890/OPERATIONS")
```
