...
from cdktf import Token, TerraformCount, Fn, property_access, TerraformStack
#
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        CloudhsmV2Cluster(self, "cloudhsm_v2_cluster",
            ...
            subnet_ids=Token.as_list(property_access(cloudhsm_v2_subnets, ["*", "id"])),
            tags={
                "Name": "example-aws_cloudhsm_v2_cluster"
            }
        )
...
<!-- cache-key: cdktf-0.17.1 input-60608d99ff28e60f3d4ab022d7e83a5948556613036f369878a80719c7316ce2 -->