...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        SfnStateMachine(self, "sfn_state_machine",
    ...
    def __init__(self, scope, name):
        ...
        SfnStateMachine(self, "sfn_state_machine",
            ...
            logging_configuration=SfnStateMachineLoggingConfiguration(
                ...
                level="ERROR",
                log_destination="${" + log_group_for_sfn.arn + "}:*"
            ),
            name="my-state-machine",
            role_arn=iam_for_sfn.arn
        )
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        SfnStateMachine.generate_config_for_import(self, "foo", "arn:aws:states:eu-west-1:123456789098:stateMachine:bar")
```
...
<!-- cache-key: cdktf-0.20.9 input-3a927a5a3818486809d11ed4e2289fb8d594b822509fb105363e4056e08a0bce -->