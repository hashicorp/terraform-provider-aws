...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ApiGatewayRestApiPolicy.generate_config_for_import(self, "example", "12345abcde")
```
...
<!-- cache-key: cdktf-0.20.1 input-a578ab2cbd9dbd4f544af9402983cad6a4047d176dace00d2077faadb4d78cfa -->