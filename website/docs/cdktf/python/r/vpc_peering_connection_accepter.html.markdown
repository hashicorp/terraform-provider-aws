...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        VpcPeeringConnectionAccepterA.generate_config_for_import(self, "example", "pcx-12345678")
```
...
<!-- cache-key: cdktf-0.20.9 input-dbb400c8499f3d1bd1cf4007a705760a09da1d8679355ddec9917b7f40b9f101 -->