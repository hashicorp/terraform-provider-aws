...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        EvidentlyLaunch.generate_config_for_import(self, "example", "exampleLaunchName:exampleProjectName")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        EvidentlyLaunch.generate_config_for_import(self, "example", "exampleLaunchName:arn:aws:evidently:us-east-1:123456789012:project/exampleProjectName")
```
