...
#
from imports.aws.neptunegraph_graph import NeptunegraphGraph
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        NeptunegraphGraph(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        NeptunegraphGraph.generate_config_for_import(self, "example", "graph_id")
```
