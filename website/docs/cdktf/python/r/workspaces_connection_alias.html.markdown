...
#
from imports.aws.workspaces_connection_alias import WorkspacesConnectionAlias
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        WorkspacesConnectionAlias(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        WorkspacesConnectionAlias.generate_config_for_import(self, "example", "rft-8012925589")
```
...
<!-- cache-key: cdktf-0.20.9 input-413fd75316cfeb359e07cefddd821d90ecf5ceabe738b42d92da1fd7d2704797 -->