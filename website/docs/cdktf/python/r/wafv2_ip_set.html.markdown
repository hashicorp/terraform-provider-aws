...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Wafv2IpSet.generate_config_for_import(self, "example", "a1b2c3d4-d5f6-7777-8888-9999aaaabbbbcccc/example/REGIONAL")
```
...
<!-- cache-key: cdktf-0.20.9 input-5b5edc8dc6155a31f480219df269351abee77e94b08bfc003b8a12a615fde2da -->