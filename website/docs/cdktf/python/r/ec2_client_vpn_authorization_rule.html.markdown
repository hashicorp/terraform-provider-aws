...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Ec2ClientVpnAuthorizationRule.generate_config_for_import(self, "example", "cvpn-endpoint-0ac3a1abbccddd666,10.1.0.0/24")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Ec2ClientVpnAuthorizationRule.generate_config_for_import(self, "example", "cvpn-endpoint-0ac3a1abbccddd666,10.1.0.0/24,team-a")
```
