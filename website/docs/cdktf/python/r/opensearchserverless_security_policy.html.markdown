...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        OpensearchserverlessSecurityPolicy(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        OpensearchserverlessSecurityPolicy.generate_config_for_import(self, "example", "example/encryption")
```
...
<!-- cache-key: cdktf-0.20.1 input-becd08ee3f6a3b334c7cc8143eed41d3094a5e44bfbffe39e37ab8c8a317620e -->