...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        WafRateBasedRule.generate_config_for_import(self, "wafrule", "a1b2c3d4-d5f6-7777-8888-9999aaaabbbbcccc")
```
...
<!-- cache-key: cdktf-0.20.8 input-530aa2bf29dc90170951e958f2fab3eca6770263da54a51c9aba805d25697e07 -->