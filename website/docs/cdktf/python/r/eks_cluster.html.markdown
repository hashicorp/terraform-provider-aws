...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        cluster_amazon_eks_cluster_policy = IamRolePolicyAttachment(self, "cluster_AmazonEKSClusterPolicy",
            policy_arn="arn:aws:iam::aws:policy/AmazonEKSClusterPolicy",
            role=cluster.name
        )
        EksCluster(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        cluster_amazon_eks_block_storage_policy = IamRolePolicyAttachment(self, "cluster_AmazonEKSBlockStoragePolicy",
        ...
        cluster_amazon_eks_compute_policy = IamRolePolicyAttachment(self, "cluster_AmazonEKSComputePolicy",
            policy_arn="arn:aws:iam::aws:policy/AmazonEKSComputePolicy",
            role=cluster.name
        )
        cluster_amazon_eks_load_balancing_policy = IamRolePolicyAttachment(self, "cluster_AmazonEKSLoadBalancingPolicy",
            policy_arn="arn:aws:iam::aws:policy/AmazonEKSLoadBalancingPolicy",
            role=cluster.name
        )
        cluster_amazon_eks_networking_policy = IamRolePolicyAttachment(self, "cluster_AmazonEKSNetworkingPolicy",
            policy_arn="arn:aws:iam::aws:policy/AmazonEKSNetworkingPolicy",
            role=cluster.name
        )
        IamRolePolicyAttachment(self, "node_AmazonEC2ContainerRegistryPullOnly",
            policy_arn="arn:aws:iam::aws:policy/AmazonEC2ContainerRegistryPullOnly",
            role=node.name
        )
        IamRolePolicyAttachment(self, "node_AmazonEKSWorkerNodeMinimalPolicy",
        ...
        EksCluster(self, "example",
            ...
            depends_on=[cluster_amazon_eks_cluster_policy, cluster_amazon_eks_compute_policy, cluster_amazon_eks_block_storage_policy, cluster_amazon_eks_load_balancing_policy, cluster_amazon_eks_networking_policy
            ],
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        cluster_amazon_eks_local_outpost_cluster_policy =
        IamRolePolicyAttachment(self, "cluster_AmazonEKSLocalOutpostClusterPolicy",
            policy_arn="arn:aws:iam::aws:policy/AmazonEKSLocalOutpostClusterPolicy",
            role=cluster.name
        )
        example = DataAwsOutpostsOutpost(self, "example",
            name="example"
        )
        aws_eks_cluster_example = EksCluster(self, "example_3",
            access_config=EksClusterAccessConfig(
                authentication_mode="CONFIG_MAP"
            ),
            depends_on=[cluster_amazon_eks_local_outpost_cluster_policy],
            name="example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        EksCluster.generate_config_for_import(self, "myCluster", "my_cluster")
```
...
<!-- cache-key: cdktf-0.20.8 input-6f567f9f94ccfdffd001a70dd5ce6aa2d52c4bc607b450450bd9c47c38b92420 -->