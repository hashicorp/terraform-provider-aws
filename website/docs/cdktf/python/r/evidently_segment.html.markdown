...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        EvidentlySegment.generate_config_for_import(self, "example", "arn:aws:evidently:us-west-2:123456789012:segment/example")
```
...
<!-- cache-key: cdktf-0.20.9 input-8f4f148ae07fcc5e61c1f38f8166eb6097494f8e5ccee4064e248569af124d84 -->