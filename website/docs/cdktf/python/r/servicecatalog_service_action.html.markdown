...
#
from imports.aws.servicecatalog_service_action import ServicecatalogServiceAction
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name, *, version):
        super().__init__(scope, name)
        ServicecatalogServiceAction(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ServicecatalogServiceAction.generate_config_for_import(self, "example", "act-f1w12eperfslh")
```
