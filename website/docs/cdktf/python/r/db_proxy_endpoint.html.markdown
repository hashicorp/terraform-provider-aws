...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        DbProxyEndpoint(self, "example",
            ...
            vpc_subnet_ids=Token.as_list(property_access(aws_subnet_test, ["*", "id"]))
        )
```
...
<!-- cache-key: cdktf-0.17.1 input-350a8a6ad58a9a637252ca5d1e91e374fee3e01e2e35b79ea8ea63a3a00e8a4d -->