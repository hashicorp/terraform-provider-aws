...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        KendraDataSource(self, "example",
            configuration=KendraDataSourceConfiguration(
                template_configuration=KendraDataSourceConfigurationTemplateConfiguration(
                    template=Token.as_string(
                        Fn.jsonencode({
                            "additional_properties": {
                                "inclusion_uRLIndex_patterns": ["https:\\\\/\\\\/registry[.]terraform[.]io\\\\/providers\\\\/hashicorp\\\\/aws\\\\/latest\\\\/docs\\\\/resources\\\\/kendra_index"
                                ]
                            },
                            "connection_configuration": {
                                "repository_endpoint_metadata": {
                                    "seed_url_connections": [{
                                        "seed_url": "https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kendra_index"
                                    }
                                    ]
                                }
                            },
                            "sync_mode": "FULL_CRAWL",
                            "type": "WEBCRAWLERV2",
                            "version": "1.0.0"
                        }))
                )
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        KendraDataSource.generate_config_for_import(self, "example", "1045d08d-66ef-4882-b3ed-dfb7df183e90/b34dfdf7-1f2b-4704-9581-79e00296845f")
```
...
<!-- cache-key: cdktf-0.20.8 input-0a156ae9ba8a4ea72b7aada961fc35b813a07f0b987d06d3f572e57453bcb9b2 -->