...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ConfigOrganizationConformancePack.generate_config_for_import(self, "example", "example")
```
...
<!-- cache-key: cdktf-0.20.9 input-4f933a5e639d5b2cfd2450761a6e901c02e6e8a4875255817cf9b88f4cfacd1d -->