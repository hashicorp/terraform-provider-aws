...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        PinpointApnsVoipSandboxChannel(self, "apns_voip_sandbox",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        PinpointApnsVoipSandboxChannel.generate_config_for_import(self, "apnsVoipSandbox", "application-id")
```
...
<!-- cache-key: cdktf-0.20.1 input-10a8793c57ea80faa1bcc8e11505f01ac9d61ce493402a8a9a145cb769e2c84c -->