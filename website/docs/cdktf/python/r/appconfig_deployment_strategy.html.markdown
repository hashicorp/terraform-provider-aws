...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        AppconfigDeploymentStrategy.generate_config_for_import(self, "example", "11xxxxx")
```
...
<!-- cache-key: cdktf-0.20.1 input-5523efc97b4058c67f8184189e652c62466a4aef6fbcf077f1b0196ea0ec5624 -->