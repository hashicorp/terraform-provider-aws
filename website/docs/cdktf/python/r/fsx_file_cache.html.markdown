...
#
from imports.aws.fsx_file_cache import FsxFileCache
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        FsxFileCache(self, "example",
            data_repository_association=[FsxFileCacheDataRepositoryAssociation(
                data_repository_path="nfs://filer.domain.com",
                data_repository_subdirectories=["test", "test2"],
                file_cache_path="/ns1",
                nfs=[FsxFileCacheDataRepositoryAssociationNfs(
            ...
            lustre_configuration=[FsxFileCacheLustreConfiguration(
                deployment_type="CACHE_1",
                metadata_configuration=[FsxFileCacheLustreConfigurationMetadataConfiguration(
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        FsxFileCache.generate_config_for_import(self, "example", "fc-8012925589")
```
