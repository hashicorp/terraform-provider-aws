...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        WorkspaceswebDataProtectionSettings(self, "example",
    ...
    def __init__(self, scope, name):
        ...
        WorkspaceswebDataProtectionSettings(self, "example",
            ...
            inline_redaction_configuration=[WorkspaceswebDataProtectionSettingsInlineRedactionConfiguration(
                ...
                inline_redaction_pattern=[WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPattern(
                    built_in_pattern_id="ssn",
                    confidence_level=3,
                    redaction_place_holder=[WorkspaceswebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternRedactionPlaceHolder(
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        WorkspaceswebDataProtectionSettings.generate_config_for_import(self, "example", "arn:aws:workspaces-web:us-west-2:123456789012:dataprotectionsettings/abcdef12345")
```
