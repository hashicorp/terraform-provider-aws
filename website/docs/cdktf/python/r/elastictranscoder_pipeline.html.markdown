...
#
from imports.aws.elastictranscoder_pipeline import ElastictranscoderPipeline
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ElastictranscoderPipeline(self, "bar",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ElastictranscoderPipeline.generate_config_for_import(self, "basicPipeline", "1407981661351-cttk8b")
```
...
<!-- cache-key: cdktf-0.20.9 input-d637ae6851ebe5a730672dfa1ffb2f0583f0f26c659341ebee69f076e573b14b -->