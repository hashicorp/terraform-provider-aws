...
#
from imports.aws.route53_domains_domain import Route53DomainsDomain
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53DomainsDomain(self, "example",
            admin_contact=[{
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53DomainsDomain.generate_config_for_import(self, "example", "example.com")
```
