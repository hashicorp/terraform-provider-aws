...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        IamUserLoginProfile.generate_config_for_import(self, "example", "myusername")
```
...
<!-- cache-key: cdktf-0.20.1 input-332beff043f3f89a7086471e863d83e0d7a3e4995b3f2b9abe9a879fd8d3778f -->