...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_glue_catalog_table_test = GlueCatalogTable(self, "test_5",
        ...
        KinesisFirehoseDeliveryStream(self, "test_stream",
            ...
            iceberg_configuration=KinesisFirehoseDeliveryStreamIcebergConfiguration(
                ...
                processing_configuration=KinesisFirehoseDeliveryStreamIcebergConfigurationProcessingConfiguration(
                    enabled=Token.as_boolean("true"),
                    processors=[KinesisFirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessors(
                ...
                role_arn=firehose_role.arn,
                s3_configuration=KinesisFirehoseDeliveryStreamIcebergConfigurationS3Configuration(
                    bucket_arn=bucket.arn,
                    role_arn=firehose_role.arn
                )
            ),
