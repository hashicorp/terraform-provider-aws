...
#
from imports.aws.inspector2_filter import Inspector2Filter
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Inspector2Filter(self, "example",
            action="NONE",
            filter_criteria=[Inspector2FilterFilterCriteria(
                aws_account_id=[Inspector2FilterFilterCriteriaAwsAccountId(
                    comparison="EQUALS",
                    value="111222333444"
                )
                ]
