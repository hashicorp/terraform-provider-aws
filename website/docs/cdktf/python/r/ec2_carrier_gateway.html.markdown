...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Ec2CarrierGateway.generate_config_for_import(self, "example", "cgw-12345")
```
...
<!-- cache-key: cdktf-0.20.9 input-9d4096fc983e6a4fb708311553dddf500634237507ba8f350eee35f1f925e85c -->