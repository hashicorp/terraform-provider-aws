...
#
from imports.aws. import VpclatticeResourceConfiguration
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        VpclatticeResourceConfiguration(self, "example",
            ...
            resource_gateway_identifier=aws_vpclattice_resource_gateway_example.id,
            tags={
                "Environment": "Example"
            }
        )
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        VpclatticeResourceConfiguration(self, "test",
            ...
            resource_gateway_identifier=aws_vpclattice_resource_gateway_test.id,
            type="ARN"
        )
```
...
<!-- cache-key: cdktf-0.20.8 input-d87a5bd7b4371fe9df4ada12b08817237697bf37266caf17f76e3767ef910510 -->