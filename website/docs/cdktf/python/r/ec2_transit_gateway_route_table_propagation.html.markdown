...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Ec2TransitGatewayRouteTablePropagation.generate_config_for_import(self, "example", "tgw-rtb-12345678_tgw-attach-87654321")
```
...
<!-- cache-key: cdktf-0.20.8 input-0296774da3cc7e6a2540fcd890af389ccf67fa4d39cf5ee59832361eca60bcc4 -->