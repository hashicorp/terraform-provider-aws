...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Route53ResolverQueryLogConfig.generate_config_for_import(self, "example", "rqlc-92edc3b1838248bf")
```
...
<!-- cache-key: cdktf-0.20.1 input-5223f85f64c286cf17d4b87baa9cc06e62338ab91d82d959ba69e32ab94b1a4d -->