...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        AmiLaunchPermission.generate_config_for_import(self, "example", "123456789012/ami-12345678")
```
...
<!-- cache-key: cdktf-0.20.1 input-a0902093918e0a418db9b2fc23c95e8777db95ce86c83b3b547f718d788c6648 -->