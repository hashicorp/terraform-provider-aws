...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        Ec2Host.generate_config_for_import(self, "example", "h-0385a99d0e4b20cbb")
```
...
<!-- cache-key: cdktf-0.20.8 input-e72ecf384fda2cca3d20b84aaf4f24de52e9cc761d5cc1f6a6d8b91d7bf13fac -->