...
#
from imports.aws. import VerifiedpermissionsPolicyTemplate
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        VerifiedpermissionsPolicyTemplate(self, "example",
            policy_store_id=aws_verifiedpermissions_policy_store_example.id,
...
<!-- cache-key: cdktf-0.20.0 input-42f660b66107b10f64a559e6b9570385f505fca4bd368a8c47f9a036cb2dd5cb -->