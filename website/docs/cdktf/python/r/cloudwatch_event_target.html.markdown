...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        graphql_api = AppsyncGraphqlApi(self, "graphql-api",
            authentication_type="AWS_IAM",
            name="api",
            schema="    schema {\n      mutation: Mutation\n      query: Query\n    }\n\n    type Query {\n      testQuery: String\n    }\n\n    type Mutation {\n      testMutation(input: MutationInput!): TestMutationResult\n    }\n\n    type TestMutationResult {\n      test: String\n    }\n\n    input MutationInput {\n      testInput: String\n    }\n\n"
        )
        invoke_appsync_mutation = CloudwatchEventRule(self, "invoke_appsync_mutation",
            description="schedule_batch_test",
            name="invoke-appsync-mutation",
            schedule_expression="rate(5 minutes)"
        )
        appsync_mutation_role_policy_document = DataAwsIamPolicyDocument(self, "appsync_mutation_role_policy_document",
            statement=[DataAwsIamPolicyDocumentStatement(
        ...
        appsync_mutation_role_trust = DataAwsIamPolicyDocument(self, "appsync_mutation_role_trust",
            statement=[DataAwsIamPolicyDocumentStatement(
                actions=["sts:AssumeRole"],
                principals=[DataAwsIamPolicyDocumentStatementPrincipals(
                    identifiers=["events.amazonaws.com"],
        ...
        appsync_mutation_role_policy = IamPolicy(self, "appsync_mutation_role_policy",
            name="appsync-mutation-role-policy",
            policy=Token.as_string(appsync_mutation_role_policy_document.json)
        )
        appsync_mutation_role = IamRole(self, "appsync_mutation_role",
            assume_role_policy=Token.as_string(appsync_mutation_role_trust.json),
            name="appsync-mutation-role"
        )
        IamRolePolicyAttachment(self, "appsync_mutation_role_attachment",
            policy_arn=appsync_mutation_role_policy.arn,
            role=appsync_mutation_role.name
        )
        aws_cloudwatch_event_target_invoke_appsync_mutation =
        CloudwatchEventTarget(self, "invoke_appsync_mutation_7",
            appsync_target=CloudwatchEventTargetAppsyncTarget(
                graphql_operation="mutation TestMutation($input:MutationInput!){testMutation(input: $input) {test}}"
            ),
            arn=Token.as_string(
                Fn.replace(graphql_api.arn, "apis", "endpoints/graphql-api")),
            input_transformer=CloudwatchEventTargetInputTransformer(
                input_paths={
                    "input": "$.detail.input"
                },
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_cloudwatch_event_target_invoke_appsync_mutation.override_logical_id("invoke_appsync_mutation")
```
