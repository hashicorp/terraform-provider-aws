...
from imports.aws.dx_transit_virtual_interface import DxTransitVirtualInterface
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_dx_transit_virtual_interface_example = DxTransitVirtualInterface(self, "example_1",
            address_family="ipv4",
            bgp_asn=65352,
        ...
        aws_dx_transit_virtual_interface_example.override_logical_id("example")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DxTransitVirtualInterface.generate_config_for_import(self, "test", "dxvif-33cc44dd")
```
