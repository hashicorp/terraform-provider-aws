...
#
from imports.aws. import DatazoneEnvironment
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DatazoneEnvironment(self, "example",
            account_identifier=test.account_id,
            account_region=data_aws_region_test.name,
            blueprint_identifier=aws_datazone_environment_blueprint_configuration_test.environment_blueprint_id,
            domain_identifier=aws_datazone_domain_test.id,
            name="example",
            profile_identifier=aws_datazone_environment_profile_test.id,
            project_identifier=aws_datazone_project_test.id,
            user_parameters=[{
