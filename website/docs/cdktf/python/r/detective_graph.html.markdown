...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DetectiveGraph.generate_config_for_import(self, "example", "arn:aws:detective:us-east-1:123456789101:graph:231684d34gh74g4bae1dbc7bd807d02d")
```
...
<!-- cache-key: cdktf-0.20.9 input-ee8961bdda24bd4636640d877e7c8cec4877ed2d26e63964d9fab2e0003f440c -->