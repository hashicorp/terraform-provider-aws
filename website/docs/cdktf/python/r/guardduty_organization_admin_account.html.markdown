...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        GuarddutyOrganizationAdminAccount.generate_config_for_import(self, "example", "123456789012")
```
...
<!-- cache-key: cdktf-0.20.1 input-9503edb267379cc704ded824b2c1ffae37e126e5b11a01a39000716b3a61347e -->