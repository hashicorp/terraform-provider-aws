...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        AuditmanagerAssessment.generate_config_for_import(self, "example", "abc123-de45")
```
...
<!-- cache-key: cdktf-0.20.9 input-aa1e0891f6ec8901473fa207078140ea42269fbcc18c7cea3c07e91aa207dcb8 -->