...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CognitoManagedUserPoolClient.generate_config_for_import(self, "client", "us-west-2_abc123/3ho4ek12345678909nh3fmhpko")
```
...
<!-- cache-key: cdktf-0.20.9 input-c6a7809162d0340d1a860cbc3b4964331e19a56c412e56b2f0ba271e0cc0fe28 -->