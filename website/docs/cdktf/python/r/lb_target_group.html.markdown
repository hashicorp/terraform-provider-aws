        ...
        LbTargetGroup(self, "tcp-example",
            ...
            target_group_health=LbTargetGroupTargetGroupHealth(
                ...
                unhealthy_state_routing=LbTargetGroupTargetGroupHealthUnhealthyStateRouting(
                    minimum_healthy_targets_count=Token.as_number("1"),
                    minimum_healthy_targets_percentage="off"
                )
            ),
            vpc_id=main.id
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        LbTargetGroup.generate_config_for_import(self, "appFrontEnd", "arn:aws:elasticloadbalancing:us-west-2:187416307283:targetgroup/app-front-end/20cfe21448b66314")
```
...
<!-- cache-key: cdktf-0.20.8 input-fe844fdcd548ce79ebf9e0f2703d375dd606d408573e8bfef3816fe96dac2a10 -->