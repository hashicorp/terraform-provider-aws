    ...
    def __init__(self, scope, name):
        ...
        OrganizationsPolicyAttachment(self, "root",
            ...
            target_id=Token.as_string(
                property_access(aws_organizations_organization_example.roots, ["0", "id"]))
        )
```
...
<!-- cache-key: cdktf-0.17.1 input-3828ee0215ac304d4e2eeebab26c79536b060060799e87c63d57f977fbfbfab6 -->