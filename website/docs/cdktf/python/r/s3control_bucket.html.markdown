...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        S3ControlBucket.generate_config_for_import(self, "example", "arn:aws:s3-outposts:us-east-1:123456789012:outpost/op-12345678/bucket/example")
```
...
<!-- cache-key: cdktf-0.20.9 input-2e4677b75d6cbb099b0dd2b2385879475c02ebb3643475b93a119fd3833d7929 -->