...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        RedshiftserverlessSnapshot.generate_config_for_import(self, "example", "example")
```
...
<!-- cache-key: cdktf-0.20.8 input-8cdad9004cc5bbc08f27efbdc59cce26713d56ad09ff5203e21e04db05d9916b -->