...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        EgressOnlyInternetGateway.generate_config_for_import(self, "example", "eigw-015e0e244e24dfe8a")
```
...
<!-- cache-key: cdktf-0.20.9 input-7ed3e94395680c60b6e40820f5a3e85dfb53bdc2a67b6dc191917e0125e4b534 -->