...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DatasyncLocationSmb.generate_config_for_import(self, "example", "arn:aws:datasync:us-east-1:123456789012:location/loc-12345678901234567")
```
...
<!-- cache-key: cdktf-0.20.1 input-ef64a786032b1bd4736b717fcbb2fa2b4849fff365db36c6537de225840acb5d -->