...
#
from imports.aws.cloudfront_origin_request_policy import CloudfrontOriginRequestPolicy
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CloudfrontOriginRequestPolicy(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CloudfrontOriginRequestPolicy.generate_config_for_import(self, "policy", "ccca32ef-dce3-4df3-80df-1bd3000bc4d3")
```
...
<!-- cache-key: cdktf-0.20.1 input-2bef7bc4558d3ce6ae66dcd3bb9da0419f06c50e2e3848dabc38af31c3b16d3b -->