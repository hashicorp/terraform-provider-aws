...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        SesReceiptFilter.generate_config_for_import(self, "test", "some-filter")
```
...
<!-- cache-key: cdktf-0.20.9 input-8c7377efc81dac65453231c48c63abd93967d88ece4a6461b108dcb4049f1c6b -->