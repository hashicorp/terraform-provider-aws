...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DocdbSubnetGroup.generate_config_for_import(self, "default", "production-subnet-group")
```
...
<!-- cache-key: cdktf-0.20.9 input-88009fd606f1c5adfe6f2ed488e5bfa54a43279608f02880560a223786cb4993 -->