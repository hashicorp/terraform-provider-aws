...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        SagemakerEndpoint.generate_config_for_import(self, "testEndpoint", "my-endpoint")
```
...
<!-- cache-key: cdktf-0.20.1 input-6f77eb68ca400c61f27b4fe0845a1a77a41772c28e3c6f22dc1c8cd4be29cc30 -->