...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ApprunnerVpcIngressConnection.generate_config_for_import(self, "example", "arn:aws:apprunner:us-west-2:837424938642:vpcingressconnection/example/b379f86381d74825832c2e82080342fa")
```
...
<!-- cache-key: cdktf-0.20.1 input-5ca4eb20c816b4fc2b57f0cfd6bbd31dc7537e74b1368f2c8074afd614895b23 -->