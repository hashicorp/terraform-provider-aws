...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        KinesisVideoStream(self, "default",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        KinesisVideoStream.generate_config_for_import(self, "testStream", "arn:aws:kinesisvideo:us-west-2:123456789012:stream/terraform-kinesis-test/1554978910975")
```
