...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        sqs_queue_policy = DataAwsIamPolicyDocument(self, "sqs_queue_policy",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_sns_topic_subscription_sns_topic = SnsTopicSubscription(self, "sns_topic_9",
        ...
        aws_sns_topic_subscription_sns_topic.override_logical_id("sns_topic")
```
