...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        example = WafregionalRule(self, "example",
            metric_name="example",
            name="example"
        )
        aws_wafregional_rule_group_example = WafregionalRuleGroup(self, "example_1",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        WafregionalRuleGroup.generate_config_for_import(self, "example", "a1b2c3d4-d5f6-7777-8888-9999aaaabbbbcccc")
```
...
<!-- cache-key: cdktf-0.20.9 input-2935ebb79c393d1d70c3018dc3927bc8f00af67f128cb5a4088d52b0c5dc4769 -->