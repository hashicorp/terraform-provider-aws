...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DbSnapshot.generate_config_for_import(self, "example", "my-snapshot")
```
...
<!-- cache-key: cdktf-0.20.8 input-41ad054e1cd5f9035a73439b5851601fe3048ea049009ee39814356714bc4d11 -->