...
#
from imports.aws.backup_restore_testing_selection import BackupRestoreTestingSelection
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        BackupRestoreTestingSelection(self, "example",
            ...
            restore_testing_plan_name=Token.as_string(aws_backup_restore_testing_plan_example.name)
        )
```
    ...
    def __init__(self, scope, name):
        ...
        BackupRestoreTestingSelection(self, "example",
            ...
            protected_resource_conditions=[BackupRestoreTestingSelectionProtectedResourceConditions(
                string_equals=[BackupRestoreTestingSelectionProtectedResourceConditionsStringEquals(
