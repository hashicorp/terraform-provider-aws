...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        SecurityhubAccount.generate_config_for_import(self, "example", "123456789012")
```
...
<!-- cache-key: cdktf-0.20.1 input-3c29f6fa3b1da1b294f8e57fd126a24487344bdb5307bd88d0e5c955b64f2338 -->