...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        GuarddutyThreatintelset.generate_config_for_import(self, "myThreatIntelSet", "00b00fd5aecc0ab60a708659477e9617:123456789012")
```
...
<!-- cache-key: cdktf-0.20.9 input-cffb05b04bc89aa2a4faddb04a7472478095a1942cb1aa200f8f7a8b0848a9fd -->