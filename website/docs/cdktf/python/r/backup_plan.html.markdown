...
#
from imports.aws.backup_plan import BackupPlan
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        BackupPlan(self, "example",
            advanced_backup_setting=[BackupPlanAdvancedBackupSetting(
                backup_options={
                    "WindowsVSS": "enabled"
                },
                resource_type="EC2"
...
<!-- cache-key: cdktf-0.17.1 input-e41e73e041e50613fcaa9cb0889a0177d0b33c0a30b6e8469e4e706a67a8b35d -->