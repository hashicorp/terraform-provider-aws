...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        VpcDhcpOptionsAssociation.generate_config_for_import(self, "imported", "vpc-0f001273ec18911b1")
```
...
<!-- cache-key: cdktf-0.20.1 input-38bb6adf7a2cdaed08e8a7d0f22e47d0c02836ef15bfce74b53d370722c7efd7 -->