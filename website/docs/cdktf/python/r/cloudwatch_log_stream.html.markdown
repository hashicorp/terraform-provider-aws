...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CloudwatchLogStream.generate_config_for_import(self, "foo", "Yada:SampleLogStream1234")
```
...
<!-- cache-key: cdktf-0.20.9 input-4fed32ff75bb830aa4a809d588a8fcccf96c6368ab7e6ad418f7d940ac65117d -->