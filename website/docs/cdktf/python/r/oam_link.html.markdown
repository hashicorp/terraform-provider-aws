...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name, *, name, policy):
        ...
        aws_oam_link_example = OamLink(self, "example_2",
            depends_on=[aws_oam_sink_policy_example],
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_oam_link_example.override_logical_id("example")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        OamLink(self, "example",
            ...
            sink_identifier=Token.as_string(aws_oam_sink_example.arn)
        )
```
...
<!-- cache-key: cdktf-0.20.8 input-8f3db7661fcedd571e3da8a9767f057178a351625c2634a7ed17c4d588ee0b66 -->