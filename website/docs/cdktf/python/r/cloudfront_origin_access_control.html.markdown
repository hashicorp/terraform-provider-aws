...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        CloudfrontOriginAccessControl(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CloudfrontOriginAccessControl.generate_config_for_import(self, "example", "E327GJI25M56DG")
```
...
<!-- cache-key: cdktf-0.20.9 input-57d44c640b1c59b5d0c2dd1656c48370adc34d64a3f2a59ddd9fbaf2231990b2 -->