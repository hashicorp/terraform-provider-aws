...
#
from imports.aws.bedrockagent_flow import BedrockagentFlow
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        BedrockagentFlow(self, "example",
    ...
    def __init__(self, scope, name):
        ...
        BedrockagentFlow(self, "example",
            definition=[BedrockagentFlowDefinition(
                ...
                node_attribute=[BedrockagentFlowDefinitionNode(
                    configuration=[BedrockagentFlowDefinitionNodeConfiguration(
                        input=[BedrockagentFlowDefinitionNodeConfigurationInput()]
                    )
                    ],
                    name="FlowInputNode",
                    output=[BedrockagentFlowDefinitionNodeOutput(
                        name="document",
                        type="String"
                    )
                    ],
                    ...
                    configuration=[BedrockagentFlowDefinitionNodeConfiguration(
                        prompt=[BedrockagentFlowDefinitionNodeConfigurationPrompt(
                            source_configuration=[BedrockagentFlowDefinitionNodeConfigurationPromptSourceConfiguration(
                                inline=[BedrockagentFlowDefinitionNodeConfigurationPromptSourceConfigurationInline(
                                    inference_configuration=[BedrockagentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineInferenceConfiguration(
                                    ...
                                    template_configuration=[BedrockagentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfiguration(
                                        text=[BedrockagentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationText(
                                            input_variable=[BedrockagentFlowDefinitionNodeConfigurationPromptSourceConfigurationInlineTemplateConfigurationTextInputVariable(
                                                name="topic"
                                            )
                                            ],
                    ...
                    input=[BedrockagentFlowDefinitionNodeInput(
                        expression="$.data",
                        name="topic",
                        type="String"
                    )
                    ...
                    configuration=[BedrockagentFlowDefinitionNodeConfiguration(
                        output=[BedrockagentFlowDefinitionNodeConfigurationOutput()]
                    )
                    ],
                    input=[BedrockagentFlowDefinitionNodeInput(
                        expression="$.data",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        BedrockagentFlow.generate_config_for_import(self, "example", "ABCDEFGHIJ")
```
...
<!-- cache-key: cdktf-0.20.8 input-87b7da4f4c4aabd439916a7521b4871589ea4ac36b01bbd2bc40c700e5058f17 -->