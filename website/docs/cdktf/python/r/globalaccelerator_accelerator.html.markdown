...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        GlobalacceleratorAccelerator.generate_config_for_import(self, "example", "arn:aws:globalaccelerator::111111111111:accelerator/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx")
```
...
<!-- cache-key: cdktf-0.20.1 input-7f5b36602f0875f89018a31aa91d4a8e5d30b8b26a613494ca2259ff9749c761 -->