    ...
    def __init__(self, scope, name):
        ...
        TransferConnector(self, "example",
            ...
            sftp_config=TransferConnectorSftpConfig(
                ...
                user_secret_id=Token.as_string(aws_secretsmanager_secret_example.id)
            ),
            url="sftp://test.com"
        )
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        TransferConnector.generate_config_for_import(self, "example", "c-4221a88afd5f4362a")
```
...
<!-- cache-key: cdktf-0.20.8 input-b870b656d06cf5d883b713f3560edb961cd460502fa124ce4f32c7d3f023d2c9 -->