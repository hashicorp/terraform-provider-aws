...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        MskconnectConnector.generate_config_for_import(self, "example", "arn:aws:kafkaconnect:eu-central-1:123456789012:connector/example/264edee4-17a3-412e-bd76-6681cfc93805-3")
```
...
<!-- cache-key: cdktf-0.20.9 input-8bf765ae92b4515b183aeeaf6db394f4d9e92daef2b158bdb10a64871f0845b2 -->