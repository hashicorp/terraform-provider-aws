...
#
from imports.aws.s3_bucket_metadata_configuration import S3BucketMetadataConfiguration
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        S3BucketMetadataConfiguration(self, "example",
            bucket=Token.as_string(aws_s3_bucket_example.bucket),
            metadata_configuration=[S3BucketMetadataConfigurationMetadataConfiguration(
                ...
                journal_table_configuration=[S3BucketMetadataConfigurationMetadataConfigurationJournalTableConfiguration(
                    record_expiration=[S3BucketMetadataConfigurationMetadataConfigurationJournalTableConfigurationRecordExpiration(
                        days=7,
                        expiration="ENABLED"
                    )
                    ]
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        S3BucketMetadataConfiguration.generate_config_for_import(self, "example", "bucket-name")
```
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        S3BucketMetadataConfiguration.generate_config_for_import(self, "example", "bucket-name,123456789012")
```
