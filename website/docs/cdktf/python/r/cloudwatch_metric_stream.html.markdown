...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CloudwatchMetricStream.generate_config_for_import(self, "sample", "sample-stream-name")
```
...
<!-- cache-key: cdktf-0.20.8 input-121a06fbc0a0d82902da37567ec20331be6d9cd3454597870b725279796adcfa -->