    ...
    def __init__(self, scope, name):
        ...
        aws_opensearch_domain_example = OpensearchDomain(self, "example_9",
            ...
            vpc_options=OpensearchDomainVpcOptions(
                ...
                subnet_ids=[
                    Token.as_string(Fn.lookup_nested(data_aws_subnets_example.ids, ["0"])),
                    Token.as_string(Fn.lookup_nested(data_aws_subnets_example.ids, ["1"]))
                ]
            )
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        OpensearchDomain.generate_config_for_import(self, "example", "domain_name")
```
...
<!-- cache-key: cdktf-0.20.9 input-e6b148c9a7c92900cd9d50b4727945d4f9e3161b5067e03493d017c7dae1d336 -->