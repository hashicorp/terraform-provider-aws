...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        TerraformOutput(self, "lambda_result",
            value=property_access(example.result_map, ["\"key1\""])
        )
```
...
# Code generated by 'cdktf convert' - Please report bugs at https://cdk.tf/bug
from constructs import Construct
from cdktf import TerraformOutput, Fn, Token, property_access, TerraformStack
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        TerraformOutput(self, "lambda_result",
            value=property_access(Fn.jsondecode(Token.as_string(example.result)), ["\"key1\""
            ])
        )
```
...
# Code generated by 'cdktf convert' - Please report bugs at https://cdk.tf/bug
from constructs import Construct
from cdktf import Fn, Op, Token, TerraformCount, property_access, TerraformStack
#
# Provider bindings are generated by running `cdktf get`.
# See https://cdk.tf/provider-generation for more details.
#
    ...
    def __init__(self, scope, name):
        ...
        aws_route53_record_existing = Route53Record(self, "existing_2",
            ...
            name=Token.as_string(
                property_access(
                    property_access(existing.domain_validation_options, [existing_count.index
        ...
        aws_acm_certificate_validation_existing = AcmCertificateValidation(self, "existing_3",
            ...
            validation_record_fqdns=Token.as_list(
                property_access(aws_route53_record_existing, ["*", "fqdn"]))
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
...
# Code generated by 'cdktf convert' - Please report bugs at https://cdk.tf/bug
from constructs import Construct
from cdktf import Token, TerraformIterator, property_access, TerraformStack
#
# Provider bindings are generated by running `cdktf get`.
# See https://cdk.tf/provider-generation for more details.
#
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        existing = Route53Record(self, "existing",
            allow_overwrite=True,
            name=Token.as_string(
                property_access(existing_for_each_iterator.value, ["name"])),
            records=[
                Token.as_string(
                    property_access(existing_for_each_iterator.value, ["record"]))
            ],
            ttl=60,
            type=Token.as_string(
                property_access(existing_for_each_iterator.value, ["type"])),
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        existing1 = Route53Record(self, "existing_1",
            allow_overwrite=True,
            name=Token.as_string(
                property_access(existing.domain_validation_options, ["0", "resource_record_name"
                ])),
            records=[
                Token.as_string(
                    property_access(existing.domain_validation_options, ["0", "resource_record_value"
                    ]))
            ],
            ttl=60,
            type=Token.as_string(
                property_access(existing.domain_validation_options, ["0", "resource_record_type"
                ])),
            zone_id=Token.as_string(data_aws_route53_zone_public_root_domain.zone_id)
        )
        existing3 = Route53Record(self, "existing_3",
            allow_overwrite=True,
            name=Token.as_string(
                property_access(existing.domain_validation_options, ["2", "resource_record_name"
                ])),
            records=[
                Token.as_string(
                    property_access(existing.domain_validation_options, ["2", "resource_record_value"
                    ]))
            ],
            ttl=60,
            type=Token.as_string(
                property_access(existing.domain_validation_options, ["2", "resource_record_type"
                ])),
            zone_id=Token.as_string(data_aws_route53_zone_public_root_domain.zone_id)
        )
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        existing1 = Route53Record(self, "existing_1",
            ...
            name=Token.as_string(
                property_access(
                    property_access(existing_domain_validation_options, ["existing1.${" + public_root_domain.value + "}"
                    ]), ["name"])),
            records=[
                Token.as_string(
                    property_access(
        ...
        existing3 = Route53Record(self, "existing_3",
            ...
            name=Token.as_string(
                property_access(
                    property_access(existing_domain_validation_options, ["existing3.${" + public_root_domain.value + "}"
                    ]), ["name"])),
            records=[
                Token.as_string(
                    property_access(
...
<!-- cache-key: cdktf-0.17.1 input-cafb9442374ebbe14af7d62bc8f66e62550e48629c30694dfcb6daf5647b227b -->