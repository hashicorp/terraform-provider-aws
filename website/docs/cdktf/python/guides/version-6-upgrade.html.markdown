...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ApiGatewayDeployment(self, "example",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        BatchJobQueue(self, "example",
            compute_environments=[aws_batch_compute_environment_example.arn],
            name="patagonia",
            priority=1,
            state="ENABLED"
        )
    ...
    def __init__(self, scope, name):
        ...
        BatchJobQueue(self, "example",
            compute_environment_order=[BatchJobQueueComputeEnvironmentOrder(
                compute_environment=Token.as_string(aws_batch_compute_environment_example.arn),
                order=0
            )
            ],
            name="patagonia",
