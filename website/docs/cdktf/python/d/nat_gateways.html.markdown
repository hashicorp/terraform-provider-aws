...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        DataAwsNatGateway(self, "ngw",
            id=Token.as_string(property_access(Fn.tolist(ngws.ids), [ngw_count.index])),
            count=ngw_count
        )
```
...
<!-- cache-key: cdktf-0.17.1 input-3dfcb9644adaffbf7b3a6ffb1c20821b6b1308407d55040b08b25e3a1307ee56 -->