...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        DataAwsSecretsmanagerSecrets(self, "example",
            filter=[DataAwsSecretsmanagerSecretsFilter(
                name="name",
                values=["example"]
            )
            ]
...
<!-- cache-key: cdktf-0.20.9 input-150d44c91f421068bbfdaf75b6d510764b7e066887fe235c7afddf8fee2eaa61 -->