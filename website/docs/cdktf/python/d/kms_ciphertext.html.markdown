...
#
from imports.aws.data_aws_kms_ciphertext import DataAwsKmsCiphertext
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        DataAwsKmsCiphertext(self, "oauth",
...
<!-- cache-key: cdktf-0.20.9 input-b95133cf0e6d636d0e7e0bba6f81265bceaccd42767260a7c1b7aa55fb5a81e8 -->