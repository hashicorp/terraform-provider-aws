...
#
from imports.aws.data_aws_backup_framework import DataAwsBackupFramework
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsBackupFramework(self, "example",
...
<!-- cache-key: cdktf-0.20.9 input-070382f6ead1d1cc0b69de2f856a82f41ed348235bed7c03c3b9216ebaf43096 -->