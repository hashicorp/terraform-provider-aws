...
#
from imports.aws. import DataAwsBedrockagentAgentVersions
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsBedrockagentAgentVersions(self, "test",
            agent_id=aws_bedrockagent_agent_test.agent_id
        )
```
...
<!-- cache-key: cdktf-0.20.1 input-e8636da2e6a3484a7889e96812691570a2397695de11688fd63667f1878a7793 -->