...
#
from imports.aws.data_aws_ssm_patch_baseline import DataAwsSsmPatchBaseline
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsSsmPatchBaseline(self, "centos",
            name_prefix="AWS-",
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsSsmPatchBaseline(self, "default_custom",
