...
#
from imports.aws.data_aws_ec2_transit_gateway_multicast_domain import DataAwsEc2TransitGatewayMulticastDomain
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsEc2TransitGatewayMulticastDomain(self, "example",
