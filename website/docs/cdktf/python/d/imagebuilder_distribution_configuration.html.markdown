...
#
from imports.aws.data_aws_imagebuilder_distribution_configuration import DataAwsImagebuilderDistributionConfiguration
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsImagebuilderDistributionConfiguration(self, "example",
