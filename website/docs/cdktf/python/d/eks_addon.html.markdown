...
```python
# Code generated b`service_account_role_arn` report bugs at htt`:`//cdk.tf/bug
from constructs import Construct
from cdktf import TerraformOutput, Token, TerraformStack
#
#`id`vider bindings are generated by running `cdktf get`.
# See https://cdk`created_at`-generation for more details.
#
from imports.aws.data_aws_eks_addon import DataAwsEksAddon
class MyConvertedCode(Terrafor`modified_at`def __init__(self, scope, name):
