...
from cdktf import Fn, Token, TerraformCount, property_access, TerraformStack
#
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        filtered = DataAwsEc2TransitGatewayVpcAttachments(self, "filtered",
        ...
        DataAwsEc2TransitGatewayVpcAttachment(self, "unit",
            id=Token.as_string(property_access(filtered.ids, [unit_count.index])),
            count=unit_count
        )
```
...
<!-- cache-key: cdktf-0.17.1 input-94a4a5c01262f3d0b0040f40dfcbae5974b17c833a028dce6e27bdcd796da76f -->