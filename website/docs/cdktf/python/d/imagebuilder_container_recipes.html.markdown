...
#
from imports.aws.data_aws_imagebuilder_container_recipes import DataAwsImagebuilderContainerRecipes
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsImagebuilderContainerRecipes(self, "example",
...
<!-- cache-key: cdktf-0.20.9 input-5556cc7e6737887747c6c1b66b2640e6962330ec1998be772953787d4830860a -->