...
#
from imports.aws.data_aws_timestreamwrite_table import DataAwsTimestreamwriteTable
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsTimestreamwriteTable(self, "test",
            database_name=Token.as_string(aws_timestreamwrite_database_test.database_name),
            name=Token.as_string(aws_timestreamwrite_table_test.table_name)
        )
```
...
<!-- cache-key: cdktf-0.20.9 input-64cce03e034d1817777cb7a66a12bd88fb6b9a77007d581d6d9dc6359893b48a -->