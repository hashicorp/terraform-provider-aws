...
#
from imports.aws.data_aws_cloudwatch_contributor_managed_insight_rules import DataAwsCloudwatchContributorManagedInsightRules
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsCloudwatchContributorManagedInsightRules(self, "example",
