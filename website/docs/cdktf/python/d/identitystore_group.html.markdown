...
from cdktf import Fn, property_access, Token, TerraformOutput, TerraformStack
#
    ...
    def __init__(self, scope, name):
        ...
        data_aws_identitystore_group_example = DataAwsIdentitystoreGroup(self, "example_1",
            ...
            identity_store_id=Token.as_string(
                property_access(Fn.tolist(example.identity_store_ids), ["0"]))
        )
...
<!-- cache-key: cdktf-0.17.1 input-2fcb556c2eb46db4584d2fe081f0b7d851acf4cb81549c92e7a9b3bac001e703 -->