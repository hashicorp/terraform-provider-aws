    ...
    def __init__(self, scope, name, *, engine):
        ...
        aws_rds_cluster_example = RdsCluster(self, "example_1",
            master_password=Token.as_string(
                property_access(example.plaintext, ["\"master_password\""])),
            master_username=Token.as_string(
                property_access(example.plaintext, ["\"master_username\""])),
            engine=engine
        )
...
<!-- cache-key: cdktf-0.17.1 input-163ab67c377949aee00b00e3a19b28f529fc14cff02471ea6c0bd31a209a5b1d -->