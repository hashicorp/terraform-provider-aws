...
#
from imports.aws.data_aws_ec2_transit_gateway_peering_attachments import DataAwsEc2TransitGatewayPeeringAttachments
...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        filtered = DataAwsEc2TransitGatewayPeeringAttachments(self, "filtered",
            filter=[DataAwsEc2TransitGatewayPeeringAttachmentsFilter(
                name="state",
