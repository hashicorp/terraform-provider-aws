...
#
from imports.aws.data_aws_dms_endpoint import DataAwsDmsEndpoint
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsDmsEndpoint(self, "test",
            endpoint_id="test_id"
        )
```
...
<!-- cache-key: cdktf-0.20.9 input-998a5893daed445684f6f9e1f26e5c03b27e3ac275e8cdebccf3ef05a470a1a7 -->