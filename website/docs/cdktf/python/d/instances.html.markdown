...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_eip_test = Eip(self, "test_1",
            instance=Token.as_string(property_access(test.ids, [test_count.index])),
            count=test_count
        )
...
<!-- cache-key: cdktf-0.17.1 input-b32a570916ee4ab91b69b22089fb9eae9d1e369af64f851ec6954b99768d43fd -->