...
#
from imports.aws.data_aws_connect_hours_of_operation import DataAwsConnectHoursOfOperation
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        DataAwsConnectHoursOfOperation(self, "test",
...
<!-- cache-key: cdktf-0.20.9 input-86439a7339e655a280f3361f3160fa22a502fdea3b251d553d7e684d0a1b53cd -->