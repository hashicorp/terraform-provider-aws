...
* `identityId` - (Optional) A unique identifier in the format REGION:GUID.
...
* `principalTags` - (Optional) Use this operation to configure attribute mappings for custom providers.
