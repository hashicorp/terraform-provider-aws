...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const example = new MedialiveMultiplex(this, "example", {
      availabilityZones: [
        Token.asString(propertyAccess(available.names, ["0"])),
        Token.asString(propertyAccess(available.names, ["1"])),
      ],
      multiplexSettings: {
...
<!-- cache-key: cdktf-0.17.1 input-d0f4d6ecf5fbb8e34c4bfcc4ff4baddff29c0893a211fa29af99ff4cfade72b1 -->