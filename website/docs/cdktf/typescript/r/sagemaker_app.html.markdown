...
* `resourceSpec` - (Optional) The instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance.See [Resource Spec](#resource-spec) below.
