 ...
 */
import { OpsworksMemcachedLayer } from "./.gen/providers/aws/opsworks-memcached-layer";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new OpsworksMemcachedLayer(this, "cache", {
      stackId: main.id,
    });
  }
}
...
<!-- cache-key: cdktf-0.20.1 input-05a372e54fd07197c1f42442567c63b5866c6980883edb9054bbf50151850fd4 -->