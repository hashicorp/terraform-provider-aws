...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    KendraThesaurus.generateConfigForImport(
      this,
      "example",
      "thesaurus-123456780/idx-8012925589"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-c0dadf9d404f36bcb0eb8e47f42f731ded578d3015ecba91c35c34dacf029082 -->