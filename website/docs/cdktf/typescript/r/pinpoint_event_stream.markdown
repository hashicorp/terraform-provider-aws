...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import Pinpoint Event Stream using the `applicationId`. For example:
...
Using `terraform import`, import Pinpoint Event Stream using the `applicationId`. For example:

```console
% terraform import aws_pinpoint_event_stream.stream application-id
```

<!-- cache-key: cdktf-0.17.1 input-781c351d9404f1abba2f962888a231281d00739d19baa3253947f07c74cba124 -->