...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import WorkLink Website Certificate Authority using `fleetArn,websiteCaId`. For example:
...
Using `terraform import`, import WorkLink Website Certificate Authority using `fleetArn,websiteCaId`. For example:
