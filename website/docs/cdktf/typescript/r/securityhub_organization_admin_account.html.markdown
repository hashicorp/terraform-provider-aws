...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    SecurityhubOrganizationAdminAccount.generateConfigForImport(
      this,
      "example",
      "123456789012"
    );
...
<!-- cache-key: cdktf-0.20.9 input-83f23d6f1c3f73f98991d420d396e1f7a78ea374e63126ce3c3d410cf5917cbd -->