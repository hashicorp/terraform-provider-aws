 ...
 */
import { RdsCertificate } from "./.gen/providers/aws/rds-certificate";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new RdsCertificate(this, "example", {
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    RdsCertificate.generateConfigForImport(this, "example", "${default}");
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-873f171ae10cace77e0e04fd00e2dc1192be9f05baa882b62e376e718f07dea2 -->