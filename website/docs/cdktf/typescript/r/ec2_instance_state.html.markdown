...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsEc2InstanceState` using the `instanceId` attribute. For example:
...
Using `terraform import`, import `awsEc2InstanceState` using the `instanceId` attribute. For example:

```console
% terraform import aws_ec2_instance_state.test i-02cae6557dfcf2f96
```

<!-- cache-key: cdktf-0.17.1 input-55ec6962efa979f04735e3258bd738fd11e346e716880406215eee2600843353 -->