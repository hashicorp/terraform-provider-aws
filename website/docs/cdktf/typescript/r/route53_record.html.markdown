...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const awsRoute53RecordExample = new Route53Record(this, "example_1", {
      ...
      name: "test.example.com",
      records: [
        Token.asString(propertyAccess(example.nameServers, ["0"])),
        Token.asString(propertyAccess(example.nameServers, ["1"])),
        Token.asString(propertyAccess(example.nameServers, ["2"])),
        Token.asString(propertyAccess(example.nameServers, ["3"])),
      ],
      ttl: 172800,
      type: "NS",
...
<!-- cache-key: cdktf-0.17.1 input-ff3c2884016714726f134a120fd1d35b335e3a18fa3df771cb63253090a4eb1e -->