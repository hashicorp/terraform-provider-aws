  ...
  constructor(scope: Construct, name: string) {
    ...
    new SpotFleetRequest(this, "example", {
      ...
      launchSpecification: exampleDynamicIterator0.dynamic({
        ...
        subnet_id: propertyAccess(exampleDynamicIterator0.value, ["subnet_id"]),
        tags: {
          Name: "Spot Node",
          tag_builder: "builder",
        },
      ...
      launchTemplateConfig: [
        {
          ...
          overrides: [
            {
              subnetId: Token.asString(propertyAccess(example.ids, ["0"])),
            },
            {
              subnetId: Token.asString(propertyAccess(example.ids, ["1"])),
            },
            {
              subnetId: Token.asString(propertyAccess(example.ids, ["2"])),
            },
          ],
        },
      ],
