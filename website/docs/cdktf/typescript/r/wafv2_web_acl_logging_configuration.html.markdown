...
* `logDestinationConfigs` - (Required) Configuration block that allows you to associate Amazon Kinesis Data Firehose, Cloudwatch Log log group, or S3 bucket Amazon Resource Names (ARNs) with the web ACL.
...
<!-- cache-key: cdktf-0.17.1 input-60ef699b0482de4af25573a90d2e9c0b9fd3b109babb987aeed3f47916d34b11 -->