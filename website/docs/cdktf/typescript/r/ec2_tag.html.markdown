...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsEc2Tag` using the EC2 resource identifier and key, separated by a comma (`,`). For example:
...
Using `terraform import`, import `awsEc2Tag` using the EC2 resource identifier and key, separated by a comma (`,`). For example:

```console
% terraform import aws_ec2_tag.example tgw-attach-1234567890abcdef,Name
```

<!-- cache-key: cdktf-0.17.1 input-426f65492ad1473d61135571b53f491b7c40004b57450d752d563e20252feea5 -->