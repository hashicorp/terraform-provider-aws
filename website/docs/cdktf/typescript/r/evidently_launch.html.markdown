...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    EvidentlyLaunch.generateConfigForImport(
      this,
      "example",
      "exampleLaunchName:exampleProjectName"
    );
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    EvidentlyLaunch.generateConfigForImport(
      this,
      "example",
      "exampleLaunchName:arn:aws:evidently:us-east-1:123456789012:project/exampleProjectName"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.1 input-aae11bd8a9c8b5e230e84e3f211fbabba6612255938e01ceece5ed580fbee328 -->