...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import Athena Prepared Statement using the `workgroupName/statementName`. For example:
...
Using `terraform import`, import Athena Prepared Statement using the `workgroupName/statementName`. For example:
