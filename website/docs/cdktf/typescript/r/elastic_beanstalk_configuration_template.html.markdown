...
import { ElasticBeanstalkConfigurationTemplate } from "./.gen/providers/aws/elastic-beanstalk-configuration-template";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new ElasticBeanstalkConfigurationTemplate(this, "tf_template", {
