...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const awsSubnetExampleSecondary = new Subnet(this, "example-secondary_8", {
      availabilityZone: Token.asString(
        propertyAccess(availableSecondary.names, [exampleSecondaryCount.index])
      ),
      cidrBlock: Token.asString(
        Fn.cidrsubnet(
      ...
      "example_9",
      {
        ...
        vpcSettings: {
          subnetIds: Token.asList(
            propertyAccess(awsSubnetExample, ["*", "id"])
          ),
          vpcId: example.id,
        },
      }
    ...
    const awsDirectoryServiceRegionExample = new DirectoryServiceRegion(
      ...
      "example_10",
      {
        ...
        vpcSettings: {
          subnetIds: Token.asList(
            propertyAccess(awsSubnetExampleSecondary, ["*", "id"])
          ),
          vpcId: exampleSecondary.id,
        },
      }
...
<!-- cache-key: cdktf-0.17.1 input-20d7af9911cb4ea2ab9c63d5899325921c11d1438c0a0bd4b54c4be7952b8fff -->