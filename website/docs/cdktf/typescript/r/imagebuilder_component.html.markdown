...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsImagebuilderComponents` resources using the Amazon Resource Name (ARN). For example:
...
Using `terraform import`, import `awsImagebuilderComponents` resources using the Amazon Resource Name (ARN). For example:
...
<!-- cache-key: cdktf-0.17.1 input-7920aa22e67cfcf51eafb7a57251408d3c0e3878496f0aa735aa73051dd90d92 -->