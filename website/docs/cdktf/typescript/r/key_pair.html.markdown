...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import Key Pairs using the `keyName`. For example:
...
Using `terraform import`, import Key Pairs using the `keyName`. For example:
...
<!-- cache-key: cdktf-0.17.1 input-bc4b2bf30b41e8b680f59b0e745bd630e891fca6baac140b343a76369eb3e8aa -->