...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsRolesanywhereProfile` using its `id`. For example:
...
Using `terraform import`, import `awsRolesanywhereProfile` using its `id`. For example:

```console
% terraform import aws_rolesanywhere_profile.example db138a85-8925-4f9f-a409-08231233cacf
```

<!-- cache-key: cdktf-0.17.1 input-6014aa495fc385a2acfb6b7b4cb2e96800954c65d55817afa8439b60e41c2538 -->