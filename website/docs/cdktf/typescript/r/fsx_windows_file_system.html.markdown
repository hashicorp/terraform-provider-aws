...
* `diskIopsConfiguration` - (Optional) The SSD IOPS configuration for the Amazon FSx for Windows File Server file system. See [`diskIopsConfiguration` Block](#disk_iops_configuration-block) for details.
...
### `auditLogConfiguration` Block

The `auditLogConfiguration` configuration block supports the following arguments:
...
### `selfManagedActiveDirectory` Block
...
<!-- cache-key: cdktf-0.20.9 input-7fa8e6f410a078e6243e08b1d44003de54acd11d819ea1c8c9817cd9106d7c9c -->