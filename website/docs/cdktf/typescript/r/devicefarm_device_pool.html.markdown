 ...
 */
import { DevicefarmDevicePool } from "./.gen/providers/aws/devicefarm-device-pool";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DevicefarmDevicePool(this, "example", {
      name: "example",
      projectArn: Token.asString(awsDevicefarmProjectExample.arn),
      rule: [
        {
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    DevicefarmDevicePool.generateConfigForImport(
      this,
      "example",
      "arn:aws:devicefarm:us-west-2:123456789012:devicepool:4fa784c7-ccb4-4dbf-ba4f-02198320daa1/4fa784c7-ccb4-4dbf-ba4f-02198320daa1"
    );
  }
}
