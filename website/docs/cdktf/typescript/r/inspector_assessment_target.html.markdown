...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    InspectorAssessmentTarget.generateConfigForImport(
      this,
      "example",
      "arn:aws:inspector:us-east-1:123456789012:target/0-xxxxxxx"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.8 input-751090ce084efdbf0b345dca096fd95c6240e0d6d09be01dcacf39cbb869bd19 -->