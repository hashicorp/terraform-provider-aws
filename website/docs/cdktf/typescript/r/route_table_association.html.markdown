...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new RouteTableAssociation(this, "a", {
      routeTableId: bar.id,
      subnetId: foo.id,
    });
  }
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new RouteTableAssociation(this, "b", {
      gatewayId: foo.id,
      routeTableId: bar.id,
    });
  }
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    RouteTableAssociation.generateConfigForImport(
      this,
      "assoc",
      "subnet-6777656e646f6c796e/rtb-656c65616e6f72"
    );
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    RouteTableAssociation.generateConfigForImport(
      this,
      "assoc",
      "igw-01b3a60780f8d034a/rtb-656c65616e6f72"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.1 input-4552818b4878e80d058998466d30965c95d752e528e046f4f7a9999a8dfcb719 -->