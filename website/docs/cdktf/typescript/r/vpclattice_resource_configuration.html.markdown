 ...
 */
import { VpclatticeResourceConfiguration } from "./.gen/providers/aws/";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new VpclatticeResourceConfiguration(this, "example", {
      ...
      resource_gateway_identifier: awsVpclatticeResourceGatewayExample.id,
      tags: {
        Environment: "Example",
      },
    });
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new VpclatticeResourceConfiguration(this, "test", {
      ...
      resource_gateway_identifier: awsVpclatticeResourceGatewayTest.id,
      type: "ARN",
    });
  }
}
