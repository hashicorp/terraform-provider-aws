...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    DatasyncLocationFsxWindowsFileSystem.generateConfigForImport(
      this,
      "example",
...
<!-- cache-key: cdktf-0.20.9 input-4eec17500a279969bf934f139b5e4af49e794bbe75e137b1fefca8b157890cbf -->