 ...
 */
import { SesTemplate } from "./.gen/providers/aws/ses-template";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new SesTemplate(this, "MyTemplate", {
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    SesTemplate.generateConfigForImport(this, "myTemplate", "MyTemplate");
  }
}
...
<!-- cache-key: cdktf-0.20.8 input-89f6a47e22acad1bd893a7574f8e49d30c8778128ae5a667746ded2b1f55f3f8 -->