...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new MqBroker(this, "example_primary", {
      applyImmediately: true,
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    MqBroker.generateConfigForImport(
      this,
      "example",
...
<!-- cache-key: cdktf-0.20.8 input-2a127239eced2a03086d54bb37e844bd5331b396884465afcaabe829bfcb0ae5 -->