...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import EBS Volume Attachments using `deviceName:volumeId:instanceId`. For example:
...
Using `terraform import`, import EBS Volume Attachments using `deviceName:volumeId:instanceId`. For example:
...
<!-- cache-key: cdktf-0.17.1 input-8d70c75bb952f6c2a4ba80ab20190c8861ad57f287b2752a94e208c0c56f0a76 -->