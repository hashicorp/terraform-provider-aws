 ...
 */
import { RamSharingWithOrganization } from "./.gen/providers/aws/ram-sharing-with-organization";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new RamSharingWithOrganization(this, "example", {});
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    RamSharingWithOrganization.generateConfigForImport(
      this,
      "example",
      "123456789012"
    );
...
<!-- cache-key: cdktf-0.20.1 input-0c4fa7fe1ef6a2bea6e88c0be32053d41d723ebfb97b9b5e06eddaaf8a239ae7 -->