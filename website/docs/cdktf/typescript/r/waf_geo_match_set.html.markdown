 ...
 */
import { WafGeoMatchSet } from "./.gen/providers/aws/waf-geo-match-set";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new WafGeoMatchSet(this, "geo_match_set", {
      geoMatchConstraint: [
        {
          type: "Country",
          value: "US",
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    WafGeoMatchSet.generateConfigForImport(
      this,
      "example",
...
<!-- cache-key: cdktf-0.20.1 input-c1ffab5d5b03d4b8b05b08bb866e76580c89d0afb01bede81ffc61a97685962b -->