...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import DataExchange Revisions using their `dataSetId:revisionId`. For example:
...
Using `terraform import`, import DataExchange Revisions using their `dataSetId:revisionId`. For example:
...
<!-- cache-key: cdktf-0.17.1 input-1dff294cf3af4fd0944cbd190d7f06ffbbea96e953f96933b6e5b54e4c8fdcd1 -->