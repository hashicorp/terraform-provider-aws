...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    StoragegatewayTapePool.generateConfigForImport(
      this,
      "example",
      "arn:aws:storagegateway:us-east-1:123456789012:tapepool/pool-12345678"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-dba7df3eb905d7a9811189b7532fba2b7eb6c8127d9f909ad0446160863c1c13 -->