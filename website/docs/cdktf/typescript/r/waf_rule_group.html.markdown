...
* `name` - (Optional) Name of the rule group. If omitted, Terraform will assign a random, unique name. Conflicts with `namePrefix`.
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    WafRuleGroup.generateConfigForImport(
      this,
      "example",
...
<!-- cache-key: cdktf-0.20.1 input-55ab96b827dc2a0f93ec875d666102ecc7d13a2de2d65c381747b9a8c9c72a79 -->