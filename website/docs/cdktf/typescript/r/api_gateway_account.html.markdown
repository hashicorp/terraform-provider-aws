...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import API Gateway Accounts using the word `apiGatewayAccount`. For example:
...
Using `terraform import`, import API Gateway Accounts using the word `apiGatewayAccount`. For example:
