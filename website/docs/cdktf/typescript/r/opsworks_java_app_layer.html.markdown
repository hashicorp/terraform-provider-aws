 ...
 */
import { OpsworksJavaAppLayer } from "./.gen/providers/aws/opsworks-java-app-layer";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new OpsworksJavaAppLayer(this, "app", {
      stackId: main.id,
    });
  }
}
...
<!-- cache-key: cdktf-0.20.1 input-22f1dac0366505ea416dcd52815ba922756da61064d917cfb0310e814c99266a -->