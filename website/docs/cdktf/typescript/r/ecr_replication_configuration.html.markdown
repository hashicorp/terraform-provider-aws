          ...
          rule: [
            {
              destination: [
                {
                  region: Token.asString(propertyAccess(example.names, ["0"])),
          ...
          rule: [
            {
              destination: [
                ...
                {
                  region: Token.asString(propertyAccess(example.names, ["1"])),
                  registryId: Token.asString(current.accountId),
                },
              ],
            },
...
<!-- cache-key: cdktf-0.17.1 input-1e720b09bffb1410913da15b1daa4aaef042cc175055603ba3335ca4406730fc -->