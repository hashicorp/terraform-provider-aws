...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    VpcIpv4CidrBlockAssociation.generateConfigForImport(
      this,
      "example",
      "vpc-cidr-assoc-021e8461d70ed08be"
    );
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    VpcIpv4CidrBlockAssociation.generateConfigForImport(
      this,
      "example",
      "vpc-cidr-assoc-021e8461d70ed08be,ipam-pool-0a07c432810393463"
    );
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    VpcIpv4CidrBlockAssociation.generateConfigForImport(
      this,
      "example",
      "vpc-cidr-assoc-021e8461d70ed08be,ipam-pool-0a07c432810393463,28"
    );
  }
}
