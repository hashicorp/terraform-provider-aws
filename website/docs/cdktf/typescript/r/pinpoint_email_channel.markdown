...
* `fromAddress` - (Required) The email address used to send emails from. You can use email only (`user@exampleCom`) or friendly address (`User <user@example.com>`). This field comply with [RFC 5322](https://www.ietf.org/rfc/rfc5322.txt).
...
<!-- cache-key: cdktf-0.17.1 input-669b9a713da9a2dec982762fd0942f91a639ba307f5affad6cecab1234f05e8f -->