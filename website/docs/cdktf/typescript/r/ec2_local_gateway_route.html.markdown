...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    Ec2LocalGatewayRoute.generateConfigForImport(
      this,
      "example",
      "lgw-rtb-12345678_172.16.0.0/16"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-760f4fd810c3df45b557ef2e81d281f4a76d35aed253a5917f9f7fd6971b06b0 -->