...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsMacie2Member` using the account ID of the member account. For example:
...
Using `terraform import`, import `awsMacie2Member` using the account ID of the member account. For example:

```console
% terraform import aws_macie2_member.example 123456789012
```

<!-- cache-key: cdktf-0.17.1 input-270188c839fbbf61a15582b99048abc7d28b091c50c92930247fa2315358a77d -->