...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import Cloud9 environment membership using the `environmentId#userArn`. For example:
...
Using `terraform import`, import Cloud9 environment membership using the `environmentId#userArn`. For example:
