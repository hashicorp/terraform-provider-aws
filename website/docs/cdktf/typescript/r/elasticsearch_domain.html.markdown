  ...
  constructor(scope: Construct, name: string) {
    ...
    const awsElasticsearchDomainEs = new ElasticsearchDomain(this, "es_8", {
      ...
      vpcOptions: {
        ...
        subnetIds: [
          Token.asString(propertyAccess(dataAwsSubnetsSelected.ids, ["0"])),
          Token.asString(propertyAccess(dataAwsSubnetsSelected.ids, ["1"])),
        ],
      },
    });
    /*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
...
<!-- cache-key: cdktf-0.17.1 input-2ba3b0b9b5de9cf5e4bfb0c3d93db7aa5852b5b15d23694c08cdf16cdf8481e6 -->