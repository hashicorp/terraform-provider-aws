 ...
 */
import { VpcEndpointServicePrivateDnsVerification } from "./.gen/providers/aws/vpc-endpoint-service-private-dns-verification";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new VpcEndpointServicePrivateDnsVerification(this, "example", {
      serviceId: Token.asString(awsVpcEndpointServiceExample.id),
    });
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-4671d8cf2673b68762d7174f6686d4fd96e13d38210b0d5fa7bab0049cc74bc4 -->