...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsLightsailDisk` using the name attribute. For example:
...
Using `terraform import`, import `awsLightsailDisk` using the name attribute. For example:

```console
% terraform import aws_lightsail_disk.test test
```

<!-- cache-key: cdktf-0.17.1 input-7753e5e8b07d0ea697ccda6f53778fce21cb9f997c8e2dfbe4fb7552ab0ed771 -->