...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    DefaultNetworkAcl.generateConfigForImport(this, "sample", "acl-7aaabd18");
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-1ee0cdf2a65fb9b81bf170ed16e018fb9c51a76e5efe0185e333f268f198ed71 -->