...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const sqsQueuePolicy = new DataAwsIamPolicyDocument(
      ...
      {
        policyId:
          "arn:aws:sqs:us-west-2:123456789012:user_updates_queue/SQSDefaultPolicy",
        statement: [
          {
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const sqsQueue = new SqsQueue(this, "sqs_queue", {
    ...
    awsSnsTopicSubscriptionSnsTopic.overrideLogicalId("sns_topic");
  }
}
...
This example demonstrates how to define a `deliveryPolicy` for an HTTPS subscription. Unlike the `aws_sns_topic` resource, the `deliveryPolicy` for `aws_sns_topic_subscription` should not be wrapped in an `"http"` object.
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new SnsTopicSubscription(this, "example_with_delivery_policy", {
      deliveryPolicy:
...
<!-- cache-key: cdktf-0.20.8 input-481921e69616672308afc7cf698dfebc33439d2dbadb62b5ed7a6942e89ca73d -->