...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsAppstreamDirectoryConfig` using the id. For example:
...
Using `terraform import`, import `awsAppstreamDirectoryConfig` using the id. For example:

```console
% terraform import aws_appstream_directory_config.example directoryNameExample
```

<!-- cache-key: cdktf-0.17.1 input-cc4dcd0e21d4459a6f134b5283f0f40cf04088ba29d91cc8b5c68f07a92ceeb9 -->