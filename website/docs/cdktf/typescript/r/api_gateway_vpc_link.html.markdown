...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const awsApiGatewayVpcLinkExample = new ApiGatewayVpcLink(
      this,
      "example_1",
      {
        description: "example description",
        name: "example",
        targetArns: [example.arn],
      }
    );
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    ApiGatewayVpcLink.generateConfigForImport(this, "example", "12345abcde");
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-67ae655f1b594d4a56352e7b95e9f98e0a7e757e376024aa97ec46526256091e -->