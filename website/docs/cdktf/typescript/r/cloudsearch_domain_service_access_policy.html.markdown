...
import { CloudsearchDomainServiceAccessPolicy } from "./.gen/providers/aws/cloudsearch-domain-service-access-policy";
import { DataAwsIamPolicyDocument } from "./.gen/providers/aws/data-aws-iam-policy-document";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    const example = new CloudsearchDomain(this, "example", {
      name: "example-domain",
    });
    ...
    const awsCloudsearchDomainServiceAccessPolicyExample =
      new CloudsearchDomainServiceAccessPolicy(this, "example_2", {
        accessPolicy: Token.asString(dataAwsIamPolicyDocumentExample.json),
...
<!-- cache-key: cdktf-0.17.1 input-c2ebea6afae4e24a2fd5837f7a4fbdb9c6667ec6f7293e498314a0c3b1c43e87 -->