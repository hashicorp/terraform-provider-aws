...
* `analyticsEngine` - (Optional) Analytics engine used by the collaboration. Valid values are `CLEAN_ROOMS_SQL` (deprecated) and `SPARK`.
...
* `updatedTime` - Date and time the collaboration was last updated.
...
<!-- cache-key: cdktf-0.20.8 input-492dd57fa3c90d45415487b8764ba8b18f80b2eda96166eeaba95c6664ba5b62 -->