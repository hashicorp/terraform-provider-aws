...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import SageMaker AI Workforces using the `workforceName`. For example:
...
Using `terraform import`, import SageMaker AI Workforces using the `workforceName`. For example:
