...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const awsLexv2ModelsBotExample = new Lexv2ModelsBot(this, "example_1", {
      dataPrivacy: [
        {
          childDirected: false,
        },
    ...
    awsLexv2ModelsBotExample.overrideLogicalId("example");
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    Lexv2ModelsBot.generateConfigForImport(this, "example", "bot-id-12345678");
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-2d5c17d5b236548880764f250ad235cee892b9d3db7b5cf759003e8a5990aa67 -->