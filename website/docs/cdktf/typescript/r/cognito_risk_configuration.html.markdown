...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    CognitoRiskConfiguration.generateConfigForImport(this, "main", "example");
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    CognitoRiskConfiguration.generateConfigForImport(
      this,
      "main",
      "example:example"
    );
...
<!-- cache-key: cdktf-0.20.9 input-b75593cc575d1cd95ecde1a9b1a8a4e0bd77767201715d4f626c2fa0398eed4b -->