...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    Ec2LocalGatewayRouteTableVpcAssociation.generateConfigForImport(
      this,
      "example",
      "lgw-vpc-assoc-1234567890abcdef"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.8 input-f4f905dac47ee96e216b29234377003c85028f4754efe49a90ad2269ba720a64 -->