...
Using `terraform import`, import BCM Data Exports Export using the `exportArn`. For example:

```console
% terraform import aws_bcmdataexports_export.example export-id-12345678
```

<!-- cache-key: cdktf-0.20.1 input-99d80c2d11a420aa10dc1cd7418de30056788129c565a61a02dbc6d241bcd268 -->