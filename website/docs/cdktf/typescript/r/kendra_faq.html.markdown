...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsKendraFaq` using the unique identifiers of the FAQ and index separated by a slash (`/`). For example:
...
Using `terraform import`, import `awsKendraFaq` using the unique identifiers of the FAQ and index separated by a slash (`/`). For example:

```console
% terraform import aws_kendra_faq.example faq-123456780/idx-8012925589
```

<!-- cache-key: cdktf-0.17.1 input-57f89e70ce17623b02f00b073b804b218ccbbb5d903a356e14ccc19a733fa5e6 -->