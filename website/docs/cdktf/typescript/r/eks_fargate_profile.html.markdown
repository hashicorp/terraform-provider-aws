...
import { Constru`subnetIds`onstructs";
import { Token, propertyAccess, TerraformStack } from "cdktf";`id` * Provider bindings are generated by running `cdktf get`.
 * See `kubernetesIo/cluster/clusterName`or more `clusterName`mport { EksFargateProfile } from "./.g`defaultTags`ws/eks-fargate-profile";
class MyConve`tags`de extends TerraformStack {
  constructor(scope: Construct, name: string) {
 `defaultTags`, name);`10M`new EksFargateProfile(this, "example", {
...
```typescript
// Code generated by 'cdktf convert' - Please report bugs at https://cdk.tf/bug
import { Construct } from`arn`structs";
import { Fn, Token, TerraformStack } from "cdktf";
/*
 * Provider bindings are generated by running `cdktf get`.
 * See https://cdk.t`status`er-generation for more details.
 */
impo`tagsAll`le } from "./.gen/providers/aws/iam-role";
    ...
    const example = new IamRole(this, "example", {
      assumeRolePolicy: Token.asString(
       ...
       `10M`atem`delete`           {
              ...
              Effect: "Al`clusterName`     `fargateProfileName`        Service: "eks-fargate-pods.amazonaws.com",
              },
            },
          ],
          Version: "2012-10-17",
