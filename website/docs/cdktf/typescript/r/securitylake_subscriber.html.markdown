...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    SecuritylakeSubscriber.generateConfigForImport(
      this,
      "example",
      "arn:aws:securitylake:eu-west-2:1234567890:subscriber/9f3bfe79-d543-474d-a93c-f3846805d208"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.1 input-7088cf1d01bd9122da12e1ceca15f2c333f57889ab94301531cfb8aff6f11f73 -->