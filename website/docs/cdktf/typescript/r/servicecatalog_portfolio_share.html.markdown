...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    ServicecatalogPortfolioShare.generateConfigForImport(
      this,
      "example",
      "port-12344321:ACCOUNT:123456789012"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-2bfc4e872e821217e1db9b54e4495ec060f98eb8c8810ca144d89c25443c542e -->