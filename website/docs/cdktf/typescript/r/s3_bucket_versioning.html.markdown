...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    S3BucketVersioningA.generateConfigForImport(this, "example", "bucket-name");
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    S3BucketVersioningA.generateConfigForImport(
      this,
      "example",
...
<!-- cache-key: cdktf-0.20.1 input-f387859e1c4ace75d718b32236f2b55857b5ddbb6588f6fc4186285c2f0e2659 -->