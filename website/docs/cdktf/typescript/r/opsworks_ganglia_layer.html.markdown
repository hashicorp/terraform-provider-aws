 ...
 */
import { OpsworksGangliaLayer } from "./.gen/providers/aws/opsworks-ganglia-layer";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new OpsworksGangliaLayer(this, "monitor", {
      password: "foobarbaz",
      stackId: main.id,
    });
  }
...
<!-- cache-key: cdktf-0.20.1 input-cd3f72f3fcce85e722f3f818cc5881919d478fd39c4c26ac44c9940408fce59f -->