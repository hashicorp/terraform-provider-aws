...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import AWS API Gateway Authorizer using the `restApiId/authorizerId`. For example:
...
Using `terraform import`, import AWS API Gateway Authorizer using the `restApiId/authorizerId`. For example:

```console
% terraform import aws_api_gateway_authorizer.authorizer 12345abcde/example
```

<!-- cache-key: cdktf-0.17.1 input-2079e78abb2de34b252c2d1829bd6d6c7b5e8eea6a54c81a845e12111109c59f -->