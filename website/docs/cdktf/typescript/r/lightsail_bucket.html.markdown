...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    LightsailBucket.generateConfigForImport(this, "test", "example-bucket");
  }
}
...
<!-- cache-key: cdktf-0.20.1 input-d78cdd83a8835a614b707d0e291b7c234f89104b66f2a32a7706513d7cce144c -->