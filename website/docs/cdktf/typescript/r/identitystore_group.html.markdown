...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    IdentitystoreGroup.generateConfigForImport(
      this,
      "example",
      "d-9c6705e95c/b8a1c340-8031-7071-a2fb-7dc540320c30"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-77081370c526c7da03dc3c3f8a50e4bd16a1ba6cea9abd0f209e0c794a9106bf -->