...
import { Token, TerraformCount, propertyAccess, TerraformStack } from "cdktf";
/*
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new Route53Record(this, "example_amazonses_dkim_record", {
      name:
        Token.asString(
          propertyAccess(awsSesDomainDkimExample.dkimTokens, [
...
<!-- cache-key: cdktf-0.17.1 input-39725dfa611ba6cca577c30709217ceb82a4f67575d3367fd44ba5c674ea4983 -->