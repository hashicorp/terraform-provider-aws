...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import EMR studio session mappings using `studioId:identityType:identityId`. For example:
...
Using `terraform import`, import EMR studio session mappings using `studioId:identityType:identityId`. For example:

```console
% terraform import aws_emr_studio_session_mapping.example es-xxxxx:USER:xxxxx-xxx-xxx
```

<!-- cache-key: cdktf-0.17.1 input-6be21ee08f5326f461796bd38e16a942ea254529c5e303950bf2b3a3f049afa4 -->