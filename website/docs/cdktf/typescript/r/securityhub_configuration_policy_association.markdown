...
import { SecurityhubConfigurationPolicyAssociation } from "./.gen/providers/aws/securityhub-configuration-policy-association";
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new SecurityhubConfigurationPolicyAssociation(this, "account_example", {
      policyId: Token.asString(awsSecurityhubConfigurationPolicyExample.id),
