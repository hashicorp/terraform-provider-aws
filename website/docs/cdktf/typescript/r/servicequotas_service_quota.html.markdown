...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsServicequotasServiceQuota` using the service code and quota code, separated by a front slash (`/`). For example:
...
Using `terraform import`, import `awsServicequotasServiceQuota` using the service code and quota code, separated by a front slash (`/`). For example:
...
<!-- cache-key: cdktf-0.17.1 input-8925c6b8aa699116dcad422ba2332dd43139659327e20ceb1d3df872c9c113ea -->