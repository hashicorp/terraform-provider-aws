 ...
 */
import { IvsPlaybackKeyPair } from "./.gen/providers/aws/ivs-playback-key-pair";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new IvsPlaybackKeyPair(this, "example", {
      publicKey: Token.asString(Fn.file("./public-key.pem")),
    });
  }
}
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    IvsPlaybackKeyPair.generateConfigForImport(
      this,
      "example",
      "arn:aws:ivs:us-west-2:326937407773:playback-key/KDJRJNQhiQzA"
    );
  }
}
