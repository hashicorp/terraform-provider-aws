 ...
 */
import { RedshiftDataShareAuthorization } from "./.gen/providers/aws/redshift-data-share-authorization";
...
* `consumerIdentifier` - (Required) Identifier of the data consumer that is authorized to access the datashare. This identifier is an AWS account ID or a keyword, such as `ADX`.
* `dataShareArn` - (Required) Amazon Resource Name (ARN) of the datashare that producers are to authorize sharing for.
...
* `id` - A comma-delimited string concatenating `dataShareArn` and `consumerIdentifier`.
...
<!-- cache-key: cdktf-0.20.8 input-dc3a17ac6bda6d7316c30a94de4347cba29e545e22910c9152a354a5526aa233 -->