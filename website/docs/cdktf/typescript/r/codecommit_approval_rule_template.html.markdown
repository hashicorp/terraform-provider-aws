 ...
 */
import { CodecommitApprovalRuleTemplate } from "./.gen/providers/aws/codecommit-approval-rule-template";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new CodecommitApprovalRuleTemplate(this, "example", {
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    CodecommitApprovalRuleTemplate.generateConfigForImport(
      this,
      "imported",
      "ExistingApprovalRuleTemplateName"
    );
  }
}
