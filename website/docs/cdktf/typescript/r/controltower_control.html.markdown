  ...
  constructor(scope: Construct, name: string) {
    ...
    const dataAwsOrganizationsOrganizationalUnitsExample =
      new DataAwsOrganizationsOrganizationalUnits(this, "example_1", {
        parentId: Token.asString(propertyAccess(example.roots, ["0", "id"])),
      });
...
<!-- cache-key: cdktf-0.17.1 input-9eb1fc57f4835f2b8e9d32dc66ec655897e6e1d78cffd7254048eef1370885df -->