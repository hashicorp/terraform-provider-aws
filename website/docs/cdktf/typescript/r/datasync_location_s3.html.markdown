...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DatasyncLocationS3(this, "destination", {
      agentArns: [example.arn],
      s3BucketArn: Token.asString(awsS3AccessPointExample.arn),
      s3Config: {
        bucketAccessRoleArn: Token.asString(awsIamRoleExample.arn),
      },
...
* `s3StorageClass` - (Optional) Amazon S3 storage class that you want to store your files in when this location is used as a task destination. [Valid values](https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html#using-storage-classes)  
...
<!-- cache-key: cdktf-0.20.8 input-602d6b35937c6a5910bc8bcb38bb83eac8894a68cede303d25991fe39da713bb -->