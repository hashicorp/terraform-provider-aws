...
* `id` - A forward slash-delimited string concatenating `serviceIdentifier`, `listenerIdentifier`, and `ruleId`.
...
<!-- cache-key: cdktf-0.20.8 input-2ce4885aeda3f51075b0868b2a75d6a185abdd5966060f7435907f5f2e496547 -->