 ...
 */
import { PrometheusScraper } from "./.gen/providers/aws/";
      ...
      destination: [
        {
          amp: [
            {
              workspace_arn: awsPrometheusWorkspaceExample.arn,
            },
          ],
        },
      ],
      ...
      source: [
        {
          eks: [
            {
              cluster_arn: dataAwsEksClusterExample.arn,
              subnet_ids: Fn.lookupNested(dataAwsEksClusterExample.vpcConfig, [
                "0",
                "subnet_ids",
              ]),
            },
        ...
        source: [
          {
            eks: [
              {
                cluster_arn: dataAwsEksClusterExample.arn,
                subnet_ids: Fn.lookupNested(
                  dataAwsEksClusterExample.vpcConfig,
                  ["0", "subnet_ids"]
                ),
              },
            ],
