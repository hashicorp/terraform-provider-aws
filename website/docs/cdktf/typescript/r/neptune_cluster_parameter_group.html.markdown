 ...
 */
import { NeptuneClusterParameterGroup } from "./.gen/providers/aws/neptune-cluster-parameter-group";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new NeptuneClusterParameterGroup(this, "example", {
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    NeptuneClusterParameterGroup.generateConfigForImport(
      this,
      "clusterPg",
      "production-pg-1"
    );
...
<!-- cache-key: cdktf-0.20.1 input-3c39999f95e5475d491571cada3c79f247de16c4aa849b9cba8ecd969f7df95d -->