...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsEc2TransitGatewayVpcAttachment` using the EC2 Transit Gateway Attachment identifier. For example:
...
Using `terraform import`, import `awsEc2TransitGatewayVpcAttachment` using the EC2 Transit Gateway Attachment identifier. For example:

```console
% terraform import aws_ec2_transit_gateway_vpc_attachment.example tgw-attach-12345678
```

<!-- cache-key: cdktf-0.17.1 input-e76943b879789e9aa1c622ff0379f66692ea0b317120aa63e121af64f6a6d4c3 -->