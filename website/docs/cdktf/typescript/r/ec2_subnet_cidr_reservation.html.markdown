...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    Ec2SubnetCidrReservation.generateConfigForImport(
      this,
      "example",
      "subnet-01llsxvsxabqiymcz:scr-4mnvz6wb7otksjcs9"
    );
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-fc461a33a61b61090347c3aebed74b1fbf423338d6a3082dc4e7dd5963cc132c -->