...
import { Fn, Token, propertyAccess, TerraformStack } from "cdktf";
/*
    ...
    const awsSsoadminPermissionSetExample = new SsoadminPermissionSet(
      ...
      "example_2",
      {
        instanceArn: Token.asString(
          propertyAccess(Fn.tolist(dataAwsSsoadminInstancesExample.arns), ["0"])
        ),
        name: "Example",
      }
    );
...
<!-- cache-key: cdktf-0.17.1 input-95bb6767bb38c80b9a4e1b6387ef28cdfc43fb8b75c62aeb968db325390bfc1b -->