      ...
      new Kinesisanalyticsv2Application(this, "example_2", {
        applicationConfiguration: {
          ...
          vpcConfiguration: {
            securityGroupIds: [
              Token.asString(
                propertyAccess(awsSecurityGroupExample, ["0", "id"])
              ),
              Token.asString(
                propertyAccess(awsSecurityGroupExample, ["1", "id"])
              ),
            ],
...
<!-- cache-key: cdktf-0.17.1 input-6d238f855d065dc06f35d3883f4979e1a608611ece08c6d5911d2f7d1d7c3396 -->