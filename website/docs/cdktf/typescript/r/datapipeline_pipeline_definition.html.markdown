...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import `awsDatapipelinePipelineDefinition` using the id. For example:
...
Using `terraform import`, import `awsDatapipelinePipelineDefinition` using the id. For example:
