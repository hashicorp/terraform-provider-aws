...
// Code generated by 'cdktf convert' - Please report bugs at https://cdk.tf/bug
import { Construct } from "constructs";
import { TerraformOutput, Fn, propertyAccess, TerraformStack } from "cdktf";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new TerraformOutput(this, "example", {
      value: propertyAccess(Fn.jsondecode(example.secretString), ['"key1"']),
    });
  }
}
...
<!-- cache-key: cdktf-0.17.1 input-5f65f3c5e87dc3ce9fac6b2ac4088089f1f88f7a6df546f616bc7e3d7b3fd19d -->