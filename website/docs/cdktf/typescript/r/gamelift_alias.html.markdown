...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    GameliftAlias.generateConfigForImport(this, "example", "<alias-id>");
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-0388556f6d66db5cdeeff13f1605184c6bf94fb66ae580f7a99c34af9b175b72 -->