...
Use the navigation to the left to read about the available resources. There are currently 1336 resources and 548 data sources available in the provider.
...
* `tokenBucketRateLimiterCapacity` - (Optional) The capacity of the AWS SDK's token bucket retry rate limiter. By default each service's bucket has a capacity of 500 tokens.
...
<!-- cache-key: cdktf-0.20.1 input-ddb0437e7f27d86f48dfa2214615251aa1349acd153d448bf81d89cbc449fdd3 -->