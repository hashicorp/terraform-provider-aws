...
Use the navigation to the left to read about the available resources. There are currently 1497 resources and 604 data sources available in the provider.
...
* `assumeRole` - (Optional) List of configuration blocks for assuming an IAM role.
  See the [`assumeRole` Configuration Block](#assume_role-configuration-block) section below.
...
* `keyPrefixes` - (Optional) List of resource tag key prefixes to ignore across all resources handled by this provider.
...
<!-- cache-key: cdktf-0.20.8 input-fd67ec5efc8e2e1a4ff606df305e78993e9ab8672c589c0a71b7383b93d5f01c -->