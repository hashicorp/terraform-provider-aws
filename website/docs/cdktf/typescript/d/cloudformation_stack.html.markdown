...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new Instance(this, "web", {
      ...
      subnetId: Token.asString(propertyAccess(network.outputs, ['"SubnetId"'])),
      tags: {
        Name: "HelloWorld",
      },
    });
...
<!-- cache-key: cdktf-0.17.1 input-a9acea3392c4b01ef5f2a16da219c4a26f63291cbb995f3f40b2de0113d12c7d -->