 ...
 */
import { DataAwsCloudfrontOriginAccessControl } from "./.gen/providers/aws/data-aws-cloudfront-origin-access-control";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataAwsCloudfrontOriginAccessControl(this, "example", {
      id: "E2T5VTFBZJ3BJB",
    });
  }
}
