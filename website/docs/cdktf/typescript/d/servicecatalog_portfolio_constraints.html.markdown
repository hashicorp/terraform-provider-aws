 ...
 */
import { DataAwsServicecatalogPortfolioConstraints } from "./.gen/providers/aws/data-aws-servicecatalog-portfolio-constraints";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataAwsServicecatalogPortfolioConstraints(this, "example", {
...
<!-- cache-key: cdktf-0.20.9 input-f95e8d8a013aacf7b3916f6b479047744fecc334d40aba4c8da473d8e4af976e -->