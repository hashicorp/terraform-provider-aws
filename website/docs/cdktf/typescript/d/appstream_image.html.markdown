 ...
 */
import { DataAwsAppstreamImage } from "./.gen/providers/aws/data-aws-appstream-image";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataAwsAppstreamImage(this, "test", {
      mostRecent: true,
...
* `image error` - Resource error object that describes the error containing the following:
    ...
    * `errorMessage` - Error message of the image.
...
<!-- cache-key: cdktf-0.20.8 input-39f03a832e6704e24654ff2ffaed108e62f2139a01511d5bb7d35829e13a0986 -->