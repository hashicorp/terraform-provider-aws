 ...
 */
import { DataAwsDocdbEngineVersion } from "./.gen/providers/aws/data-aws-docdb-engine-version";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataAwsDocdbEngineVersion(this, "test", {
      version: "3.6.0",
    });
  }
}
...
<!-- cache-key: cdktf-0.20.8 input-551f8c39da9e4704102d050a7505855d613f3511c6df64ebd9c88d0d5533b8f5 -->