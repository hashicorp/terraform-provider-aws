 ...
 */
import { DataAwsSecurityGroup } from "./.gen/providers/aws/data-aws-security-group";
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    const securityGroupId = new TerraformVariable(
      this,
      "security_group_id",
      {}
    );
    const selected = new DataAwsSecurityGroup(this, "selected", {
