 ...
 */
import { DataAwsLbListenerRule } from "./.gen/providers/aws/data-aws-lb-listener-rule";
...
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new DataAwsLbListenerRule(this, "example", {
      listenerArn: lbListenerArn.stringValue,
      priority: lbRulePriority.numberValue,
    });
  }
}
...
<!-- cache-key: cdktf-0.20.8 input-15095189c28360cba3249376bfe822cf19713a058cdbf2fb55a2a5f9a9b9ceee -->