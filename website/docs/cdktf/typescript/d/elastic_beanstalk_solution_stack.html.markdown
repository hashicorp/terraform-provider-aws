 ...
 */
import { DataAwsElasticBeanstalkSolutionStack } from "./.gen/providers/aws/data-aws-elastic-beanstalk-solution-stack";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataAwsElasticBeanstalkSolutionStack(this, "multi_docker", {
      mostRecent: true,
