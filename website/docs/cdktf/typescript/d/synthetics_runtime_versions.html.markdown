 ...
 */
import { DataAwsSyntheticsRuntimeVersions } from "./.gen/providers/aws/data-aws-synthetics-runtime-versions";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataAwsSyntheticsRuntimeVersions(this, "example", {});
  }
}
...
* `runtimeVersions` - List of runtime versions. See [`runtimeVersions` attribute reference](#runtime_versions-attribute-reference).

### `runtimeVersions` Attribute Reference
...
<!-- cache-key: cdktf-0.20.8 input-e31363e80a8a71110dc91fea7ecab71b42bfd0014d1558a514d35963c2da5885 -->