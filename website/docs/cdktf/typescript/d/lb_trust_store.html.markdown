...
~> **Note:** `awsAlbTrustStore` is known as `awsLbTrustStore`. The functionality is identical.
 ...
 */
import { DataAwsLbTrustStore } from "./.gen/providers/aws/";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    /*Terraform Variables are not always the best fit for getting inputs in the context of Terraform CDK.
    You can read more about this at https://cdk.tf/variables*/
    const lbTsArn = new TerraformVariable(this, "lb_ts_arn", {
      default: "",
      type: VariableType.STRING,
    });
    const lbTsName = new TerraformVariable(this, "lb_ts_name", {
      default: "",
      type: VariableType.STRING,
    });
    new DataAwsLbTrustStore(this, "test", {
      arn: lbTsArn.value,
      name: lbTsName.value,
    });
  }
...
<!-- cache-key: cdktf-0.19.0 input-c65b04c16076ab67cd01f7b31cc6359b079e96f9f0919d6b1a421cc6e4d49836 -->