 ...
 */
import { DataAwsLbTrustStore } from "./.gen/providers/aws/data-aws-lb-trust-store";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    ...
    new DataAwsLbTrustStore(this, "test", {
      arn: lbTsArn.stringValue,
      name: lbTsName.stringValue,
    });
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-c65b04c16076ab67cd01f7b31cc6359b079e96f9f0919d6b1a421cc6e4d49836 -->