 ...
 */
import { DataAwsOdbDbNodes } from "./.gen/providers/aws/";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataAwsOdbDbNodes(this, "example", {
...
* `memorySizeInGbs` - The amount of memory, in gigabytes (GB), that's allocated on the DB node.
