 ...
 */
import { DataAwsSsmincidentsReplicationSet } from "./.gen/providers/aws/data-aws-ssmincidents-replication-set";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataAwsSsmincidentsReplicationSet(this, "example", {});
  }
}
...
<!-- cache-key: cdktf-0.20.1 input-39319f4ba29ed3dd3b2f5e50f169ffe1879a34918a97973bcb5a09f09dcd8369 -->