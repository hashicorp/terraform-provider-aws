 ...
 */
import { DataAwsEc2LocalGateways } from "./.gen/providers/aws/data-aws-ec2-local-gateways";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    const foo = new DataAwsEc2LocalGateways(this, "foo", {
      tags: {
        service: "production",
      },
    });
...
<!-- cache-key: cdktf-0.20.1 input-194cd66e7dae043fd6ed1ab7524f3a069880d0040e7bff6c2c060f60274071f5 -->