    ...
    const awsSubnetExample = new Subnet(this, "example_4", {
      cidrBlock: Token.asString(
        Fn.cidrsubnet(
          ...
          4,
          Token.asNumber(propertyAccess(azNumber.value, [example.nameSuffix]))
        )
      ),
...
<!-- cache-key: cdktf-0.17.1 input-862d7a30e7b7fec1243f9a3afe7925988e240b4d36970fb4f9743ee1e9a647b3 -->