 ...
 */
import { DataAwsEcrpublicAuthorizationToken } from "./.gen/providers/aws/data-aws-ecrpublic-authorization-token";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new DataAwsEcrpublicAuthorizationToken(this, "token", {});
  }
}
...
<!-- cache-key: cdktf-0.20.9 input-fc553185b1ad0893b42035538b008c8015883bff0b2f28b28094a5ed72a8fc63 -->