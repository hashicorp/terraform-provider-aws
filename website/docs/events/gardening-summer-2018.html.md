...
We will have a [Gitter](https://gitter.im/) room available (`hashicorp-terraform/gardening`) and a someone from HashiCorp on [Zoom conferencing](https://zoom.us/) through out the time zones.
